...
var k=new d.Appacitive.HttpRequest;k.url=j;k.method="put";b.__revision&&delete b.__revision;k.data=b;k.onSuccess=function(j){var k=null;if(j&&(j.article||j.connection||j.user||j.device))k=j.article||j.connection||j.user||j.device;j&&k?(c=k,b.__id=k.__id,e(k,b),h.connectionCollections&&0<h.connectionCollections.length&&h.connectionCollections.forEach(function(a){a.getQuery().extendOptions({articleId:b.__id})}),"connection"==h.type&&h.parseConnection(),d.Appacitive.eventManager.fire((h.schema||h.relation)+
"."+h.type+".created",h,{object:h}),"function"==typeof a&&a(h)):(j=j||{},j.status=j.status||{},j.status=l(j.status),d.Appacitive.eventManager.fire((h.schema||h.relation)+"."+h.type+".createFailed",h,{error:j.status}),"function"==typeof f&&f(j.status,h))};k.onError=function(b){b=l(b);"function"==typeof f&&f(b,h)};d.Appacitive.http.send(k);return this},t=function(f,h){f=f||function(){};h=h||function(){};var j=p(!0),k=this;if(j){var g=new d.Appacitive.HttpRequest,m=d.Appacitive.config.apiBaseUrl+d.Appacitive.storage.urlFactory[this.type].getUpdateUrl(b.__schematype||
b.__relationtype,c.__id?c.__id:b.__id,q);if(b&&b.__schematype&&("user"==b.__schematype.toLowerCase()||"device"==b.__schematype.toLowerCase()))m=d.Appacitive.config.apiBaseUrl+d.Appacitive.storage.urlFactory[b.__schematype.toLowerCase()].getUpdateUrl(c.__id);g.url=m;g.method="post";g.data=j;g.onSuccess=function(j){j&&(j.article||j.connection||j.user||j.device)?(e(b,a),c=j.article||j.connection||j.user||j.device,e(c,b),n=[],d.Appacitive.eventManager.fire((k.schema||k.relation)+"."+k.type+"."+b.__id+
".updated",k,{object:k}),"function"==typeof f&&f(k)):(j=j||{},j.status=j.status||{},j.status=l(j.status),d.Appacitive.eventManager.fire((k.schema||k.relation)+"."+k.type+"."+b.__id+".updateFailed",k,{object:j.status}),"function"==typeof h&&h(j.status,k))};g.onError=function(b){b=b||{};b.message=b.message||"Server error";b.code=b.code||"500";"function"==typeof h&&h(b,k)};d.Appacitive.http.send(g)}else"function"==typeof f&&f(k);return this};this.fetch=function(a,f){a=a||function(){};f=f||function(){};
if(b.__id){var h=this,j=d.Appacitive.config.apiBaseUrl+d.Appacitive.storage.urlFactory[this.type].getGetUrl(b.__schematype||b.__relationtype,b.__id,q),k=new d.Appacitive.HttpRequest;k.url=j;k.method="get";k.onSuccess=function(d){d&&(d.article||d.connection||d.user||d.device)?(c=d.article||d.connection||d.user||d.device,e(c,b),h.___collection&&"article"==h.___collection.collectionType&&h.___collection.addToCollection(h),"function"==typeof a&&a(h)):(d=d||{},d.status=d.status||{},d.status=l(d),"function"==
typeof f&&f(d.status,h))};k.onError=function(b){b=l(b);"function"==typeof f&&f(b,h)};d.Appacitive.http.send(k);return this}"function"==typeof f&&f({code:"400",message:"Please specify id for get operation"},this)};this.del=function(a,c,e){if(!b.__id&&this.___collection)this.___collection.removeByCId(h),"function"==typeof a&&a(this);else{a=a||function(){};c=c||function(){};e=e||{};var f=this,j=d.Appacitive.config.apiBaseUrl,j=j+d.Appacitive.storage.urlFactory[this.type].getDeleteUrl(b.__schematype||
...
e(a)):b(c,a)};g.onError=b;d.Appacitive.http.send(g)}else a.set("__link",f),"function"==typeof e&&e(a)};this.setCurrentUser=function(c,a,e){if(!c||"object"!=typeof c||0<=c.length)throw Error("Cannot set null object as user");var b=c;c.getArticle||(b=new d.Appacitive.User(c,!0));if(!b.get("__id")||0==b.get("__id").length)throw Error("Specify user __id");d.Appacitive.localStorage.set("Appacitive-User",c);e||(e=60);g=b;a&&d.Appacitive.Session.setUserAuthHeader(a,e);g.logout=function(b){d.Appacitive.Users.logout(b)};
...
a.method="post",a.data=b,a.onSuccess=function(b){b&&"200"==b.code&&("function"==typeof g?g(f):p(b,f))},a.onError=p,d.Appacitive.http.send(a));return this};g.linkFacebookAccount=function(b,a){var c=function(){f(Appacitive.Facebook.accessToken,g,function(a){d.Appacitive.eventManager.fire("user..article."+a.get("__id")+".updated",a,{object:a});"function"==typeof b&&b(a)},a)};Appacitive.Facebook.getCurrentUserInfo(function(){c()},function(){Appacitive.Facebook.requestLogin(function(){c()},a)});return this};
g.unlinkFacebookAccount=function(b,a){f("facebook",this,function(a){d.Appacitive.eventManager.fire("user.article."+a.get("__id")+".updated",a,{object:a});"function"==typeof b&&b(a)},a);return this};g.logout=function(b){Appacitive.Users.logout(b)};d.Appacitive.eventManager.clearAndSubscribe("user.article."+b.get("__id")+".updated",function(b,a){d.Appacitive.localStorage.set("Appacitive-User",a.object.getArticle())});return g};d.Appacitive.User=function(c){c=c||{};c.__schematype="user";d.Appacitive.Article.call(this,
c);return this};d.Appacitive.User.prototype=new d.Appacitive.Article("user");d.Appacitive.User.prototype.constructor=d.Appacitive.User;d.Appacitive.User.prototype.__defineGetter__("linkedAccounts",function(){var c=this.get("__link");c?"object"==typeof c&&!(0<=c.length)?c=[c]:0<=c.length||(c=c[0]):c=[];return c});d.Appacitive.User.prototype.getAllLinkedAccounts=function(c,a){c=c||function(){};var e=this,b=this,f=function(b){e.linkedAccounts=b;"function"==typeof c&&c(b,e)},g=a,k=b.get("__id");(!k||
"string"!==typeof k||0==k.length)&&"function"==typeof f&&f(b.linkedAccounts,b);var f=f||function(){},g=g||function(){},l=new d.Appacitive.HttpRequest;l.url=d.Appacitive.config.apiBaseUrl+d.Appacitive.storage.urlFactory.user.getGetAllLinkedAccountsUrl(k);l.method="get";l.onSuccess=function(a){a&&a.status&&"200"==a.status.code?(a=a.identities||[],0<a.length?b.set("__link",a):b.set("__link",null),"function"==typeof f&&f(a,b)):g(a.status,b)};l.onError=g;d.Appacitive.http.send(l);return this};d.Appacitive.User.prototype.linkFacebookAccount=
