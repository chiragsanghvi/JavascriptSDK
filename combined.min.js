...
(function(f){f.Appacitive.File=function(d){d=d||{};this.fileId=d.fileId;this.contentType=d.contentType;this.fileData=d.fileData;var g=function(b,e,c){var d=new f.Appacitive.HttpRequest;d.url=b;d.method="GET";d.onSuccess=e;d.onError=c;f.Appacitive.http.send(d)},c=function(b,e,c,d,g){(new FormData).append("fileToUpload",e);var k=new f.Appacitive.HttpRequest;k.url=b;k.method="PUT";k.data=e;k.headers.push({key:"content-type",value:c});k.onSuccess=d;k.onError=g;k.send(!0)};this.save=function(b,e,d){if(this.fileId&&
...
g(b,function(b){b&&b.status&&"200"==b.status.code?c(b.url,l.fileData,l.contentType,function(){l.fileId=b.id;l.getDownloadUrl(function(b){p(b)},q)},q):"function"==typeof q&&q(b.status,l)},q)}};this.deleteFile=function(b,e){if(!this.fileId)throw Error("Please specify fileId to delete");b=b||function(){};e=e||function(){};var c=new f.Appacitive.HttpRequest;c.url=f.Appacitive.config.apiBaseUrl+f.Appacitive.storage.urlFactory.file.getDeleteUrl(this.fileId);c.method="DELETE";c.onSuccess=function(c){c&&
"200"==c.code?"function"==typeof b&&b():"function"==typeof e&&"function"==typeof e&&e(c)};c.onError=e;f.Appacitive.http.send(c)};this.getDownloadUrl=function(b,c){if(!this.fileId)throw Error("Please specify fileId to download");var d=this;b=b||function(){};c=c||function(){};var g=new f.Appacitive.HttpRequest;g.url=f.Appacitive.config.apiBaseUrl+f.Appacitive.storage.urlFactory.file.getDownloadUrl(this.fileId,556E4);g.method="GET";g.onSuccess=function(f){f&&f.status&&"200"==f.status.code?(d.url=f.uri,
