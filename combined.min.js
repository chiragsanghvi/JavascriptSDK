...
"sandbox");h=a})};e.Appacitive.initialize=function(d){e.Appacitive.session.setApiKey(d.apikey||"");e.Appacitive.session.environment=d.env||"";e.Appacitive.useApiKey=!0;if(d.userToken)-1==d.expiry?d.expiry=null:d.expiry||(d.expiry=3600),e.Appacitive.session.setUserAuthHeader(d.userToken,d.expiry),d.user&&(e.Appacitive.localStorage.set("Appacitive-User",d.user),e.Appacitive.Users.setCurrentUser(d.user));else if(e.Appacitive.runtime.isBrowser&&(d=e.Appacitive.Cookie.readCookie("Appacitive-UserToken"))){var c=
e.Appacitive.Cookie.readCookie("Appacitive-UserTokenExpiry");c||(c=60);var b=e.Appacitive.localStorage.get("Appacitive-User");e.Appacitive.Users.setCurrentUser(b,d,c)}}})(global);(function(e){e.Appacitive&&e.Appacitive.http&&e.Appacitive.http.addProcessor({pre:function(d){d.headers.push({key:"appacitive-environment",value:e.Appacitive.session.environment})}})})(global);
(function(e){e.Appacitive.queries={};var d=function(a){a=a||{};var b=1,c=200;this.__defineGetter__("pageNumber",function(){return b});this.__defineSetter__("pageNumber",function(a){b=a||1});this.__defineGetter__("pageSize",function(){return c});this.__defineSetter__("pageSize",function(a){c=a||200});this.pageNumber=a.pageNumber;this.pageSize=a.pageSize};d.prototype.toString=function(){return"psize="+this.pageSize+"&pnum="+this.pageNumber};var c=function(a){a=a||{};var b="__UtcLastUpdatedDate",c=!1;
this.__defineGetter__("orderBy",function(){return b});this.__defineSetter__("orderBy",function(a){b=a||"__UtcLastUpdatedDate"});this.__defineGetter__("isAscending",function(){return c});this.__defineSetter__("isAscending",function(a){c="undefined"==typeof a?!1:a});this.orderBy=a.orderBy;this.isAscending=a.isAscending};c.prototype.toString=function(){return"orderBy="+this.orderBy+"&isAsc="+this.isAscending};var b=function(a){var b=a||{},e="",h="",j="",l=a.queryType,n=new d(a),q=new c(a),k=a.schema||
a.relation,m=a.schema?"article":"connection";this.__defineGetter__("type",function(){return m});this.__defineGetter__("entityType",function(){return k});this.__defineGetter__("queryType",function(){return l});this.__defineGetter__("pageQuery",function(){return n});this.__defineGetter__("sortQuery",function(){return q});this.__defineGetter__("filter",function(){return e});this.__defineSetter__("filter",function(a){e=a});this.__defineGetter__("freeText",function(){return h});this.__defineSetter__("freeText",
function(a){"string"==typeof a?h=a:"object"==typeof a&&a.length&&(h=a.join(" "))});this.__defineGetter__("fields",function(){return j});this.__defineSetter__("fields",function(a){"string"==typeof a?j=a:"object"==typeof a&&a.length&&(j=a.join(","))});this.filter=b.filter||"";this.freeText=b.freeText||"";this.fields=b.fields||"";this.setFilter=function(a){this.filter=a};this.setFreeText=function(a){this.freeText=a};this.setFields=function(a){this.fields=a};this.extendOptions=function(a){for(var e in a)b[e]=
a[e];n=new d(b);q=new c(b)};this.getQueryString=function(){var a=this.pageQuery.toString()+"&"+this.sortQuery.toString();this.filter&&0<this.filter.trim().length&&(a+="&query="+this.filter);this.freeText&&0<this.freeText.trim().length&&(a+="&freetext="+this.freeText+"&language=en");this.fields&&0<this.fields.trim().length&&(a+="&fields="+this.fields);return a};this.getOptions=function(){var a={},b;for(b in this)this.hasOwnProperty(b)&&"function"!=typeof this[b]&&(a[b]=this[b]);return a}};e.Appacitive.queries.BasicFilterQuery=
function(a){a=a||{};if(!a.schema&&!a.relation||a.schema&&a.relation)throw Error("Specify either schema or relation for basic filter query");a.queryType="BasicFilterQuery";a=new b(a);a.toRequest=function(){var a=new e.Appacitive.HttpRequest;a.url=this.toUrl();a.method="get";return a};a.toUrl=function(){return e.Appacitive.config.apiBaseUrl+this.type+".svc/"+this.entityType+"/find/all?"+this.getQueryString()};return a};e.Appacitive.queries.GraphQuery=function(a){a=a||{};if(!a.graphQuery)throw Error("graphQuery object is mandatory");
this.toRequest=function(){var b=new e.Appacitive.HttpRequest;b.url=e.Appacitive.config.apiBaseUrl;b.url+=e.Appacitive.storage.urlFactory.article.getProjectionQueryUrl();b.method="post";b.data=a.graphQuery;return b}};e.Appacitive.queries.ConnectedArticlesQuery=function(a){a=a||{};if(!a.relation)throw Error("Specify relation for connected articles query");if(!a.articleId)throw Error("Specify articleId for connected articles query");a.schema&&delete a.schema;a.queryType="ConnectedArticlesQuery";var c=
new b(a);c.articleId=a.articleId;c.toRequest=function(){var a=new e.Appacitive.HttpRequest;a.url=this.toUrl();a.method="get";return a};c.toUrl=function(){return e.Appacitive.config.apiBaseUrl+"connection/"+a.relation+"/"+this.articleId+"/find?"+c.getQueryString()};return c}})(global);
...
function(a){e.Appacitive.session.removeUserAuthHeader();c(a)},b||function(){})};this.createUser=function(c,b,a){b=b||function(){};a=a||function(){};c=c||{};c.__schematype="user";if(!c.username||!c.password||!c.firstname||0==c.username.length||0==c.password.length||0==c.firstname.length)throw Error("Username, password and firstname are mandatory");var d=new e.Appacitive.HttpRequest;d.method="put";d.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getCreateUrl();d.data=c;d.onSuccess=
function(c){c&&c.user?b(c.user):a((c||{}).status||"No response from APIs.")};d.onError=a;e.Appacitive.http.send(d)};this.signup=function(c,b,a){var d=this;this.createUser(c,function(){d.login(c.username,c.password,b,a)},function(b){a(b)})};this.authenticateUser=function(c,b,a){b=b||function(){};a=a||function(){};c.expiry||(c.expiry=-1);var f=this,g=new e.Appacitive.HttpRequest;g.method="post";g.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getAuthenticateUserUrl();g.data=
c;g.onSuccess=function(e){e&&e.user?(d=e.user,f.setCurrentUser(e.user,e.token,c.expiry),b(e)):(e=e||{},a(e.status))};g.onError=a;e.Appacitive.http.send(g)};this.login=function(c,b,a,d){if(!c||!b||0==c.length||0==b.length)throw Error("Please specify username and password");this.authenticateUser({username:c,password:b,expiry:-1},a||function(){},d||function(){})};this.authenticateWithFacebook=this.signupWithFacebook=function(c,b){c=c||function(){};b=b||function(){};var a=this;FB?FB.api("/me",function(){var f=
{accesstoken:e.Appacitive.facebook.accessToken,type:"facebook",expiry:7200,createnew:!0},g=new e.Appacitive.HttpRequest;g.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getAuthenticateUserUrl();g.method="post";g.data=f;g.onSuccess=function(e){e.user?(e.user.__authType="FB",d=e.user,a.setCurrentUser(e.user,e.token,120),c(e)):b(e)};g.onError=function(){b()};e.Appacitive.http.send(g)}):b()};this.validateCurrentUser=function(c,b){c&&("function"!=typeof c&&"boolean"==typeof c)&&
(b=c,c=function(){});var a=e.Appacitive.Cookie.readCookie("Appacitive-UserToken");if(!a)return"function"==typeof c&&c(!1),!1;if(b)return"function"==typeof c&&c(!0),!0;try{var d=new e.Appacitive.HttpRequest;d.url=e.Appacitive.config.apiBaseUrl+Appacitive.storage.urlFactory.user.getValidateTokenUrl(a);d.method="POST";d.data={};d.onSuccess=function(a){"function"==typeof c&&c(a.result)};e.Appacitive.http.send(d)}catch(g){c(!1)}};this.logout=function(c){c=c||function(){};this.currentUser?e.Appacitive.session.removeUserAuthHeader(c):
c()}}})(global);
