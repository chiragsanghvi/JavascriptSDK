...
function(b){e.push(b)};this.notify=function(){if(0!==e.length){var d=[],f;for(f in g)g.hasOwnProperty(f)&&d.push(g[f]);for(;0<e.length;){var k=e.shift(),l=[];for(f in c)c.hasOwnProperty(f)&&l.push(c[f](k));b.send(k,d,l)}}};this.onResponse=function(b){console.dir(b)}},d=function(){var b=function(){throw Error("Not Implemented Exception");};this.inOnline=this.send=b;this.onResponse=function(){b()};this.onError=function(){b()}},g=null,g=global.Appacitive.runtime.isBrowser?XMLHttpRequest:require("xmlhttprequest").XMLHttpRequest,
...
e.Appacitive.session.incrementExpiry():(null!=e.Appacitive.session.get()&&e.Appacitive.session.resetSession(),e.Appacitive.http.send(c))}catch(d){}}}),e.Appacitive.http.addProcessor({pre:function(){return(new Date).getTime()},post:function(b,e){var c=(new Date).getTime()-e;b._timeTakenInMilliseconds=c}}))})();
...
if(!b.articleId)throw Error("Specify articleId for connected articles query");b.schema&&delete b.schema;b.queryType="ConnectedArticlesQuery";var e=new c(b);e.articleId=b.articleId;e.relation=b.relation;e.toRequest=function(){var b=new f.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};e.toUrl=function(){return f.Appacitive.config.apiBaseUrl+"connection/"+this.relation+"/"+this.articleId+"/find?"+e.getQueryString()};return e};f.Appacitive.Queries.GetConnectionsQuery=function(b){b=
b||{};if(!b.relation)throw Error("Specify relation for GetConnectionsQuery query");if(!b.articleId)throw Error("Specify articleId for GetConnectionsQuery query");if(!b.label||0==b.label.trim().length)throw Error("Specify label for GetConnectionsQuery query");b.schema&&delete b.schema;b.queryType="GetConnectionsQuery";var e=new c(b);e.articleId=b.articleId;e.relation=b.relation;e.label=b.label;e.toRequest=function(){var b=new f.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};e.toUrl=
function(){return f.Appacitive.config.apiBaseUrl+"connection/"+e.relation+"/find/all?articleid="+this.articleId+"&label="+this.label+e.getQueryString()};return e};f.Appacitive.Queries.GetConnectionsBetweenArticlesQuery=function(b,e){b=b||{};if(!b.articleAId||"string"!=typeof b.articleAId||0==b.articleAId.length)throw Error("Specify valid articleAId for GetConnectionsBetweenArticlesQuery query");if(!b.articleBId||"string"!=typeof b.articleBId||0==b.articleBId.length)throw Error("Specify articleBId for GetConnectionsBetweenArticlesQuery query");
b.schema&&delete b.schema;b.queryType=e||"GetConnectionsBetweenArticlesQuery";var d=new c(b);d.articleAId=b.articleAId;d.articleBId=b.articleBId;d.label=b.label;d.relation=b.relation&&"string"==typeof b.relation&&0<b.relation.length?b.relation+"/":"";d.toRequest=function(){var b=new f.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};d.toUrl=function(){return f.Appacitive.config.apiBaseUrl+"connection/"+d.relation+"find/"+this.articleAId+"/"+this.articleBId+"?"+d.getQueryString()};
return d};f.Appacitive.Queries.GetConnectionsBetweenArticlesForRelationQuery=function(b){b=b||{};if(!b.relation)throw Error("Specify relation for GetConnectionsBetweenArticlesForRelationQuery query");return new f.Appacitive.Queries.GetConnectionsBetweenArticlesQuery(b,"GetConnectionsBetweenArticlesForRelationQuery")};f.Appacitive.Queries.GraphQuery=function(b){b=b||{};if(!b.graphQuery)throw Error("graphQuery object is mandatory");this.toRequest=function(){var e=new f.Appacitive.HttpRequest;e.url=
f.Appacitive.config.apiBaseUrl;e.url+=f.Appacitive.storage.urlFactory.article.getProjectionQueryUrl();e.method="post";e.data=b.graphQuery;return e}}})(global);
...
c[0]&&(e[c]=b[c])}if(0===arguments.length)return e;if(1==arguments.length)return e[arguments[0]];throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");};var k=[];b.__tags||(b.__tags=[]);this.__defineGetter__("tags",function(){return!b.__tags?[]:b.__tags});this.addTags=function(e){e&&("string"==typeof e&&e.length)&&(b.__tags.push(e),b.__tags=Array.distinct(b.__tags),k&&k.length&&(e=k.indexOf(e),-1!=e&&k.splice(e,1)))};this.removeTags=function(e){e&&("string"==
typeof e&&e.length)&&(k.push(e),k=Array.distinct(k),b.__tags&&b.__tags.length&&(e=b.__tags.indexOf(e),-1!=e&&b.__tags.splice(e,1)))};this.get=function(e){if(e)return b[e]};this.set=function(e,c){if(!e||"string"!=typeof e||0==e.length)return c;null==c||"undefined"==c?b[e]=null:"string"==typeof c?b[e]=c:"number"==typeof c?b[e]=c+"":"object"==typeof c&&0<=c.length&&(b[e]=c);return c};this.copy=function(b){b&&n(b)};this.save=function(e,c){b.__id?l.apply(this,arguments):m.apply(this,arguments)};var m=
function(e,d){e=e||function(){};d=d||function(){};var g=this,h=f.Appacitive.config.apiBaseUrl+f.Appacitive.storage.urlFactory[this.type].getCreateUrl(b.__schematype||b.__relationtype);if(b.__schematype&&("user"==b.__schematype.toLowerCase()||"device"==b.__schematype.toLowerCase()))h=f.Appacitive.config.apiBaseUrl+f.Appacitive.storage.urlFactory[b.__schematype.toLowerCase()].getCreateUrl();var k=new f.Appacitive.HttpRequest;k.url=h;k.method="put";b.__revision&&delete b.__revision;k.data=b;k.onSuccess=
function(f){var h=null;if(f&&(f.article||f.connection||f.user||f.device))h=f.article||f.connection||f.user||f.device;f&&h?(c=h,b.__id=h.__id,n(h),g.connectionCollections&&0<g.connectionCollections.length&&g.connectionCollections.forEach(function(e){e.getQuery().extendOptions({articleId:b.__id})}),"connection"==g.type&&g.parseConnection(),Appacitive.eventManager.fire((g.__schematype||g.__relationtype)+"."+g.type+".created","base",{object:g}),"function"==typeof e&&e(g)):(f=f||{},f.status=f.status||
{},f.status=j(f.status),Appacitive.eventManager.fire((g.__schematype||g.__relationtype)+"."+g.type+".createFailed","base",{error:f.status}),"function"==typeof d&&d(f.status,g))};k.onError=function(b){b=j(b);"function"==typeof d&&d(b,g)};f.Appacitive.http.send(k)},l=function(e,d){e=e||function(){};d=d||function(){};var g=!1,h=JSON.parse(JSON.stringify(c)),m;for(m in b)"undefined"==typeof b[m]||null===b[m]?(h[m]=null,g=!0):b[m]!=c[m]?(h[m]=b[m],g=!0):b[m]==c[m]&&delete h[m];try{h.__revision&&delete h.__revision,
h.__endpointa&&delete h.__endpointa,h.__endpointb&&delete h.__endpointb,h.__createdby&&delete h.__createdby,h.__lastmodifiedby&&delete h.__lastmodifiedby,h.__schematype&&delete h.__schematype,h.__relationtype&&delete h.__relationtype,h.__utcdatecreated&&delete h.__utcdatecreated,h.__utclastupdateddate&&delete h.__utclastupdateddate,h.__tags&&delete h.__tags}catch(l){}b.__tags&&0<b.__tags.length&&(h.__addtags=b.__tags);k&&0<k.length&&(h.__removetags=k);var r=this;if(g){g=new f.Appacitive.HttpRequest;
m=f.Appacitive.config.apiBaseUrl+f.Appacitive.storage.urlFactory[this.type].getUpdateUrl(b.__schematype||b.__relationtype,c.__id?c.__id:b.__id);if(b&&b.__schematype&&("user"==b.__schematype.toLowerCase()||"device"==b.__schematype.toLowerCase()))m=f.Appacitive.config.apiBaseUrl+f.Appacitive.storage.urlFactory[b.__schematype.toLowerCase()].getUpdateUrl(c.__id);g.url=m;g.method="post";g.data=h;g.onSuccess=function(g){g&&(g.article||g.connection||g.user||g.device)?(c=g.article||g.connection||g.user||
g.device,n(c),Appacitive.eventManager.fire(r.type+"."+b.__id+".updated","base",{object:r}),"function"==typeof e&&e(r)):(g=g||{},g.status=g.status||{},g.status=j(g.status),Appacitive.eventManager.fire(r.type+"."+b.__id+".updateFailed","base",{object:g.status}),"function"==typeof d&&d(g.status,r))};g.onError=function(b){b=b||{};b.message=b.message||"Server error";b.code=b.code||"500";"function"==typeof d&&d(b,r)};f.Appacitive.http.send(g)}else"function"==typeof e&&e(r)};this.fetch=function(e,d){e=e||
function(){};d=d||function(){};if(b.__id){var g=this,h=f.Appacitive.config.apiBaseUrl+f.Appacitive.storage.urlFactory[this.type].getGetUrl(b.__schematype||b.__relationtype,b.__id),m=new f.Appacitive.HttpRequest;m.url=h;m.method="get";m.onSuccess=function(b){b&&(b.article||b.connection||b.user||b.device)?(c=b.article||b.connection||b.user||b.device,n(c),g.___collection&&"article"==g.___collection.collectionType&&g.___collection.addToCollection(g),"function"==typeof e&&e(g)):(b=b||{},b.status=b.status||
{},b.status=j(b),"function"==typeof d&&d(b.status,g))};m.onError=function(b){b=j(b);"function"==typeof d&&d(b,g)};f.Appacitive.http.send(m)}else"function"==typeof d&&d({code:"400",message:"Please specify id for get operation"},this)};this.del=function(e,c,d){if(!b.__id&&this.___collection)this.___collection.removeByCId(this.__cid),"function"==typeof e&&e(this);else{e=e||function(){};c=c||function(){};d=d||{};var g=this,h=f.Appacitive.config.apiBaseUrl,h=h+f.Appacitive.storage.urlFactory[this.type].getDeleteUrl(b.__schematype||
...
"function"==typeof e&&e(d)):(d=j(d),"function"==typeof c&&c(d,g))};d.onError=function(b){b=j(b);"function"==typeof c&&c(b,g)};f.Appacitive.http.send(d)}}};f.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())}})(global);
(function(f){var d=function(){return Math.floor(65536*Math.random()).toString(16)};f.Appacitive.GUID=function(){var g=d()+d()+"-"+d()+"-"+d()+"-"+d()+"-"+d()+d()+d(),c="",b,e,f,j,n,k,m=0,g=g.replace(/\r\n/g,"\n");e="";for(f=0;f<g.length;f++)j=g.charCodeAt(f),128>j?e+=String.fromCharCode(j):(127<j&&2048>j?e+=String.fromCharCode(j>>6|192):(e+=String.fromCharCode(j>>12|224),e+=String.fromCharCode(j>>6&63|128)),e+=String.fromCharCode(j&63|128));for(g=e;m<g.length;)b=g.charCodeAt(m++),e=g.charCodeAt(m++),
f=g.charCodeAt(m++),j=b>>2,b=(b&3)<<4|e>>4,n=(e&15)<<2|f>>6,k=f&63,isNaN(e)?n=k=64:isNaN(f)&&(k=64),c=c+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(j)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(n)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k);return c.toString()}})(global);
...
var n=["BasicFilterQuery"];this.__defineSetter__("query",function(e){if(!e||!e.toRequest)throw Error("Invalid  appacitive query passed to articleCollection");if(-1==n.indexOf(e.queryType))throw Error("ArticleCollection only accepts "+n.join(", "));b.length=0;c=e});this.setQuery=function(b){this.query=b};this.setOptions=j;j(d);this.get=function(e){if(e!=parseInt(e,10))return null;e=parseInt(e,10);return"number"!=typeof e||e>=b.length?null:b.slice(e,e+1)[0]};this.addToCollection=function(e){if(!e||
...
(function(f){f.Appacitive.File=function(d){d=d||{};this.fileId=d.fileId;this.contentType=d.contentType;this.fileData=d.fileData;var g=function(b,c,d){var g=new f.Appacitive.HttpRequest;g.url=b;g.method="GET";g.onSuccess=c;g.onError=d;f.Appacitive.http.send(g)},c=function(b,c,d,g,n){(new FormData).append("fileToUpload",c);var k=new f.Appacitive.HttpRequest;k.url=b;k.method="PUT";k.data=c;k.headers.push({key:"content-type",value:d});k.onSuccess=g;k.onError=n;k.send(!0)};this.save=function(b,e,d){if(this.fileId&&
"string"==typeof this.fileId&&0<this.fileId.length){var j=this,n=b,k=e;if(!j.fileData)throw Error("Please specify filedata");if(d||"string"==typeof d)j.contentType=d;else{if(!j.contentType||"string"!==typeof d||0==j.contentType.length)j.contentType="text/plain";try{j.contentType=file.type}catch(m){}}b=f.Appacitive.config.apiBaseUrl+f.Appacitive.storage.urlFactory.file.getUpdateUrl(j.fileId,j.contentType);n=n||function(){};k=k||function(){};g(b,function(b){b&&b.status&&"200"==b.status.code?c(b.url,
j.fileData,j.contentType,function(){j.getDownloadUrl(function(b){n(b)},k)},k):"function"==typeof k&&k(b.status,j)},k)}else{var l=this,p=b,q=e;if(!l.fileData)throw Error("Please specify filedata");if(d||"string"==typeof d)l.contentType=d;else{if(!l.contentType||"string"!==typeof d||0==l.contentType.length)l.contentType="text/plain";try{l.contentType=file.type}catch(t){}}b=f.Appacitive.config.apiBaseUrl+f.Appacitive.storage.urlFactory.file.getUploadUrl(l.contentType);p=p||function(){};q=q||function(){};
...
return f}return null}return f}catch(n){return null}};f.Appacitive.toISOString=function(d){try{return d=d.toISOString(),d.indexOf("Z"),d=replace("Z","0000Z")}catch(f){return null}}})(global);
