...
a)},error:function(f){c.onError(a,f)}});break;case "delete":$.ajax({url:a.url,type:"DELETE",async:a.async,beforeSend:function(f){for(var b=0;b<a.headers.length;b+=1)f.setRequestHeader(a.headers[b].key,a.headers[b].value)},success:function(e){try{e=JSON.parse(e)}catch(k){}b(e,f,d);c.onResponse(e,a)},error:function(b){c.onError(a,b)}});break;default:throw Error("Unrecognized http method: "+a.method);}};a.isOnline=function(){return window.navigator.onLine||!0};var b=function(a,b,f){if(b.length!=f.length)throw Error("Callback length and state length mismatch!");
for(var c=0;c<b.length;c+=1)b[c].apply({},[a,f[c]])},c=a;$=$||{};$.ajax=$.ajax||{};return a},b=function(){var a=new d;a.type="Http provider for nodejs";a.send=function(a,f,d){"function"==typeof a.beforeSend&&a.beforeSend(a);var k=a;a=require("url").parse(k.url);var k=k||{},l;for(l in k)if("headers"==l)for(var m=0;m<k.headers.length;m+=1)c.headers[k.headers[m].key]=k.headers[m].value;else c[l]=k[l];c.host=a.host;c.port=a.port||80;c.path=a.path;c.method=k.method.toUpperCase();"string"!=typeof c.data&&
(c.data=JSON.stringify(c.data));c.headers["Content-Length"]=c.data.length;c.headers["Content-Type"]="application/json";l=e.request(c,function(a){var c="";a.setEncoding("utf8");a.on("data",function(a){c+=a});a.on("end",function(){if("application/json"==a.headers["content-type"]&&"200"==a.statusCode){"{"!=c[0]&&(c=c.substr(1,c.length-1));a.json=JSON.parse(c);var e=a.json;if(f.length!=d.length)throw Error("Callback length and state length mismatch!");for(var j=0;j<f.length;j+=1)f[j].apply({},[e,d[j]]);
b.onResponse(a.json,k)}else a.text=c,b.onError(k,a)})});l.write(c.data);l.on("error",function(a){b.onError(k,a)});l.end()};a.isOnline=function(){return!0};var b=a,c={host:"localhost",port:80,path:"",data:"{}",method:"GET",headers:{"Content-Type":"application/json",accept:"application/json"}},e=require("http");return a};global.Appacitive.http=new function(){var a=global.Appacitive.runtime.isBrowser?new c:new b,d=new e(a),h=!1;this.pause=function(){h=!0};this.unpause=function(){h=!1};this.addProcessor=
...
this.connectionServiceUrl,c,b)},getDeleteUrl:function(d,c){return String.format("{0}/{1}/{2}",this.connectionServiceUrl,d,c)},getMultiDeleteUrl:function(d){return String.format("{0}/{1}/bulkdelete",this.connectionServiceUrl,d)},getSearchByArticleUrl:function(d,c,b,a,f){d="";d=String.format("{0}/{1}/find/all?label={2}&articleid={3}",this.connectionServiceUrl,c,a,b);if("undefined"!==typeof f&&0<f.length)for(c=0;c<f.length;c+=1)d=d+"&"+f[c];return d},getConnectedArticles:function(d,c,b,a){d="";d=String.format("{0}/{1}/{2}/find",
...
c){a.__id?g.apply(this,arguments):h.apply(this,arguments)};this.copy=function(b){for(var c in b)a[c]=b[c]};var g=function(c,f){c=c||function(){};f=f||function(){};var d=!1,g=JSON.parse(JSON.stringify(b)),h;for(h in a)"undefined"==typeof a[h]||null===a[h]?(g[h]=null,d=!0):a[h]!=b[h]?(g[h]=a[h],d=!0):a[h]==b[h]&&delete g[h],g.__revision&&delete g.__revision;if(d){d=new e.Appacitive.HttpRequest;h=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory[this.type].getUpdateUrl(a.__schematype||a.__relationtype,
b.__id?b.__id:a.__id);if(a&&a.__schematype&&("user"==a.__schematype.toLowerCase()||"device"==a.__schematype.toLowerCase()))h=e.Appacitive.config.apiBaseUrl,h+=e.Appacitive.storage.urlFactory[a.__schematype.toLowerCase()].getUpdateUrl(b.__id);d.url=h;d.method="post";d.data=g;d.onSuccess=function(a){a&&(a.article||a.connection||a.user||a.device)?(b=a.article||a.connection||a.user||a.device,"function"==typeof c&&c()):"function"==typeof f&&f(a.status)};d.onError=function(a){f(a)};e.Appacitive.http.send(d)}else c()},
...
function(e){var g=null;if(e&&(e.article||e.connection||e.user||e.device))g=e.article||e.connection||e.user||e.device;if(e&&g){b=g;a.__id=g.__id;for(var h in g)if("undefined"==typeof a[h])a[h]=g[h];else if("object"==typeof g[h])for(var k in g[h])a[h][k]=g[h][k];d.connectionCollections&&0<d.connectionCollections.length&&d.connectionCollections.forEach(function(b){b.getQuery().extendOptions({articleId:a.__id})});"connection"==d.type&&d.parseConnection();"function"==typeof c&&c(d)}else"function"==typeof f&&
f(e.status)};h.onError=function(a){f(a)};e.Appacitive.http.send(h)}};e.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())}})(global);
(function(e){var d=function(){return Math.floor(65536*Math.random()).toString(16)};e.Appacitive.GUID=function(){var c=d()+d()+"-"+d()+"-"+d()+"-"+d()+"-"+d()+d()+d(),b="",a,f,e,h,j,p,n=0,c=c.replace(/\r\n/g,"\n");f="";for(e=0;e<c.length;e++)h=c.charCodeAt(e),128>h?f+=String.fromCharCode(h):(127<h&&2048>h?f+=String.fromCharCode(h>>6|192):(f+=String.fromCharCode(h>>12|224),f+=String.fromCharCode(h>>6&63|128)),f+=String.fromCharCode(h&63|128));for(c=f;n<c.length;)a=c.charCodeAt(n++),f=c.charCodeAt(n++),
e=c.charCodeAt(n++),h=a>>2,a=(a&3)<<4|f>>4,j=(f&15)<<2|e>>6,p=e&63,isNaN(f)?j=p=64:isNaN(e)&&(p=64),b=b+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(a)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(j)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(p);return b.toString()}})(global);
...
d){c=c||function(){};d=d||function(){};a.length=0;var g=b.toRequest();g.onSuccess=function(b){a:{var g=c;b=b||{};var h=b.connections;if(!h)if(b.status&&b.status.code&&"200"==b.status.code)h=[];else{d(b.status);break a}if(!h.length||0===h.length)h=[];h.forEach(function(b){var c=new e.Appacitive.Connection(b,!0);c.___collection=j;a.push(c);if(b.__endpointa.article||b.__endpointb.article)b=new e.Appacitive.Article(b.__endpointa.article||b.__endpointb.article),b.___collection=j,f.push(b)});g(b.paginginfo||
{})}};e.Appacitive.http.send(g)};this.createNewConnection=function(b){b=b||{};b.__relationtype=c;b=new e.Appacitive.Connection(b);b.___collection=j;b.__cid=parseInt(1E6*Math.random(),10);a.push(b);return b};this.map=function(){return a.map.apply(this,arguments)};this.forEach=function(b,c){return a.forEach(b,c||this)};this.filter=function(){return a.filter.apply(this,arguments)}}})(global);
...
(function(e){var d=function(b,a,c){var d={label:b.label};if(b.articleid)d.articleid=b.articleid;else if(b.article&&"function"==typeof b.article.getArticle)b.article.get("__id")?d.articleid=b.article.get("__id"):d.article=b.article.getArticle(),c["endpoint"+a]=b;else if("object"==typeof b.article&&b.article.__schematype)b.article.__id?d.articleid=b.article.__id:d.article=b.article;else throw Error("Incorrectly configured endpoints provided to setupConnection");return d},c=function(b,a,c){"object"==
typeof c.get("__endpoint"+a.toLowerCase()).article?(c["endpoint"+a]?c["endpoint"+a]&&c["endpoint"+a].article&&c["endpoint"+a].article.getArticle?c["endpoint"+a].article.copy(c.get("__endpointb").article):c["endpoint"+a].article=new e.Appacitive.Article(c.get("__endpointb").article):(c["endpoint"+a]={},c["endpoint"+a].article=new e.Appacitive.Article(c.get("__endpoint"+a.toLowerCase()).article)),c["endpoint"+a].articleid=c.get("__endpoint"+a.toLowerCase()).articleid,c["endpoint"+a].label=c.get("__endpoint"+
a.toLowerCase()).label,c["endpoint"+a].type=c.get("__endpoint"+a.toLowerCase()).type,c["endpoint"+a].article.___collection=c.___collection):c["endpoint"+a]=c.get("__endpoint"+a.toLowerCase())};e.Appacitive.Connection=function(b,a){if(!b.__relationtype&&!b.relation)throw new error("Cannot set connection without schema");b.schema&&(b.__schematype=b.schema,delete b.schema);b.endpoints&&2==b.endpoints.length&&(b.__endpointa=b.endpoints[0],b.__endpointb=b.endpoints[1],delete b.endpoints);if(!b.__endpointa||
!b.__endpointb)throw Error("Provide both endpoints.");var f=new e.Appacitive.BaseObject(b);f.type="connection";f.getConnection=f.getObject;f.setupConnection=function(a,b){if(!a||!a.articleid&&!a.article||!a.label||!b||!b.articleid&&!b.article||!b.label)throw Error("Incorrect endpoints configuration passed.");f.set("__endpointa",d(a,"A",f));f.set("__endpointb",d(b,"B",f))};f.parseConnection=function(){b.__endpointa.label==this.get("__endpointb").label&&this.get("__endpointb");c(this.get("__endpointa"),
"A",f);c(this.get("__endpointb"),"B",f);f.__defineGetter__("endpoints",function(){var a=[];a.push(this.endpointA);a.push(this.endpointB);return a});return f};a?(f.__defineGetter__("connectedArticle",function(){if(!f.___collection.connectedArticle)throw Error("connectedArticle can be accessed only by using the getConnectedArticles call");var a=f.___collection.connectedArticle.get("__id");if(!a)return null;var b=f.getConnection().__endpointa.articleid;f.getConnection().__endpointa.articleid==a&&(b=
f.getConnection().__endpointb.articleid);return f.___collection.getConnectedArticle(b)}),f.parseConnection()):f.setupConnection(f.get("__endpointa"),f.get("__endpointb"));return f};e.Appacitive.Connection.multiDelete=function(b,a,c,d){if(!b)throw Error("Specify relationName");if(0<a.length){var h=new e.Appacitive.HttpRequest;h.url=e.Appacitive.config.apiBaseUrl+Appacitive.storage.urlFactory.connection.getMultideleteUrl(b);h.method="post";h.data={idlist:a};h.onSuccess=function(a){a&&"200"==a.code?
c():(a=a||{},d(a||{message:"Server error",code:400}))};h.onError=function(a){a=a||{};d(a||{message:"Server error",code:400})};e.Appacitive.http.send(h)}else c()}})(global);
...
c;d.onSuccess=function(c){c&&c.user?b(c.user):a((c||{}).status||"No response from APIs.")};d.onError=a;e.Appacitive.http.send(d)};this.authenticateUser=function(c,b,a){b=b||function(){};a=a||function(){};c.expiry||(c.expiry=-1);var f=this,g=new e.Appacitive.HttpRequest;g.method="post";g.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getAuthenticateUserUrl();g.data=c;g.onSuccess=function(e){e&&e.user?(d=e.user,f.setCurrentUser(e.user,e.token,c.expiry),b(e)):(e=e||{},a(e.status))};
g.onError=a;e.Appacitive.http.send(g)};this.authenticate=function(c,b,a,f){a=a||function(){};f=f||function(){};if(!c||!b||0==c.length||0==b.length)throw Error("Please specify username and password");var g=this;c=new e.Appacitive.HttpRequest;c.method="post";c.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getAuthenticateUserUrl();c.data=authRequest;c.onSuccess=function(b){b&&b.user?(d=b.user,g.setCurrentUser(b.user,b.token,authRequest.expiry),a(b)):(b=b||{},f(b.status))};c.onError=
f;e.Appacitive.http.send(c)};this.authenticateWithFacebook=this.signupWithFacebook=function(c,b){c=c||function(){};b=b||function(){};var a=this;FB?FB.api("/me",function(){var f={accesstoken:e.Appacitive.facebook.accessToken,type:"facebook",expiry:80,attempts:-1,createnew:!0},g=new e.Appacitive.HttpRequest;g.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getAuthenticateUserUrl();g.method="post";g.data=f;g.onSuccess=function(e){e.user?(e.user.__authType="FB",d=e.user,a.setCurrentUser(e.user,
e.token,80),c(e)):b(e)};g.onError=function(){b()};e.Appacitive.http.send(g)}):b()};this.validateCurrentUser=function(c,b){c&&("function"!=typeof c&&"boolean"==typeof c)&&(b=c,c=function(){});var a=e.Appacitive.Cookie.readCookie("Appacitive-UserToken");if(!a)return"function"==typeof c&&c(!1),!1;if(b)return"function"==typeof c&&c(!0),!0;try{var d=new e.Appacitive.HttpRequest;d.url=e.Appacitive.config.apiBaseUrl+Appacitive.storage.urlFactory.user.getValidateTokenUrl(a);d.method="POST";d.data={};d.onSuccess=
function(a){"function"==typeof c&&c(a.result)};e.Appacitive.http.send(d)}catch(g){c(!1)}};this.logout=function(c){c=c||function(){};this.currentUser?e.Appacitive.session.removeUserAuthHeader(c):c()}}})(global);
...
if(!b.subject||0==b.subject.trim().length)throw Error("Subject is mandatory to send an email");if(!b.from&&d.from)throw Error("from is mandatory to send an email. Set it in config or send it in options");if(!b.templateName)throw Error("template name is mandatory to send an email");var g={to:b.to||[],cc:b.cc||[],bcc:b.bcc||[],subject:b.subject,body:{templatename:b.templateName||"",data:b.data||{},ishtml:!1==b.isHtml?!1:!0}};if(b.useConfig){g.smtp=d.smtp;if(!b.from&&!d.from)throw Error("from is mandatory to send an email. Set it in config or send it in options");
g.from=b.from||d.from;g.replyto=b.replyTo||d.replyto}c(g,a,e)};this.sendRawEmail=function(b,a,e){a=a||function(){};e=e||function(){};if(!b||!b.to||!b.to.length||0==b.to.length)throw Error("Atleast one receipient is mandatory to send an email");if(!b.subject||0==b.subject.trim().length)throw Error("Subject is mandatory to send an email");if(!b.body)throw Error("body is mandatory to send an email");var g={to:b.to||[],cc:b.cc||[],bcc:b.bcc||[],subject:b.subject,body:{content:b.body||"",ishtml:!1==b.isHtml?
!1:!0}};if(b.useConfig){g.smtp=d.smtp;if(!b.from&&!d.from)throw Error("from is mandatory to send an email. Set it in config or send it in options");g.from=b.from||d.from;g.replyto=b.replyTo||d.replyto}c(g,a,e)}}})(global);
...
(function(e){e.Appacitive.parseISODate=function(d){try{var c=new Date(d);if(isNaN(c)){if(/^([0-9]{1,4})-([0-9]{1,2})-([0-9]{1,2})T([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2})(.([0-9]+))?Z$/.exec(d)){var b=d.split("T"),a=b[0].split("-"),e=b[1].split("Z")[0].split(":"),g=e[2].split("."),h=Number(e[0]),c=new Date;c.setUTCFullYear(Number(a[0]));c.setUTCMonth(Number(a[1])-1);c.setUTCDate(Number(a[2]));c.setUTCHours(Number(h));c.setUTCMinutes(Number(e[1]));c.setUTCSeconds(Number(g[0]));g[1]&&c.setUTCMilliseconds(Number(g[1]));
