...
function(a){a=a||{};var f=new b(a);this.__defineSetter__("filter",function(a){f.filter=a});this.__defineGetter__("freeText",function(){return f.freetext});this.__defineSetter__("freeText",function(a){"string"==typeof freeText?f.freeText=a:"object"==typeof freeText&&a.length&&(f.freeText=a.join(","))});this.__defineGetter__("fields",function(){return f.fields});this.__defineSetter__("fields",function(a){"string"==typeof fields?f.fields=a:"object"==typeof fields&&a.length&&(f.fields=a.join(","))});
this.filter=a.filter||"";this.freeText=a.freeText||"";this.fields=a.fields||"";this.toRequest=function(){var a=new e.Appacitive.HttpRequest;a.url=f.toUrl();a.method="get";return a};this.setFilter=function(a){f.filter=a};this.setFreeText=function(a){this.freeText=a};this.setFields=function(a){this.fields=a};this.extendOptions=function(){f.extendOptions.apply(f,arguments)};this.getOptions=function(){var a={},b;for(b in f)f.hasOwnProperty(b)&&"function"!=typeof f[b]&&(a[b]=f[b]);return a}};e.Appacitive.queries.GraphQuery=
function(a){a=a||{};if(!a.graphQuery)throw Error("graphQuery object is mandatory");this.toRequest=function(){var b=new e.Appacitive.HttpRequest;b.url=e.Appacitive.config.apiBaseUrl;b.url+=e.Appacitive.storage.urlFactory.article.getProjectionQueryUrl();b.method="post";b.data=a.graphQuery;return b}};e.Appacitive.queries.ConnectedArticlesQuery=function(a){a=a||{};var f=new b(a);this.__defineGetter__("filter",function(){return f.filter});this.__defineSetter__("filter",function(a){f.filter=a});this.__defineGetter__("freeText",
function(){return f.freetext});this.__defineSetter__("freeText",function(a){"string"==typeof freeText?f.freeText=a:"object"==typeof freeText&&a.length&&(f.freeText=a.join(","))});this.__defineGetter__("fields",function(){return f.fields});this.__defineSetter__("fields",function(a){"string"==typeof fields?f.fields=a:"object"==typeof fields&&a.length&&(f.fields=a.join(","))});this.filter=a.filter||"";this.freeText=a.freeText||"";this.fields=a.fields||"";this.toRequest=function(){var b=new e.Appacitive.HttpRequest;
b.url=e.Appacitive.config.apiBaseUrl+"connection/"+a.relation+"/"+a.articleId+"/find?"+f.toString();return b};this.extendOptions=function(){f.extendOptions.apply(f,arguments)};this.setFilter=function(a){f.filter=a};this.setFreeText=function(a){this.freeText=a};this.setFields=function(a){this.fields=a};this.getOptions=function(){var a={},b;for(b in f)f.hasOwnProperty(b)&&"function"!=typeof f[b]&&(a[b]=f[b]);return a}}})(global);
(function(e){e.Appacitive.BaseObject=function(d,c){var b={},a=d=d||{};if(c)for(var f in a)b[f]=a[f];!b.__id&&d.__id&&(b.__id=d.__id);this.fetch=function(f,c){f=f||function(){};c=c||function(){};if(a.__id){var d=this,g=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory[this.type].getGetUrl(a.__schematype||a.__relationtype,a.__id),h=new e.Appacitive.HttpRequest;h.url=g;h.method="get";h.onSuccess=function(e){if(e&&(e.article||e.connection||e.user||e.device)){b=e.article||e.connection||e.user||
e.device;e=e.article||e.connection||e.user||e.device;a.__id=e.__id;for(var g in e)"undefined"==typeof a[g]&&(a[g]=e[g]);d.___collection&&"article"==d.___collection.collectionType&&d.___collection.addToCollection(d);f()}else c(e.status)};e.Appacitive.http.send(h)}else c()};this.del=function(b,f,c){b=b||function(){};f=f||function(){};c=c||{};if(!a.__id&&this.___collection)this.___collection.removeByCId(this.__cid),b();else{var d=this,g=e.Appacitive.config.apiBaseUrl,g=g+e.Appacitive.storage.urlFactory[this.type].getDeleteUrl(a.__schematype||
a.__relationtype,a.__id);if(a&&a.__schematype&&("user"==a.__schematype.toLowerCase()||"device"==a.__schematype.toLowerCase()))g=e.Appacitive.config.apiBaseUrl,g+=e.Appacitive.storage.urlFactory[a.__schematype.toLowerCase()].getDeleteUrl(a.__id);c.deleteConnections&&!0===c.deleteConnections&&(g=-1==g.indexOf("?")?g+"?deleteconnections=true":g+"&deleteconnections=true");c=new e.Appacitive.HttpRequest;c.url=g;c.method="delete";c.onSuccess=function(c){"200"==c.code?(d.___collection&&d.___collection.removeById(a.__id),
b()):f(c)};c.onError=function(a){f(a)};e.Appacitive.http.send(c)}};this.getObject=function(){return a};this.toJSON=function(){return a};this.attributes=function(){if(0===arguments.length)return a.__attributes||(a.__attributes={}),a.__attributes;if(1==arguments.length)return a.__attributes||(a.__attributes={}),a.__attributes[arguments[0]];if(2==arguments.length){if("string"!==typeof arguments[1])throw Error("only string values can be stored in attributes.");a.__attributes||(a.__attributes={});a.__attributes[arguments[0]]=
...
function(c,b,a){b=b||function(){};a=a||function(){};var f=new e.Appacitive.HttpRequest;f.method="delete";f.url=e.Appacitive.config.apiBaseUrl;f.url+=e.Appacitive.storage.urlFactory.user.getDeleteUrl(c);f.onSuccess=function(c){c&&c.code&&"200"==c.code?b(c):(c=c||{},c.message=c.message||"Server error",a(c))};f.onError=a;e.Appacitive.http.send(f)};this.deleteCurrentUser=function(c,b){c=c||function(){};if(null===d)throw Error("Current user is not set yet for delete operation");this.deleteUser(d.__id,
function(a){e.Appacitive.session.removeUserAuthHeader();c(a)},b||function(){})};this.createUser=function(c,b,a){b=b||function(){};a=a||function(){};c=c||{};c.__schematype="user";if(!c.username||!c.password||!c.firstname||0==c.username.length||0==c.password.length||0==c.firstname.length)throw Error("Username, password and firstname are mandatory");var f=new e.Appacitive.HttpRequest;f.method="put";f.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getCreateUrl();f.data=c;f.onSuccess=
function(c){c&&c.user?b(c.user):a((c||{}).status||"No response from APIs.")};f.onError=a;e.Appacitive.http.send(f)};this.signup=function(c,b,a){var f=this;this.createUser(c,function(){f.login(c.username,c.password,b,a)},function(b){a(b)})};this.authenticateUser=function(c,b,a){b=b||function(){};a=a||function(){};c.expiry||(c.expiry=-1);var f=this,g=new e.Appacitive.HttpRequest;g.method="post";g.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getAuthenticateUserUrl();g.data=
c;g.onSuccess=function(e){e&&e.user?(d=e.user,f.setCurrentUser(e.user,e.token,c.expiry),b(e)):(e=e||{},a(e.status))};g.onError=a;e.Appacitive.http.send(g)};this.login=function(c,b,a,f){if(!c||!b||0==c.length||0==b.length)throw Error("Please specify username and password");this.authenticateUser({username:c,password:b,expiry:-1},a||function(){},f||function(){})};this.authenticateWithFacebook=this.signupWithFacebook=function(c,b){c=c||function(){};b=b||function(){};var a=this;FB?FB.api("/me",function(){var f=
{accesstoken:e.Appacitive.facebook.accessToken,type:"facebook",expiry:120,attempts:-1,createnew:!0},g=new e.Appacitive.HttpRequest;g.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getAuthenticateUserUrl();g.method="post";g.data=f;g.onSuccess=function(f){f.user?(f.user.__authType="FB",d=f.user,a.setCurrentUser(f.user,f.token,120),c(f)):b(f)};g.onError=function(){b()};e.Appacitive.http.send(g)}):b()};this.validateCurrentUser=function(c,b){c&&("function"!=typeof c&&"boolean"==
typeof c)&&(b=c,c=function(){});var a=e.Appacitive.Cookie.readCookie("Appacitive-UserToken");if(!a)return"function"==typeof c&&c(!1),!1;if(b)return"function"==typeof c&&c(!0),!0;try{var f=new e.Appacitive.HttpRequest;f.url=e.Appacitive.config.apiBaseUrl+Appacitive.storage.urlFactory.user.getValidateTokenUrl(a);f.method="POST";f.data={};f.onSuccess=function(a){"function"==typeof c&&c(a.result)};e.Appacitive.http.send(f)}catch(d){c(!1)}};this.logout=function(c){c=c||function(){};this.currentUser?e.Appacitive.session.removeUserAuthHeader(c):
c()}}})(global);
...
e.Appacitive.http.send(d)};this.setupEmail=function(b){b=b||{};d.smtp.username=b.username||d.smtp.username;d.from=b.from||d.from;d.smtp.password=b.password||d.smtp.password;d.smtp.host=b.smtp.host||d.smtp.host;d.smtp.port=b.smtp.port||d.smtp.port;d.smtp.enablessl=b.enableSSL||d.smtp.enablessl;d.replyto=b.replyTo||d.replyto};this.sendTemplatedEmail=function(b,a,f){a=a||function(){};f=f||function(){};if(!b||!b.to||!b.to.length||0==b.to.length)throw Error("Atleast one receipient is mandatory to send an email");
if(!b.subject||0==b.subject.trim().length)throw Error("Subject is mandatory to send an email");if(!b.from&&d.from)throw Error("from is mandatory to send an email. Set it in config or send it in options");if(!b.templateName)throw Error("template name is mandatory to send an email");var e={to:b.to||[],cc:b.cc||[],bcc:b.bcc||[],subject:b.subject,body:{templatename:b.templateName||"",data:b.data||{},ishtml:!1==b.isHtml?!1:!0}};if(b.useConfig){e.smtp=d.smtp;if(!b.from&&!d.from)throw Error("from is mandatory to send an email. Set it in config or send it in options");
e.from=b.from||d.from;e.replyto=b.replyTo||d.replyto}c(e,a,f)};this.sendRawEmail=function(b,a,f){a=a||function(){};f=f||function(){};if(!b||!b.to||!b.to.length||0==b.to.length)throw Error("Atleast one receipient is mandatory to send an email");if(!b.subject||0==b.subject.trim().length)throw Error("Subject is mandatory to send an email");if(!b.body)throw Error("body is mandatory to send an email");var e={to:b.to||[],cc:b.cc||[],bcc:b.bcc||[],subject:b.subject,body:{content:b.body||"",ishtml:!1==b.isHtml?
!1:!0}};if(b.useConfig){e.smtp=d.smtp;if(!b.from&&!d.from)throw Error("from is mandatory to send an email. Set it in config or send it in options");e.from=b.from||d.from;e.replyto=b.replyTo||d.replyto}c(e,a,f)}}})(global);
