...
(function(d){var e=function(c,b){c=c||function(){};b=b||function(){};var a=new d.Appacitive.HttpRequest;a.method="get";a.url=d.Appacitive.config.apiBaseUrl+d.Appacitive.storage.urlFactory.user.getGetAllLinkedAccountsUrl(this.get("__id"));a.onSuccess=function(a){var d=null;a&&(a.identities&&0<a.identities.length)&&(a=a.identities.filter(function(a){return"facebook"==a.authtype.toLowerCase()}),1==a.length&&(d=a[0].username));null!==d?FB.api("/"+d,function(a){a?c(a):b()}):b()};a.onError=function(){b()};
d.Appacitive.http.send(a)};d.Appacitive.Article=function(c,b){if(!c.__schematype&&!c.schema)throw new error("Cannot set article without __schematype");c.schema&&(c.__schematype=c.schema,delete c.schema);var a=new d.Appacitive.BaseObject(c,b);a.type="article";a.connectionCollections=[];a.getArticle=a.getObject;a.get("__schematype")&&"user"==a.get("__schematype").toLowerCase()&&(a.getFacebookProfile=e);return a};d.Appacitive.BaseObject.prototype.getConnectedArticles=function(c){if("article"!=this.type)return null;
c=c||{};c.articleId=this.get("__id");var b=new d.Appacitive.ConnectionCollection({relation:c.relation});b.connectedArticle=this;this.connectionCollections.push(b);c=new d.Appacitive.queries.ConnectedArticlesQuery(c);b.query=c;return b};d.Appacitive.Article.multiDelete=function(c,b,a,f){if(!c)throw Error("Specify schemaname");if(0<b.length){var e=new d.Appacitive.HttpRequest;e.url=d.Appacitive.config.apiBaseUrl+Appacitive.storage.urlFactory.article.getMultideleteUrl(c);e.method="post";e.data={idlist:b};
e.onSuccess=function(b){b&&"200"==b.code?a():(b=b||{},f(b||{message:"Server error",code:400}))};e.onError=function(a){a=a||{};f(a||{message:"Server error",code:400})};d.Appacitive.http.send(e)}else a()}})(global);
