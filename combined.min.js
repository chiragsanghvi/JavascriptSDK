...
f.device,m(c),Appacitive.eventManager.fire(r.type+"."+b.__id+".updated","base",{object:r}),"function"==typeof e&&e(r)):(f=f||{},f.status=f.status||{},f.status=j(f.status),Appacitive.eventManager.fire(r.type+"."+b.__id+".updateFailed","base",{object:f.status}),"function"==typeof d&&d(f.status,r))};g.onError=function(b){b=b||{};b.message=b.message||"Server error";b.code=b.code||"500";"function"==typeof d&&d(b,r)};f.Appacitive.http.send(g)}else"function"==typeof e&&e(r)};this.fetch=function(e,d){e=e||
function(){};d=d||function(){};if(b.__id){var g=this,h=f.Appacitive.config.apiBaseUrl+f.Appacitive.storage.urlFactory[this.type].getGetUrl(b.__schematype||b.__relationtype,b.__id),n=new f.Appacitive.HttpRequest;n.url=h;n.method="get";n.onSuccess=function(b){b&&(b.article||b.connection||b.user||b.device)?(c=b.article||b.connection||b.user||b.device,m(c),g.___collection&&"article"==g.___collection.collectionType&&g.___collection.addToCollection(g),"function"==typeof e&&e(g)):(b=b||{},b.status=b.status||
{},b.status=j(b),"function"==typeof d&&d(b.status,g))};n.onError=function(b){b=j(b);"function"==typeof d&&d(b,g)};f.Appacitive.http.send(n)}else"function"==typeof d&&d({code:"400",message:"Please specify id for get operation"},this)};this.del=function(e,c,d){if(!b.__id&&this.___collection)this.___collection.removeByCId(this.__cid),"function"==typeof e&&e(this);else{e=e||function(){};c=c||function(){};d=d||{};var g=this,h=f.Appacitive.config.apiBaseUrl,h=h+f.Appacitive.storage.urlFactory[this.type].getDeleteUrl(b.__schematype||
...
(function(f){var d=function(){return Math.floor(65536*Math.random()).toString(16)};f.Appacitive.GUID=function(){var f=d()+d()+"-"+d()+"-"+d()+"-"+d()+"-"+d()+d()+d(),c="",b,e,h,j,m,k,n=0,f=f.replace(/\r\n/g,"\n");e="";for(h=0;h<f.length;h++)j=f.charCodeAt(h),128>j?e+=String.fromCharCode(j):(127<j&&2048>j?e+=String.fromCharCode(j>>6|192):(e+=String.fromCharCode(j>>12|224),e+=String.fromCharCode(j>>6&63|128)),e+=String.fromCharCode(j&63|128));for(f=e;n<f.length;)b=f.charCodeAt(n++),e=f.charCodeAt(n++),
h=f.charCodeAt(n++),j=b>>2,b=(b&3)<<4|e>>4,m=(e&15)<<2|h>>6,k=h&63,isNaN(e)?m=k=64:isNaN(h)&&(k=64),c=c+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(j)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(m)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k);return c.toString()}})(global);
...
function(b){if(!e||0===e.length)return null;var c=e.filter(function(e){return e.get("__id")==b});return 0<c.length?c[0]:null};this.fetch=function(d,g){d=d||function(){};g=g||function(){};b.length=0;var h=c.toRequest();h.onSuccess=function(h){a:{var j=d;h=h||{};var m=h.connections;"GetConnectionsBetweenArticlesForRelationQuery"==c.queryType&&h.connection&&(m=[h.connection]);if(!m)if(h.status&&h.status.code&&"200"==h.status.code)m=[];else{g(h.status);break a}if(!m.length||0===m.length)m=[];m.forEach(function(c){c=
new f.Appacitive.Connection(c,!0);c.___collection=k;if(c.endpointA.article||c.endpointB.article){var d=c.endpointA.article||c.endpointB.article;d.___collection=k;e.push(d)}try{c.___collection.connectedArticle||delete c.connectedArticle}catch(g){}b.push(c)});j(h.paginginfo||{})}};f.Appacitive.http.send(h)};this.fetchByPageNumber=function(b,e,d){c.getOptions().pageQuery.pageNumber=d;this.fetch(b,e)};this.fetchNextPage=function(b,e){c.getOptions().pageQuery.pageNumber+=1;this.fetch(b,e)};this.fetchPreviousPage=
