...
g.device,m(c),Appacitive.eventManager.fire(t.type+"."+b.__id+".updated","base",{object:t}),"function"==typeof e&&e(t)):(g=g||{},g.status=g.status||{},g.status=j(g.status),Appacitive.eventManager.fire(t.type+"."+b.__id+".updateFailed","base",{object:g.status}),"function"==typeof d&&d(g.status,t))};g.onError=function(b){b=b||{};b.message=b.message||"Server error";b.code=b.code||"500";"function"==typeof d&&d(b,t)};f.Appacitive.http.send(g)}else"function"==typeof e&&e(t)};this.fetch=function(e,d){e=e||
function(){};d=d||function(){};if(b.__id){var g=this,h=f.Appacitive.config.apiBaseUrl+f.Appacitive.storage.urlFactory[this.type].getGetUrl(b.__schematype||b.__relationtype,b.__id),k=new f.Appacitive.HttpRequest;k.url=h;k.method="get";k.onSuccess=function(b){b&&(b.article||b.connection||b.user||b.device)?(c=b.article||b.connection||b.user||b.device,m(c),g.___collection&&"article"==g.___collection.collectionType&&g.___collection.addToCollection(g),"function"==typeof e&&e(g)):(b=b||{},b.status=b.status||
{},b.status=j(b),"function"==typeof d&&d(b.status,g))};k.onError=function(b){b=j(b);"function"==typeof d&&d(b,g)};f.Appacitive.http.send(k)}else"function"==typeof d&&d({code:"400",message:"Please specify id for get operation"},this)};this.del=function(e,c,d){if(!b.__id&&this.___collection)this.___collection.removeByCId(this.__cid),"function"==typeof e&&e(this);else{e=e||function(){};c=c||function(){};d=d||{};var g=this,h=f.Appacitive.config.apiBaseUrl,h=h+f.Appacitive.storage.urlFactory[this.type].getDeleteUrl(b.__schematype||
