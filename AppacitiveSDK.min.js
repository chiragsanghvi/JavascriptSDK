...
"sandbox");c.useApiKey=!0;c.appId=g.appId;c.Session.initialized=!0;c.Session.persistUserToken=g.persistUserToken;g.debug&&(c.config.debug=!0);f.isFunction(g.apiLog)&&(c.logs.apiLog=g.apiLog);f.isFunction(g.apiErrorLog)&&(c.logs.apiErrorLog=g.apiErrorLog);f.isFunction(g.exceptionLog)&&(c.logs.exceptionLog=g.exceptionLog);g.userToken?(-1==g.expiry?g.expiry=null:g.expiry||(g.expiry=845E4),c.Session.setUserAuthHeader(g.userToken,g.expiry),g.user?c.Users.setCurrentUser(g.user):c.LocalStorage.get("Appacitive-User").then(function(b){b&&
c.Users.setCurrentUser(b)})):c.runtime.isBrowser&&c.LocalStorage.multiGet("Appacitive-UserToken","Appacitive-UserTokenExpiry","Appacitive-UserTokenDate","Appacitive-User").then(function(b){var f=b["Appacitive-UserToken"],g=b["Appacitive-UserTokenExpiry"],d=b["Appacitive-User"];b=b["Appacitive-User"];f&&(g||(g=-1),d&&0<g&&new Date(d+1E3*g)<new Date||(-1==g&&(g=null),b&&c.Users.setCurrentUser(b,f,g)))})}};c.reset=function(){c.Session.reset()}})(global);
