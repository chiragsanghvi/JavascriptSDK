...
(function(c){c.Appacitive.Object=function(b,f){b=b||{};_type.isString(b)&&(b={__type:b});if(!b.__type&&!b.type)throw Error("Cannot set object without __type or type");b.type&&(b.__type=b.type,delete b.type);c.Appacitive.BaseObject.call(this,b,f);this.type="object";this.getObject=this.getObject;this.children={};this.toJSON=function(b){if(b){var c=function(b){var e=[];b.forEach(function(b){var f=b.getObject();if(b.children&&!Object.isEmpty(b.children)){f.children={};for(var h in b.children)f.children[h]=
c(b.children[h])}b.connection&&(f.__connection=b.connection.toJSON());e.push(f)});return e};return c([this])[0]}return this.getObject()};return this};c.Appacitive.Object.prototype=new c.Appacitive.BaseObject;c.Appacitive.Object.prototype.constructor=c.Appacitive.Object;var f=function(b){var f=[];b.forEach(function(b){f.push(new c.Appacitive.Object(b,!0))});return f};c.Appacitive._parseObjects=f;c.Appacitive.Object.multiDelete=function(b,f){b=b||{};if(!b.type||!_type.isString(b.type)||0===b.type.length)throw Error("Specify valid type");
if("user"===b.type.toLowerCase()||"device"===b.type.toLowerCase())throw Error("Cannot delete user and devices using multidelete");if(!b.ids||0===b.ids.length)throw Error("Specify ids to delete");var e=new c.Appacitive._Request({method:"POST",data:{idlist:b.ids},type:"object",op:"getMultiDeleteUrl",args:[b.type],callbacks:f,onSuccess:function(b){e.promise.fulfill()}});return e.send()};c.Appacitive.Object.multiGet=function(b,h){b=b||{};if(!b.type||!_type.isString(b.type)||0===b.type.length)throw Error("Specify valid type");
if(!b.ids||0===b.ids.length)throw Error("Specify ids to delete");var e=new c.Appacitive._Request({method:"GET",type:"object",op:"getMultiGetUrl",args:[b.type,b.ids.join(","),b.fields],callbacks:h,onSuccess:function(b){e.promise.fulfill(f(b.objects))}});return e.send()};c.Appacitive.Object.get=function(b,f){b=b||{};if(!b.type)throw Error("Specify type");if(!b.id)throw Error("Specify id to fetch");var e={},e="user"===b.type.toLowerCase()?new c.Appacitive.User({__id:b.id}):new c.Appacitive.Object({__type:b.type,
