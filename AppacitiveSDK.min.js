...
function(){return!(!_type.isNullOrUndefined(this.id)||this.has(this.idAttribute))};this.clone=function(){return"object"==this.type?b.Object._create(_deepExtend({__meta:this.meta},this.getObject())):new b.connection._create(_deepExtend({__meta:this.meta},this.getObject()))};this.copy=function(b,c){b&&(n(b,m),c&&n(b,g));return this};this.mergeWithPrevious=function(){n(m,g);k._aclFactory&&k._aclFactory.merge();l(g);v=[];w={};u={};z={};return this};var K=function(){n(g,m);k._aclFactory&&k._aclFactory.merge();
l(m);v=[];w={};u={};z={}};this.rollback=function(){m=x={};K();return this};var L=function(b,c,f,d){if(!b||!_type.isString(b)||0===b.length||0===b.indexOf("__"))return this;b=b.toLowerCase();if(_type.isObject(m[b])||_type.isArray(m[b]))throw Error("Cannot increment/decrement array/object");try{_type.isObject(c)?(d=c,c=f):c=!c||isNaN(Number(c))?f:Number(c)*f,m[b]=isNaN(Number(m[b]))?c:Number(m[b])+c,k.isNew()||(w[b]={value:(w[b]?w[b].value:0)+c})}catch(e){throw Error("Cannot perform increment/decrement operation");
}B(b,d);return k};this.increment=function(b,c,f){return L(b,c,1,f)};this.decrement=function(b,c,f){return L(b,c,-1,f)};this._findUnsavedChanges=function(){var b={object:null,isNested:!1};if(this.id)b.object=D(!0);else{var c=k.getObject();delete c.__meta;for(var f in c)"$"==f[0]&&delete c[f];c.__revision&&delete c.__revision;"object"==k.type&&k._aclFactory&&(f=k._aclFactory.getChanged())&&(c.__acls=f);c.__tags&&0==c.__tags.length&&delete c.__tags;Object.isEmpty(c.__attributes)&&delete c.__attributes;
"connection"==k.type&&(c.__endpointa.objectid&&delete c.__endpointa.object,c.__endpointb.objectid&&delete c.__endpointb.object);b.object=c}return b};this.getType=function(){var b=k.type;!m.__type||"user"!=m.__type.toLowerCase()&&"device"!=m.__type.toLowerCase()||(b=m.__type.toLowerCase());return b};this._parseOutput=function(c,f){var d=k.getType(),e;c=c||{};if(f&&f[d]){c&&c.parse&&(f[d]=this.parse(f[d]));var h=this.isNew(),n=!1;"connection"==k.type&&m.__endpointa&&f[d].__endpointa.label!=m.__endpointa.label&&
(n=f[d].__endpointa,f[d].__endpointa=f[d].__endpointb,f[d].__endpointb=n,n=!0);g=b._decode(_extend({__meta:_extend(k.meta,f.__meta)},f[d]));k.id=m[k.idAttribute]=f[d][k.idAttribute];K();h?("connection"==k.type&&(c._batch||(n?(m.__endpointa.object&&f.__bmeta&&(m.__endpointa.object.__meta=f.__bmeta),m.__endpointb.object&&f.__ameta&&(m.__endpointb.object.__meta=f.__ameta)):(m.__endpointa.object&&f.__ameta&&(m.__endpointa.object.__meta=f.__ameta),m.__endpointb.object&&f.__bmeta&&(m.__endpointb.object.__meta=
f.__bmeta))),k.parseConnection(c._batch)),k.trigger("change:__id",k,k.id,{}),b.eventManager.fire(k.entityType+"."+d+".created",k,{object:k}),k.created=!0):b.eventManager.fire(k.entityType+"."+d+"."+k.id+".updated",k,{object:k});c.silent||k.trigger("sync",k,f[d],c)}else f=f||{},f.status=f.status||{},e=F(f.status),k._triggerError(c,new b.Error(e)),k.isNew()?b.eventManager.fire(k.entityType+"."+d+".createFailed",k,{error:e}):b.eventManager.fire(k.entityType+"."+d+"."+k.id+".updateFailed",k,{object:e});
return e};this._save=function(){return this.id?O.apply(this,arguments):P.apply(this,arguments)};var P=function(c){c=c||{};var f=k.getType(),d=k._findUnsavedChanges(),e=new b._Request({method:"PUT",type:f,op:"getCreateUrl",args:[this.className,A],data:d.object,options:c,entity:k,onSuccess:function(b){(b=k._parseOutput(c,b))?e.promise.reject(b,k):e.promise.fulfill(k)}});return e.send()},O=function(c,f){b.Promise.is(f)||(f=b.Promise.buildPromise(c));var d=k._findUnsavedChanges();c=c||{};if(Object.isEmpty(d.object))f.fulfill(k);
else{var e=k.type,h=[k.className,k.id,A];m&&m.__type&&("user"==m.__type.toLowerCase()||"device"==m.__type.toLowerCase())&&(e=m.__type.toLowerCase(),h.splice(0,1));var g=new b._Request({method:"POST",type:e,op:"getUpdateUrl",args:h,data:d.object,options:c,entity:k,onSuccess:function(b){(b=k._parseOutput(c,b))?g.promise.reject(b,k):g.promise.fulfill(k)}});return g.send()}return f},Q=function(c){if(!k.id)throw Error("Please specify id for get operation");c=c||{};var f=k.getType(),d=new b._Request({method:"GET",
type:f,op:"getGetUrl",args:[this.className,k.id,A],options:c,entity:k,onSuccess:function(e){e&&e[f]?(c&&c.parse&&(e[f]=k.parse(e[f])),g=b._decode(_extend({__meta:_extend(k.meta,e.__meta)},e[f])),n(g,m),l(m),k._aclFactory&&k._aclFactory._rollback(),e.connection&&(k.endpoints||k.endpointA&&k.endpointB||k.setupConnection(m.__endpointa,m.__endpointb)),c.silent||k.trigger("sync",k,e[f],c),b.eventManager.fire(k.entityType+"."+f+"."+k.id+".fetched",k,{object:k}),d.promise.fulfill(k)):(e=e||{},e.status=e.status||
