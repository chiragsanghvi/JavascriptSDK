...
"application/javascript"==d.value.toLowerCase()||"application/json; charset=utf-8"==d.value.toLowerCase()||"application/json; charset=utf-8;"==d.value.toLowerCase())&&(e=!1)});if(e)c=d.data;else if(d.data&&(c=d.data,"object"==typeof d.data))try{c=JSON.stringify(c)}catch(k){}var u=d.url.split("/")[2]||"";if(global.navigator&&-1!=global.navigator.userAgent.indexOf("MSIE 8")&&u!==window.location.host.toLowerCase())return d.data=c,new b(d);u=new g;u.onreadystatechange=function(){if(4==this.readyState)if(200<=
...
d))}h.fulfill(d,this)}else h.reject(this,new l.Error(l.Error.ConnectionFailed,this.responseText,"Unknown"))};u.open(d.method,d.url,d.sync?!1:!0);for(var f=0;f<d.headers.length;f+=1)u.setRequestHeader(d.headers[f].key,d.headers[f].value);l.runtime.isBrowser||u.setRequestHeader("User-Agent","Appacitive-NodeJSSDK");u.send(c);return h},k=function(){var d=new f;d.isOnline=function(){return!0};var b=function(b,c,g){b.options=b.options||{};new e({method:b.method,url:b.url,headers:b.headers,data:b.data,sync:b.options.sync,
...
+d}if("object"!=typeof b||"object"!=typeof d)return!1;if(b instanceof l.Appacitive.GeoCoord&&d instanceof l.Appacitive.GeoCoord)return b.toString()==d.toString();for(g=c.length;g--;)if(c[g]==b)return h[g]==d;var g=b.constructor,u=d.constructor;if(g!==u&&!(_types.isFunction(g)&&g instanceof g&&_types.isFunction(u)&&u instanceof u)&&"constructor"in b&&"constructor"in d)return!1;c.push(b);h.push(d);g=0;u=!0;if("[object Array]"==f){if(g=b.length,u=g==d.length)for(;g--&&(u=e(b[g],d[g],c,h)););}else{for(var t in b)if(Object.prototype.hasOwnProperty.call(b,
t)&&(g++,!(u=Object.prototype.hasOwnProperty.call(d,t)&&e(b[t],d[t],c,h))))break;if(u){for(t in d)if(Object.prototype.hasOwnProperty.call(d,t)&&!g--)break;u=!g}}c.pop();h.pop();return u};_type.isEqual=function(b,d){return e(b,d,[],[])};l.Appacitive.utils=l.Appacitive.utils||{};l.Appacitive.utils._type=_type})(global);
...
0<h.options.userToken.length?h.options.userToken:!1;if(!0===d||g){var u=-1,t=h.headers.filter(function(b,c){return"ut"==b.key?(u=c,!0):!1});if(h.options.ignoreUserToken)-1!=u&&h.headers.splice(u,1);else{var r=g||k;1==t.length?h.headers.forEach(function(b){"ut"==b.key&&(b.value=r)}):h.headers.push({key:"ut",value:r})}}}});this.setUserAuthHeader=function(b,h,e){try{b&&(d=!0,k=b,e||(h||(h=-1),-1==h&&(h=null),c.localStorage.set("Appacitive-UserToken",b),c.localStorage.set("Appacitive-UserTokenExpiry",
...
m.prototype=new b;m.prototype.constructor=q;var v=function(b){g.call(this);b=b||{};if(!b.tags||!f.isArray(b.tags)||0===b.tags.length)throw Error("Specify valid tags");this.tags=b.tags;this.operator=b.operator;this.toString=function(){return String.format("{0}('{1}')",this.operator,this.tags.join(","))}};v.prototype=new g;v.prototype.constructor=v;var u=function(b,c){if(!c||!c.length||2>c.length)throw Error("Provide valid or atleast 2 filters");this.operator=b;this.innerFilters=[];for(var d=0;d<c.length;d+=
1){if(!(c[d]instanceof g))throw Error("Invalid filter provided");this.innerFilters.push(c[d])}this.toString=function(){var b=this.operator,c="(";this.innerFilters.forEach(function(d){c=1===c.length?c+(" "+d.toString()):c+String.format(" {0} {1} ",b,d.toString())});return c+=")"}};u.prototype=new g;u.prototype.constructor=u;var t={isEqualTo:"==",notEqualTo:"<>",isGreaterThan:">",isGreaterThanEqualTo:">=",isLessThan:"<",isLessThanEqualTo:"<=",like:"like",match:"match",between:"between",withinCircle:"within_circle",
withinPolygon:"within_polygon",or:"or",and:"and",taggedWithAll:"tagged_with_all",taggedWithOneOrMore:"tagged_with_one_or_more",isNull:"is null",containedIn:"in",isNotNull:"is not null",notIn:"not in"},r=function(b,d){if(null===b||void 0===b||0===b.length)throw Error("Specify value");this.value=b;this.type=d?d:typeof this.value;if("number"===this.type&&!f.isNumeric(this.value))throw Error("Value should be numeric for filter expression");this.getValue=function(){return"number"===this.type||f.isBoolean(this.value)||
f.isNumber(this.value)?this.value:"object"===this.type&&f.isDate(this.value)?"datetime('"+c.Date.toISOString(this.value)+"')":"object"==this.type&&this.value instanceof c.GeoCoord?this.value.toString():"'"+this.value.toString()+"'"}},w=function(c,f,g){g||(g=this);g.type=c;g.name=f;g.equalTo=function(c){return new b({field:this.name,fieldType:this.type,value:new r(c),operator:t.isEqualTo})};g.notEqualTo=function(c){return new b({field:this.name,fieldType:this.type,value:new r(c),operator:t.notEqualTo})};
g.greaterThan=function(c){return new b({field:this.name,fieldType:this.type,value:new r(c),operator:t.isGreaterThan})};g.greaterThanEqualTo=function(c){return new b({field:this.name,fieldType:this.type,value:new r(c),operator:t.isGreaterThanEqualTo})};g.lessThan=function(c){return new b({field:this.name,fieldType:this.type,value:new r(c),operator:t.isLessThan})};g.lessThanEqualTo=function(c){return new b({field:this.name,fieldType:this.type,value:new r(c),operator:t.isLessThanEqualTo})};g.like=function(c){return new b({field:this.name,
fieldType:this.type,value:new r("*"+c+"*"),operator:t.like})};g.match=function(c){return new b({field:this.name,fieldType:this.type,value:new r("*"+c+"*"),operator:t.match})};g.startsWith=function(c){return new b({field:this.name,fieldType:this.type,value:new r(c+"*"),operator:t.like})};g.endsWith=function(c){return new b({field:this.name,fieldType:this.type,value:new r("*"+c),operator:t.like})};g.contains=function(b){return new e({field:this.name,fieldType:this.type,value:b,operator:t.isEqualTo})};
g.containedIn=function(b){return new k({field:this.name,fieldType:this.type,value:b,operator:t.containedIn})};g.isNull=function(){return new d({field:this.name,fieldType:this.type,operator:t.isNull})};g.notIn=function(b){return new k({field:this.name,fieldType:this.type,value:b,operator:t.notIn})};g.isNotNull=function(){return new d({field:this.name,fieldType:this.type,operator:t.isNotNull})};g.between=function(b,c){return new q({field:this.name,fieldType:this.type,val1:new r(b),val2:new r(c),operator:t.between})};
g.withinCircle=function(b,c,d){return new h({field:this.name,fieldType:this.type,geoCoord:b,distance:c,unit:d,operator:t.withinCircle})};g.withinPolygon=function(b){return new m({field:this.name,fieldType:this.type,geoCoords:b,operator:t.withinPolygon})}},n=function(b){if(!b||0===b.length)throw Error("Specify field name");this.field=b;w("property",b,this);return this},P=function(b){if(!b||0===b.length)throw Error("Specify field name");this.field=b;var c=new w("aggregate",b);this.equalTo=function(b){return c.equalTo(b)};
this.notEqualTo=function(b){return c.notEqualTo(b)};this.greaterThan=function(b){return c.greaterThan(b)};this.greaterThanEqualTo=function(b){return c.greaterThanEqualTo(b)};this.lessThan=function(b){return c.lessThan(b)};this.lessThanEqualTo=function(b){return c.lessThanEqualTo(b)};this.between=function(b,d){return c.between(b,d)};this.contains=function(b){return c.contains(b)};return this},O=function(b){if(!b||0===b.length)throw Error("Specify field name");this.field=b;var c=new w("attribute",b);
...
return this};c.Filter={Property:function(b){return new n(b)},Aggregate:function(b){return new P(b)},Attribute:function(b){return new O(b)},Or:function(){return new u(t.or,arguments)},And:function(){return new u(t.and,arguments)},taggedWithOneOrMore:function(b){return new v({tags:b,operator:t.taggedWithOneOrMore})},taggedWithAll:function(b){return new v({tags:b,operator:t.taggedWithAll})}}})(global);
(function(l){var c=l.Appacitive,f=c.utils._type,g=c.utils._extend;c.Queries={};var b=function(b){b=b||{};this._pageNumber=1;this._pageSize=null;this.pageNumber(b.pageNumber);this.pageSize(b.pageSize);this.isPageDefault=!0};b.prototype.pageNumber=function(){return 1==arguments.length?(this._pageNumber=arguments[0]||1,this.isPageDefault=!1,this):this._pageNumber};b.prototype.pageSize=function(){return 1==arguments.length?(this._pageSize=arguments[0],this.isPageDefault=!1,this):this._pageSize};b.prototype.reset=
function(){this._pageSize=null;this._pageNumber=1;this.isPageDefault=!0;return this};b.prototype.pageString=function(){return"pnum="+this._pageNumber+(this._pageSize?"&psize="+this._pageSize:"")};var e=function(b){b=b||{};this._isAscending=!1;this._order=[];this.isSortSet=!1;this.orderBy(b.orderBy);this.isAscending(b.isAscending);b.ascending&&this.addAscending(b.ascending);b.descending&&this.addAscending(b.descending)};e.prototype.orderBy=function(){return 1===arguments.length&&f.isString(arguments[0])?
(this._order=[{orderBy:arguments[0],isAscending:this._isAscending}],this.isSortSet=!0,this):this._order[0]?this._order[0].orderBy:null};e.prototype.isAscending=function(){if(1===arguments.length){var b=void 0===arguments[0]||null==arguments[0]?!1:arguments[0];this._order.forEach(function(c){c.isAscending=b});this._isAscending=b;this.isSortSet=!0;return this}return 0<this._order.length?order[0].isAscending:this._isAscending};e.prototype.reset=function(){this._order=[];this.isSortSet=this._isAscending=
!1};e.prototype.ascending=function(){this._order=[];return 0<arguments.length?this.addAscending.apply(this,Array.prototype.slice.call(arguments)):this._order};e.prototype.addAscending=function(){var b=this;Array.prototype.slice.call(arguments).forEach(function(c){Array.isArray(c)&&(c=c.join());b._order=b._order.concat(c.replace(/\s/g,"").split(",").map(function(b){return{orderBy:b,isAscending:!0}}))});return this};e.prototype.descending=function(){this._order=[];return 0<arguments.length?this.addDecending.apply(this,
Array.prototype.slice.call(arguments)):this._order};e.prototype.addDecending=function(){var b=this;Array.prototype.slice.call(arguments).forEach(function(c){Array.isArray(c)&&(c=c.join());b._order=b._order.concat(c.replace(/\s/g,"").split(",").map(function(b){return{orderBy:b,isAscending:!1}}))});return this};e.prototype.sortString=function(){return this._order&&0<this._order.length?"orderBy="+this._order.map(function(b){return b.orderBy+" "+(b.isAscending?"asc":"desc")}).join(","):""};l=function(){};
l.prototype._setPaging=function(b){b&&(this.pageNumber(b.pagenumber),this.pageSize(b.pagesize),this.results=this.results||[],this.results.isLastPage=!1,this.results.total=b.totalrecords,this.results.pageNumber=b.pagenumber,this.results.pageSize=b.pagesize,b.pagenumber*b.pagesize>=b.totalrecords&&(this.results.isLastPage=!0))};l.prototype._parse=function(b,e,h){b||(b=[]);var f="object"===this.type()?"Object":"Connection";return c[f]._parseResult(b,h.entity,e)};l.prototype.collection=function(b,e){e=
e||{};f.isObject(b)&&(e=b,b=null);b||(b=this.results?this.results:[]);var h=options.entity;!h&&0<b.length&&b[0]instanceof c.BaseObject&&(h="object"==b[0].type?"Object":"Connection",h=c[h]._getClass(b[0].className));h||(h="object"===_etype?"Object":"Connection",h=c[h]._getClass(this[h]));return new c.Collection(b,g(e,{model:h,query:this}))};l.prototype.fetchNext=function(b){var c=this.pageNumber();if(!c||0>=c)c=1;this.pageNumber(++c);return this.fetch(b)};l.prototype.fetchPrev=function(b){var c=this.pageNumber();
--c;if(!c||0>=c)c=1;this.pageNumber(c);return this.fetch(b)};l.prototype.count=function(b){var e=c.Promise.buildPromise(b);b=this.toRequest(b);b.onSuccess=function(b){b=b||{};b=b.paginginfo;var c=0,c=b?b.totalrecords:0;e.fulfill(c)};b.promise=e;b.entity=this;return c.http.send(b)};var k=function(d){var g=d||{};b.call(this,d);e.call(this,d);var h="",m="",k="",u=g.queryType||"BasicQuery",t=g.type||g.relation,r=g.relation?"connection":"object",w=this;g.entity&&(this.entity=g.entity);this.type=function(){return r};
this.entityType=function(){return t};this.queryType=function(){return u};this.filter=function(){return 1===arguments.length?(h=arguments[0],this):h};this.freeText=function(){if(1===arguments.length){var b=arguments[0];f.isString(b)?m=arguments[0]:f.isArray(b)&&b.length&&(m=arguments[0].join(" "));return this}return m};this.fields=function(){if(1===arguments.length){var b=arguments[0];f.isString(b)?k=b:f.isArray(b)&&b.length&&(k=b.join(","));return this}return k};this.filter(g.filter||"");this.freeText(g.freeText||
"");this.fields(g.fields||"");this.setFilter=function(b){this.filter(b)};this.setFreeText=function(b){this.freeText(b)};this.setFields=function(b){this.fields(b)};this.extendOptions=function(c){for(var d in c)g[d]=c[d];b.call(this,g);e.call(this,g);return this};this.getQueryString=function(){var b=this.pageString(),c=this.sortString();c&&(b+="&"+c);this.filter()&&(c=encodeURIComponent(this.filter().toString()),0<c.trim().length&&(b+="&query="+c));this.freeText()&&0<this.freeText().trim().length&&
(b+="&freetext="+encodeURIComponent(this.freeText())+"&language=en");this.fields()&&0<this.fields().trim().length&&(b+="&fields="+this.fields());return b};this.toUrl=function(){return{url:c.config.apiBaseUrl+r+"/"+t+"/find/all?"+this.getQueryString(),description:"FindAll "+t+" "+r+"s"}};this.toRequest=function(b){var d=new c.HttpRequest,h=this.toUrl();d.url=h.url;d.options=b;d.description=h.description;d.method="get";return d};this.getOptions=function(){var b={},c;for(c in this)this.hasOwnProperty(c)&&
!f.isFunction(this[c])&&(b[c]=this[c]);return b};this.fetch=function(b){var d=c.Promise.buildPromise(b);b=this.toRequest(b);b.onSuccess=function(b){w.results=w._parse(b[r+"s"],b.__meta,g);w._setPaging(b.paginginfo);d.fulfill(w.results,b.paginginfo)};b.promise=d;b.entity=this;return c.http.send(b)};this.fetch=function(b){var d=c.Promise.buildPromise(b);b=this.toRequest(b);b.onSuccess=function(b){w.results=w._parse(b[r+"s"],b.__meta,g);w._setPaging(b.paginginfo);d.fulfill(w.results,b.paginginfo)};b.promise=
d;b.entity=this;return c.http.send(b)}};g(k.prototype,l.prototype,e.prototype,b.prototype);c.Queries.FindAllQuery=function(b){b=b||{};if(!b.type&&!b.relation)throw Error("Specify either type or relation for basic filter query");b.queryType="FindAllQuery";k.call(this,b);return this};c.Queries.FindAllQuery.prototype=new k;c.Queries.FindAllQuery.prototype.constructor=c.Queries.FindAllQuery;c.Query=c.Queries.FindAllQuery;c.Queries.ConnectedObjectsQuery=function(b){b=b||{};if(!b.relation)throw Error("Specify relation for connected objects query");
if(!b.objectId)throw Error("Specify objectId for connected objects query");if(!b.type)throw Error("Specify type of object id for connected objects query");var e=b.type;delete b.type;b.queryType="ConnectedObjectsQuery";k.call(this,b);this.objectId=b.objectId;this.relation=b.relation;this.type=e;b.object instanceof c.Object&&(this.object=b.object);this.returnEdge=!0;void 0===b.returnEdge||null===b.returnEdge||b.returnEdge||(this.returnEdge=!1);this.label="";var h=this;f.isString(b.label)&&0<b.label.length&&
(this.label="&label="+b.label);this.toUrl=function(){return{url:c.config.apiBaseUrl+"connection/"+this.relation+"/"+this.type+"/"+this.objectId+"/find?"+this.getQueryString()+this.label+"&returnEdge="+this.returnEdge,description:"GetConnectedObjects for relation "+this.relation+" of type "+this.type+" for object "+this.objectId}};var m=function(b,d,e,f){var m=[];b.forEach(function(b){var h=b.__edge;delete b.__edge;var k=c.Object._create(g({__meta:e},b),!0);h&&(h.__endpointa=d,h.__endpointb={objectid:b.__id,
label:h.__label,type:b.__type},delete h.label,k.connection=c.Connection._create(g({__meta:f},h),!0));m.push(k)});h.object&&(h.object.children[h.relation]=m);return m};this.fetch=function(f){var g=c.Promise.buildPromise(f);f=this.toRequest(f);f.onSuccess=function(c){h.results=m(c.nodes?c.nodes:[],{objectid:b.objectId,type:e,label:c.parent},c.__nodemeta,c.__edgemeta);h._setPaging(c.paginginfo);g.fulfill(h.results,c.paginginfo)};f.promise=g;f.entity=this;return c.http.send(f)};return this};c.Queries.ConnectedObjectsQuery.prototype=
new k;c.Queries.ConnectedObjectsQuery.prototype.constructor=c.Queries.ConnectedObjectsQuery;c.Queries.GetConnectionsQuery=function(b){b=b||{};if(!b.relation)throw Error("Specify relation for GetConnectionsQuery query");if(!b.objectId)throw Error("Specify objectId for GetConnectionsQuery query");if(!b.label||0===b.label.trim().length)throw Error("Specify label for GetConnectionsQuery query");b.type&&delete b.type;b.queryType="GetConnectionsQuery";k.call(this,b);this.objectId=b.objectId;this.relation=
b.relation;this.label=b.label;this.toUrl=function(){return{url:c.config.apiBaseUrl+"connection/"+this.relation+"/find/all?"+this.getQueryString()+"&objectid="+this.objectId+"&label="+this.label,description:"FindAllConnections for relation "+this.relation+" from object id "+this.objectId}};return this};c.Queries.GetConnectionsQuery.prototype=new k;c.Queries.GetConnectionsQuery.prototype.constructor=c.Queries.GetConnectionsQuery;c.Queries.GetConnectionsBetweenObjectsQuery=function(b,e){b=b||{};delete b.entity;
if(!b.objectAId||!f.isString(b.objectAId)||0===b.objectAId.length)throw Error("Specify valid objectAId for GetConnectionsBetweenObjectsQuery query");if(!b.objectBId||!f.isString(b.objectBId)||0===b.objectBId.length)throw Error("Specify objectBId for GetConnectionsBetweenObjectsQuery query");b.type&&delete b.type;b.queryType=e||"GetConnectionsBetweenObjectsQuery";k.call(this,b);this.objectAId=b.objectAId;this.objectBId=b.objectBId;this.label="GetConnectionsBetweenObjectsForRelationQuery"===this.queryType()&&
b.label&&f.isString(b.label)&&0<b.label.length?"&label="+b.label:"";this.relation=b.relation&&f.isString(b.relation)&&0<b.relation.length?b.relation+"/":"";this.toUrl=function(){return{url:c.config.apiBaseUrl+"connection/"+this.relation+"find/"+this.objectAId+"/"+this.objectBId+"?"+this.getQueryString()+this.label,description:"FindConnectionBetween for relation "+this.relation+" between object ids "+this.objectAId+" and "+this.objectBId}};return this};c.Queries.GetConnectionsBetweenObjectsQuery.prototype=
new k;c.Queries.GetConnectionsBetweenObjectsQuery.prototype.constructor=c.Queries.GetConnectionsBetweenObjectsQuery;c.Queries.GetConnectionsBetweenObjectsForRelationQuery=function(b){b=b||{};if(!b.relation)throw Error("Specify relation for GetConnectionsBetweenObjectsForRelationQuery query");var e=new c.Queries.GetConnectionsBetweenObjectsQuery(b,"GetConnectionsBetweenObjectsForRelationQuery");e.fetch=function(h){var f=c.Promise.buildPromise(h);h=this.toRequest(h);h.onSuccess=function(h){e.results=
h.connection?[c.Connection._create(g({__meta:h.__meta},h.connection),!0,b.entity)]:null;f.fulfill(e.results?e.results[0]:null)};h.promise=f;h.entity=this;return c.http.send(h)};return e};c.Queries.InterconnectsQuery=function(b){b=b||{};delete b.entity;if(!b.objectAId||!f.isString(b.objectAId)||0===b.objectAId.length)throw Error("Specify valid objectAId for InterconnectsQuery query");if(!(b.objectBIds&&f.isArray(b.objectBIds)&&0<b.objectBIds.length))throw Error("Specify list of objectBIds for InterconnectsQuery query");
b.type&&delete b.type;b.queryType="InterconnectsQuery";k.call(this,b);this.objectAId=b.objectAId;this.objectBIds=b.objectBIds;this.toRequest=function(b){var d=new c.HttpRequest,e=this.toUrl();d.url=e.url;d.options=b;d.description=e.description;d.method="post";d.data={object1id:this.objectAId,object2ids:this.objectBIds};return d};this.toUrl=function(){return{url:c.config.apiBaseUrl+"connection/interconnects?"+this.getQueryString(),description:"GetInterConnections between objects"}};return this};c.Queries.InterconnectsQuery.prototype=
new k;c.Queries.InterconnectsQuery.prototype.constructor=c.Queries.InterconnectsQuery;c.Queries.GraphQuery=function(d,g,h){f.isObject(d)&&(h=d.options||{},this.returnObjects=h.returnObjects,g=d.placeholders||{},d=d.name);if(!d||0===d.length)throw Error("Specify name of filter query");b.call(this,h);e.call(this,h);this.name=d;this.data={};this.queryType="GraphQuery";var m=this;if(g){this.data.placeholders=g;for(var k in this.data.placeholders)this.data.placeholders[k]=this.data.placeholders[k]}this.type=
function(){return"object"};this.toRequest=function(b){var d=new c.HttpRequest,h=this.toUrl();d.url=h.url;d.options=b;d.description=h.description;d.method="post";d.data=this.data;return d};this.getQueryString=function(){var b=[];this.isPageDefault||b.push(this.pageString());this.isSortSet&&b.push(this.sortString());return b.join("&")};this.toUrl=function(){return{url:c.config.apiBaseUrl+"search/"+this.name+"/"+(this.returnObjects?"graphquery":"filter")+"?"+this.getQueryString(),description:"Filter Query with name "+
this.name}};this.fetch=function(b){var d=c.Promise.buildPromise(b);b=this.toRequest(b);b.onSuccess=function(b){var c;m.returnObjects?(m.results=m._parse(b.objects,b.__meta,h),c=m.results):this.results=c=b.ids?b.ids:[];m.isPageDefault||m._setPaging(b.paginginfo);d.fulfill(c,b.paginginfo)};b.promise=d;b.entity=this;return c.http.send(b)}};g(c.Queries.GraphQuery.prototype,l.prototype,e.prototype,b.prototype);c.Queries.GraphAPI=function(b,e,h){if(!b||0===b.length)throw Error("Specify name of project query");
...
this.name}};var u=function(b){var d,h;for(h in b)if("status"!==h){d=b[h];break}var e=function(b,d,h,f,m){var u=[];b.forEach(function(b){var r=b.__children;delete b.__children;var k=b.__edge;delete b.__edge;b=c.Object._create(g({__meta:f},b),!0);b.children={};for(var t in r)b.children[t]=[],b.children[t]=e(r[t].values,r[t].parent,b.id,r[t].__nodemeta,r[t].__edgemeta);k&&(k.__endpointa={objectid:h,label:d},k.__endpointb={objectid:b.id,label:k.__label},delete k.__label,b.connection=c.Connection._create(g({__meta:m},
k),!0));u.push(b)});return u};return e(d.values,null,null,d.__nodemeta)};this.collection=function(b,d){d=d||{};f.isObject(b)&&(d=b,b=null);b||(b=this.results?ths.results:[]);var h;0<b.length&&b[0]instanceof c.BaseObject&&(h=c.Object._getClass(b[0].className));return new c.Collection(b,g(d,{model:h,query:this}))};this.fetch=function(b){var d=c.Promise.buildPromise(b);b=this.toRequest(b);b.onSuccess=function(b){m.results=u(b);d.fulfill(m.results)};b.promise=d;b.entity=this;return c.http.send(b)}}})(global);
...
{},d;for(d in b){var h=b[d];f.isArray(h)?(c[d]=[],h.forEach(function(b){(b=v(b))&&c[d].push(b)})):c[d]=v(b[d])}return c};c._decode=function(b){var c={},d=g({},k,h(b));delete b.__meta;for(var e in b)f.isArray(b[e])?(c[e]=[],b[e].forEach(function(b){b=d[e]?m[d[e]](b):b;c[e].push(b)})):f.isString(b[e])?c[e]=d[e]?m[d[e]](b[e]):b[e]:c[e]=b[e];return c};l=function(d,h){var r={};h=h||{};d=d||{};d=b({},d);this.meta={};d.__meta=g(this.meta,d.__meta);h&&h.parse&&(d=this.parse(d));var k=c.utils._result(this,
"defaults");f.isObject(this.defaults)&&!h.setSnapShot&&(d=b({},k,d));h&&h.collection&&(this.collection=h.collection);d=c._decode(d);var n=this,v=function(d,h){d.__meta=g(n.meta,d.__meta);n.meta=d.__meta;l(d);var e=c._decode(d),m;for(m in e)m==n.idAttribute&&(n.id=e[m]),x[m]&&delete x[m],B[m]&&delete B[m],A[m]&&delete A[m],q(e[m])?h[m]=e[m]:f.isObject(e[m])?h[m]=b({},h[m],e[m]):f.isArray(e[m])?(h[m]=[],e[m].forEach(function(b){if(q(b)||"__link"==m)h[m].push(b);else throw Error("Multivalued property cannot add object or array as property of object");
...
"__id";var x={},B={},A={},y={};v(d,y);var p=y;h.setSnapShot&&v(p,r);!r[this.idAttribute]&&y[this.idAttribute]&&(r[this.idAttribute]=y[this.idAttribute]);this.id=r[this.idAttribute];y.__type?(y.__type=y.__type.toLowerCase(),this.entityType="type",this.type="object",this.className=y.__type):y.__relationtype&&(y.__relationtype=y.__relationtype.toLowerCase(),this.entityType="relation",this.type="connection",this.className=y.__relationtype);p.__attributes||(p.__attributes={});r.__attributes||(r.__attributes=
{});var z=[];p.__tags||(p.__tags=[]);r.__tags||(r.__tags=[]);this.attributes=p;var D="";l(this.attributes);var G="__id __revision __endpointa __endpointb __createdby __lastmodifiedby __type __relationtype __typeid __relationid __utcdatecreated __utclastupdateddate __tags __authType __link __acls __meta".split(" "),H=function(b){b=b||{};b.message=b.message||"Server error";b.code=b.code||"500";return b};this.getObject=function(){var d=c._encode(b({__meta:this.meta},p));"connection"==n.type&&(d.__endpointa=
...
{}),p.__attributes[arguments[0]];if(2===arguments.length){if(!f.isString(arguments[1])&&null!==arguments[1])throw Error("only string values can be stored in attributes.");p.__attributes||(p.__attributes={});p.__attributes[arguments[0]]=arguments[1]}else throw Error(".attr() called with an incorrect number of arguments. 0, 1, 2 are supported.");C("__attributes");return p.__attributes};var I=function(){if(p.__attributes){if(!r.__attributes)return p.__attributes;var b=!1,c=JSON.parse(JSON.stringify(r.__attributes)),
d;for(d in p.__attributes)null==p.__attributes[d]||void 0==p.__attributes[d]?(c[d]=null,b=!0):p.__attributes[d]!=r.__attributes[d]?(c[d]=p.__attributes[d],b=!0):p.__attributes[d]==r.__attributes[d]&&delete c[d];return b?c:void 0}};this.getChangedAttributes=I;this.aggregate=function(){var b={},c;for(c in p){if(!p.hasOwnProperty(c))return;"$"==c[0]&&(b[c.substring(1)]=p[c])}if(0===arguments.length)return b;if(1==arguments.length)return b[arguments[0]];throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");
};this.tags=function(){return p.__tags?p.__tags:[]};this.addTag=function(b){if(!b||!f.isString(b)||!b.length)return this;p.__tags||(p.__tags=[]);p.__tags.push(b);p.__tags=Array.distinct(p.__tags);if(!z||!z.length)return C("__tags"),this;b=z.indexOf(b);-1!=b&&z.splice(b,1);C("__tags");return this};this.removeTag=function(b){if(!b||!f.isString(b)||!b.length)return this;z.push(b);z=Array.distinct(z);if(!p.__tags||!p.__tags.length)return C("__tags"),this;b=p.__tags.indexOf(b);-1!=b&&p.__tags.splice(b,
1);C("__tags");return this};var J=function(){if(p.__tags){if(!r.__tags)return p.__tags;var b=[];p.__tags.forEach(function(c){-1==r.__tags.indexOf(c)&&b.push(c)});return 0<b.length?b:void 0}};this.getChangedTags=J;this.getRemovedTags=function(){return _removetags};var K=function(b,c,d,h){if(!b||!f.isString(b)||0===b.length||0==b.trim().indexOf("__")||0===b.trim().indexOf("$")||void 0==c||null==c)return this;b=b.toLowerCase();try{var e=function(c){if(!q(c))throw Error("Multivalued property cannot have values of property as an object");
if(p[b]&&f.isArray(p[b]))if("additems"==d)p[b].push(c);else if("adduniqueitems"==d){var h=-1;p[b].find(function(b,d){return f.isEqual(b,c)?(h=d,!0):!1});-1==h&&p[b].push(c)}else"removeitems"==d&&p[b].removeAll(c);else p[b]="removeitems"==d?[]:[c];B[b]||(B[b]={additems:[],adduniqueitems:[],removeitems:[]});B[b][d].push(c)};f.isArray(c)?c.forEach(function(b){e(b)}):e(c);C(b,h)}catch(g){throw Error("Unable to add item to "+b);}return n};this.add=function(b,c,d){return K.apply(this,[b,c,"additems",d])};
this.addUnique=function(b,c,d){return K.apply(this,[b,c,"adduniqueitems",d])};this.remove=function(b,c,d){return K.apply(this,[b,c,"removeitems",d])};var E=function(b,c,d,h){var e=void 0;f.isEqual(d,c)||("__tags"==b?(b=J())&&0<b.length&&(e=b):"__attributes"==b?(b=I(),Object.isEmpty(b)||(e=b)):f.isArray(d)?B[b]&&!A[b]?e=h?B[b]:d:d.equals(c)||(e=d):e=x[b]&&!A[b]?h?{incrementby:x[b].value}:d:d);return e},F=function(d){var h=!1,e=b({},r),f;for(f in e)"$"==f[0]&&delete e[f];for(var g in p)f=E(g,e[g],p[g],
d),void 0===f?delete e[g]:(h=!0,e[g]=f);try{G.forEach(function(b){e[b]&&delete e[b]})}catch(m){}d&&(e=c._encode(e));g=J();d?(g&&0<g.length&&(e.__addtags=g,h=!0),z&&0<z.length&&(e.__removetags=z,h=!0)):g&&0<g.length&&(e.__tags=g,h=!0);(d=I())&&!Object.isEmpty(d)?(e.__attributes=d,h=!0):delete e.__attributes;"object"==n.type&&n._aclFactory&&(d=n._aclFactory.getChanged())&&(h=!0,e.__acls=d);return h&&!Object.isEmpty(e)?e:!1};this.changed=function(){return this.isNew()?this.toJSON():F()};this.hasChanged=
function(){return this.isNew()?!0:0===arguments.length?Object.isEmpty(F(!0))?!1:!0:1==arguments.length&&f.isString(arguments[0])&&0<arguments[0].length?void 0==E(arguments[0],r[arguments[0]],p[arguments[0]])?!1:!0:!1};this.changedAttributes=function(){if(this.isNew())return this.toJSON();if(0===arguments.length)return F();if(1==arguments.length&&f.isArray(arguments[0])&&arguments[0].length){var b={};arguments[0].forEach(function(c){c=E(c,r[c],p[c]);void 0!=c&&b.push(c)});return b}return!1};this.previous=
function(){return this.isNew()?null:1==arguments.length&&f.isString(arguments[0])&&arguments[0].length?r[arguments[0]]:null};this.previousAttributes=function(){return this.isNew()?null:g({},r)};this.fields=function(){if(1==arguments.length){var b=arguments[0];f.isString(b)?D=b:f.isArray(b)&&(D=b.join(","));return this}return D};this.get=function(b,c){if(b){if(c&&m[c.toLowerCase()]){if(m[c.toLowerCase()])return m[c.toLowerCase()](p[b]);throw Error('Invalid cast-type "'+c+'"" provided for get "'+b+
'"');}return p[b]}};this.tryGet=function(b,c,d){b=this.get(b,d);return void 0!==b?b:c};var C=function(b,c){if(c&&!c.silent){var d=E(b,r[b],p[b]);if(void 0!=d[b]||-1!=G.indexOf(b))n.trigger("change:"+b,n,d[b]||p[b],{}),c.ignoreChange||n.trigger("change",n,c)}},L=function(b){b&&!b.silent&&n.trigger("destroy",n,n.collection,b)};this._triggerError=function(b,c){b.silent||n.trigger("error",n,c,b)};var R=function(b,c,d){if(!b||!f.isString(b)||0===b.length||0===b.trim().indexOf("$"))return this;b=b.toLowerCase();
try{if(f.isNullOrUndefined(c))p[b]=null;else if(q(c))p[b]=c;else if(f.isObject(c))if(-1!==e.indexOf(b))p[b]=c;else throw Error("Property cannot have value as an object");else f.isArray(c)&&(p[b]=[],c.forEach(function(c){if(q(c))p[b].push(c);else throw Error("Multivalued property cannot have values of property as an object");}));delete x[b];delete B[b];delete A[b];f.isEqual(p[b],r[b])||(A[b]=!0);b==n.idAttribute&&(n.id=c);return this}catch(h){throw Error("Unable to set "+b);}};this.set=function(b,
c,d){var h,e;if(null==b)return this;null==b||"object"===typeof b?(e=b,d=c):(e={})[b]=c;d||(d={});if(!this._validate(e,d))return!1;this.idAttribute in e&&(this.id=e[this.idAttribute]);l(e);var f=!1;for(h in e)c=e[h],R.apply(this,[h,c,g({},d,{ignoreChange:!0})]);if(d&&!d.silent)for(h in e)if(void 0!=E(h,r[h],p[h])||-1!=G.indexOf(h))f=!0,n.trigger("change:"+b,n,p[b],{});f&&this.trigger("change",this,d);return this};this.unset=function(b,c){if(!b||!f.isString(b)||0===b.length||0===b.indexOf("__"))return this;
...
h.typeName&&!h.isNew()&&(h=h.id);var k=q.filter(function(b){return b.sid==h&&b.type==d});k&&0!=k.length?k=k[0]:(k={sid:h,type:d,deny:[],allow:[]},q.push(k));k.allow||(k.allow=[]);k.deny||(k.deny=[]);f=e(f);var v=m.filter(function(b){return b.sid==h&&b.type==d});v&&0!=v.length?v=v[0]:(v={sid:h,type:d},m.push(v));f.forEach(function(c){for(var d=0;d<g.length;d+=1){var h=k[g[d]].indexOf(c);if(-1!=h){k[g[d]].splice(h,1);break}}"dontcare"!=b&&k[b].push(c);v[c]=b});return this},u=function(b,c,d,h){if(!d)throw Error("Please provide valid id or name for setting acls");
if(!h)throw Error("Please provide valid access permissions for setting acls");f.isArray(h)||(h=[h]);f.isArray(d)?d.forEach(function(d){v(b,c,d,h)}):v(b,c,d,h);return this},l=function(){q.allowUser=function(b,c){return u.apply(this,["allow","user",b,c])};q.allowGroup=function(b,c){return u.apply(this,["allow","usergroup",b,c])};q.denyUser=function(b,c){return u.apply(this,["deny","user",b,c])};q.denyGroup=function(b,c){return u.apply(this,["deny","usergroup",b,c])};q.resetUser=function(b,c){return u.apply(this,
["dontcare","user",b,c])};q.resetGroup=function(b,c){return u.apply(this,["dontcare","usergroup",b,c])};q.allowAnonymous=function(b){return u.apply(this,["allow","usergroup",["anonymous"],b])};q.denyAnonymous=function(b){return u.apply(this,["deny","usergroup",["anonymous"],b])};q.resetAnonymous=function(b){return u.apply(this,["dontcare","usergroup",["anonymous"],b])};q.allowLoggedIn=function(b){return u.apply(this,["allow","usergroup",["anonymous"],b])};q.denyLoggedIn=function(b){return u.apply(this,
["deny","usergroup",["anonymous"],b])};q.resetLoggedIn=function(b){return u.apply(this,["dontcare","usergroup",["anonymous"],b])}};this._rollback=function(){m=[];q=JSON.parse(JSON.stringify(h));l();return this};this.toJSON=this.getChanged=function(){var c=[];m.forEach(function(d){var h={sid:d.sid,type:d.type,allow:[],deny:[],dontcare:[]};b.forEach(function(b){d[b]&&h[d[b]].push(b)});g.forEach(function(b){0==h[b].length&&delete h[b]});0==h.dontcare.length&&delete h.dontcare;c.push(h)});return 0==c.length?
null:c};this.merge=function(){m=[];return this};l();return this};c.Group=new function(){var b=function(b,e,h,g){if(!e||!f.isString(e)||0===e.length)throw Error("Please specify valid groupname");f.isArray(h)||(h=[h]);var k={};k[b]=[];h.forEach(function(h){h&&(h instanceof c.Object&&"user"==h.typeName&&!h.isNew()?k[b].push(h.id):f.isString(h)&&k[b].push(h))});if(0==k[b].length)throw Error("Please specify valid members as second argument");var u=new c._Request({method:"POST",type:"usergroup",op:"getUpdateUrl",
args:[e],data:k,entity:this,options:g,onSuccess:function(b){u.promise.fulfill(b)}});return u.send()};this.addMembers=function(c,e,h){return b("add",c,e)};this.removeMembers=function(c,e,h){return b("remove",c,e)}}})(global);
...
(function(l){var c=l.Appacitive,f=c.utils._type,g=c.utils._extend,b=function(b,d){b=b||{};b.__type="user";c.Object.call(this,b,d);return this},e=null;b.currentUser=b.current=function(){return e};var k=function(b,d,e){var g=this.get("__id");if(!g||!f.isString(g)||0===g.length)throw Error("Please specify valid userid");if(!b||!f.isString(b)||0===b.length)throw Error("Please specify valid oldPassword");if(!d||!f.isString(d)||0===d.length)throw Error("Please specify valid newPassword");var k=this,r=new c._Request({method:"POST",
type:"user",op:"getUpdatePasswordUrl",args:[g],options:e,data:{oldpassword:b,newpassword:d},entity:this,onSuccess:function(b){r.promise.fulfill(k)}});return r.send()},d=function(b,d){var e=this.get("__id");if(!this.get("__id"))return this.set("__link",b),c.Promise.buildPromise(d).fulfill(this);var g=this,k=new c._Request({method:"POST",type:"user",op:"getLinkAccountUrl",args:[e],options:d,data:b,entity:this,onSuccess:function(c){c=g.get("__link");f.isArray(c)||(c=c?[c]:[]);c.push(b);g.copy({__link:c},
...
return(new c.User(b)).save(d)};b.createUser=b.createNewUser;b.signup=function(b,d){var e=this,f=c.Promise.buildPromise(d);this.createUser(b).then(function(){e.login(b.username,b.password).then(function(){f.fulfill.apply(f,arguments)},function(b){f.reject.apply(f,arguments)})},function(){f.reject.apply(f,arguments)});return f};b.authenticateUser=function(b,d,k){d=d||{};b.expiry||(b.expiry=864E5);var q=this,t;f.isString(k)&&f.isObject(d.user)&&(b.user=d.user instanceof l.Appacitive.User?d.user.toJSON():
d.user,delete b.user.__meta,t=d.user);var r=new c._Request({method:"POST",type:"user",op:"getAuthenticateUserUrl",options:d,data:b,onSuccess:function(d){d&&d.user?(k&&(d.user.__authType=k),g(d.user,{__meta:d.__meta}),t instanceof l.Appacitive.User&&(d.user=t.copy(d.user,!0)),q.setCurrentUser(d.user,d.token,b.expiry),c.User.trigger("login",e,e,d.token),r.promise.fulfill({user:e,token:d.token})):r.promise.reject(d.status)}});return r.send()};b.login=function(b,c,d){if(!b||!c||0==b.length||0==c.length)throw Error("Please specify username and password");
...
getObject:function(b){return this.models.map(function(c){return c.getObject(b)})},add:function(b,c){c=c||{};var g,d,l,h,m,v={},u={},t=[],r=c.sort,w;b=f.isArray(b)?b.slice():[b];g=0;for(d=b.length;g<d;g++){b[g]=this._prepareModel(b[g]);l=b[g];if(!l)throw Error("Can't add an invalid model to a collection");h=l.cid;if(v[h]||this._byCid[h])throw Error("Duplicate cid: can't add the same model to a collection twice");(m=l.id)&&((w=u[m])||(w=this._byId[m]))?(w.copy(l.getObject(),c.setSnapShot),w.children=
l.children):(u[m]=l,v[h]=l,t.push(l),this._addReference(l,c))}this.models.splice.apply(this.models,[null!=c.at?c.at:this.models.length,0].concat(t));r&&this.comparator&&this.sort({silent:!0});this.length=this.models.length;if(c.silent)return this;g=0;for(d=t.length;g<d;g++)l=t[g],c.index=g,l.trigger("add",l,this,c);return this},remove:function(b,c){var g,d,l,h;c=c||{};b=f.isArray(b)?b.slice():[b];g=0;for(d=b.length;g<d;g++)if(h=this.getByCid(b[g])||this.get(b[g]))delete this._byId[h.id],delete this._byCid[h.cid],
...
this._byId[b instanceof c.BaseObject?b.id:b]},query:function(b){if(b){if(b instanceof c.Query||b instanceof c.Queries.GraphAPI)return this._query=b,this;throw Error("Cannot bind this query");}this._query||(this._query=new c.Query(this.model));return this._query},getByCid:function(b){return b&&this._byCid[b.cid||b]},at:function(b){return this.models[b]},where:function(b,c){return Object.isEmpty(b)?c?void 0:[]:this.models[c?"find":"filter"](function(c){for(var d in b)if(b[d]!==c.get(d))return!1;return!0})},
...
1]:null},reset:function(b,c){c||(c={});for(var f=0,d=this.models.length;f<d;f++)this._removeReference(this.models[f],c);this._reset();this.add(b,g({silent:!0},c));c.silent||this.trigger("reset",this,c);return this},fetch:function(b){b=c.utils._clone(b)||{};var e=this,f=this.query()||new c.Query(this.model),d=c.Promise.buildPromise(b);f.fetch(b).then(function(c){0==b.reset?e.add(c,g({setSnapShot:!0},b)):e.reset(c,b);d.fulfill(e)},function(){d.reject.apply(d,arguments)});return d},fetchNext:function(b){var c=
this.query().pageNumber();this.query().pageNumber(++c);return this.fetch(b)},fetchPrev:function(b){var c=this.query().pageNumber();--c;0>=c&&(c=1);this.query().pageNumber(c);return this.fetch(b)},mutiGet:function(b){b=c.utils._clone(b)||{};var e=this,g=c.Promise.buildPromise(b);b=b||{};f.isArray(b)&&(b[0]instanceof c.Object?(models=b,b={ids:models.map(function(b){return b.id}).filter(function(b){return b})}):b={ids:b});var d=b.ids||[];if(0==d.length)return g.fulfill(e);this.model.multiGet({ids:d,
fields:b.fields}).then(function(c){b.add?e.add(c,b):e.reset(c,b);g.fulfill(e)},function(){g.reject.apply(g,arguments)});return g},saveAll:function(b){return this.model.saveAll(this.models,g({},b))},save:function(b){return this.model.saveAll(this.models,g({},b))},create:function(b,e){var f=this;e=e?c.utils._clone(e):{};if(!(b=this._prepareModel(b,e)))return!1;e.wait||this.add(b,e);var d=e.success;e.success=function(){e.wait&&f.add(b,g({setSnapShot:!0},e));d&&d(b,f)};b.save(e);return b},_reset:function(b){this.length=
0;this.models=[];this._byId={};this._byCid={}},_prepareModel:function(b){b instanceof c.BaseObject||(b=new this.model(b));b.collection||(b.collection=this);return b},_addReference:function(b){this._byId[b.cid]=b;null!=b.id&&(this._byId[b.id]=b);b.collection||(b.collection=this);b.on("all",this._onModelEvent,this)},_removeReference:function(b){this===b.collection&&delete b.collection;b.off("all",this._onModelEvent,this)},_onModelEvent:function(b,c,f,d){if("add"!==b&&"remove"!==b||f===this)"destroy"===
b&&this.remove(c,d),c&&"change:__id"===b&&(delete this._byId[c.previous(c.idAttribute)],null!=c.id&&(this._byId[c.id]=c)),this.trigger.apply(this,arguments)}});c.Collection.extend=function(b,e){b&&b.query&&(b._query=b.query,delete b.query);var f=c.utils.classExtend(this,b,e);f.extend=this.extend;return f};"forEach each map find filter every some indexOf lastIndexOf isEmpty difference without reduce".split(" ").each(function(b){c.Collection.prototype[b]=function(){var c=Array.prototype.slice.call(arguments);
return Array.prototype[b].apply(this.models,c)}})})(global);
...
op:"getBatchUrl",data:d,options:b,entity:this,onSuccess:function(c){(c=t.apply(e,[c,b]))?f.promise.reject(c,e):f.promise.fulfill(e)}});return f.send()};c.Events.mixin(c.Batch.prototype)})(global);
...
b)})};this.save=function(b,c){"number"!==typeof b&&(c=b,b=-1);return this.fileId&&f.isString(this.fileId)&&0<this.fileId.length?l(b,c):d(b,c)};var d=function(d,g){if(!b.fileData)throw Error("Please specify filedata");if(!b.contentType)try{b.contentType=b.fileData.type}catch(l){}b.contentType&&f.isString(b.contentType)&&0!==b.contentType.length||(b.contentType="text/plain");var q=c.Promise.buildPromise(g),t=c.config.apiBaseUrl+c.storage.urlFactory.file.getUploadUrl(b.contentType,b.fileId?b.fileId:
"");e(t,function(c){k(c.url,b.fileData,b.contentType,function(){b.fileId=c.id;b.getDownloadUrl(d,g).then(function(c){return q.fulfill(c,b)},function(b){return q.reject(b)})},q)},q," Get upload url for file ",g);return q},l=function(d,g){if(!b.fileData)throw Error("Please specify filedata");if(!b.contentType)try{b.contentType=b.fileData.type}catch(l){}b.contentType&&f.isString(b.contentType)&&0!==b.contentType.length||(b.contentType="text/plain");var q=c.Promise.buildPromise(g),t=c.config.apiBaseUrl+
c.storage.urlFactory.file.getUpdateUrl(b.fileId,b.contentType);e(t,function(c){k(c.url,b.fileData,b.contentType,function(){b.getDownloadUrl(d,g).then(function(c){q.fulfill(c,b)},function(b){q.reject(b)})},q)},q," Get update url for file "+b.fileId,g);return q};this.destroy=function(d){if(!this.fileId)throw Error("Please specify fileId to delete");var e=c.Promise.buildPromise(d),f=new c.HttpRequest;f.url=c.config.apiBaseUrl+c.storage.urlFactory.file.getDeleteUrl(this.fileId);f.method="DELETE";f.description=
