...
[],h;for(h in d)d.hasOwnProperty(h)&&a.push(d[h]);for(;0<c.length;){var g=c.shift(),f=[];for(h in e)e.hasOwnProperty(h)&&f.push(e[h](g));this.changeRequestForCors(g);b.send(g,a,f)}}};this.onResponse=function(b){console.dir(b)}},f=function(){var b=function(){throw Error("Not Implemented Exception");};this.inOnline=this.send=b;this.onResponse=function(c,e){b()};this.onError=function(c){b()}},g=null,g=global.Appacitive.runtime.isBrowser?XMLHttpRequest:require("xmlhttprequest").XMLHttpRequest,c=function(b){var c=
...
location.search||-1==location.search.indexOf("?")?c:a?(a=a.toLowerCase(),location.search.split("?")[1].split("&").forEach(function(d,e){var b=e.split("="),f=b[1];2<b.length&&b.forEach(function(a,c){0!=a&&1!=a&&(f=f+"="+b[a])});b[0].toLowerCase()==a&&(c=[b[0],f])}),c):location.search.split("?")[1].split("=")}}}})(global);
...
(function(a){a.Appacitive.Session=new function(){this.initialized=!1;var f=function(){this.apikey="";this.isnonsliding=!1;this.usagecount=-1;this.windowtime=240},g=null,c=null,d=null,e=!1;this.useApiKey=!0;this.onSessionCreated=function(){};this.recreate=function(){a.Appacitive.Session.create(null)};this.create=function(b,e){if(!this.initialized)throw Error("Intialize Appacitvie SDK");var d=new f;d.apikey=c;var k=new a.Appacitive.HttpRequest;k.url=a.Appacitive.config.apiBaseUrl+"application.svc/session";
k.method="put";k.data=d;k.onSuccess=function(c){c&&c.status&&"200"==c.status.code?(g=c.session.sessionkey,a.Appacitive.Session.useApiKey=!1,b&&"function"==typeof b&&b(c),a.Appacitive.Session.onSessionCreated()):e&&"function"==typeof e&&e(c)};k.onError=e;a.Appacitive.http.send(k)};a.Appacitive.http.addProcessor({pre:function(b){a.Appacitive.Session.useApiKey?b.headers.push({key:"ak",value:c}):b.headers.push({key:"as",value:g});!0===e&&(1==b.headers.filter(function(a){return"ut"==a.key}).length?b.headers.forEach(function(a){"ut"==
a.key&&(a.value=d)}):b.headers.push({key:"ut",value:d}))}});this.setUserAuthHeader=function(b,c,h){try{b&&(e=!0,d=b,h||(c||(c=60),-1==c&&(c=null),a.Appacitive.runtime.isBrowser&&(a.Appacitive.Cookie.setCookie("Appacitive-UserToken",b,c),a.Appacitive.Cookie.setCookie("Appacitive-UserTokenExpiry",c?c:-1,c))))}catch(k){}};this.incrementExpiry=function(){};this.removeUserAuthHeader=function(b,c){b&&("function"!=typeof b&&"boolean"==typeof b)&&(c=b,b=function(){});e=!1;b=b||function(){};a.Appacitive.localStorage.remove("Appacitive-User");
a.Appacitive.runtime.isBrowser&&(a.Appacitive.Cookie.eraseCookie("Appacitive-UserToken"),a.Appacitive.Cookie.eraseCookie("Appacitive-UserTokenExpiry"));if(d&&!c)try{var h=new a.Appacitive.HttpRequest;h.url=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.user.getInvalidateTokenUrl(d);d=null;h.method="POST";h.data={};h.onSuccess=function(){"function"==typeof b&&b()};a.Appacitive.http.send(h)}catch(k){}else d=null,"function"==typeof b&&b()};this.isSessionValid=function(a){if(!a)return!0;
...
"')":"time('"+this.value+"'')"}},n=function(a){this.value=a;this.getValue=function(){return"object"==typeof this.value&&this.value instanceof Date?"datetime('"+f.Date.toISOString(this.value)+"')":"datetime('"+this.value+"'')"}},p=function(a,f,g){g||(g=this);g.type=a;g.name=f;g.equalTo=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"=="})};g.equalToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:"=="})};g.equalToTime=
function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"=="})};g.equalToDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:"=="})};g.greaterThan=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:">"})};g.greaterThanDate=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:">"})};g.greaterThanTime=function(a){return new c({field:this.name,fieldType:this.type,
value:new k(a),operator:">"})};g.greaterThanDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:">"})};g.greaterThanEqualTo=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:">="})};g.greaterThanEqualToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:">="})};g.greaterThanEqualToTime=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:">="})};g.greaterThanEqualToDateTime=
function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:">="})};g.lessThan=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"<"})};g.lessThanDate=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:"<"})};g.lessThanTime=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"<"})};g.lessThanDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),
operator:"<"})};g.lessThanEqualTo=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"<="})};g.lessThanEqualToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:"<="})};g.lessThanEqualToTime=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"<="})};g.lessThanEqualToDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:"<="})};g.like=function(a){return new c({field:this.name,
fieldType:this.type,value:new l("*"+a+"*"),operator:"like"})};g.startsWith=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a+"*"),operator:"like"})};g.endsWith=function(a){return new c({field:this.name,fieldType:this.type,value:new l("*"+a),operator:"like"})};g.contains=function(a){return new d({field:this.name,fieldType:this.type,value:a,operator:"=="})};g.between=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new l(a),val2:new l(b),operator:"between"})};
g.betweenDate=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new h(a),val2:new h(b),operator:"between"})};g.betweenTime=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new k(a),val2:new k(b),operator:"between"})};g.betweenDateTime=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new n(a),val2:new n(b),operator:"between"})};g.withinCircle=function(a,c,e){return new b({field:this.name,fieldType:this.type,geoCoord:a,distance:c,unit:e,operator:"within_circle"})};
g.withinPolygon=function(a){return new m({field:this.name,fieldType:this.type,geoCoords:a,operator:"within_polygon"})}};_propertyExpression=function(a){if(!a||0==a.length)throw Error("Specify field name");this.field=a;p("property",a,this);return this};_aggregateExpression=function(a){if(!a||0==a.length)throw Error("Specify field name");this.field=a;var b=new p("aggregate",a);this.equalTo=function(a){return b.equalTo(a)};this.greaterThan=function(a){return b.greaterThan(a)};this.greaterThanEqualTo=
...
arguments[0]||"__UtcLastUpdatedDate",this):c};this.isAscending=function(){return 1==arguments.length?(b="undefined"==typeof arguments[0]?!1:arguments[0],this):b};this.orderBy(a.orderBy);this.isAscending(a.isAscending)};g.prototype.toString=function(){return"orderBy="+this.orderBy()+"&isAsc="+this.isAscending()};var c=function(c){var e=c||{},b="",m="",l="",h=e.queryType||"BasicQuery",k=new f(c),n=new g(c),p=e.schema||e.relation,r=e.relation?"connection":"article";this.type=function(){return r};this.entityType=
function(){return p};this.queryType=function(){return h};this.pageQuery=function(){return k};this.pageNumber=function(){return 1==arguments.length?(k.pageNumber(arguments[0]),this):k.pageNumber()};this.pageSize=function(){return 1==arguments.length?(k.pageSize(arguments[0]),this):k.pageSize()};this.sortQuery=function(){return n};this.orderBy=function(){return 1==arguments.length?(n.orderBy(arguments[0]),this):n.orderBy()};this.isAscending=function(){return 1==arguments.length?(n.isAscending(arguments[0]),
this):n.isAscending()};this.filter=function(){return 1==arguments.length?(b=arguments[0],this):b};this.freeText=function(){if(1==arguments.length){var a=arguments[0];"string"==typeof a?m=arguments[0]:"object"==typeof a&&a.length&&(m=arguments[0].join(" "));return this}return m};this.fields=function(){if(1==arguments.length){var a=arguments[0];"string"==typeof a?l=a:"object"==typeof a&&a.length&&(l=a.join(","));return this}return l};this.filter(e.filter||"");this.freeText(e.freeText||"");this.fields(e.fields||
"");this.setFilter=function(a){this.filter(a)};this.setFreeText=function(a){this.freeText(a)};this.setFields=function(a){this.fields(a)};this.extendOptions=function(a){for(var b in a)e[b]=a[b];k=new f(e);n=new g(e);return this};this.getQueryString=function(){var a=k.toString()+"&"+n.toString();if(this.filter()){var b=this.filter().toString();0<b.trim().length&&(a+="&query="+b)}this.freeText()&&0<this.freeText().trim().length&&(a+="&freetext="+this.freeText()+"&language=en");this.fields()&&0<this.fields().trim().length&&
...
!0))});return c};this.fetch=function(b,c){var e=this.toRequest();e.onSuccess=function(a){a&&a.status&&"200"==a.status.code?"function"==typeof b&&b(u(a[r+"s"]),a.paginginfo):(a=a||{},"function"==typeof c&&c(a.status||{message:"Server error",code:400}))};e.onError=function(a){a=a||{};"function"==typeof c&&c(a.status||{message:"Server error",code:400})};a.Appacitive.http.send(e);return this};this.count=function(b,c){b=b||function(){};c=c||function(){};var e=k.pageSize,d=k.pageNumber;k.pageSize=1;k.pageNumber=
999999999;var h=this,l=this.toRequest();l.onSuccess=function(a){k.pageSize=e;k.pageNumber=d;a=a||{};var l=a.paginginfo,f=0;if(l)f=l.totalrecords;else if(a.status&&a.status.code&&"200"==a.status.code)f=0;else{a=a.status||{message:"Server error",code:400};"function"==typeof c&&c(a,h);return}"function"==typeof b&&b(f)};l.onError=function(a){k.pageSize=e;k.pageNumber=d;a=a||{message:"Server error",code:400};"function"==typeof c&&c(a,h)};a.Appacitive.http.send(l);return this}};a.Appacitive.Queries.FindAllQuery=
...
(b.__relationtype=b.__relationtype.toLowerCase(),this.relation=this.entityType=b.__relationtype,this.type="connection");var m=parseInt(1E6*Math.random(),10);this.cid=m;var l="__id __revision __endpointa __endpointb __createdby __lastmodifiedby __schematype __relationtype __schemaid __relationid __utcdatecreated __utclastupdateddate __tags __authType __link".split(" "),h=["__link","__endpointa","__endpointb"],k=function(a){a=a||{};a.message=a.message||"Server error";a.code=a.code||"500";return a};
...
-1!=a&&b.__tags.splice(a,1);return this};var r=function(){if(!b.__tags)return[];if(!c.__tags)return b.__tags;var a=[];b.__tags.every(function(b){-1==c.__tags.indexOf(b)&&a.push(b)});return a};this.getChangedTags=r;this.getRemovedTags=function(){return _removetags};var u=function(a){var e=!1,d=JSON.parse(JSON.stringify(c)),k;for(k in b)"undefined"==typeof b[k]||null===b[k]?(d[k]=null,e=!0):b[k]!=c[k]?"__tags"==k||"__attributes"==k?delete d[k]:(d[k]=b[k],e=!0):b[k]==c[k]&&delete d[k];try{l.forEach(function(a){d[a]&&
delete d[a]})}catch(h){}a?(b.__tags&&0<b.__tags.length&&(d.__addtags=r(),e=!0),p&&0<p.length&&(d.__removetags=p,e=!0)):b.__tags&&0<b.__tags.length&&(d.__tags=r(),e=!0);(a=n())?(d.__attributes=a,e=!0):delete d.__attributes;for(var f in d)"$"==f[0]&&delete d[f];return e&&!Object.isEmpty(d)?d:!1};this.changed=function(){return u()};this.hasChanged=function(){var a=u(!0);return 0===arguments.length?Object.isEmpty(a)?!1:!0:1==arguments.length&&"string"==typeof arguments[0]&&0<arguments[0].length&&a&&a[arguments[0]]?
...
new a.Appacitive.connection(b)};this.copy=function(a,e){a&&(d(a,b),e&&d(a,c));return this};var t=[],y=function(a,b,c){if(!a||"string"!=typeof a||0==a.length||0==a.indexOf("__"))return this;b=!b||isNaN(parseInt(b))?c:parseInt(b)*c;t.push({key:a.toLowerCase(),amount:b});return e};this.increment=function(a,b){return y(a,b,1)};this.decrement=function(a,b){return y(a,b,-1)};this.save=function(){b.__id?x.apply(this,arguments):A.apply(this,arguments);return this};var A=function(e,f,h){e=e||function(){};
f=f||function(){};"string"==typeof h?q=value:h="object"==typeof h&&h.length?h.join(","):q;var l=this;h=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[this.type].getCreateUrl(b.__schematype||b.__relationtype,h);!b.__schematype||"user"!=b.__schematype.toLowerCase()&&"device"!=b.__schematype.toLowerCase()||(h=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[b.__schematype.toLowerCase()].getCreateUrl());for(var g in b)"$"==g[0]&&delete b[g];g=new a.Appacitive.HttpRequest;
g.url=h;g.method="put";b.__revision&&delete b.__revision;g.data=b;g.onSuccess=function(h){var g=null;h&&(h.article||h.connection||h.user||h.device)&&(g=h.article||h.connection||h.user||h.device);h&&g?(c=g,b.__id=g.__id,d(g,b),l.connectionCollections&&0<l.connectionCollections.length&&l.connectionCollections.forEach(function(a){a.getQuery().extendOptions({articleId:b.__id})}),"connection"==l.type&&l.parseConnection(),a.Appacitive.eventManager.fire((l.schema||l.relation)+"."+l.type+".created",l,{object:l}),
"function"==typeof e&&e(l)):(h=h||{},h.status=h.status||{},h.status=k(h.status),a.Appacitive.eventManager.fire((l.schema||l.relation)+"."+l.type+".createFailed",l,{error:h.status}),"function"==typeof f&&f(h.status,l))};g.onError=function(a){a=k(a);"function"==typeof f&&f(a,l)};a.Appacitive.http.send(g);return this},x=function(h,f,l){h=h||function(){};f=f||function(){};var g=function(g){var n=u(!0),m;for(m in n)"$"==m[0]&&delete n[m];if(Object.isEmpty(n))"function"==typeof h&&h(e);else{"string"==typeof l?
q=value:l="object"==typeof l&&l.length?l.join(","):q;m=new a.Appacitive.HttpRequest;var r=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[e.type].getUpdateUrl(b.__schematype||b.__relationtype,c.__id?c.__id:b.__id,l,g),v=e.type;b&&(b.__schematype&&("user"==b.__schematype.toLowerCase()||"device"==b.__schematype.toLowerCase()))&&(v=b.__schematype.toLowerCase(),r=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[b.__schematype.toLowerCase()].getUpdateUrl(c.__id,l,g));m.url=
r;m.method="post";m.data=n;m.onSuccess=function(g){g&&g[v]?(t.length=0,c=g[e.type],d(c,b),p=[],a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+v+"."+b.__id+".updated",e,{object:e}),"function"==typeof h&&h(e)):(g=g||{},g.status=g.status||{},g.status=k(g.status),"7008"==g.status.code&&0<t.length?x(h,f,l):(a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+v+"."+b.__id+".updateFailed",e,{object:g.status}),"function"==typeof f&&f(g.status,e)))};m.onError=function(a){a=a||{};a.message=
a.message||"Server error";a.code=a.code||"500";"7008"==a.code&&0<t.length?x(h,f,l):"function"==typeof f&&f(a,e)};a.Appacitive.http.send(m)}};if(0<t.length){var n=["__revision"];t.forEach(function(a){n.push(a.key)});z(function(a){t.forEach(function(b){var c=w.integer(a[b.key]);c||(c=0);e.set(b.key,c+b.amount)});g(a.__revision)},f,n,!0)}else g();return this},z=function(h,f,l,g){h=h||function(){};f=f||function(){};if(b.__id){"string"==typeof l?q=value:l="object"==typeof l&&l.length?l.join(","):q;l=a.Appacitive.config.apiBaseUrl+
a.Appacitive.storage.urlFactory[e.type].getGetUrl(b.__schematype||b.__relationtype,b.__id,l);var m=new a.Appacitive.HttpRequest;m.url=l;m.method="get";m.onSuccess=function(a){a&&a[e.type]?g?"function"==typeof h&&h(a[e.type]):(c=a[e.type],d(c,b),a.connection&&(e.endpoints||e.endpointA&&e.endpointB||e.setupConnection(b.__endpointa,b.__endpointb)),e.___collection&&"article"==e.___collection.collectionType&&e.___collection.addToCollection(e),"function"==typeof h&&h(e)):(a=a||{},a.status=a.status||{},
a.status=k(a),"function"==typeof f&&f(a.status,e))};m.onError=function(a){a=k(a);"function"==typeof f&&f(a,e)};a.Appacitive.http.send(m);return e}"function"==typeof f&&f({code:"400",message:"Please specify id for get operation"},e)};this.fetch=function(a,b,c){z(a,b,c)};this.del=function(c,e,d){if(b.__id){c=c||function(){};e=e||function(){};var h=this,f=a.Appacitive.config.apiBaseUrl,f=f+a.Appacitive.storage.urlFactory[this.type].getDeleteUrl(b.__schematype||b.__relationtype,b.__id);b&&(b.__schematype&&
("user"==b.__schematype.toLowerCase()||"device"==b.__schematype.toLowerCase()))&&(f=a.Appacitive.config.apiBaseUrl,f+=a.Appacitive.storage.urlFactory[b.__schematype.toLowerCase()].getDeleteUrl(b.__id));d&&!0===d&&(f=-1==f.indexOf("?")?f+"?deleteconnections=true":f+"&deleteconnections=true");d=new a.Appacitive.HttpRequest;d.url=f;d.method="delete";d.onSuccess=function(a){"200"==a.code?(h.___collection&&h.___collection.removeById(b.__id),"function"==typeof c&&c(a)):(a=k(a),"function"==typeof e&&e(a,
h))};d.onError=function(a){a=k(a);"function"==typeof e&&e(a,h)};a.Appacitive.http.send(d)}else this.___collection&&this.___collection.removeByCId(m),"function"==typeof c&&c(this)}};a.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())}})(global);
(function(a){var f=function(){return Math.floor(65536*Math.random()).toString(16)};a.Appacitive.GUID=function(){var a=f()+f()+"-"+f()+"-"+f()+"-"+f()+"-"+f()+f()+f(),c="",d,e,b,m,l,h,k=0,a=a.replace(/\r\n/g,"\n");e="";for(b=0;b<a.length;b++)m=a.charCodeAt(b),128>m?e+=String.fromCharCode(m):(127<m&&2048>m?e+=String.fromCharCode(m>>6|192):(e+=String.fromCharCode(m>>12|224),e+=String.fromCharCode(m>>6&63|128)),e+=String.fromCharCode(m&63|128));for(a=e;k<a.length;)d=a.charCodeAt(k++),e=a.charCodeAt(k++),
b=a.charCodeAt(k++),m=d>>2,d=(d&3)<<4|e>>4,l=(e&15)<<2|b>>6,h=b&63,isNaN(e)?l=h=64:isNaN(b)&&(h=64),c=c+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(m)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(d)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(l)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h);return c.toString()}})(global);
...
(function(a){var f=function(c,b,d){var f={label:c.label};c.articleid&&(f.articleid=c.articleid);if(c.article)"function"==typeof c.article.getArticle?c.article.get("__id")?f.articleid=c.article.get("__id"):f.article=c.article.getArticle():"object"==typeof c.article&&c.article.__schematype&&(c.article.__id?f.articleid=c.article.__id:f.article=c.article,c.article=new a.Appacitive.Article(c.article));else if(!f.articleid&&!f.article)throw Error("Incorrectly configured endpoints provided to setupConnection");
d["endpoint"+b]=c;return f},g=function(c,b,d){c.article&&"object"==typeof c.article?(d["endpoint"+b]?d["endpoint"+b]&&d["endpoint"+b].article&&d["endpoint"+b].article instanceof a.Appacitive.Article?d["endpoint"+b].article.copy(c.article,!0):d["endpoint"+b].article=new a.Appacitive.Article(c.article,!0):(d["endpoint"+b]={},d["endpoint"+b].article=new a.Appacitive.Article(c.article,!0)),d["endpoint"+b].articleid=c.article.__id,d["endpoint"+b].label=c.label,d["endpoint"+b].type=c.type,d["endpoint"+
...
function(a,b){if(!(a&&(a.articleid||a.article)&&a.label&&b&&(b.articleid||b.article)&&b.label))throw Error("Incorrect endpoints configuration passed.");this.set("__endpointa",f(a,"A",this));this.set("__endpointb",f(b,"B",this));this.endpoints=function(){var a=[];a.push(this.endpointA);a.push(this.endpointB);return a}};a.Appacitive.Connection.get=function(c,b,d){c=c||{};if(!c.relation)throw Error("Specify relation");if(!c.id)throw Error("Specify id to fetch");var f=new a.Appacitive.Connection({__relationtype:c.relation,
__id:c.id});f.fields=c.fields;f.fetch(b,d)};var c=function(c){var b=[];c||(c=[]);c.forEach(function(c){b.push(new a.Appacitive.Connection(c))});return b},d=function(e,b,d){e.onSuccess=function(a){a&&a.status&&"200"==a.status.code?"function"==typeof b&&b(c(a.connections),a.paginginfo):(a=a||{},"function"==typeof d&&d(a.status||{message:"Server error",code:400}))};e.onError=function(a){a=a||{message:"Server error",code:400};"function"==typeof d&&d(a)};a.Appacitive.http.send(e)};a.Appacitive.Connection.multiGet=
function(c,b,f){c=c||{};if(!c.relation||"string"!=typeof c.relation||0==c.relation.length)throw Error("Specify valid relation");if(c.ids&&0<c.ids.length){var g=new a.Appacitive.HttpRequest;g.url=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.connection.getMultiGetUrl(c.relation,c.ids.join(","),c.fields);g.method="get";return d(g,b,f)}"function"==typeof b&&b([])};a.Appacitive.Connection.multiDelete=function(c,b,d){c=c||{};if(!c.relation||"string"!=typeof c.relation||0==c.relation.length)throw Error("Specify valid relation");
...
null),"function"==typeof d&&d(c)):e(a,c)};g.onError=e;a.Appacitive.http.send(g)}else"function"==typeof d&&d(c)};this.setCurrentUser=function(c,h,k){if(!c)throw Error("Cannot set null object as user");var m=c;if(m instanceof a.Appacitive.User)if(m.get("__id")&&0!=m.get("__id").length)c=m.toJSON();else throw Error("Specify user __id");else m=new a.Appacitive.User(c,!0);a.Appacitive.localStorage.set("Appacitive-User",c);k||(k=60);f=m;h&&a.Appacitive.Session.setUserAuthHeader(h,k);f.logout=function(b){a.Appacitive.Users.logout(b)};
...
"string"==typeof this.fileId&&0<this.fileId.length?e(this,a,c,f):d(this,a,c,f)};var d=function(b,d,e,f){if(!b.fileData)throw Error("Please specify filedata");if(f||"string"==typeof f)b.contentType=f;else{b.contentType&&"string"===typeof b.contentType&&0!=b.contentType.length||(b.contentType="text/plain");try{b.contentType=file.type}catch(k){}}f=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.file.getUploadUrl(b.contentType,b.fileId?b.fileId:"");d=d||function(){};e=e||function(){};g(f,
function(a){a&&a.status&&"200"==a.status.code?c(a.url,b.fileData,b.contentType,function(){b.fileId=a.id;b.getDownloadUrl(function(a){d(a,b)},e)},e):"function"==typeof e&&e(a.status,b)},e);return this},e=function(b,d,e,f){if(!b.fileData)throw Error("Please specify filedata");if(f||"string"==typeof f)b.contentType=f;else{b.contentType&&"string"===typeof f&&0!=b.contentType.length||(b.contentType="text/plain");try{b.contentType=file.type}catch(k){}}f=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.file.getUpdateUrl(b.fileId,
...
(function(a){a.Appacitive.Date={};a.Appacitive.Date.parseISODate=function(a){try{var g=new Date(a);if(isNaN(g)){var c=/^([0-9]{1,4})-([0-9]{1,2})-([0-9]{1,2})T([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2})(.([0-9]+))?Z$/,d=!1;if(!c.exec(a))if(c=/^([0-9]{1,4})-([0-9]{1,2})-([0-9]{1,2})/,c.exec(a))d=!0;else return null;var e=a.split("T"),b=e[0].split("-"),m=e[1].split("Z")[0].split(":"),l=m[2].split("."),h=Number(m[0]),g=new Date;g.setUTCFullYear(Number(b[0]));g.setUTCMonth(Number(b[1])-1);g.setUTCDate(Number(b[2]));
d||(g.setUTCHours(Number(h)),g.setUTCMinutes(Number(m[1])),g.setUTCSeconds(Number(l[0])),l[1]&&g.setUTCMilliseconds(Number(l[1])))}return g}catch(k){return null}};a.Appacitive.Date.toISOString=function(a){try{return a=a.toISOString(),a=a.replace("Z","0000Z")}catch(g){return null}};a.Appacitive.Date.toISODate=function(a){try{return a=a.toISOString().split("T")[0]}catch(g){return null}};a.Appacitive.Date.toISOTime=function(a){try{return a=a.toISOString().split("T")[1],a=a.replace("Z","0000Z")}catch(g){return null}};
...
(function(a){a.Appacitive.Cloud=new function(){this.apis=[];this.declare=function(){if(2!==arguments.length)throw Error("Invalid no. of argument provided to cloud function declare");if("string"!=typeof arguments[0])throw Error("Invalid api name provided to cloud api declare");if("function"!=typeof arguments[1])throw Error("Invalid api callback provided to cloud api declare");this.apis.push({name:arguments[0],method:arguments[1]})};this.execute=function(){if(2>arguments.length||"string"!=typeof arguments[0]||
"object"!=typeof arguments[1])throw Error("Invalid list of arguments passed to incoke cloud api");var a=arguments[0],g=this.apis.filter(function(c){return c.name==a}),c=arguments[1];if(0<g.length)setTimeout(function(){g[0].method.call({},c.request,c.response)},0);else throw Error("Api with name "+arguments[0]+" doesn't exits");}}})(global);"undefined"==typeof module||global.Appacitive.runtime.isBrowser||(module.exports=global.Appacitive);
