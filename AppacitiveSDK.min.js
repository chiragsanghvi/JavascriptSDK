...
function(b){var d=!1,e=JSON.parse(JSON.stringify(c)),l;for(l in a)"undefined"==typeof a[l]||null===a[l]?(e[l]=null,d=!0):a[l]!=c[l]?"__tags"==l||"__attributes"==l?delete e[l]:(e[l]=a[l],d=!0):a[l]==c[l]&&delete e[l];try{m.forEach(function(a){e[a]&&delete e[a]})}catch(k){}b?(a.__tags&&0<a.__tags.length&&(e.__addtags=r(),d=!0),n&&0<n.length&&(e.__removetags=n,d=!0)):a.__tags&&0<a.__tags.length&&(e.__tags=r(),d=!0);(b=h())?(e.__attributes=b,d=!0):delete e.__attributes;return d?e:!1};this.changed=function(){return p()};
