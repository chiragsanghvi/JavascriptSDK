...
c.Date.toISODate(this.value)+"')":"date('"+this.value+"')"}},t=function(b){this.value=b;this.getValue=function(){return this.value instanceof Date?"time('"+c.Date.toISOTime(this.value)+"')":"time('"+this.value+"')"}},v=function(b){this.value=b;this.getValue=function(){return this.value instanceof Date?"datetime('"+c.Date.toISOString(this.value)+"')":"datetime('"+this.value+"')"}},u=function(b,c,e){e||(e=this);e.type=b;e.name=c;e.equalTo=function(b){return new f({field:this.name,fieldType:this.type,
value:new r(b),operator:m.isEqualTo})};e.equalToNumber=function(b){return new f({field:this.name,fieldType:this.type,value:new r(b,"number"),operator:m.isEqualTo})};e.equalToDate=function(b){return new f({field:this.name,fieldType:this.type,value:new q(b),operator:m.isEqualTo})};e.equalToTime=function(b){return new f({field:this.name,fieldType:this.type,value:new t(b),operator:m.isEqualTo})};e.equalToDateTime=function(b){return new f({field:this.name,fieldType:this.type,value:new v(b),operator:m.isEqualTo})};
e.greaterThan=function(b){return new f({field:this.name,fieldType:this.type,value:new r(b,"number"),operator:m.isGreaterThan})};e.greaterThanDate=function(b){return new f({field:this.name,fieldType:this.type,value:new q(b),operator:m.isGreaterThan})};e.greaterThanTime=function(b){return new f({field:this.name,fieldType:this.type,value:new t(b),operator:m.isGreaterThan})};e.greaterThanDateTime=function(b){return new f({field:this.name,fieldType:this.type,value:new v(b),operator:m.isGreaterThan})};
e.greaterThanEqualTo=function(b){return new f({field:this.name,fieldType:this.type,value:new r(b,"number"),operator:m.isGreaterThanEqualTo})};e.greaterThanEqualToDate=function(b){return new f({field:this.name,fieldType:this.type,value:new q(b),operator:m.isGreaterThanEqualTo})};e.greaterThanEqualToTime=function(b){return new f({field:this.name,fieldType:this.type,value:new t(b),operator:m.isGreaterThanEqualTo})};e.greaterThanEqualToDateTime=function(b){return new f({field:this.name,fieldType:this.type,
value:new v(b),operator:m.isGreaterThanEqualTo})};e.lessThan=function(b){return new f({field:this.name,fieldType:this.type,value:new r(b,"number"),operator:m.isLessThan})};e.lessThanDate=function(b){return new f({field:this.name,fieldType:this.type,value:new q(b),operator:m.isLessThan})};e.lessThanTime=function(b){return new f({field:this.name,fieldType:this.type,value:new t(b),operator:m.isLessThan})};e.lessThanDateTime=function(b){return new f({field:this.name,fieldType:this.type,value:new v(b),
operator:m.isLessThan})};e.lessThanEqualTo=function(b){return new f({field:this.name,fieldType:this.type,value:new r(b,"number"),operator:m.isLessThanEqualTo})};e.lessThanEqualToDate=function(b){return new f({field:this.name,fieldType:this.type,value:new q(b),operator:m.isLessThanEqualTo})};e.lessThanEqualToTime=function(b){return new f({field:this.name,fieldType:this.type,value:new t(b),operator:m.isLessThanEqualTo})};e.lessThanEqualToDateTime=function(b){return new f({field:this.name,fieldType:this.type,
value:new v(b),operator:m.isLessThanEqualTo})};e.like=function(b){return new f({field:this.name,fieldType:this.type,value:new r("*"+b+"*"),operator:m.like})};e.match=function(b){return new f({field:this.name,fieldType:this.type,value:new r("*"+b+"*"),operator:m.match})};e.startsWith=function(b){return new f({field:this.name,fieldType:this.type,value:new r(b+"*"),operator:m.like})};e.endsWith=function(b){return new f({field:this.name,fieldType:this.type,value:new r("*"+b),operator:m.like})};e.contains=
function(b){return new g({field:this.name,fieldType:this.type,value:b,operator:m.isEqualTo})};e.between=function(b,d){return new h({field:this.name,fieldType:this.type,val1:new r(b,"number"),val2:new r(d,"number"),operator:m.between})};e.betweenDate=function(b,d){return new h({field:this.name,fieldType:this.type,val1:new q(b),val2:new q(d),operator:m.between})};e.betweenTime=function(b,d){return new h({field:this.name,fieldType:this.type,val1:new t(b),val2:new t(d),operator:m.between})};e.betweenDateTime=
function(b,d){return new h({field:this.name,fieldType:this.type,val1:new v(b),val2:new v(d),operator:m.between})};e.withinCircle=function(b,g,c){return new d({field:this.name,fieldType:this.type,geoCoord:b,distance:g,unit:c,operator:m.withinCircle})};e.withinPolygon=function(b){return new l({field:this.name,fieldType:this.type,geoCoords:b,operator:m.withinPolygon})}},y=function(b){if(!b||0===b.length)throw Error("Specify field name");this.field=b;u("property",b,this);return this},z=function(b){if(!b||
0===b.length)throw Error("Specify field name");this.field=b;var d=new u("aggregate",b);this.equalTo=function(b){return d.equalTo(b)};this.greaterThan=function(b){return d.greaterThan(b)};this.greaterThanEqualTo=function(b){return d.greaterThanEqualTo(b)};this.lessThan=function(b){return d.lessThan(b)};this.lessThanEqualTo=function(b){return d.lessThanEqualTo(b)};this.between=function(b,g){return d.between(b,g)};return this},x=function(b){if(!b||0===b.length)throw Error("Specify field name");this.field=
b;var d=new u("attribute",b);this.like=function(b){return d.like(b)};this.like=function(b){return d.match(b)};this.startWith=function(b){return d.startsWith(b)};this.endsWith=function(b){return d.endsWith(b)};this.equalTo=function(b){return d.equalTo(b)};this.contains=function(b){return d.contains(b)};return this};c.Filter={Property:function(b){return new y(b)},Aggregate:function(b){return new z(b)},Attribute:function(b){return new x(b)},Or:function(){return new p(m.or,arguments)},And:function(){return new p(m.and,
...
(c=arguments[0],this):c};this.isAscending=function(){return 1===arguments.length?(d=void 0===arguments[0]||null==arguments[0]?!1:arguments[0],this):d};this.orderBy(b.orderBy);this.isAscending(b.isAscending)};e.prototype.toString=function(){return this.orderBy()&&0<this.orderBy().length?"orderBy="+this.orderBy()+"&isAsc="+this.isAscending():""};var f=function(g){var f=g||{},d="",l="",k="",p=f.queryType||"BasicQuery",m=new c(g),r=new e(g),q=f.type||f.relation,t=f.relation?"connection":"object",v=this;
f.entity&&(this.entity=f.entity);this.type=function(){return t};this.entityType=function(){return q};this.queryType=function(){return p};this.pageQuery=function(){return m};this.pageNumber=function(){return 1===arguments.length?(m.pageNumber(arguments[0]),this):m.pageNumber()};this.pageSize=function(){return 1===arguments.length?(m.pageSize(arguments[0]),this):m.pageSize()};this.sortQuery=function(){return r};this.orderBy=function(){return 1===arguments.length?(r.orderBy(arguments[0]),this):r.orderBy()};
...
this.meta={};f.__meta=_extend(this.meta,f.__meta);l&&l.parse&&(f=this.parse(f));_type.isObject(this.defaults)&&!l.setSnapShot&&(f=_extend({},this.defaults,f));l&&l.collection&&(this.collection=l.collection);f=c._decode(f);var k=this,t=function(b,d){b.__meta=_extend(k.meta,b.__meta);k.meta=b.__meta;v(b);var e=c._decode(b),f;for(f in e)f==k.idAttribute&&(k.id=e[f]),u[f]&&delete u[f],y[f]&&delete y[f],z[f]&&delete z[f],g(e[f])?d[f]=e[f]:_type.isObject(e[f])?d[f]=_extend({},d[f],e[f]):_type.isArray(e[f])?
(d[f]=[],e[f].forEach(function(b){if(g(b)||"__link"==f)d[f].push(b);else throw Error("Multivalued property cannot add object or array as property of object");})):d[f]=e[f]},v=function(d,c){var g={id:"id",__id:"id",__utclastupdateddate:"lastUpdatedAt",__utcdatecreated:"createdAt",__createdby:"createdBy",__updatedby:"lastUpdatedBy"};"id __id __utclastupdateddate __utcdatecreated __createdby __updatedby".split(" ").forEach(function(e){d[e]&&("__utcdatecreated"!==e&&"__utclastupdateddate"!==e||_type.isDate(d[e])?
k[g[e]]=d[e]:k[g[e]]=b.Appacitive.Date.parseISODate(d[e]),c&&delete d[e])})};this.base=b.Appacitive.Object.prototype;this.cid=parseInt(1E8*Math.random(),10);this.idAttribute="__id";var u={},y={},z={},x={};t(f,x);var n=x;l.setSnapShot&&t(n,h);!h[this.idAttribute]&&x[this.idAttribute]&&(h[this.idAttribute]=x[this.idAttribute]);this.id=h[this.idAttribute];x.__type?(x.__type=x.__type.toLowerCase(),this.entityType="type",this.type="object",this.className=x.__type):x.__relationtype&&(x.__relationtype=x.__relationtype.toLowerCase(),
this.entityType="relation",this.type="connection",this.className=x.__relationtype);n.__attributes||(n.__attributes={});h.__attributes||(h.__attributes={});var w=[];n.__tags||(n.__tags=[]);h.__tags||(h.__tags=[]);this.attributes=n;var A="";v(this.attributes);var G="__id __revision __endpointa __endpointb __createdby __lastmodifiedby __type __relationtype __typeid __relationid __utcdatecreated __utclastupdateddate __tags __authType __link __acls __meta".split(" "),E=function(b){b=b||{};b.message=b.message||
"Server error";b.code=b.code||"500";return b};this.toJSON=this.getObject=function(){var b=c._encode(_extend({__meta:this.meta},n));Object.prototype.hasOwnProperty("id")&&(b.__id=this.id);return b};this.properties=function(){var b=_extend({},this.attributes);delete b.__attributes;delete b.__tags;return b};this.attr=function(){if(0===arguments.length)return n.__attributes||(n.__attributes={}),n.__attributes;if(1===arguments.length)return n.__attributes||(n.__attributes={}),n.__attributes[arguments[0]];
if(2===arguments.length){if(!_type.isString(arguments[1])&&null!==arguments[1])throw Error("only string values can be stored in attributes.");n.__attributes||(n.__attributes={});n.__attributes[arguments[0]]=arguments[1]}else throw Error(".attr() called with an incorrect number of arguments. 0, 1, 2 are supported.");B("__attributes");return n.__attributes};var F=function(){if(n.__attributes){if(!h.__attributes)return n.__attributes;var b=!1,d=JSON.parse(JSON.stringify(h.__attributes)),c;for(c in n.__attributes)null==
n.__attributes[c]||void 0==n.__attributes[c]?(d[c]=null,b=!0):n.__attributes[c]!=h.__attributes[c]?(d[c]=n.__attributes[c],b=!0):n.__attributes[c]==h.__attributes[c]&&delete d[c];return b?d:void 0}};this.getChangedAttributes=F;this.aggregate=function(){var b={},d;for(d in n){if(!n.hasOwnProperty(d))return;"$"==d[0]&&(b[d.substring(1)]=n[d])}if(0===arguments.length)return b;if(1==arguments.length)return b[arguments[0]];throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");
};this.tags=function(){return n.__tags?n.__tags:[]};this.addTag=function(b){if(!b||!_type.isString(b)||!b.length)return this;n.__tags||(n.__tags=[]);n.__tags.push(b);n.__tags=Array.distinct(n.__tags);if(!w||!w.length)return B("__tags"),this;b=w.indexOf(b);-1!=b&&w.splice(b,1);B("__tags");return this};this.removeTag=function(b){if(!b||!_type.isString(b)||!b.length)return this;w.push(b);w=Array.distinct(w);if(!n.__tags||!n.__tags.length)return B("__tags"),this;b=n.__tags.indexOf(b);-1!=b&&n.__tags.splice(b,
1);B("__tags");return this};var H=function(){if(n.__tags){if(!h.__tags)return n.__tags;var b=[];n.__tags.forEach(function(d){-1==h.__tags.indexOf(d)&&b.push(d)});return 0<b.length?b:void 0}};this.getChangedTags=H;this.getRemovedTags=function(){return _removetags};var I=function(b,d,c,e){if(!b||!_type.isString(b)||0===b.length||0==b.trim().indexOf("__")||0===b.trim().indexOf("$")||void 0==d||null==d)return this;b=b.toLowerCase();try{var f=function(d){if(!g(d))throw Error("Multivalued property cannot have values of property as an object");
if(n[b]&&_type.isArray(n[b]))if("additems"==c)n[b].push(d);else if("adduniqueitems"==c){var e=-1;n[b].find(function(b,c){return _type.isEqual(b,d)?(e=c,!0):!1});-1==e&&n[b].push(d)}else"removeitems"==c&&n[b].removeAll(d);else"removeitems"!=c&&(n[b]=[d]);y[b]||(y[b]={additems:[],adduniqueitems:[],removeitems:[]});y[b][c].push(d)};_type.isArray(d)?d.forEach(function(b){f(b)}):f(d);B(b,e)}catch(l){throw Error("Unable to add item to "+b);}return k};this.add=function(b,d,c){return I.apply(this,[b,d,"additems",
c])};this.addUnique=function(b,d,c){return I.apply(this,[b,d,"adduniqueitems",c])};this.remove=function(b,d,c){return I.apply(this,[b,d,"removeitems",c])};var C=function(b,d,c,e){var g=void 0;_type.isEqual(c,d)||("__tags"==b?(b=H())&&0<b.length&&(g=b):"__attributes"==b?(b=F(),Object.isEmpty(b)||(g=b)):_type.isArray(c)?y[b]&&!z[b]?g=e?y[b]:c:c.equals(d)||(g=c):g=u[b]&&!z[b]?e?{incrementby:u[b].value}:c:c);return g},D=function(b){var d=!1,g=_extend({},h),e;for(e in g)"$"==e[0]&&delete g[e];for(var f in n)e=
C(f,g[f],n[f],b),void 0==e?delete g[f]:(d=!0,g[f]=e);try{G.forEach(function(b){g[b]&&delete g[b]})}catch(l){}b&&(g=c._encode(g));f=H();b?(f&&0<f.length&&(g.__addtags=f,d=!0),w&&0<w.length&&(g.__removetags=w,d=!0)):f&&0<f.length&&(g.__tags=f,d=!0);(b=F())&&!Object.isEmpty(b)?(g.__attributes=b,d=!0):delete g.__attributes;"object"==k.type&&k._aclFactory&&(b=k._aclFactory.getChanged())&&(g.__acls=b);return d&&!Object.isEmpty(g)?g:!1};this.changed=function(){return this.isNew()?this.toJSON():D()};this.hasChanged=
...
null:1==arguments.length&&_type.isString(arguments[0])&&arguments[0].length?h[arguments[0]]:null};this.previousAttributes=function(){return this.isNew()?null:_extend({},h)};this.fields=function(){if(1==arguments.length){var b=arguments[0];_type.isString(b)?A=b:_type.isArray(b)&&(A=b.join(","));return this}return A};this.get=function(b,c){if(b){if(c&&d[c.toLowerCase()]){if(d[c.toLowerCase()])return d[c.toLowerCase()](n[b]);throw Error('Invalid cast-type "'+c+'"" provided for get "'+b+'"');}return n[b]}};
this.tryGet=function(b,d,c){b=this.get(b,c);return void 0!==b?b:d};var B=function(b,d){if(d&&!d.silent){var c=C(b,h[b],n[b]);if(void 0!=c[b]||-1!=G.indexOf(b))k.trigger("change:"+b,k,c[b]||n[b],{}),d.ignoreChange||k.trigger("change",k,d)}},K=function(b){b&&!b.silent&&k.trigger("destroy",k,k.collection,b)},M=function(b,d,c){if(!b||!_type.isString(b)||0===b.length||0===b.trim().indexOf("$"))return this;b=b.toLowerCase();try{if(_type.isNullOrUndefined(d))n[b]=null;else if(g(d))n[b]=d;else if(_type.isObject(d))if(-1!==
e.indexOf(b))n[b]=d;else throw Error("Property cannot have value as an object");else _type.isArray(d)&&(n[b]=[],d.forEach(function(d){if(g(d))n[b].push(d);else throw Error("Multivalued property cannot have values of property as an object");}));delete u[b];delete y[b];delete z[b];_type.isEqual(n[b],h[b])||(z[b]=!0);b==k.idAttribute&&(k.id=d);return this}catch(f){throw Error("Unable to set "+b);}};this.set=function(b,d,c){var g,e;if(null==b)return this;null==b||"object"===typeof b?(e=b,c=d):(e={})[b]=
d;c||(c={});if(!this._validate(e,c))return!1;this.idAttribute in e&&(this.id=e[this.idAttribute]);v(e);var f=!1;for(g in e)d=e[g],M.apply(this,[g,d,_extend({},c,{ignoreChange:!0})]);if(c&&!c.silent)for(g in e)if(C(g,h[g],n[g])||-1!=G.indexOf(g))f=!0,k.trigger("change:"+b,k,n[b],{});f&&this.trigger("change",this,c);return this};this.unset=function(b,d){if(!b||!_type.isString(b)||0===b.length||0===b.indexOf("__"))return this;b=b.toLowerCase();delete n[b];B(b,d);return this};this._validate=function(b,
d){if(!d.validate||!this.validate||!_type.isFunction(this.validate))return!0;b=_extend({},this.attributes,b);var c=this.validationError=this.validate(b,d)||null;if(!c)return!0;this.trigger("invalid",this,c,_extend(d,{validationError:c}));return!1};this.isValid=function(b){return this._validate({},_extend(b||{},{validate:!0}))};this.has=function(b){return b&&_type.isString(b)&&0!==b.length?n[b]&&!_type.isUndefined(n[b])?!0:!1:!1};this.isNew=function(){return!this.has(this.idAttribute)};this.clone=
function(){return"object"==this.type?b.Appacitive.Object._create(_extend({__meta:this.meta},this.toJSON())):new b.Appacitive.connection._create(_extend({__meta:this.meta},this.toJSON()))};this.copy=function(b,d){b&&(t(b,n),d&&t(b,h));return this};this.mergeWithPrevious=function(){t(n,h);k._aclFactory&&k._aclFactory.merge();v(h);w=[];u={};y={};z={};return this};var J=function(){t(h,n);k._aclFactory&&k._aclFactory.merge();v(n);w=[];u={};y={};z={}};this.rollback=function(){n=x={};J();return this};var L=
function(b,d,c,g){if(!b||!_type.isString(b)||0===b.length||0===b.indexOf("__"))return this;b=b.toLowerCase();if(_type.isObject(n[b])||_type.isArray(n[b]))throw Error("Cannot increment/decrement array/object");try{_type.isObject(d)?(g=d,d=c):d=!d||isNaN(Number(d))?c:Number(d)*c,n[b]=isNaN(Number(n[b]))?d:Number(n[b])+d,k.isNew()||(u[b]={value:(u[b]?u[b].value:0)+d})}catch(e){throw Error("Cannot perform increment/decrement operation");}B(b,g);return k};this.increment=function(b,d,c){return L(b,d,1,
c)};this.decrement=function(b,d,c){return L(b,d,-1,c)};this._save=function(){return this.id?N.apply(this,arguments):O.apply(this,arguments)};var O=function(d){d=d||{};var g=k.type;!n.__type||"user"!=n.__type.toLowerCase()&&"device"!=n.__type.toLowerCase()||(g=n.__type.toLowerCase());var e=k.toJSON();delete e.__meta;for(var f in e)"$"==f[0]&&delete e[f];e.__revision&&delete e.__revision;"object"==g&&k._aclFactory&&(f=k._aclFactory.getChanged())&&(e.__acls=f);e.__tags&&0==e.__tags.length&&delete e.__tags;
Object.isEmpty(e.__attributes)&&delete e.__attributes;var l=new b.Appacitive._Request({method:"PUT",type:g,op:"getCreateUrl",args:[this.className,A],data:e,options:d,entity:k,onSuccess:function(e){var f=null;e&&e[g]?(f=e[g],h=c._decode(_extend({__meta:_extend(k.meta,e.__meta)},f)),k.id=n[k.idAttribute]=f[k.idAttribute],J(),"connection"==k.type&&(n.__endpointa.object&&(n.__endpointa.object.__meta=e.__ameta),n.__endpointb.object&&(n.__endpointb.object.__meta=e.__bmeta),k.parseConnection()),k.trigger("change:__id",
k,k.id,{}),b.Appacitive.eventManager.fire(k.entityType+"."+g+".created",k,{object:k}),k.created=!0,d.silent||k.trigger("sync",k,e[g],d),l.promise.fulfill(k)):(d.silent||k.trigger("error",k,e.status,d),b.Appacitive.eventManager.fire(k.entityType+"."+g+".createFailed",k,{error:e.status}),l.promise.reject(e.status,k))}});return l.send()},N=function(d,e){b.Appacitive.Promise.is(e)||(e=b.Appacitive.Promise.buildPromise(d));var g=D(!0);d=d||{};if(Object.isEmpty(g))e.fulfill(k);else{var f=k.type,l=[k.className,
k.id,A];n&&(n.__type&&("user"==n.__type.toLowerCase()||"device"==n.__type.toLowerCase()))&&(f=n.__type.toLowerCase(),l.splice(0,1));var m=new b.Appacitive._Request({method:"POST",type:f,op:"getUpdateUrl",args:l,data:g,options:d,entity:k,onSuccess:function(e){e&&e[f]?(h=c._decode(_extend({__meta:_extend(k.meta,e.__meta)},e[f])),J(),delete k.created,d.silent||k.trigger("sync",k,e[f],d),b.Appacitive.eventManager.fire(k.entityType+"."+f+"."+k.id+".updated",k,{object:k}),m.promise.fulfill(k)):(e=e||{},
e.status=e.status||{},e.status=E(e.status),d.silent||k.trigger("error",k,e.status,d),b.Appacitive.eventManager.fire(k.entityType+"."+f+"."+k.id+".updateFailed",k,{object:e.status}),m.promise.reject(e.status,k))}});return m.send()}return e},P=function(d){if(!k.id)throw Error("Please specify id for get operation");d=d||[];var e=this.type;n&&(n.__type&&("user"==n.__type.toLowerCase()||"device"==n.__type.toLowerCase()))&&(e=n.__type.toLowerCase());var g=new b.Appacitive._Request({method:"GET",type:e,
op:"getGetUrl",args:[this.className,k.id,A],options:d,entity:k,onSuccess:function(f){f&&f[e]?(h=c._decode(_extend({__meta:_extend(k.meta,f.__meta)},f[e])),t(h,n),v(n),k._aclFactory&&k._aclFactory._rollback(),f.connection&&(k.endpoints||k.endpointA&&k.endpointB||k.setupConnection(n.__endpointa,n.__endpointb)),d.silent||k.trigger("sync",k,f[e],d),b.Appacitive.eventManager.fire(k.entityType+"."+e+"."+k.id+".updated",k,{object:k}),g.promise.fulfill(k)):(f=f||{},f.status=f.status||{},f.status=E(f.status),
g.promise.reject(f.status,k))}});return g.send()};this._fetch=function(b){return P.apply(this,[b])};this.del=this._destroy=function(d){d=d||{};var c=d.deleteConnections;_type.isBoolean(d)&&(c=d,d={});d.wait||K(d);if(!k.id)return(new b.Appacitive.Promise.buildPromise(d)).fulfill();var e=this.type;!n.__type||"user"!=n.__type.toLowerCase()&&"device"!=n.__type.toLowerCase()||(e=n.__type.toLowerCase());var g=new b.Appacitive._Request({method:"DELETE",type:e,op:"getDeleteUrl",args:[this.className,k.id,
c],options:d,entity:this,onSuccess:function(b){b&&b.status?(n={},h={},d.wait&&K(d),g.promise.fulfill(b.status)):(b=b||{},b.status=b.status||{},b.status=E(b.status),g.promise.reject(b.status,k))}});return g.send()};"object"==this.type&&(this._destroyWithConnections=function(b){return this.destroy(_extend({deleteConnections:!0},b))})};k.prototype.save=function(){return this._save.apply(this,arguments)};k.prototype.fetch=function(){return this._fetch.apply(this,arguments)};k.prototype.destroy=function(){return this._destroy.apply(this,
arguments)};k.prototype.destroyWithConnections=function(){return this._destroyWithConnections.apply(this,arguments)};b.Appacitive.BaseObject=k;b.Appacitive.BaseObject._saveAll=function(d,e,g){var f=[],l=[];if(!_type.isArray(d))throw Error("Provide an array of objects for Object.saveAll");d.forEach(function(d){d instanceof b.Appacitive.BaseObject||!_type.isObject(d)||(d=new b.Appacitive[g](d));f.find(function(b){return b.id==d.id})||(f.push(d),l.push(d.save()))});return c.Promise.when(l)};b.Appacitive.BaseObject.prototype.toString=
function(){return JSON.stringify(this.getObject())};b.Appacitive.BaseObject.prototype.parse=function(b,d){return b};b.Appacitive.BaseObject.prototype.escape=function(b){return _.escape(this.get(b))};b.Appacitive.Events.mixin(b.Appacitive.BaseObject.prototype)})(global);
...
for(var g in b.children)e.children[g]=c(b.children[g])}b.connection&&(e.__connection=b.connection.toJSON());d.push(e)});return d};return c([this])[0]}return this.getObject()};this.typeName=c.__type;this._aclFactory=new b.Appacitive._Acl(e.__acls,e.setSnapShot);this.acls=this._aclFactory.acls;_type.isFunction(this.initialize)&&this.initialize.apply(this,[c]);return this};b.Appacitive.Object.prototype=new b.Appacitive.BaseObject;b.Appacitive.Object.prototype.constructor=b.Appacitive.Object;b.Appacitive.Object.extend=
