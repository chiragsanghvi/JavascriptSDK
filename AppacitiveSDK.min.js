...
f.ontimeout=function(){b.reject(f)};f.onprogress=function(){};-1===c.url.indexOf("?")?c.url+="?ua=ie":c.url+="&ua=ie";f.open(c.method,c.url,!0);f.send(c.data);return b},f=function(b){if(!b.url)throw Error("Please specify request url");b.method||(b.method="GET");b.headers||(b.headers=[]);var f={};b.onSuccess&&_type.isFunction(b.onSuccess)||(b.onSuccess=function(){});b.onError&&_type.isFunction(b.onError)||(b.onError=function(){});var d=global.Appacitive.Promise.buildPromise({success:b.onSuccess,error:b.onError}),
k=!0;b.headers.forEach(function(c){"content-type"==c.key.toLowerCase()&&(k=!0,"application/json"==c.value.toLowerCase()||"application/javascript"==c.value.toLowerCase()||"application/json; charset=utf-8"==c.value.toLowerCase()||"application/json; charset=utf-8;"==c.value.toLowerCase())&&(k=!1)});if(k)f=b.data;else if(b.data&&(f=b.data,_type.isObject(b.data)))try{f=JSON.stringify(f)}catch(h){}if(!global.navigator||-1==global.navigator.userAgent.indexOf("MSIE 8")&&-1==global.navigator.userAgent.indexOf("MSIE 9")){var p=
new c;p.onreadystatechange=function(){if(4==this.readyState)if(200<=this.status&&300>this.status||304==this.status){var c=this.responseText;try{var b=this.getResponseHeader("content-type")||this.getResponseHeader("Content-Type");if("application/json"==b.toLowerCase()||"application/javascript"==b.toLowerCase()||"application/json; charset=utf-8"==b.toLowerCase()||"application/json; charset=utf-8;"==b.toLowerCase())b=c,global.Appacitive.runtime.isBrowser||"{"!=b[0]&&(b=b.substr(1,b.length-1)),c=JSON.parse(b)}catch(f){}d.fulfill(c,
this)}else d.reject(this)};p.open(b.method,b.url,!0);for(var q=0;q<b.headers.length;q+=1)p.setRequestHeader(b.headers[q].key,b.headers[q].value);global.Appacitive.runtime.isBrowser||p.setRequestHeader("User-Agent","Appacitive-NodeJSSDK");p.send(f);return d}b.data=f;return new e(b)},k=function(){var c=new d;c.isOnline=function(){return!0};var b=function(b,e,d){new f({method:b.method,url:b.url,headers:b.headers,data:b.data,onSuccess:function(f,l){if(f){try{f=JSON.parse(f)}catch(k){}var t=f;if(e.length!=
...
g[b])});g[0].toLowerCase()===b&&(d=[g[0],l])}),d):location.search.split("?")[1].split("=")}}}})(global);
...
this.state=2;this.reason=this.value=arguments;this.done();return this};c.prototype.then=function(b,f){var k=this,g=new c;this.calls[this.calls.length]=[g,b,f];this.state&&d(function(){k.done()});return g};c.when=function(b){var f=[],k=[],g,l=0,m=new c;if(!b)return m.fulfill(f),m;var n=function(){l+=1;l==g&&(m.state||(0<k.length?m.reject(k,f?f:[]):m.fulfill(f?f:[])))},h=function(g){var l=b[g];l instanceof c||l&&"function"===typeof l.then?d(function(){l.then(function(b){f[g]=b;n()},function(b){k[g]=
b;n()})}):d(function(){try{f[g]=l.call()}catch(b){k[g]=b}n()})};Array.isArray(b)||(b=[b]);g=b.length;for(var p=0;p<g;p+=1)h(p);return m};c.is=function(b){return b instanceof c?!0:!1};c.buildPromise=function(b){var f=new c;_type.isObject(b)&&f.then(b.success,b.error);return f};b.Appacitive.Promise=c})(global);
...
(function(b){var d={},c=Array.prototype.forEach,e=Object.prototype.hasOwnProperty,f=Array.prototype.slice,k=0,g=function(){return{keys:Object.keys,uniqueId:function(b){var c=++k+"";return b?b+c:c},has:function(b,c){return e.call(b,c)},each:function(b,f,g){if(null!=b)if(c&&b.forEach===c)b.forEach(f,g);else if(b.length===+b.length)for(var e=0,l=b.length;e<l&&f.call(g,b[e],e,b)!==d;e++);else for(e in b)if(this.has(b,e)&&f.call(g,b[e],e,b)===d)break},once:function(b){var c=!1,f;return function(){if(c)return f;
c=!0;f=b.apply(this,arguments);b=null;return f}}}}(),l;l={on:function(b,c,f){if(!n(this,"on",b,[c,f])||!c)return this;this._events||(this._events={});(this._events[b]||(this._events[b]=[])).push({callback:c,context:f,ctx:f||this});return this},once:function(b,c,f){if(!n(this,"once",b,[c,f])||!c)return this;var d=this,e=g.once(function(){d.off(b,e);c.apply(this,arguments)});e._callback=c;return this.on(b,e,f)},off:function(b,c,f){var d,e,l,h,k,m,w,v;if(!this._events||!n(this,"off",b,[c,f]))return this;
if(!b&&!c&&!f)return this._events={},this;h=b?[b]:g.keys(this._events);k=0;for(m=h.length;k<m;k++)if(b=h[k],l=this._events[b]){this._events[b]=d=[];if(c||f)for(w=0,v=l.length;w<v;w++)e=l[w],(c&&c!==e.callback&&c!==e.callback._callback||f&&f!==e.context)&&d.push(e);d.length||delete this._events[b]}return this},trigger:function(b){if(!this._events)return this;var c=f.call(arguments,1);if(!n(this,"trigger",b,c))return this;var d=this._events[b],g=this._events.all;d&&h(d,c);g&&h(g,arguments);return this},
stopListening:function(b,c,f){var d=this._listeners;if(!d)return this;var g=!c&&!f;"object"===typeof c&&(f=this);b&&((d={})[b._listenerId]=b);for(var e in d)d[e].off(c,f,this),g&&delete this._listeners[e];return this}};var m=/\s+/,n=function(b,c,f,d){if(!f)return!0;if("object"===typeof f){for(var g in f)b[c].apply(b,[g,f[g]].concat(d));return!1}if(m.test(f)){f=f.split(m);g=0;for(var e=f.length;g<e;g++)b[c].apply(b,[f[g]].concat(d));return!1}return!0},h=function(b,c){var f,d=-1,g=b.length,e=c[0],l=
c[1],h=c[2];switch(c.length){case 0:for(;++d<g;)(f=b[d]).callback.call(f.ctx);break;case 1:for(;++d<g;)(f=b[d]).callback.call(f.ctx,e);break;case 2:for(;++d<g;)(f=b[d]).callback.call(f.ctx,e,l);break;case 3:for(;++d<g;)(f=b[d]).callback.call(f.ctx,e,l,h);break;default:for(;++d<g;)(f=b[d]).callback.apply(f.ctx,c)}};g.each({listenTo:"on",listenToOnce:"once"},function(b,c){l[c]=function(c,f,d){var e=this._listeners||(this._listeners={}),l=c._listenerId||(c._listenerId=g.uniqueId("l"));e[l]=c;"object"===
...
this.data.placeholders[m]}this.toRequest=function(c){var d=new b.Appacitive.HttpRequest,f=this.toUrl();d.url=f.url;d.description=f.description;d.method="post";d.data=this.data;d.options=c;return d};this.toUrl=function(){return{url:b.Appacitive.config.apiBaseUrl+"search/"+this.name+"/project",description:"Project Query with name "+this.name}};var n=function(c){var d,f;for(f in c)if("status"!==f){d=c[f];break}var g=function(c,d,f){var e=[];c.forEach(function(c){var h=c.__children;delete c.__children;
var l=c.__edge;delete c.__edge;c=b.Appacitive.Object._create(c,!0);c.children={};for(var k in h)c.children[k]=[],c.children[k]=g(h[k].values,h[k].parent,c.id);l&&(l.__endpointa={objectid:f,label:d},l.__endpointb={objectid:c.id(),label:l.__label},delete l.__label,c.connection=b.Appacitive.Connection._create(l,!0));e.push(c)});return e};return g(d.values)};this.collection=function(c,d){d=d||{};c=c||[];_type.isObject(c)&&(d=c,c=null);c||(c=this.results?ths.results:[]);0<c.length&&c[0]instanceof b.Appacitive.BaseObject&&
...
"relation",this.type="connection",this.className=n.__relationtype);this.cid=parseInt(1E8*Math.random(),10);h.__attributes||(h.__attributes={});e.__attributes||(e.__attributes={});var p=[];h.__tags||(h.__tags=[]);e.__tags||(e.__tags=[]);var q="",r="__id __revision __endpointa __endpointb __createdby __lastmodifiedby __type __relationtype __typeid __relationid __utcdatecreated __utclastupdateddate __tags __authType __authtype __link".split(" "),t=["__link","__endpointa","__endpointb"],u=function(b){b=
...
c[1])}};this.get=function(b,c){if(b){if(c&&w[c.toLowerCase()]){if(w[c.toLowerCase()])return w[c.toLowerCase()](h[b]);throw Error('Invalid cast-type "'+c+'"" provided for get "'+b+'"');}return h[b]}};this.tryGet=function(b,c,d){b=this.get(b,d);return void 0!==b?b:c};var v=function(b,c){if(c&&!c.silent){var d=y();d[b]&&(m.trigger("change:"+b,m,d[b],{}),m.trigger("change",m,c))}},D=function(b){b&&!b.silent&&m.trigger("destroy",m,m.collection,b)};this.set=function(c,d,l){l=l||{};var m=l.dataType;if(!c||
!_type.isString(c)||0===c.length||0===c.trim().indexOf("$"))return this;c=c.toLowerCase();try{if(void 0==d||null==d)h[c]=null;else if(_type.isString(d))h[c]=d;else if(_type.isNumber(d)||_type.isBoolean(d))h[c]=d+"";else if(d instanceof Date)h[c]="date"==m?b.Appacitive.Date.toISODate(d):"time"==m?b.Appacitive.Date.toISOTime(d):b.Appacitive.Date.toISOString(d);else if(_type.isObject(d))if(-1!==t.indexOf(c))h[c]=d;else if(d instanceof b.Appacitive.GeoCoord)h[c]=d.toString();else throw Error("Property cannot have value as an object");
else _type.isArray(d)&&(h[c]=[],d.forEach(function(b){if(_type.isString(b))h[c].push(b);else if(_type.isNumber(b)||_type.isBoolean(b))h[c].push(b+"");else{if(d instanceof Date)throw Error("Multivalued property cannot have values of property as date");throw Error("Multivalued property cannot have values of property as an object");}}),"tags"!==c||"__link"!==c)&&(h[c].push=function(b){var d=this.length;if(_type.isString(b))this[d]=b;else if(_type.isNumber(b)||_type.isBoolean(b))this[d]=b+"";else throw Error("Multivalued property cannot have values of property as an object");
v(c,l);return this});delete f[c];delete k[c];delete g[c];h[c]!==e[c]&&(_type.isArray(h[c])&&!h[c].equals(e[c])||_type.isString(h[c])||_type.isObject(h[c]))&&(g[c]=!0);v(c,l);return this}catch(n){throw Error("Unable to set "+c);}};this.unset=function(b,c){if(!b||!_type.isString(b)||0===b.length||0===b.indexOf("__"))return this;b=b.toLowerCase();delete h[b];v(b,c);return this};this.has=function(b){return b&&_type.isString(b)&&0!==b.length?h[b]&&!_type.isUndefined(h[b])?!0:!1:!1};this.isNew=function(){return h.__id&&
h.__id.length?!1:!0};this.clone=function(){return"object"==this.type?b.Appacitive.Object._create(this.toJSON()):new b.Appacitive.connection._create(this.toJSON())};this.copy=function(b,c){b&&(l(b,h),c&&l(b,e));return this};this.mergeWithPrevious=function(){l(h,e);p=[];f={};k={};g={};return this};var B=function(){l(e,h);p=[];f={};k={};g={}};this.rollback=function(){h=n={};B();return this};var C=function(b,c,d,g){if(!b||!_type.isString(b)||0===b.length||0===b.indexOf("__"))return this;b=b.toLowerCase();
if(_type.isObject(h[b])||_type.isArray(h[b]))throw Error("Cannot increment/decrement array/object");try{_type.isObject(c)?(g=c,c=d):c=!c||isNaN(Number(c))?d:Number(c)*d,h[b]=isNaN(Number(h[b]))?c:Number(h[b])+c,m.isNew()||(f[b]={value:(f[b]?f[b].value:0)+c})}catch(e){throw Error("Cannot perform increment/decrement operation");}v(b,g);return m};this.increment=function(b,c,d){return C(b,c,1,d)};this.decrement=function(b,c,d){return C(b,c,-1,d)};this.save=function(){return h.__id?E.apply(this,arguments):
F.apply(this,arguments)};var F=function(c){var d=m.type;!h.__type||"user"!=h.__type.toLowerCase()&&"device"!=h.__type.toLowerCase()||(d=h.__type.toLowerCase());for(var f in h)"$"==f[0]&&delete h[f];h.__revision&&delete h.__revision;var g=new b.Appacitive._Request({method:"PUT",type:d,op:"getCreateUrl",args:[this.className,q],data:h,callbacks:c,entity:m,onSuccess:function(f){var l=null;f&&f[d]?(e=l=f[d],h.__id=l.__id,B(),"connection"==m.type&&m.parseConnection(),b.Appacitive.eventManager.fire(m.entityType+
"."+d+".created",m,{object:m}),m.created=!0,m.trigger("sync",m,f[d],c),g.promise.fulfill(m)):(b.Appacitive.eventManager.fire(m.entityType+"."+d+".createFailed",m,{error:f.status}),g.promise.reject(f.status,m))}});return g.send()},E=function(c,d){b.Appacitive.Promise.is(d)||(d=b.Appacitive.Promise.buildPromise(c));var f=y(!0),g;for(g in f)"$"==g[0]&&delete f[g];if(Object.isEmpty(f))d.fulfill(m);else{var l=m.type;g=[m.className,e.__id?e.__id:h.__id,q];h&&(h.__type&&("user"==h.__type.toLowerCase()||
"device"==h.__type.toLowerCase()))&&(l=h.__type.toLowerCase(),g.splice(0,1));var k=new b.Appacitive._Request({method:"POST",type:l,op:"getUpdateUrl",args:g,data:f,callbacks:c,entity:m,onSuccess:function(d){d&&d[l]?(e=d[l],B(),delete m.created,m.trigger("sync",m,d[l],c),b.Appacitive.eventManager.fire(m.entityType+"."+l+"."+h.__id+".updated",m,{object:m}),k.promise.fulfill(m)):(d=d||{},d.status=d.status||{},d.status=u(d.status),b.Appacitive.eventManager.fire(m.entityType+"."+l+"."+h.__id+".updateFailed",
m,{object:d.status}),k.promise.reject(d.status,m))}});return k.send()}return d},G=function(c){if(!h.__id)throw Error("Please specify id for get operation");var d=this.type;h&&(h.__type&&("user"==h.__type.toLowerCase()||"device"==h.__type.toLowerCase()))&&(d=h.__type.toLowerCase());var f=new b.Appacitive._Request({method:"GET",type:d,op:"getGetUrl",args:[this.className,h.__id,q],callbacks:c,entity:m,onSuccess:function(b){b&&b[d]?(e=b[d],l(e,h),b.connection&&(m.endpoints||m.endpointA&&m.endpointB||
m.setupConnection(h.__endpointa,h.__endpointb)),m.trigger("sync",m,b[d],c),f.promise.fulfill(m)):(b=b||{},b.status=b.status||{},b.status=u(b.status),f.promise.reject(b.status,m))}});return f.send()};this.fetch=function(b){return G.apply(this,[b])};this.del=this.destroy=function(c){c=c||{};var d=c.deleteConnections;_type.isBoolean(c)&&(d=c,c={});c.wait||D(c);if(!h.__id)return(new b.Appacitive.Promise.buildPromise(c)).fulfill();var f=this.type;!h.__type||"user"!=h.__type.toLowerCase()&&"device"!=h.__type.toLowerCase()||
(f=h.__type.toLowerCase());var g=new b.Appacitive._Request({method:"DELETE",type:f,op:"getDeleteUrl",args:[this.className,h.__id,d],callbacks:c,entity:this,onSuccess:function(b){g.promise.fulfill(b);b&&b.status?(c.wait&&D(c),g.promise.fulfill(b.status)):(b=b||{},b.status=b.status||{},b.status=u(b.status),g.promise.reject(b.status,m))}});return g.send()};"object"==this.type&&(this.destroyWithConnections=function(b){return this.destroy(_extend({deleteConnections:!0},b))})};b.Appacitive.BaseObject.prototype.toString=
...
c.password).then(function(){f.fulfill.apply(f,arguments)},function(c){f.reject.apply(f,arguments)})},function(){f.reject(arguments)});return f};d.authenticateUser=function(d,e,f){d.expiry||(d.expiry=864E5);var k=this,h=new b.Appacitive._Request({method:"POST",type:"user",op:"getAuthenticateUserUrl",callbacks:e,data:d,onSuccess:function(e){e&&e.user?(f&&(e.user.__authType=f),k.setCurrentUser(e.user,e.token,d.expiry),b.Appacitive.User.trigger("login",c,c,e.token),h.promise.fulfill({user:c,token:e.token})):
h.promise.reject(e.status)}});return h.send()};d.login=function(c,b,d){if(!c||!b||0==c.length||0==b.length)throw Error("Please specify username and password");return this.authenticateUser({username:c,password:b,expiry:864E5},d,"BASIC")};d.loginWithFacebook=function(c,b){if(!c||!_type.isString(c))throw Error("Please provide accessToken");return this.authenticateUser({accesstoken:c,type:"facebook",expiry:864E5,createnew:!0},b,"FB")};d.loginWithTwitter=function(c,b){if(!_type.isObject(c)||!c.oAuthToken||
!c.oAuthTokenSecret)throw Error("Twitter Token and Token Secret required for linking");var d={type:"twitter",oauthtoken:c.oAuthToken,oauthtokensecret:c.oAuthTokenSecret,expiry:864E5,createnew:!0};c.consumerKey&&c.consumerSecret&&(d.consumersecret=c.consumerSecret,d.consumerkey=c.consumerKey);return this.authenticateUser(d,b,"TWITTER")};d.validateCurrentUser=function(c,d){var e=b.Appacitive.Promise.buildPromise({success:d});d&&_type.isBoolean(d)&&(c=d,d=function(){});var f=b.Appacitive.localStorage.get("Appacitive-UserToken");
if(!f)return e.fulfill(!1),e;if(c)e.fulfill(!0);else try{var h=this;this.getUserByToken(f).then(function(c){h.setCurrentUser(c,f);e.fulfill(!0)},function(){e.fulfill(!1)})}catch(k){e.fulfill(!1)}return e};var k=function(c,d,e){var f=new b.Appacitive._Request({method:"GET",type:"user",op:c,callbacks:e,args:d,onSuccess:function(c){c&&c.user?f.promise.fulfill(new b.Appacitive.User(c.user)):f.promise.reject(c.status)}});return f.send()};d.getUserByToken=function(c,d){if(!c||!_type.isString(c)||0===c.length)throw Error("Please specify valid token");
b.Appacitive.Session.setUserAuthHeader(c,0,!0);return k("getUserByTokenUrl",[c],d)};d.getUserByUsername=function(c,b){if(!c||!_type.isString(c)||0===c.length)throw Error("Please specify valid username");return k("getUserByUsernameUrl",[c],b)};d.logout=function(d){c=null;return b.Appacitive.Session.removeUserAuthHeader(d)};d.sendResetPasswordEmail=function(c,d,e){if(!c||!_type.isString(c)||0===c.length)throw Error("Please specify valid username");if(!d||!_type.isString(d)||0===d.length)throw Error("Plase specify subject for email");
...
d.validateResetPasswordToken=function(c,d){if(!c)throw Error("Please specify token");var e=new b.Appacitive._Request({method:"POST",type:"user",op:"getValidateResetPasswordUrl",callbacks:d,data:{},args:[c],onSuccess:function(c){e.promise.fulfill(c.user)}});return e.send()};b.Appacitive.Users=b.Appacitive.User;b.Appacitive.Events.mixin(b.Appacitive.User)})(global);
...
b.Appacitive.runtime.isBrowser?new function(){var c=null,d=!0;this.initialize=function(c){if(!FB)throw"Facebook SDK needs be loaded before calling initialize.";if(!c.appId)throw Error("Please provide appid");FB.init(c);d=!0};this.requestLogin=function(b){b=b||{};if(!d)throw Error("Either facebook sdk has not yet been initialized, or not yet loaded.");var k=new Appacitive.Promise;FB.login(function(b){b&&"connected"===b.status&&b.authResponse?(c=b.authResponse.accessToken,k.fulfill(b.authResponse)):
...
(function(b){b.Appacitive.Email=new function(){var d={smtp:{username:null,password:null,host:"smtp.gmail.com",port:465,enablessl:!0},from:null,replyto:null};this.getConfig=function(){return d};var c=function(c,d){var k=new b.Appacitive._Request({method:"POST",type:"email",op:"getSendEmailUrl",callbacks:d,data:c,entity:c,onSuccess:function(c){k.promise.fulfill(c.email)}});return k.send()};this.setupEmail=function(c){c=c||{};d.smtp.username=c.username||d.smtp.username;d.from=c.from||d.from;d.smtp.password=
c.password||d.smtp.password;d.smtp.host=c.smtp.host||d.smtp.host;d.smtp.port=c.smtp.port||d.smtp.port;d.smtp.enablessl=c.enableSSL||d.smtp.enablessl;d.replyto=c.replyTo||d.replyto};this.sendTemplatedEmail=function(b,f){if(!b||!b.to||!b.to.length||0===b.to.length)throw Error("Atleast one receipient is mandatory to send an email");if(!b.subject||0===b.subject.trim().length)throw Error("Subject is mandatory to send an email");if(!b.from&&d.from)throw Error("from is mandatory to send an email. Set it in config or send it in options on the portal");
...
"");e(d,function(b){f(b.url,c.fileData,c.contentType,function(){c.fileId=b.id;c.getDownloadUrl().then(function(b){return k.fulfill(b,c)},function(b){return k.reject(b)})},k)},k," Get upload url for file ");return k},g=function(d){if(!c.fileData)throw Error("Please specify filedata");if(!c.contentType)try{c.contentType=c.fileData.type}catch(g){}c.contentType&&_type.isString(c.contentType)&&0!==c.contentType.length||(c.contentType="text/plain");var k=b.Appacitive.Promise.buildPromise(d);d=b.Appacitive.config.apiBaseUrl+
b.Appacitive.storage.urlFactory.file.getUpdateUrl(c.fileId,c.contentType);e(d,function(b){f(b.url,c.fileData,c.contentType,function(){c.getDownloadUrl().then(function(b){k.fulfill(b,c)},function(b){k.reject(b)})},k)},k," Get update url for file "+c.fileId);return k};this.deleteFile=function(d){if(!this.fileId)throw Error("Please specify fileId to delete");var e=b.Appacitive.Promise.buildPromise(d);d=new b.Appacitive.HttpRequest;d.url=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory.file.getDeleteUrl(this.fileId);
d.method="DELETE";d.description="Delete file with id "+this.fileId;d.onSuccess=function(b){e.fulfill()};d.promise=e;d.entity=c;return b.Appacitive.http.send(d)};this.getDownloadUrl=function(d,f){if(!this.fileId)throw Error("Please specify fileId to download");"number"!==typeof d&&(f=d,d=-1);var g=b.Appacitive.Promise.buildPromise(f),h=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory.file.getDownloadUrl(this.fileId,d);e(h,function(b){c.url=b.uri;g.fulfill(b.uri)},g," Get download url for file "+
this.fileId);return g};this.getUploadUrl=function(d){c.contentType&&_type.isString(c.contentType)&&0!==c.contentType.length||(c.contentType="text/plain");var f=b.Appacitive.Promise.buildPromise(d);d=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory.file.getUploadUrl(this.contentType,this.fileId?this.fileId:"");e(d,function(b){c.url=b.url;f.fulfill(b.url,c)},f," Get upload url for file "+this.fileId);return f}}})(global);
...
(function(b){b.Appacitive.localStorage=new (b.Appacitive.runtime.isBrowser?function(){var d=b.Appacitive.runtime.isBrowser?window.localStorage:{getItem:function(){return null}};this.set=function(c,e){e=e||"";if(!c)return!1;if(_type.isObject(e)||_type.isArray(e))try{e=JSON.stringify(e)}catch(f){}c=b.Appacitive.getAppPrefix(c);d[c]=e;return this};this.get=function(c){if(!c)return null;c=b.Appacitive.getAppPrefix(c);c=d.getItem(c);if(!c)return null;if("{"===c[0])try{c=JSON.parse(c)}catch(e){}return c};
this.remove=function(c){if(c){c=b.Appacitive.getAppPrefix(c);try{delete d[c]}catch(e){}}}}:function(){var d=[];this.set=function(c,e){e=e||"";if(!c||_type.isString(c))return!1;c=b.Appacitive.getAppPrefix(c);d[c]=e;return this};this.get=function(c){if(!c||_type.isString(c))return null;c=b.Appacitive.getAppPrefix(c);return(c=d[c])?c:null};this.remove=function(c){if(c&&!_type.isString(c)){c=b.Appacitive.getAppPrefix(c);try{delete d[c]}catch(e){}}}})})(global);
