...
h.like=function(a){return new c({field:this.name,fieldType:this.type,value:new m("*"+a+"*"),operator:"like"})};h.startsWith=function(a){return new c({field:this.name,fieldType:this.type,value:new m(a+"*"),operator:"like"})};h.endsWith=function(a){return new c({field:this.name,fieldType:this.type,value:new m("*"+a),operator:"like"})};h.contains=function(a){return new d({field:this.name,fieldType:this.type,value:a,operator:"=="})};h.between=function(a,b){return new e({field:this.name,fieldType:this.type,
val1:new m(a),val2:new m(b),operator:"between"})};h.betweenDate=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new n(a),val2:new n(b),operator:"between"})};h.betweenTime=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new p(a),val2:new p(b),operator:"between"})};h.betweenDateTime=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new q(a),val2:new q(b),operator:"between"})};h.withinCircle=function(a,c,e){return new b({field:this.name,fieldType:this.type,
geoCoord:a,distance:c,unit:e,operator:"within_circle"})};h.withinPolygon=function(a){return new l({field:this.name,fieldType:this.type,geoCoords:a,operator:"within_polygon"})}},r=function(a){if(!a||0===a.length)throw Error("Specify field name");this.field=a;t("property",a,this);return this},v=function(a){if(!a||0===a.length)throw Error("Specify field name");this.field=a;var b=new t("aggregate",a);this.equalTo=function(a){return b.equalTo(a)};this.greaterThan=function(a){return b.greaterThan(a)};this.greaterThanEqualTo=
...
(a+="&fields="+this.fields());return a};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+q+"/"+p+"/find/all?"+this.getQueryString()};this.toRequest=function(){var b=new a.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};this.getOptions=function(){var a={},b;for(b in this)this.hasOwnProperty(b)&&"function"!=typeof this[b]&&(a[b]=this[b]);return a};var t=function(b){var c=[];b||(b=[]);var e="article"===q?"Article":"Connection";b.forEach(function(b){c.push(new a.Appacitive[e](b,
!0))});return c};this.fetch=function(b,c){var e=this.toRequest();e.onSuccess=function(a){a&&a.status&&"200"==a.status.code?"function"===typeof b&&b(t(a[q+"s"]),a.paginginfo):(a=a||{},"function"===typeof c&&c(a.status||{message:"Server error",code:400}))};e.onError=function(a){a=a||{};"function"===typeof c&&c(a.status||{message:"Server error",code:400})};a.Appacitive.http.send(e);return this};this.count=function(b,c){b=b||function(){};c=c||function(){};var e=m.pageSize,d=m.pageNumber;m.pageSize=1;
m.pageNumber=999999999;var h=this,k=this.toRequest();k.onSuccess=function(a){m.pageSize=e;m.pageNumber=d;a=a||{};var k=a.paginginfo,g=0;if(k)g=k.totalrecords;else if(a.status&&a.status.code&&"200"==a.status.code)g=0;else{a=a.status||{message:"Server error",code:400};"function"===typeof c&&c(a,h);return}"function"===typeof b&&b(g)};k.onError=function(a){m.pageSize=e;m.pageNumber=d;a=a||{message:"Server error",code:400};"function"===typeof c&&c(a,h)};a.Appacitive.http.send(k);return this}};a.Appacitive.Queries.FindAllQuery=
...
x.apply(this,arguments):A.apply(this,arguments);return this};var A=function(e,h,k){e=e||function(){};h=h||function(){};"string"==typeof k?r=value:k="object"==typeof k&&k.length?k.join(","):r;var g=this;k=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[this.type].getCreateUrl(b.__schematype||b.__relationtype,k);!b.__schematype||"user"!=b.__schematype.toLowerCase()&&"device"!=b.__schematype.toLowerCase()||(k=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[b.__schematype.toLowerCase()].getCreateUrl());
for(var f in b)"$"==f[0]&&delete b[f];f=new a.Appacitive.HttpRequest;f.url=k;f.method="put";b.__revision&&delete b.__revision;f.data=b;f.onSuccess=function(k){var f=null;k&&(k.article||k.connection||k.user||k.device)&&(f=k.article||k.connection||k.user||k.device);k&&f?(c=f,b.__id=f.__id,d(f,b),g.connectionCollections&&0<g.connectionCollections.length&&g.connectionCollections.forEach(function(a){a.getQuery().extendOptions({articleId:b.__id})}),"connection"==g.type&&g.parseConnection(),a.Appacitive.eventManager.fire((g.schema||
g.relation)+"."+g.type+".created",g,{object:g}),"function"==typeof e&&e(g)):(k=k||{},k.status=k.status||{},k.status=m(k.status),a.Appacitive.eventManager.fire((g.schema||g.relation)+"."+g.type+".createFailed",g,{error:k.status}),"function"==typeof h&&h(k.status,g))};f.onError=function(a){a=m(a);"function"==typeof h&&h(a,g)};a.Appacitive.http.send(f);return this},x=function(k,h,g){k=k||function(){};h=h||function(){};var f=function(f){var l=t(!0),n;for(n in l)"$"==n[0]&&delete l[n];if(Object.isEmpty(l))"function"==
typeof k&&k(e);else{"string"==typeof g?r=value:g="object"==typeof g&&g.length?g.join(","):r;n=new a.Appacitive.HttpRequest;var q=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[e.type].getUpdateUrl(b.__schematype||b.__relationtype,c.__id?c.__id:b.__id,g,f),w=e.type;b&&(b.__schematype&&("user"==b.__schematype.toLowerCase()||"device"==b.__schematype.toLowerCase()))&&(w=b.__schematype.toLowerCase(),q=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[b.__schematype.toLowerCase()].getUpdateUrl(c.__id,
g,f));n.url=q;n.method="post";n.data=l;n.onSuccess=function(f){f&&f[w]?(u.length=0,c=f[e.type],d(c,b),p=[],a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+w+"."+b.__id+".updated",e,{object:e}),"function"==typeof k&&k(e)):(f=f||{},f.status=f.status||{},f.status=m(f.status),"14008"==f.status.code&&0<u.length?x(k,h,g):(a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+w+"."+b.__id+".updateFailed",e,{object:f.status}),"function"==typeof h&&h(f.status,e)))};n.onError=function(a){a=a||
{};a.message=a.message||"Server error";a.code=a.code||"500";"14008"==a.code&&0<u.length?x(k,h,g):"function"==typeof h&&h(a,e)};a.Appacitive.http.send(n)}};if(0<u.length){var l=["__revision"];u.forEach(function(a){l.push(a.key)});z(function(a){u.forEach(function(b){var c=v.integer(a[b.key]);c||(c=0);e.set(b.key,c+b.amount)});f(a.__revision)},h,l,!0)}else f();return this},z=function(k,h,g,f){k=k||function(){};h=h||function(){};if(b.__id){"string"==typeof g?r=value:g="object"==typeof g&&g.length?g.join(","):
r;g=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[e.type].getGetUrl(b.__schematype||b.__relationtype,b.__id,g);var l=new a.Appacitive.HttpRequest;l.url=g;l.method="get";l.onSuccess=function(a){a&&a[e.type]?f?"function"==typeof k&&k(a[e.type]):(c=a[e.type],d(c,b),a.connection&&(e.endpoints||e.endpointA&&e.endpointB||e.setupConnection(b.__endpointa,b.__endpointb)),e.___collection&&"article"==e.___collection.collectionType&&e.___collection.addToCollection(e),"function"==typeof k&&k(e)):
...
b.__id);b&&(b.__schematype&&("user"==b.__schematype.toLowerCase()||"device"==b.__schematype.toLowerCase()))&&(k=a.Appacitive.config.apiBaseUrl,k+=a.Appacitive.storage.urlFactory[b.__schematype.toLowerCase()].getDeleteUrl(b.__id));d&&!0===d&&(k=-1==k.indexOf("?")?k+"?deleteconnections=true":k+"&deleteconnections=true");d=new a.Appacitive.HttpRequest;d.url=k;d.method="delete";d.onSuccess=function(a){"200"==a.code?(h.___collection&&h.___collection.removeById(b.__id),"function"==typeof c&&c(a)):(a=m(a),
"function"==typeof e&&e(a,h))};d.onError=function(a){a=m(a);"function"==typeof e&&e(a,h)};a.Appacitive.http.send(d)}else this.___collection&&this.___collection.removeByCId(l),"function"==typeof c&&c(this)}};a.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())}})(global);
...
if(!c.id)throw Error("Specify id to fetch");var h=new a.Appacitive.Connection({__relationtype:c.relation,__id:c.id});h.fields=c.fields;h.fetch(b,d)};var c=function(c){var b=[];c||(c=[]);c.forEach(function(c){b.push(new a.Appacitive.Connection(c))});return b},d=function(e,b,d){e.onSuccess=function(a){a&&a.status&&"200"==a.status.code?"function"===typeof b&&b(c(a.connections),a.paginginfo):(a=a||{},"function"===typeof d&&d(a.status||{message:"Server error",code:400}))};e.onError=function(a){a=a||{message:"Server error",
code:400};"function"===typeof d&&d(a)};a.Appacitive.http.send(e)};a.Appacitive.Connection.multiGet=function(c,b,g){c=c||{};if(!c.relation||"string"!==typeof c.relation||0===c.relation.length)throw Error("Specify valid relation");if(c.ids&&0<c.ids.length){var h=new a.Appacitive.HttpRequest;h.url=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.connection.getMultiGetUrl(c.relation,c.ids.join(","),c.fields);h.method="get";return d(h,b,g)}"function"===typeof b&&b([])};a.Appacitive.Connection.multiDelete=
function(c,b,d){c=c||{};if(!c.relation||"string"!==typeof c.relation||0===c.relation.length)throw Error("Specify valid relation");if(c.ids&&0<c.ids.length){var h=new a.Appacitive.HttpRequest;h.url=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.connection.getMultiDeleteUrl(c.relation);h.method="post";h.data={idlist:c.ids};h.onSuccess=function(a){a&&"200"==a.code?"function"===typeof b&&b():(a=a||{},"function"===typeof d&&d(a||{message:"Server error",code:400}))};h.onError=function(a){a=
a||{};"function"===typeof d&&d(a||{message:"Server error",code:400})};a.Appacitive.http.send(h)}else"function"===typeof b&&b()};a.Appacitive.Connection.getInterconnects=function(c,b,g){c=new a.Appacitive.Queries.InterconnectsQuery(c);d(c.toRequest(),request,b,g)};a.Appacitive.Connection.getBetweenArticles=function(c,b,g){c=new a.Appacitive.Queries.GetConnectionsBetweenArticlesQuery(c);d(c.toRequest(),b,g)};a.Appacitive.Connection.getBetweenArticlesForRelation=function(c,b,d){(new a.Appacitive.Queries.GetConnectionsBetweenArticlesForRelationQuery(c)).fetch(b,
d)}})(global);
(function(a){a.Appacitive.Users=new function(){var f=null;this.currentUser=function(){return f};var g=function(b,c,d,e,g){var f=b.get("__id");if(!f||"string"!==typeof f||0===f.length)throw Error("Please specify valid userid");if(!c||"string"!==typeof c||0===c.length)throw Error("Please specify valid oldPassword");if(!d||"string"!==typeof d||0===d.length)throw Error("Please specify valid newPassword");e=e||function(){};g=g||function(){};c={oldpassword:c,newpassword:d};d=new a.Appacitive.HttpRequest;d.url=
a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.user.getUpdatePasswordUrl(f);d.method="post";d.data=c;d.onSuccess=function(a){a&&"200"==a.code?"function"==typeof e&&e(b):g(a,b)};d.onError=g;a.Appacitive.http.send(d)},c=function(b,c,d){var e=b.get("__id");e&&"string"===typeof e&&0!==e.length||"function"===typeof c&&c(b.linkedAccounts(),b);c=c||function(){};d=d||function(){};var g=new a.Appacitive.HttpRequest;g.url=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.user.getGetAllLinkedAccountsUrl(e);
...
"function"===typeof a&&a(b.authResponse)):"function"===typeof e&&e()},{scope:"email,user_birthday"})};this.getCurrentUserInfo=function(a,e){if(!c)throw Error("Either facebook sdk has not yet been initialized, or not yet loaded.");a=a||function(){};e=e||function(){};FB.api("/me",function(b){b&&!b.error?(g=FB.getAuthResponse().accessToken,"function"===typeof a&&a(b)):"function"===typeof e&&e()})};this.accessToken=function(){return 1===arguments.length?(g=arguments[0],this):g};this.getProfilePictureUrl=
...
(function(a){if(!a.Appacitive.runtime.isBrowser)var f=function(){this.setCookie=function(f,c){a.Appacitive.localStorage.set("cookie/"+f,c)};this.readCookie=function(f){return a.Appacitive.localStorage.get("cookie/"+f)};this.eraseCookie=function(f){a.Appacitive.localStorage.remove("cookie/"+f)}};a.Appacitive.Cookie=new f})(global);
(function(a){a.Appacitive.Cloud=new function(){var a=[],g=function(){if(2!==arguments.length)throw"Invalid no. of arguments provided to cloud function declare";if("string"!==typeof arguments[0])throw"Error: Provide name fo cloud api";if("function"!==typeof arguments[1])throw"Error: Invalid api function provided for cloud api";var c=arguments[0];if(!/^[A-Za-z][A-Za-z_0-9]*$/.test(c))throw"Error: Invalid name for api function "+c;a[c.toLowerCase()]=arguments[1]};this.declare=function(){g.apply(null,
arguments)};this.declare.toString=function(){return"function () { [native code] }"};var c=function(){if(2>arguments.length||"string"!==typeof arguments[0]||"object"!==typeof arguments[1])throw new "Error: Invalid list of arguments passed to cloud api";var c=arguments[0],e=arguments[1].request,b=arguments[1].response;if("function"==typeof a[c]){var g=a[c];setTimeout(function(){g.apply(null,[e,b])},0)}else throw{code:"404",message:"Error: Api with name "+arguments[0]+" doesn't exits"};};this.execute=
function(){c.apply(null,arguments)};this.execute.toString=function(){return"function () { [native code] }"}}})(global);"undefined"===typeof module||global.Appacitive.runtime.isBrowser||(module.exports=global.Appacitive);
