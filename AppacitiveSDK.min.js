...
new b;l.onreadystatechange=function(){if(4==this.readyState)if(200<=this.status&&300>this.status||304==this.status){var b=this.responseText;try{var g=this.getResponseHeader("content-type")||this.getResponseHeader("Content-Type");if("application/json"==g.toLowerCase()||"application/javascript"==g.toLowerCase()||"application/json; charset=utf-8"==g.toLowerCase()||"application/json; charset=utf-8;"==g.toLowerCase())g=b,global.Appacitive.runtime.isBrowser||"{"!=g[0]&&(g=g.substr(1,g.length-1)),b=JSON.parse(g)}catch(c){}h.fulfill(b,
...
b=!0;g=c.apply(this,arguments);c=null;return g}}}}(),m;m={on:function(c,b,g){if(!p(this,"on",c,[b,g])||!b)return this;this._events||(this._events={});(this._events[c]||(this._events[c]=[])).push({callback:b,context:g,ctx:g||this});return this},once:function(c,b,h){if(!p(this,"once",c,[b,h])||!b)return this;var e=this,f=g.once(function(){e.off(c,f);b.apply(this,arguments)});f._callback=b;return this.on(c,f,h)},off:function(b,c,h){var e,f,k,n,m,l,x,w;if(!this._events||!p(this,"off",b,[c,h]))return this;
if(!b&&!c&&!h)return this._events={},this;n=b?[b]:g.keys(this._events);m=0;for(l=n.length;m<l;m++)if(b=n[m],k=this._events[b]){this._events[b]=e=[];if(c||h)for(x=0,w=k.length;x<w;x++)f=k[x],(c&&c!==f.callback&&c!==f.callback._callback||h&&h!==f.context)&&e.push(f);e.length||delete this._events[b]}return this},trigger:function(b){if(!this._events)return this;var c=h.call(arguments,1);if(!p(this,"trigger",b,c))return this;var g=this._events[b],e=this._events.all;g&&k(g,c);e&&k(e,arguments);return this},
stopListening:function(b,c,g){var h=this._listeners;if(!h)return this;var e=!c&&!g;"object"===typeof c&&(g=this);b&&((h={})[b._listenerId]=b);for(var f in h)h[f].off(c,g,this),e&&delete this._listeners[f];return this}};var n=/\s+/,p=function(b,c,g,h){if(!g)return!0;if("object"===typeof g){for(var e in g)b[c].apply(b,[e,g[e]].concat(h));return!1}if(n.test(g)){g=g.split(n);e=0;for(var f=g.length;e<f;e++)b[c].apply(b,[g[e]].concat(h));return!1}return!0},k=function(b,c){var g,h=-1,e=b.length,f=c[0],k=
c[1],n=c[2];switch(c.length){case 0:for(;++h<e;)(g=b[h]).callback.call(g.ctx);break;case 1:for(;++h<e;)(g=b[h]).callback.call(g.ctx,f);break;case 2:for(;++h<e;)(g=b[h]).callback.call(g.ctx,f,k);break;case 3:for(;++h<e;)(g=b[h]).callback.call(g.ctx,f,k,n);break;default:for(;++h<e;)(g=b[h]).callback.apply(g.ctx,c)}};g.each({listenTo:"on",listenToOnce:"once"},function(b,c){m[c]=function(c,h,e){var f=this._listeners||(this._listeners={}),k=c._listenerId||(c._listenerId=g.uniqueId("l"));f[k]=c;"object"===
typeof h&&(e=this);c[b](h,e,this);return this}});m.bind=m.on;m.unbind=m.off;m.mixin=function(b){g.each("on once off trigger stopListening listenTo listenToOnce bind unbind".split(" "),function(c){b[c]=this[c]},this);return b};c.Appacitive.Events=m})(global);
...
!1,h=null,c.Appacitive.localStorage.remove("Appacitive-UserToken"),c.Appacitive.localStorage.remove("Appacitive-UserTokenExpiry"),c.Appacitive.localStorage.remove("Appacitive-UserTokenDate"),e.fulfill()};this.isSessionValid=function(b){if(b.status){if(b.status.code&&("420"==b.status.code||"19027"==b.status.code||"19002"==b.status.code))return{status:!1,isSession:"19027"==b.status.code||"420"==b.status.code?!0:!1}}else if(b.code&&("420"==b.code||"19027"==b.code||"19002"==b.code))return{status:!1,isSession:"19027"==
b.code||"420"==b.code?!0:!1};return{status:!0}};this.resetSession=function(){b=null;this.useApiKey=!0};this.get=function(){return b};this.setSession=function(c){c&&(b=c,this.useApiKey=!1)};this.setApiKey=function(b){b&&(f=b,this.useApiKey=!0)};this.setMasterKey=function(b){g=b};this.reset=function(){this.removeUserAuthHeader();h=f=b=null;l=!1;g=null;this.useMasterKey=this.useApiKey=this.initialized=!1};var m="sandbox";this.environment=function(){if(1==arguments.length){var b=arguments[0];"sandbox"!=
b&&"live"!=b&&(b="sandbox");m=b}return m}};c.Appacitive.getAppPrefix=function(e){return c.Appacitive.Session.environment()+"/"+c.Appacitive.appId+"/"+e};c.Appacitive.initialize=function(e){e=e||{};if(!c.Appacitive.Session.initialized){e.masterKey&&0<e.masterKey.length&&c.Appacitive.Session.setMasterKey(e.masterKey);if(!e.apikey||0===e.apikey.length)if(_masterKey)e.apikey=_masterKey;else throw Error("apikey is mandatory");if(!e.appId||0===e.appId.length)throw Error("appId is mandatory");c.Appacitive.Session.setApiKey(e.apikey);
...
new Date||(-1==f&&(f=null),(b=c.Appacitive.localStorage.get("Appacitive-User"))&&c.Appacitive.Users.setCurrentUser(b,e,f))}}};c.Appacitive.reset=function(){}})(global);(function(c){c.Appacitive&&c.Appacitive.http&&(c.Appacitive.http.addProcessor({pre:function(e){e.headers.push({key:"e",value:c.Appacitive.Session.environment()})}}),c.Appacitive.Events.mixin(c.Appacitive))})(global);
(function(c){var e=c.Appacitive;e.GeoCoord=function(b,c){var g=function(b,c){if(isNaN(b)||isNaN(c))throw Error("Invalid Latitiude or longitiude provided");if(-90>b||90<b)throw Error("Latitude "+b+" should be in range of  -90.0 to 90.");if(-180>c||180<c)throw Error("Latitude "+c+" should be in range of  -180.0 to 180.");},h=function(b){if("string"!==typeof b||0==b.length)return!1;b=b.split(",");if(2!==b.length)return!1;try{return new e.GeoCoord(b[0],b[1])}catch(c){return!1}};if(_type.isString(b)&&
...
function(b){return new h({field:this.name,fieldType:this.type,value:b,operator:k.isEqualTo})};e.between=function(b,c){return new l({field:this.name,fieldType:this.type,val1:new q(b,"number"),val2:new q(c,"number"),operator:k.between})};e.betweenDate=function(b,c){return new l({field:this.name,fieldType:this.type,val1:new r(b),val2:new r(c),operator:k.between})};e.betweenTime=function(b,c){return new l({field:this.name,fieldType:this.type,val1:new t(b),val2:new t(c),operator:k.between})};e.betweenDateTime=
function(b,c){return new l({field:this.name,fieldType:this.type,val1:new u(b),val2:new u(c),operator:k.between})};e.withinCircle=function(b,c,e){return new g({field:this.name,fieldType:this.type,geoCoord:b,distance:c,unit:e,operator:k.withinCircle})};e.withinPolygon=function(b){return new m({field:this.name,fieldType:this.type,geoCoords:b,operator:k.withinPolygon})}},B=function(b){if(!b||0===b.length)throw Error("Specify field name");this.field=b;v("property",b,this);return this},A=function(b){if(!b||
...
(function(c){c.Appacitive.Queries={};var e=function(b){b=b||{};var c=1,g=20;this.pageNumber=function(){return 1==arguments.length?(c=arguments[0]||1,this):c};this.pageSize=function(){return 1==arguments.length?(g=arguments[0]||20,this):g};this.pageNumber(b.pageNumber);this.pageSize(b.pageSize)};e.prototype.toString=function(){return"psize="+this.pageSize()+"&pnum="+this.pageNumber()};var b=function(b){b=b||{};var c=null,g=!1;this.orderBy=function(){return 1===arguments.length&&_type.isString(arguments[0])?
(c=arguments[0],this):c};this.isAscending=function(){return 1===arguments.length?(g=void 0===arguments[0]||null==arguments[0]?!1:arguments[0],this):g};this.orderBy(b.orderBy);this.isAscending(b.isAscending)};b.prototype.toString=function(){return this.orderBy()&&0<this.orderBy().length?"orderBy="+this.orderBy()+"&isAsc="+this.isAscending():""};var f=function(h){var f=h||{},g="",m="",n="",p=f.queryType||"BasicQuery",k=new e(h),q=new b(h),r=f.type||f.relation,t=f.relation?"connection":"object",u=this;
...
this.isAscending=function(){return 1===arguments.length?(q.isAscending(arguments[0]),this):q.isAscending()};this.filter=function(){return 1===arguments.length?(g=arguments[0],this):g};this.freeText=function(){if(1===arguments.length){var b=arguments[0];_type.isString(b)?m=arguments[0]:_type.isArray(b)&&b.length&&(m=arguments[0].join(" "));return this}return m};this.fields=function(){if(1===arguments.length){var b=arguments[0];_type.isString(b)?n=b:_type.isArray(b)&&b.length&&(n=b.join(","));return this}return n};
this.filter(f.filter||"");this.freeText(f.freeText||"");this.fields(f.fields||"");this.setFilter=function(b){this.filter(b)};this.setFreeText=function(b){this.freeText(b)};this.setFields=function(b){this.fields(b)};this.extendOptions=function(c){for(var g in c)f[g]=c[g];k=new e(f);q=new b(f);return this};this.getQueryString=function(){var b=k.toString(),c=q.toString();c&&(b+="&"+c);this.filter()&&(c=encodeURIComponent(this.filter().toString()),0<c.trim().length&&(b+="&query="+c));this.freeText()&&
0<this.freeText().trim().length&&(b+="&freetext="+encodeURIComponent(this.freeText())+"&language=en");this.fields()&&0<this.fields().trim().length&&(b+="&fields="+this.fields());return b};this.toUrl=function(){return{url:c.Appacitive.config.apiBaseUrl+t+"/"+r+"/find/all?"+this.getQueryString(),description:"FindAll "+r+" "+t+"s"}};this.toRequest=function(b){var g=new c.Appacitive.HttpRequest,e=this.toUrl();g.url=e.url;g.options=b;g.description=e.description;g.method="get";return g};this.getOptions=
...
e||(e="object"===t?"Object":"Connection",c.Appacitive[e]._getClass(this[e]));return new Appacitive.Collection(b,_extend(g,{model:this.model,query:this}))};this.fetchNext=function(b){var c=this.pageNumber();this.pageNumber(++c);return this.fetch(b)};this.fetchPrev=function(b){var c=this.pageNumber(),c=c-1;0>=c&&(c=1);this.pageNumber(c);return this.fetch(b)};this.count=function(b){var g=c.Appacitive.Promise.buildPromise(b);b=this.toRequest(b);b.onSuccess=function(b){b=b||{};b=b.paginginfo;var c=0,c=
b?b.totalrecords:0;g.fulfill(c)};b.promise=g;b.entity=this;return c.Appacitive.http.send(b)}};c.Appacitive.Query=f;c.Appacitive.Queries.FindAllQuery=function(b){b=b||{};if(!b.type&&!b.relation)throw Error("Specify either type or relation for basic filter query");b.queryType="FindAllQuery";f.call(this,b);return this};c.Appacitive.Queries.FindAllQuery.prototype=new f;c.Appacitive.Queries.FindAllQuery.prototype.constructor=c.Appacitive.Queries.FindAllQuery;c.Appacitive.Queries.ConnectedObjectsQuery=
...
if(!f.__attributes)return k.__attributes;var b=!1,c=JSON.parse(JSON.stringify(f.__attributes)),g;for(g in k.__attributes)null==k.__attributes[g]||void 0==k.__attributes[g]?(c[g]=null,b=!0):k.__attributes[g]!=f.__attributes[g]?(c[g]=k.__attributes[g],b=!0):k.__attributes[g]==f.__attributes[g]&&delete c[g];return b?c:null};this.getChangedAttributes=B;this.aggregate=function(){var b={},c;for(c in k){if(!k.hasOwnProperty(c))return;"$"==c[0]&&(b[c.substring(1)]=k[c])}if(0===arguments.length)return b;if(1==
...
q.push(b);q=Array.distinct(q);if(!k.__tags||!k.__tags.length)return w("__tags"),this;b=k.__tags.indexOf(b);-1!=b&&k.__tags.splice(b,1);w("__tags");return this};var A=function(){if(!k.__tags)return[];if(!f.__tags)return k.__tags;var b=[];k.__tags.forEach(function(c){-1==f.__tags.indexOf(c)&&b.push(c)});return 0<b.length?b:null};this.getChangedTags=A;this.getRemovedTags=function(){return _removetags};var y=function(b,c,g,e){if(!b||!_type.isString(b)||0===b.length||0==b.trim().indexOf("__")||0===b.trim().indexOf("$")||
void 0==c||null==c)return this;b=b.toLowerCase();try{var f=function(c){if(!_type.isString(c))if(_type.isNumber(c)||_type.isBoolean(c))c+="";else throw Error("Multivalued property cannot have values of property as an object");if(k[b]&&_type.isArray(k[b])){var e=k[b].indexOf(c);"additems"==g?k[b].push(c):-1==e&&"adduniqueitems"==g?k[b].push(c):"removeitems"==g&&k[b].removeAll(c)}else"removeitems"!=g&&(k[b]=[c]);l[b]||(l[b]={additems:[],adduniqueitems:[],removeitems:[]});l[b][g].push(c)};_type.isArray(c)?
c.forEach(function(b){f(b)}):f(c);w(b,e)}catch(h){throw Error("Unable to add item to "+b);}return n};this.add=function(b,c,g){return y.apply(this,[b,c,"additems",g])};this.addUnique=function(b,c,g){return y.apply(this,[b,c,"adduniqueitems",g])};this.remove=function(b,c,g){return y.apply(this,[b,c,"removeitems",g])};var z=function(b){var c=!1,e=JSON.parse(JSON.stringify(f)),m;for(m in e)"$"==m[0]&&delete e[m];for(var p in k)null==k[p]||void 0==k[p]?(e[p]=null,c=!0):k[p]!=f[p]?"__tags"==p||"__attributes"==
p?delete e[p]:_type.isArray(k[p])?l[p]&&!g[p]?(e[p]=l[p],c=!0):k[p].equals(f[p])?delete e[p]:(e[p]=k[p],c=!0):(e[p]=h[p]&&!g[p]?{incrementby:h[p].value}:k[p],c=!0):k[p]==f[p]&&delete e[p];try{t.forEach(function(b){e[b]&&delete e[b]})}catch(r){}m=A();b?(m&&(e.__addtags=m,c=!0),q&&0<q.length&&(e.__removetags=q,c=!0)):m&&(e.__tags=m,c=!0);(b=B())?(e.__attributes=b,c=!0):delete e.__attributes;"object"==n.type&&(b=n._aclFactory.getChanged())&&(e.__acls=b);return c&&!Object.isEmpty(e)?e:!1};this.changed=
function(){return this.isNew()?this.toJSON():z()};this.hasChanged=function(){if(this.isNew())return!0;var b=z(!0);return 0===arguments.length?Object.isEmpty(b)?!1:!0:1==arguments.length&&_type.isString(arguments[0])&&0<arguments[0].length&&b&&b[arguments[0]]?!0:!1};this.changedAttributes=function(){if(this.isNew())return this.toJSON();var b=z(!0);if(0===arguments.length)return b;if(1==arguments.length&&_type.isArray(arguments[0])&&arguments[0].length){var c={};arguments[0].forEach(function(g){b[g]&&
c.push(b[g])});return c}return!1};this.previous=function(){return this.isNew()?null:1==arguments.length&&_type.isString(arguments[0])&&arguments[0].length?f[arguments[0]]:null};this.previousAttributes=function(){return this.isNew()?null:f};this.fields=function(){if(1==arguments.length){var b=arguments[0];_type.isString(b)?r=b:_type.isArray(b)&&(r=b.join(","));return this}return r};var x={integer:function(b){if(b){var c=parseInt(b);if(!isNaN(c))return c}return b},decimal:function(b){if(b){var c=parseFloat(b);
if(!isNaN(c))return c}return b},"boolean":function(b){return void 0!==b&&null!==b&&("true"===b.toString().toLowerCase()||!0===b||0<b)?!0:!1},date:function(b){if(b){var g=c.Appacitive.Date.parseISODate(b);if(g)return g}return b},datetime:function(b){if(b){var g=c.Appacitive.Date.parseISODate(b);if(g)return g}return b},time:function(b){if(b){var g=c.Appacitive.Date.parseISOTime(b);if(g)return g}return b},string:function(b){return b?b.toString():b},geocode:function(b){if(!_type.isString(b)||0==b.trim().length)return!1;
b=b.split(",");return 2!==b.length?!1:new c.Appacitive.GeoCoord(b[0],b[1])}};this.get=function(b,c){if(b){if(c&&x[c.toLowerCase()]){if(x[c.toLowerCase()])return x[c.toLowerCase()](k[b]);throw Error('Invalid cast-type "'+c+'"" provided for get "'+b+'"');}return k[b]}};this.tryGet=function(b,c,g){b=this.get(b,g);return void 0!==b?b:c};var w=function(b,c){if(c&&!c.silent){var g=z();if(g[b]||-1!=t.indexOf(b))n.trigger("change:"+b,n,g[b]||k[b],{}),n.trigger("change",n,c)}},E=function(b){b&&!b.silent&&
n.trigger("destroy",n,n.collection,b)};this.set=function(b,e,m){m=m||{};if(!b||!_type.isString(b)||0===b.length||0===b.trim().indexOf("$"))return this;b=b.toLowerCase();try{if(void 0==e||null==e)k[b]=null;else if(_type.isString(e))k[b]=e;else if(_type.isNumber(e)||_type.isBoolean(e))k[b]=e+"";else if(e instanceof Date)k[b]="date"==dataType?c.Appacitive.Date.toISODate(e):"time"==dataType?c.Appacitive.Date.toISOTime(e):c.Appacitive.Date.toISOString(e);else if(_type.isObject(e))if(-1!==u.indexOf(b))k[b]=
...
this.length;if(_type.isString(c))this[g]=c;else if(_type.isNumber(c)||_type.isBoolean(c))this[g]=c+"";else throw Error("Multivalued property cannot have values of property as an object");w(b,m);return this});delete h[b];delete l[b];delete g[b];k[b]!==f[b]&&(_type.isArray(k[b])&&!k[b].equals(f[b])||_type.isString(k[b])||_type.isObject(k[b]))&&(g[b]=!0);w(b,m);return this}catch(n){throw Error("Unable to set "+b);}};this.unset=function(b,c){if(!b||!_type.isString(b)||0===b.length||0===b.indexOf("__"))return this;
b=b.toLowerCase();delete k[b];w(b,c);return this};this.has=function(b){return b&&_type.isString(b)&&0!==b.length?k[b]&&!_type.isUndefined(k[b])?!0:!1:!1};this.isNew=function(){return k.__id&&k.__id.length?!1:!0};this.clone=function(){return"object"==this.type?c.Appacitive.Object._create(this.toJSON()):new c.Appacitive.connection._create(this.toJSON())};this.copy=function(b,c){b&&(m(b,k),c&&m(b,f));return this};this.mergeWithPrevious=function(){m(k,f);q=[];h={};l={};g={};return this};var C=function(){m(f,
k);q=[];h={};l={};g={}};this.rollback=function(){k=p={};C();return this};var D=function(b,c,g,e){if(!b||!_type.isString(b)||0===b.length||0===b.indexOf("__"))return this;b=b.toLowerCase();if(_type.isObject(k[b])||_type.isArray(k[b]))throw Error("Cannot increment/decrement array/object");try{_type.isObject(c)?(e=c,c=g):c=!c||isNaN(Number(c))?g:Number(c)*g,k[b]=isNaN(Number(k[b]))?c:Number(k[b])+c,n.isNew()||(h[b]={value:(h[b]?h[b].value:0)+c})}catch(f){throw Error("Cannot perform increment/decrement operation");
}w(b,e);return n};this.increment=function(b,c,g){return D(b,c,1,g)};this.decrement=function(b,c,g){return D(b,c,-1,g)};this.save=function(){return k.__id?F.apply(this,arguments):G.apply(this,arguments)};var G=function(b){var g=n.type;!k.__type||"user"!=k.__type.toLowerCase()&&"device"!=k.__type.toLowerCase()||(g=k.__type.toLowerCase());for(var e in k)"$"==e[0]&&delete k[e];k.__revision&&delete k.__revision;"object"==g&&(e=n._aclFactory.getChanged())&&(k.__acls=e);var h=new c.Appacitive._Request({method:"PUT",
...
this.destroy=function(b){b=b||{};var g=b.deleteConnections;_type.isBoolean(b)&&(g=b,b={});b.wait||E(b);if(!k.__id)return(new c.Appacitive.Promise.buildPromise(b)).fulfill();var e=this.type;!k.__type||"user"!=k.__type.toLowerCase()&&"device"!=k.__type.toLowerCase()||(e=k.__type.toLowerCase());var f=new c.Appacitive._Request({method:"DELETE",type:e,op:"getDeleteUrl",args:[this.className,k.__id,g],options:b,entity:this,onSuccess:function(c){f.promise.fulfill(c);c&&c.status?(b.wait&&E(b),f.promise.fulfill(c.status)):
(c=c||{},c.status=c.status||{},c.status=v(c.status),f.promise.reject(c.status,n))}});return f.send()};"object"==this.type&&(this.destroyWithConnections=function(b){return this.destroy(_extend({deleteConnections:!0},b))})};c.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())};c.Appacitive.Events.mixin(c.Appacitive.BaseObject.prototype)})(global);
(function(c){var e=function(){return Math.floor(65536*Math.random()).toString(16)};c.Appacitive.GUID=function(){var b=e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e(),c="",h,l,g,m,n,p,k=0,b=b.replace(/\r\n/g,"\n");l="";for(g=0;g<b.length;g++)m=b.charCodeAt(g),128>m?l+=String.fromCharCode(m):(127<m&&2048>m?l+=String.fromCharCode(m>>6|192):(l+=String.fromCharCode(m>>12|224),l+=String.fromCharCode(m>>6&63|128)),l+=String.fromCharCode(m&63|128));for(b=l;k<b.length;)h=b.charCodeAt(k++),l=b.charCodeAt(k++),
g=b.charCodeAt(k++),m=h>>2,h=(h&3)<<4|l>>4,n=(l&15)<<2|g>>6,p=g&63,isNaN(l)?n=p=64:isNaN(g)&&(p=64),c=c+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(m)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(n)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(p);return c.toString()}})(global);
...
m.typeName&&!m.isNew())&&(m=m.id());var l=g.filter(function(b){return b.sid==m&&b.type==h});l&&0!=l.length?l=l[0]:(l={sid:m,type:h,deny:[],allow:[]},g.push(l));l.allow||(l.allow=[]);l.deny||(l.deny=[]);k=f(k);var p=n.filter(function(b){return b.sid==m&&b.type==h});p&&0!=p.length?p=p[0]:(p={sid:m,type:h},n.push(p));k.forEach(function(c){for(var g=0;g<e.length;g+=1){var f=l[e[g]].indexOf(c);if(-1!=f){l[e[g]].splice(f,1);break}}"inherit"!=b&&l[b].push(c);p[c]=b});return this},k=function(b,c,g,e){if(!g)throw Error("Please provide valid id or name for setting acls");
if(!e)throw Error("Please provide valid access permissions for setting acls");_type.isArray(e)||(e=[e]);_type.isArray(g)?g.forEach(function(g){p(b,c,g,e)}):p(b,c,g,e);return this},q=function(){g.allowUser=function(b,c){return k.apply(this,["allow","user",b,c])};g.allowGroup=function(b,c){return k.apply(this,["allow","usergroup",b,c])};g.denyUser=function(b,c){return k.apply(this,["deny","user",b,c])};g.denyGroup=function(b,c){return k.apply(this,["deny","usergroup",b,c])};g.resetUser=function(b,c){return k.apply(this,
["inherit","user",b,c])};g.resetGroup=function(b,c){return k.apply(this,["inherit","usergroup",b,c])};g.allowAnonymous=function(b){return k.apply(this,["allow","usergroup",["anonymous"],b])};g.denyAnonymous=function(b){return k.apply(this,["deny","usergroup",["anonymous"],b])};g.resetAnonymous=function(b){return k.apply(this,["inherit","usergroup",["anonymous"],b])};g.allowLoggedIn=function(b){return k.apply(this,["allow","usergroup",["anonymous"],b])};g.denyLoggedIn=function(b){return k.apply(this,
["deny","usergroup",["anonymous"],b])};g.resetLoggedIn=function(b){return k.apply(this,["inherit","usergroup",["anonymous"],b])}};this._rollback=function(){n=[];g=JSON.parse(JSON.stringify(m));q();return this};this.getChanged=function(){var c=[];n.forEach(function(g){var f={sid:g.sid,type:g.type,allow:[],deny:[],inherit:[]};b.forEach(function(b){g[b]&&f[g[b]].push(b)});e.forEach(function(b){0==f[b].length&&delete f[b]});0==f.inherit.length&&delete f.inherit;c.push(f)});return 0==c.length?null:c};
...
op:"getUpdateUrl",args:[g],data:h,entity:this,options:f,onSuccess:function(b){k.promise.fulfill(b)}});return k.send()};this.addMembers=function(c,g,e){return b("add",c,g)};this.removeMembers=function(c,g,e){return b("remove",c,g)}}})(global);
(function(c){c.Appacitive.Object=function(b,e){b=b||{};e=e||{};this.className&&(b.__type=this.className);_type.isString(b)&&(b={__type:b});if(!b.__type)throw Error("Cannot set object without __type");_type.isBoolean(e)&&(e={setSnapShot:!0});c.Appacitive.BaseObject.call(this,b,e);this.type="object";this.getObject=this.getObject;this.children={};this.toJSON=function(b){if(b){var c=function(b){var g=[];b.forEach(function(b){var e=b.getObject();if(b.children&&!Object.isEmpty(b.children)){e.children={};
for(var f in b.children)e.children[f]=c(b.children[f])}b.connection&&(e.__connection=b.connection.toJSON());g.push(e)});return g};return c([this])[0]}return this.getObject()};this.typeName=b.__type;this._aclFactory=new Appacitive._Acl(e.__acls,e.setSnapShot);this.acls=this._aclFactory.acls;_type.isFunction(this.initialize)&&this.initialize.apply(this,[b]);return this};c.Appacitive.Object.prototype=new c.Appacitive.BaseObject;c.Appacitive.Object.prototype.constructor=c.Appacitive.Object;c.Appacitive.Object.extend=
...
this:g?g:b(c.__type))(c)).copy(c,e)};var f=function(b,e){var g=[];b.forEach(function(b){b=c.Appacitive.Object._create(b,!0,e);g.push(b)});return g};c.Appacitive.Object._parseResult=f;c.Appacitive.Object.multiDelete=function(b,e){b=b||{};e=e||{};var g=[];this.className&&(b.type=this.className);_type.isArray(b)&&0<b.length&&(g=b,b={type:g[0].className,ids:g.map(function(b){return b.id()}).filter(function(b){return b})});if(!b.type||!_type.isString(b.type)||0===b.type.length)throw Error("Specify valid type");
if("user"===b.type.toLowerCase()||"device"===b.type.toLowerCase())throw Error("Cannot delete user and devices using multidelete");if(!b.ids||0===b.ids.length)throw Error("Specify ids to delete");var f=new c.Appacitive._Request({method:"POST",data:{idlist:b.ids},type:"object",op:"getMultiDeleteUrl",args:[b.type],options:e,onSuccess:function(b){e&&!e.silent&&g.forEach(function(b){b.trigger("destroy",b,b.collection,e)});f.promise.fulfill()}});return f.send()};c.Appacitive.Object.multiGet=function(b,
