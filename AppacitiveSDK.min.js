...
url:c.url,headers:c.headers,data:c.data,onSuccess:function(d,e){if(d){try{d=JSON.parse(d)}catch(m){}var q=d;if(b.length!=f.length)throw Error("Callback length and state length mismatch!");for(var t=0;t<b.length;t+=1)b[t].apply({},[q,f[t]]);a.onResponse(d,c)}else a.onError(c,{code:"400",messgae:"Invalid request"})},onError:function(b){a.onError(c,b)}})};a.send=function(a,b,d){if(!global.Appacitive.Session.initialized)throw Error("Initialize Appacitive SDK");"function"==typeof a.beforeSend&&a.beforeSend(a);
...
if(2==arguments.length){if("string"!==typeof arguments[1]&&null!=arguments[1])throw Error("only string values can be stored in attributes.");a.__attributes||(a.__attributes={});a.__attributes[arguments[0]]=arguments[1]}else throw Error(".attr() called with an incorrect number of arguments. 0, 1, 2 are supported.");}return a.__attributes};var h=function(){var b=!1,d=JSON.parse(JSON.stringify(c.__attributes)),e;for(e in a.__attributes)"undefined"==typeof a.__attributes[e]||null===a.__attributes[e]?
(d[e]=null,b=!0):a.__attributes[e]!=c.__attributes[e]?(d[e]=a.__attributes[e],b=!0):a.__attributes[e]==c.__attributes[e]&&delete d[e];return b?d:null};this.getChangedAttributes=h;this.aggregates=function(){var b={},c;for(c in a){if(!a.hasOwnProperty(c))return;"$"==c[0]&&(b[c]=a[c])}if(0===arguments.length)return b;if(1==arguments.length)return b[arguments[0]];throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");};var n=[];a.__tags||(a.__tags=[]);c.__tags||
(c.__tags=[]);this.tags=function(){return a.__tags?a.__tags:[]};this.addTag=function(b){if(!b||"string"!=typeof b||!b.length)return this;a.__tags.push(b);a.__tags=Array.distinct(a.__tags);if(!n||!n.length)return this;b=n.indexOf(b);-1!=b&&n.splice(b,1);return this};this.removeTag=function(b){if(!b||"string"!=typeof b||!b.length)return this;n.push(b);n=Array.distinct(n);if(!a.__tags||!a.__tags.length)return this;b=a.__tags.indexOf(b);-1!=b&&a.__tags.splice(b,1);return this};var r=function(){var b=
[];a.__tags.every(function(a){-1==c.__tags.indexOf(a)&&b.push(a)});return b};this.getChangedTags=r;this.getRemovedTags=function(){return _removetags};var p=function(b){var d=!1,e=JSON.parse(JSON.stringify(c)),l;for(l in a)"undefined"==typeof a[l]||null===a[l]?(e[l]=null,d=!0):a[l]!=c[l]?"__tags"==l||"__attributes"==l?delete e[l]:(e[l]=a[l],d=!0):a[l]==c[l]&&delete e[l];try{m.forEach(function(a){e[a]&&delete e[a]})}catch(k){}b?(a.__tags&&0<a.__tags.length&&(e.__addtags=r(),d=!0),n&&0<n.length&&(e.__removetags=
n,d=!0)):a.__tags&&0<a.__tags.length&&(e.__tags=r(),d=!0);(b=h())?(e.__attributes=b,d=!0):delete e.__attributes;return d?e:!1};this.changed=function(){return p()};this.hasChanged=function(){var a=p(!0);return 0===arguments.length?Object.isEmpty(a)?!1:!0:1==arguments.length&&"string"==typeof arguments[0]&&0<arguments[0].length&&a&&a[arguments[0]]?!0:!1};this.changedAttributes=function(){var a=p(!0);if(0===arguments.length)return a;if(1==arguments.length&&"object"==typeof arguments[0]&&arguments[0].length){var b=
{};arguments[0].forEach(function(c){a[c]&&b.push(a[c])});return b}return!1};this.previous=function(){return 1==arguments.length&&"string"==typeof arguments[0]&&arguments[0].length?c[arguments[0]]:null};this.previousAttributes=function(){return c};var q="";this.fields=function(){if(1==arguments.length){var a=arguments[0];"string"==typeof a?q=a:"object"==typeof a&&a.length&&(q=a.join(","));return this}return q};var t={integer:function(a){if(a){var b=parseInt(a);if(!isNaN(b))return b}return a},decimal:function(a){if(a){var b=
parseFloat(a);if(!isNaN(b))return b}return a},"boolean":function(a){return"true"==a||!0==a||0<a?!0:!1},date:function(a){if(a){var b=Appacitive.Date.parseISODate(a);if(b)return b}return a},datetime:function(a){if(a){var b=Appacitive.Date.parseISODate(a);if(b)return b}return a},time:function(a){if(a){var b=Appacitive.Date.parseISOTime(a);if(b)return b}return a},string:function(a){return a?a.toSting():a}};this.get=function(b,c){if(b)return c&&t[c.toLowerCase()]?t[c.toLowerCase()](a[b]):a[b]};this.tryGet=
function(a,b,c){a=this.get(a,c);return void 0!=a?a:b};this.set=function(b,c){if(!b||"string"!=typeof b||0==b.length||0==b.trim().indexOf("$"))return this;null==c||"undefined"==c?a[b]=null:"string"==typeof c?a[b]=c:"number"==typeof c||"boolean"==typeof c?a[b]=c+"":"object"==typeof c&&(0<=c.length?a[b]=c:-1!==k.indexOf(b)&&(a[b]=c));return this};this.unset=function(b){if(!b||"string"!=typeof b||0==b.length||0==b.indexOf("__"))return this;try{delete a[b]}catch(c){}return this};this.has=function(b){return b&&
"string"==typeof b&&0!=b.length?a[b]&&"undefined"!=typeof a[b]?!0:!1:!1};this.isNew=function(){return a.__id&&a.__id.length?!1:!0};this.clone=function(){return"article"==this.type?new b.Appacitive.Article(this.toJSON()):new b.Appacitive.connection(a)};this.copy=function(b,e){b&&(d(b,a),e&&d(b,c));return this};this.save=function(b,c){a.__id?u.apply(this,arguments):v.apply(this,arguments);return this};var v=function(e,k){e=e||function(){};k=k||function(){};var h=this,g=b.Appacitive.config.apiBaseUrl+
b.Appacitive.storage.urlFactory[this.type].getCreateUrl(a.__schematype||a.__relationtype,q);!a.__schematype||"user"!=a.__schematype.toLowerCase()&&"device"!=a.__schematype.toLowerCase()||(g=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[a.__schematype.toLowerCase()].getCreateUrl());var f=new b.Appacitive.HttpRequest;f.url=g;f.method="put";a.__revision&&delete a.__revision;f.data=a;f.onSuccess=function(g){var f=null;g&&(g.article||g.connection||g.user||g.device)&&(f=g.article||g.connection||
g.user||g.device);g&&f?(c=f,a.__id=f.__id,d(f,a),h.connectionCollections&&0<h.connectionCollections.length&&h.connectionCollections.forEach(function(b){b.getQuery().extendOptions({articleId:a.__id})}),"connection"==h.type&&h.parseConnection(),b.Appacitive.eventManager.fire((h.schema||h.relation)+"."+h.type+".created",h,{object:h}),"function"==typeof e&&e(h)):(g=g||{},g.status=g.status||{},g.status=l(g.status),b.Appacitive.eventManager.fire((h.schema||h.relation)+"."+h.type+".createFailed",h,{error:g.status}),
"function"==typeof k&&k(g.status,h))};f.onError=function(a){a=l(a);"function"==typeof k&&k(a,h)};b.Appacitive.http.send(f);return this},u=function(e,g){e=e||function(){};g=g||function(){};var h=p(!0),k=this;if(h){var f=new b.Appacitive.HttpRequest,m=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[this.type].getUpdateUrl(a.__schematype||a.__relationtype,c.__id?c.__id:a.__id,q);a&&(a.__schematype&&("user"==a.__schematype.toLowerCase()||"device"==a.__schematype.toLowerCase()))&&(m=b.Appacitive.config.apiBaseUrl+
b.Appacitive.storage.urlFactory[a.__schematype.toLowerCase()].getUpdateUrl(c.__id));f.url=m;f.method="post";f.data=h;f.onSuccess=function(h){h&&(h.article||h.connection||h.user||h.device)?(c=h.article||h.connection||h.user||h.device,d(c,a),n=[],b.Appacitive.eventManager.fire((k.schema||k.relation)+"."+k.type+"."+a.__id+".updated",k,{object:k}),"function"==typeof e&&e(k)):(h=h||{},h.status=h.status||{},h.status=l(h.status),b.Appacitive.eventManager.fire((k.schema||k.relation)+"."+k.type+"."+a.__id+
".updateFailed",k,{object:h.status}),"function"==typeof g&&g(h.status,k))};f.onError=function(a){a=a||{};a.message=a.message||"Server error";a.code=a.code||"500";"function"==typeof g&&g(a,k)};b.Appacitive.http.send(f)}else"function"==typeof e&&e(k);return this};this.fetch=function(e,h){e=e||function(){};h=h||function(){};if(a.__id){var g=this,k=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[this.type].getGetUrl(a.__schematype||a.__relationtype,a.__id,q),f=new b.Appacitive.HttpRequest;
f.url=k;f.method="get";f.onSuccess=function(b){b&&(b.article||b.connection||b.user||b.device)?(c=b.article||b.connection||b.user||b.device,d(c,a),g.___collection&&"article"==g.___collection.collectionType&&g.___collection.addToCollection(g),"function"==typeof e&&e(g)):(b=b||{},b.status=b.status||{},b.status=l(b),"function"==typeof h&&h(b.status,g))};f.onError=function(a){a=l(a);"function"==typeof h&&h(a,g)};b.Appacitive.http.send(f);return this}"function"==typeof h&&h({code:"400",message:"Please specify id for get operation"},
this)};this.del=function(c,d,e){if(a.__id){c=c||function(){};d=d||function(){};var h=this,k=b.Appacitive.config.apiBaseUrl,k=k+b.Appacitive.storage.urlFactory[this.type].getDeleteUrl(a.__schematype||a.__relationtype,a.__id);a&&(a.__schematype&&("user"==a.__schematype.toLowerCase()||"device"==a.__schematype.toLowerCase()))&&(k=b.Appacitive.config.apiBaseUrl,k+=b.Appacitive.storage.urlFactory[a.__schematype.toLowerCase()].getDeleteUrl(a.__id));e&&!0===e&&(k=-1==k.indexOf("?")?k+"?deleteconnections=true":
k+"&deleteconnections=true");e=new b.Appacitive.HttpRequest;e.url=k;e.method="delete";e.onSuccess=function(b){"200"==b.code?(h.___collection&&h.___collection.removeById(a.__id),"function"==typeof c&&c(b)):(b=l(b),"function"==typeof d&&d(b,h))};e.onError=function(a){a=l(a);"function"==typeof d&&d(a,h)};b.Appacitive.http.send(e)}else this.___collection&&this.___collection.removeByCId(g),"function"==typeof c&&c(this)}};b.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())}})(global);
