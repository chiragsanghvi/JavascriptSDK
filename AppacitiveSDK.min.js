...
null;c.Appacitive.Session.removeUserAuthHeader();f.fulfill()},function(){f.reject.apply(f,arguments)});return f};e.createNewUser=function(b,e){b=b||{};b.__type="user";if(!b.username||!b.password||!b.firstname||0===b.username.length||0===b.password.length||0===b.firstname.length)throw Error("username, password and firstname are mandatory");return(new c.Appacitive.User(b)).save(e)};e.createUser=e.createNewUser;e.signup=function(b,e){var f=this,h=c.Appacitive.Promise.buildPromise(e);this.createUser(b).then(function(){f.login(b.username,
