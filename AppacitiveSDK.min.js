...
this)}else g.reject(this.responseText,this)};q.open(e.method,e.url,!0);for(var r=0;r<e.headers.length;r+=1)q.setRequestHeader(e.headers[r].key,e.headers[r].value);global.Appacitive.runtime.isBrowser||q.setRequestHeader("User-Agent","Appacitive-NodeJSSDK");q.send(c);return g}e.data=c;return new h(e)},g=function(){var b=new f;b.isOnline=function(){return!0};var c=function(c,g,h){new e({method:c.method,url:c.url,headers:c.headers,data:c.data,onSuccess:function(e,k){if(e){try{e=JSON.parse(e)}catch(f){}var t=
e;if(g.length!=h.length)throw Error("Callback length and state length mismatch!");for(var v=0;v<g.length;v+=1)g[v].apply({},[t,h[v]]);if("200"<=e.code&&"300">=e.code||e.status&&"200"<=e.status.code&&"300">=e.status.code)b.onResponse(c,e);else e=e||{},e=e.status||e,e.message=e.message||"Bad Request",e.code=e.code||"400",b.onError(c,{responseText:JSON.stringify(e)})}else b.onError(c,{responseText:JSON.stringify({code:"400",message:"Invalid request"})})},onError:function(e){b.onError(c,e)}})};b.send=
function(b,e,g){if(!global.Appacitive.Session.initialized)throw Error("Initialize Appacitive SDK");_type.isFunction(b.beforeSend)&&b.beforeSend(b);c(b,e,g)};return b};global.Appacitive.http=new function(){var b=new g,e=new c(b),h=!1;this.pause=function(){h=!0};this.unpause=function(){h=!1};this.addProcessor=function(b){var c=Error('Must provide a processor object with either a "pre" function or a "post" function.');if(!b)throw c;if(!b.pre&&!b.post)throw c;e.addProcessor(b)};this.send=function(c){c.promise=
global.Appacitive.Promise.is(c.promise)?c.promise:new global.Appacitive.Promise.buildPromise({error:c.onError});e.enqueueRequest(c);b.isOnline()&&!1===h&&e.notify();return c.promise};this.flush=function(c){c?e.notify():b.isOnline()&&e.notify()};this.onError=function(b,e){var c;if(e&&e.responseText)try{var g=JSON.parse(e.responseText);g&&(c={code:g.code,error:g.message})}catch(h){}c=c||{code:e.status,message:e.responseText};global.Appacitive.logs.logRequest(b,c,c,"error");b.promise.reject(c,b.entity)};
b.onError=this.onError;this.onResponse=function(b,e){if(b.onSuccess)if(b.context)b.onSuccess.apply(b.context,[e]);else b.onSuccess(e);global.Appacitive.logs.logRequest(b,e,e?e.status:null,"successful")};b.onResponse=this.onResponse};global.Appacitive.HttpRequest=function(b){b=b||{};this.url=b.url||"";this.data=b.data||{};this.headers=b.headers||[];this.method=b.method||"GET";this.onSuccess=b.onSuccess||function(){};this.onError=b.onError||function(){};this.send=function(b){return new e(this,b)}};
(function(b){b.Appacitive&&b.Appacitive.http&&(b.Appacitive.http.addProcessor({pre:function(b){return b},post:function(e,c){try{var g=b.Appacitive.Session.isSessionValid(e);g.status?e&&(e.status&&e.status.code&&"19036"==e.status.code||e.code&&"19036"==e.code)?b.Appacitive.Users.logout():b.Appacitive.Session.incrementExpiry():g.isSession&&(null!==b.Appacitive.Session.get()&&b.Appacitive.Session.resetSession(),b.Appacitive.http.send(c))}catch(h){}}}),b.Appacitive.http.addProcessor({pre:function(b){return{start:(new Date).getTime(),
request:b}},post:function(b,e){e.request.timeTakenInMilliseconds=(new Date).getTime()-e.start}}))})(global)})(this);
...
b.returnEdge||b.returnEdge||this.prev)||(this.returnEdge=!1);this.label="";var f=this;_type.isString(b.label)&&0<b.label.length&&(this.label="&label="+b.label);this.toRequest=function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+"connection/"+this.relation+"/"+this.type+"/"+this.objectId+"/find?"+this.getQueryString()+this.label+"&returnEdge="+this.returnEdge};var k=function(b,e){var g=[];b.forEach(function(b){var f=
null;if(b.__edge){f=b.__edge;delete b.__edge;f.__endpointa=e;f.__endpointb={objectid:b.__id,label:f.__label,type:b.__type};delete f.label;var h=new c.Appacitive.Connection(f,!0),f=new c.Appacitive.Object(b,!0);f.connection=h}else f=new c.Appacitive.Object(b,!0);g.push(f)});f.object&&(f.object.children[f.relation]=g);return g};this.fetch=function(h){var m=c.Appacitive.Promise.buildPromise(h);h=this.toRequest();h.onSuccess=function(c){var h=k;f.prev&&(h=prevParseNodes);f.results=h(c.nodes?c.nodes:[],
{objectid:b.objectId,type:g,label:c.parent});f._setPaging(c.paginginfo);m.fulfill(f.results,c.paginginfo)};h.promise=m;h.entity=this;return c.Appacitive.http.send(h)};return this};c.Appacitive.Queries.ConnectedObjectsQuery.prototype=new h;c.Appacitive.Queries.ConnectedObjectsQuery.prototype.constructor=c.Appacitive.Queries.ConnectedObjectsQuery;c.Appacitive.Queries.GetConnectionsQuery=function(b){b=b||{};if(!b.relation)throw Error("Specify relation for GetConnectionsQuery query");if(!b.objectId)throw Error("Specify objectId for GetConnectionsQuery query");
if(!b.label||0===b.label.trim().length)throw Error("Specify label for GetConnectionsQuery query");b.type&&delete b.type;b.queryType="GetConnectionsQuery";h.call(this,b);this.objectId=b.objectId;this.relation=b.relation;this.label=b.label;this.toRequest=function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+"connection/"+this.relation+"/find/all?"+this.getQueryString()+"&objectid="+this.objectId+"&label="+
this.label};return this};c.Appacitive.Queries.GetConnectionsQuery.prototype=new h;c.Appacitive.Queries.GetConnectionsQuery.prototype.constructor=c.Appacitive.Queries.GetConnectionsQuery;c.Appacitive.Queries.GetConnectionsBetweenObjectsQuery=function(b,g){b=b||{};if(!b.objectAId||!_type.isString(b.objectAId)||0===b.objectAId.length)throw Error("Specify valid objectAId for GetConnectionsBetweenObjectsQuery query");if(!b.objectBId||!_type.isString(b.objectBId)||0===b.objectBId.length)throw Error("Specify objectBId for GetConnectionsBetweenObjectsQuery query");
b.type&&delete b.type;b.queryType=g||"GetConnectionsBetweenObjectsQuery";h.call(this,b);this.objectAId=b.objectAId;this.objectBId=b.objectBId;this.label="GetConnectionsBetweenObjectsForRelationQuery"===this.queryType()&&b.label&&_type.isString(b.label)&&0<b.label.length?"&label="+b.label:"";this.relation=b.relation&&_type.isString(b.relation)&&0<b.relation.length?b.relation+"/":"";this.toRequest=function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+
"connection/"+this.relation+"find/"+this.objectAId+"/"+this.objectBId+"?"+this.getQueryString()+this.label};return this};c.Appacitive.Queries.GetConnectionsBetweenObjectsQuery.prototype=new h;c.Appacitive.Queries.GetConnectionsBetweenObjectsQuery.prototype.constructor=c.Appacitive.Queries.GetConnectionsBetweenObjectsQuery;c.Appacitive.Queries.GetConnectionsBetweenObjectsForRelationQuery=function(b){b=b||{};if(!b.relation)throw Error("Specify relation for GetConnectionsBetweenObjectsForRelationQuery query");
b=new c.Appacitive.Queries.GetConnectionsBetweenObjectsQuery(b,"GetConnectionsBetweenObjectsForRelationQuery");b.fetch=function(b){var e=c.Appacitive.Promise.buildPromise(b);b=this.toRequest();b.onSuccess=function(b){e.fulfill(b.connection?new c.Appacitive.Connection(b.connection,!0):null)};b.promise=e;b.entity=this;return c.Appacitive.http.send(b)};return b};c.Appacitive.Queries.InterconnectsQuery=function(b){b=b||{};if(!b.objectAId||!_type.isString(b.objectAId)||0===b.objectAId.length)throw Error("Specify valid objectAId for InterconnectsQuery query");
if(!(b.objectBIds&&_type.isArray(b.objectBIds)&&0<b.objectBIds.length))throw Error("Specify list of objectBIds for InterconnectsQuery query");b.type&&delete b.type;b.queryType="InterconnectsQuery";h.call(this,b);this.objectAId=b.objectAId;this.objectBIds=b.objectBIds;this.toRequest=function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();b.method="post";b.data={object1id:this.objectAId,object2ids:this.objectBIds};return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+"connection/interconnects?"+
this.getQueryString()};return this};c.Appacitive.Queries.InterconnectsQuery.prototype=new h;c.Appacitive.Queries.InterconnectsQuery.prototype.constructor=c.Appacitive.Queries.InterconnectsQuery;c.Appacitive.Queries.GraphFilterQuery=function(b,g){if(!b||0===b.length)throw Error("Specify name of filter query");this.name=b;this.data={};this.queryType="GraphFilterQuery";if(g){this.data.placeholders=g;for(var f in this.data.placeholders)this.data.placeholders[f]=this.data.placeholders[f]}this.toRequest=
function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();b.method="post";b.data=this.data;return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+"search/"+this.name+"/filter"};this.fetch=function(b){var e=c.Appacitive.Promise.buildPromise(b);b=this.toRequest();b.onSuccess=function(b){e.fulfill(b.ids?b.ids:[])};b.promise=e;b.entity=this;return c.Appacitive.http.send(b)}};c.Appacitive.Queries.GraphProjectQuery=function(b,g,f){if(!b||0===b.length)throw Error("Specify name of project query");
if(!g||!g.length)throw Error("Specify ids to project");this.name=b;this.data={ids:g};this.queryType="GraphProjectQuery";if(f){this.data.placeholders=f;for(var h in this.data.placeholders)this.data.placeholders[h]=this.data.placeholders[h]}this.toRequest=function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();b.method="post";b.data=this.data;return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+"search/"+this.name+"/project"};var p=function(b){var e,g;for(g in b)if("status"!==
g){e=b[g];break}var f=function(b,e,g){var h=[];b.forEach(function(b){var k=b.__children;delete b.__children;var l=b.__edge;delete b.__edge;b=new c.Appacitive.Object(b,!0);b.children={};for(var p in k)b.children[p]=[],b.children[p]=f(k[p].values,k[p].parent,b.id);l&&(l.__endpointa={objectid:g,label:e},l.__endpointb={objectid:b.id(),label:l.__label},delete l.__label,b.connection=new c.Appacitive.Connection(l,!0));h.push(b)});return h};return f(e.values)};this.fetch=function(b){var e=c.Appacitive.Promise.buildPromise(b);
b=this.toRequest();b.onSuccess=function(b){e.fulfill(p(b))};b.promise=e;b.entity=this;return c.Appacitive.http.send(b)}}})(global);
