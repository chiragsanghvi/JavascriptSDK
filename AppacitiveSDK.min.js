...
a.data=this.data;return a};this.toUrl=function(){return b.Appacitive.config.apiBaseUrl+"search/"+this.name+"/project"};var f=function(a){var c,d;for(d in a)if("status"!==d){c=a[d];break}var e=function(a,c,d){var g=[];a.forEach(function(a){var l=a.__children;delete a.__children;var k=a.__edge;delete a.__edge;a=new b.Appacitive.Article(a,!0);a.children={};for(var h in l)a.children[h]=[],a.children[h]=e(l[h].values,l[h].parent,a.id);k&&(k.__endpointa={articleid:d,label:c},k.__endpointb={articleid:a.id,
label:k.label},delete k.label,a.connection=new b.Appacitive.Connection(k));g.push(a)});return g};return e(c.values)};this.fetch=function(a,c){var d=this.toRequest();d.onSuccess=function(b){b&&b.status&&"200"==b.status.code?"function"==typeof a&&a(f(b)):(b=b||{},"function"==typeof c&&c(b.status||{message:"Server error",code:400}))};d.onError=function(a){a=a||{};"function"==typeof c&&c(a.status||{message:"Server error",code:400})};b.Appacitive.http.send(d);return this}}})(global);
