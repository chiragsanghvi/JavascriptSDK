...
(function(a){if(!a.Appacitive.runtime.isBrowser)var f=function(){this.setCookie=function(f,c){a.Appacitive.localStorage.set("cookie/"+f,c)};this.readCookie=function(f){return a.Appacitive.localStorage.get("cookie/"+f)};this.eraseCookie=function(f){a.Appacitive.localStorage.remove("cookie/"+f)}};a.Appacitive.Cookie=new f})(global);"undefined"===typeof module||global.Appacitive.runtime.isBrowser||(module.exports=global.Appacitive);
