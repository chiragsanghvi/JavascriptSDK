...
(c=arguments[0],this):c};this.isAscending=function(){return 1===arguments.length?(f=void 0===arguments[0]||null==arguments[0]?!1:arguments[0],this):f};this.orderBy(b.orderBy);this.isAscending(b.isAscending)};b.prototype.toString=function(){return this.orderBy()&&0<this.orderBy().length?"orderBy="+this.orderBy()+"&isAsc="+this.isAscending():""};var h=function(e){var g=e||{},h="",k="",p="",m=g.queryType||"BasicQuery",n=new f(e),q=new b(e),r=g.schema||g.relation,u=g.relation?"connection":"article",t=
this;this.type=function(){return u};this.entityType=function(){return r};this.queryType=function(){return m};this.pageQuery=function(){return n};this.pageNumber=function(){return 1===arguments.length?(n.pageNumber(arguments[0]),this):n.pageNumber()};this.pageSize=function(){return 1===arguments.length?(n.pageSize(arguments[0]),this):n.pageSize()};this.sortQuery=function(){return q};this.orderBy=function(){return 1===arguments.length?(q.orderBy(arguments[0]),this):q.orderBy()};this.isAscending=function(){return 1===
...
b||{};b=b.paginginfo;var c=0,c=b?b.totalrecords:0;e.fulfill(c)};b.promise=e;b.entity=this;return c.Appacitive.http.send(b)}};c.Appacitive.Queries.FindAllQuery=function(b){b=b||{};if(!b.schema&&!b.relation||b.schema&&b.relation)throw Error("Specify either schema or relation for basic filter query");b.queryType="BasicFilterQuery";h.call(this,b);return this};c.Appacitive.Queries.FindAllQuery.prototype=new h;c.Appacitive.Queries.FindAllQuery.prototype.constructor=c.Appacitive.Queries.FindAllQuery;c.Appacitive.Queries.ConnectedArticlesQuery=
...
b[g]},g=this,l={};e(f,l);var k=l;b&&e(k,h);!h.__id&&l.__id&&(h.__id=l.__id);l.__schematype?(l.__schematype=l.__schematype.toLowerCase(),this.schema=this.entityType=l.__schematype,this.type="user"==l.__schematype||"device"==l.__schematype?l.__schematype:"article"):l.__relationtype&&(l.__relationtype=l.__relationtype.toLowerCase(),this.relation=this.entityType=l.__relationtype,this.type="connection");this.cid=parseInt(1E6*Math.random(),10);k.__attributes||(k.__attributes={});h.__attributes||(h.__attributes=
{});var p=[],m=[];k.__tags||(k.__tags=[]);h.__tags||(h.__tags=[]);var n="",q="__id __revision __endpointa __endpointb __createdby __lastmodifiedby __schematype __relationtype __schemaid __relationid __utcdatecreated __utclastupdateddate __tags __authType __link".split(" "),r=["__link","__endpointa","__endpointb"],u=function(b){b=b||{};b.message=b.message||"Server error";b.code=b.code||"500";return b};this.attributes=this.toJSON=this.getObject=function(){return JSON.parse(JSON.stringify(k))};this.properties=
...
k.__attributes||(k.__attributes={});k.__attributes[arguments[0]]=arguments[1]}else throw Error(".attr() called with an incorrect number of arguments. 0, 1, 2 are supported.");}return k.__attributes};var t=function(){if(!k.__attributes)return null;if(!h.__attributes)return k.__attributes;var b=!1,c=JSON.parse(JSON.stringify(h.__attributes)),e;for(e in k.__attributes)null==k.__attributes[e]||void 0==k.__attributes[e]?(c[e]=null,b=!0):k.__attributes[e]!=h.__attributes[e]?(c[e]=k.__attributes[e],b=!0):
k.__attributes[e]==h.__attributes[e]&&delete c[e];return b?c:null};this.getChangedAttributes=t;this.aggregate=function(){var b={},c;for(c in k){if(!k.hasOwnProperty(c))return;"$"==c[0]&&(b[c.substring(1)]=k[c])}if(0===arguments.length)return b;if(1==arguments.length)return b[arguments[0]];throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");};this.tags=function(){return k.__tags?k.__tags:[]};this.addTag=function(b){if(!b||!_type.isString(b)||!b.length)return this;
k.__tags||(k.__tags=[]);k.__tags.push(b);k.__tags=Array.distinct(k.__tags);if(!m||!m.length)return this;b=m.indexOf(b);-1!=b&&m.splice(b,1);return this};this.removeTag=function(b){if(!b||!_type.isString(b)||!b.length)return this;m.push(b);m=Array.distinct(m);if(!k.__tags||!k.__tags.length)return this;b=k.__tags.indexOf(b);-1!=b&&k.__tags.splice(b,1);return this};var v=function(){if(!k.__tags)return[];if(!h.__tags)return k.__tags;var b=[];k.__tags.forEach(function(c){-1==h.__tags.indexOf(c)&&b.push(c)});
return 0<b.length?b:null};this.getChangedTags=v;this.getRemovedTags=function(){return _removetags};var x=function(b){var c=!1,e=JSON.parse(JSON.stringify(h)),g;for(g in k)null==k[g]||void 0==k[g]?(e[g]=null,c=!0):k[g]!=h[g]?"__tags"==g||"__attributes"==g?delete e[g]:(e[g]=k[g],c=!0):k[g]==h[g]&&delete e[g];try{q.forEach(function(b){e[b]&&delete e[b]})}catch(f){}g=v();b?(g&&(e.__addtags=g,c=!0),m&&0<m.length&&(e.__removetags=m,c=!0)):g&&(e.__addtags=g,c=!0);(b=t())?(e.__attributes=b,c=!0):delete e.__attributes;
for(var l in e)"$"==l[0]&&delete e[l];return c&&!Object.isEmpty(e)?e:!1};this.changed=function(){return x()};this.hasChanged=function(){var b=x(!0);return 0===arguments.length?Object.isEmpty(b)?!1:!0:1==arguments.length&&_type.isString(arguments[0])&&0<arguments[0].length&&b&&b[arguments[0]]?!0:!1};this.changedAttributes=function(){var b=x(!0);if(0===arguments.length)return b;if(1==arguments.length&&_type.isArray(arguments[0])&&arguments[0].length){var c={};arguments[0].forEach(function(e){b[e]&&
c.push(b[e])});return c}return!1};this.previous=function(){return 1==arguments.length&&_type.isString(arguments[0])&&arguments[0].length?h[arguments[0]]:null};this.previousAttributes=function(){return h};this.fields=function(){if(1==arguments.length){var b=arguments[0];_type.isString(b)?n=b:_type.isArray(b)&&(n=b.join(","));return this}return n};var w={integer:function(b){if(b){var c=parseInt(b);if(!isNaN(c))return c}return b},decimal:function(b){if(b){var c=parseFloat(b);if(!isNaN(c))return c}return b},
"boolean":function(b){return void 0!==b&&null!==b&&("true"===b.toString().toLowerCase()||!0===b||0<b)?!0:!1},date:function(b){if(b){var e=c.Appacitive.Date.parseISODate(b);if(e)return e}return b},datetime:function(b){if(b){var e=c.Appacitive.Date.parseISODate(b);if(e)return e}return b},time:function(b){if(b){var e=c.Appacitive.Date.parseISOTime(b);if(e)return e}return b},string:function(b){return b?b.toString():b},geocode:function(b){if(!_type.isString(b)||0==b.trim().length)return!1;b=b.split(",");
return 2!==b.length?!1:new c.Appacitive.GeoCoord(b[0],b[1])}};this.get=function(b,c){if(b){if(c&&w[c.toLowerCase()]){if(w[c.toLowerCase()])return w[c.toLowerCase()](k[b]);throw Error('Invalid cast-type "'+c+'"" provided for get "'+b+'"');}return k[b]}};this.tryGet=function(b,c,e){b=this.get(b,e);return void 0!==b?b:c};this.set=function(b,e){if(!b||!_type.isString(b)||0===b.length||0===b.trim().indexOf("$"))return this;if(void 0==e||null==e)k[b]=null;else if(_type.isString(e))k[b]=e;else if(_type.isNumber(e)||
_type.isBoolean(e))k[b]=e+"";else if(e instanceof Date)k[b]=c.Appacitive.Date.toISOString(e);else if(_type.isObject(e))if(-1!==r.indexOf(b))k[b]=e;else if(e instanceof c.Appacitive.GeoCoord)k[b]=e.toString();else throw Error("Property cannot have value as an object");else _type.isArray(e)&&(k[b]=[],e.forEach(function(e){if(_type.isString(e))k[b].push(e);else if(_type.isNumber(e)||_type.isBoolean(e))k[b].push(e+"");else if(e instanceof Date)k[b].push(c.Appacitive.Date.toISOString(e));else throw Error("Multivalued property cannot have values of property as an object");
}),"tags"!==b||"__link"!==b)&&(k[b].push=function(b){var e=this.length;if(_type.isString(b))this[e]=b;else if(_type.isNumber(b)||_type.isBoolean(b))this[e]=b+"";else if(b instanceof Date)this[e]=c.Appacitive.Date.toISOString(b);else throw Error("Multivalued property cannot have values of property as an object");return this});return this};this.unset=function(b){if(!b||!_type.isString(b)||0===b.length||0===b.indexOf("__"))return this;try{delete k[b]}catch(c){}return this};this.has=function(b){return b&&
_type.isString(b)&&0!==b.length?k[b]&&!_type.isUndefined(k[b])?!0:!1:!1};this.isNew=function(){return k.__id&&k.__id.length?!1:!0};this.clone=function(){return"article"==this.type?new c.Appacitive.Article(this.toJSON()):new c.Appacitive.connection(k)};this.copy=function(b,c){b&&(e(b,k),c&&e(b,h));return this};this.mergeWithPrevious=function(){e(k,h);m=[];p.length=0;return this};var y=function(){e(h,k);m=[];p.length=0};this.rollback=function(){k=l={};y();return this};var A=function(b,c,e){if(!b||!_type.isString(b)||
0===b.length||0===b.indexOf("__"))return this;c=!c||isNaN(parseInt(c))?e:parseInt(c)*e;p.push({key:b.toLowerCase(),amount:c});return g};this.increment=function(b,c){return A(b,c,1)};this.decrement=function(b,c){return A(b,c,-1)};this.save=function(){return k.__id?z.apply(this,arguments):B.apply(this,arguments)};var B=function(b){var e=g.type;!k.__schematype||"user"!=k.__schematype.toLowerCase()&&"device"!=k.__schematype.toLowerCase()||(e=k.__schematype.toLowerCase());for(var f in k)"$"==f[0]&&delete k[f];
k.__revision&&delete k.__revision;var l=new c.Appacitive._Request({method:"PUT",type:e,op:"getCreateUrl",args:[k.__schematype||k.__relationtype,n],data:k,callbacks:b,entity:g,onSuccess:function(b){var e=null;b&&(b.article||b.connection||b.user||b.device)&&(e=b.article||b.connection||b.user||b.device);b&&e?(h=e,k.__id=e.__id,y(),"connection"==g.type&&g.parseConnection(),c.Appacitive.eventManager.fire((g.schema||g.relation)+"."+g.type+".created",g,{object:g}),g.created=!0,l.promise.fulfill(g)):(c.Appacitive.eventManager.fire((g.schema||
g.relation)+"."+g.type+".createFailed",g,{error:b.status}),l.promise.reject(b.status,g))}});return l.send()},z=function(b,e){c.Appacitive.Promise.is(e)||(e=c.Appacitive.Promise.buildPromise(b));var f=function(f){var l=x(!0),m;for(m in l)"$"==m[0]&&delete l[m];if(Object.isEmpty(l))e.fulfill(g);else{m=n;var q=new c.Appacitive.HttpRequest,r=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory[g.type].getUpdateUrl(k.__schematype||k.__relationtype,h.__id?h.__id:k.__id,m,f),t=g.type;k&&(k.__schematype&&
("user"==k.__schematype.toLowerCase()||"device"==k.__schematype.toLowerCase()))&&(t=k.__schematype.toLowerCase(),r=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory[k.__schematype.toLowerCase()].getUpdateUrl(h.__id,m,f));q.url=r;q.method="post";q.data=l;q.onSuccess=function(f){f&&f[t]?(h=f[t],y(),delete g.created,c.Appacitive.eventManager.fire((g.schema||g.relation)+"."+t+"."+k.__id+".updated",g,{object:g}),e.fulfill(g)):"14008"==f.status.code&&0<p.length?z(b,e):(c.Appacitive.eventManager.fire((g.schema||
g.relation)+"."+t+"."+k.__id+".updateFailed",g,{object:f.status}),e.reject(f.status,g))};q.onError=function(c){c=u(c);"14008"==c.code&&0<p.length?z(b,e):e.reject(c,g)};c.Appacitive.http.send(q)}};if(0<p.length){var l=["__revision"];p.forEach(function(b){l.push(b.key)});c.Appacitive.Article.get({schema:this.get("__schematype"),id:this.id(),fields:l}).then(function(b){b=b.toJSON();p.forEach(function(c){var e=w.integer(b[c.key]);e||(e=0);g.set(c.key,e+c.amount)});f(b.__revision)},function(b){e.reject(b)})}else f();
return e},C=function(b){if(!k.__id)throw Error("Please specify id for get operation");var f=this.type;k&&(k.__schematype&&("user"==k.__schematype.toLowerCase()||"device"==k.__schematype.toLowerCase()))&&(f=k.__schematype.toLowerCase());var l=new c.Appacitive._Request({method:"GET",type:f,op:"getGetUrl",args:[k.__schematype||k.__relationtype,k.__id,n],callbacks:b,entity:g,onSuccess:function(b){b&&b[f]?(h=b[f],e(h,k),b.connection&&(g.endpoints||g.endpointA&&g.endpointB||g.setupConnection(k.__endpointa,
k.__endpointb)),l.promise.fulfill(g)):(b=b||{},b.status=b.status||{},b.status=u(b.status),l.promise.reject(b.status,g))}});return l.send()};this.fetch=function(b){return C.apply(this,[b])};this.del=this.destroy=function(b,e){_type.isBoolean(b)?(e=b,b=null):_type.isBoolean(e)||(e=!1);if(!k.__id)return(new c.Appacitive.Promise.buildPromise(b)).fulfill();var g=this.type;!k.__schematype||"user"!=k.__schematype.toLowerCase()&&"device"!=k.__schematype.toLowerCase()||(g=k.__schematype.toLowerCase());var f=
new c.Appacitive._Request({method:"DELETE",type:g,op:"getDeleteUrl",args:[k.__schematype||k.__relationtype,k.__id,e],callbacks:b,entity:this,onSuccess:function(b){f.promise.fulfill(b)}});return f.send()}};c.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())}})(global);
