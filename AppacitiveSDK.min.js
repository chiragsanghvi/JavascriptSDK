...
typeof e&&e(a,b)});return this};this.count=function(a,b){this.query.count(a,b);return this};this.fetchByPageNumber=function(a,b,e){c.pageNumber(e);this.fetch(a,b);return this};this.fetchNextPage=function(a,b){c.pageNumber(++c.pageNumber);this.fetch(a,b);return this};this.fetchPreviousPage=function(a,b){var e=c.pageNumber(),e=e-1;0>=e&&(e=1);c.pageNumber(e);this.fetch(a,b);return this};this.createNewArticle=function(c){c=c||{};c.__schematype=g;c=new a.Appacitive.Article(c);c.___collection=b;d.push(c);
...
c){k(b,c,a)},function(a){"function"==typeof b&&b(a,m)});return this};this.count=function(a,b){c.count(a,b);return this};this.fetchByPageNumber=function(a,b,e){c.pageNumber(e);this.fetch(a,b);return this};this.fetchNextPage=function(a,b){c.pageNumber(++c.pageNumber);this.fetch(a,b);return this};this.fetchPreviousPage=function(a,b){var e=c.pageNumber(),e=e-1;0>=e&&(e=1);c.pageNumber(e);this.fetch(a,b);return this};this.createNewConnection=function(b){b=b||{};b.__relationtype=g;b=new a.Appacitive.Connection(b);
