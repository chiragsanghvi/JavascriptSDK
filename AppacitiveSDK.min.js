...
0==b.length||0==b.trim().indexOf("$"))return this;null==c||"undefined"==c?a[b]=null:"string"==typeof c?a[b]=c:"number"==typeof c?a[b]=c+"":"object"==typeof c&&(0<=c.length?a[b]=c:-1!==k.indexOf(b)&&(a[b]=c));return this};this.unset=function(b){if(!b||"string"!=typeof b||0==b.length||0==b.indexOf("__"))return this;try{delete a[b]}catch(c){}return this};this.has=function(b){return b&&"string"==typeof b&&0!=b.length?a[b]&&"undefined"!=typeof a[b]?!0:!1:!1};this.isNew=function(){return a.__id&&a.__id.length?
!1:!0};this.clone=function(){return"article"==this.type?new b.Appacitive.Article(this.toJSON()):new b.Appacitive.connection(a)};this.copy=function(b,e){b&&(d(b,a),e&&d(b,c));return this};this.save=function(b,c){a.__id?u.apply(this,arguments):t.apply(this,arguments);return this};var t=function(e,k){e=e||function(){};k=k||function(){};var h=this,g=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[this.type].getCreateUrl(a.__schematype||a.__relationtype,q);!a.__schematype||"user"!=a.__schematype.toLowerCase()&&
