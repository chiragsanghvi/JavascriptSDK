...
!0);a.children={};for(var g in k)a.children[g]=[],a.children[g]=e(k[g].values,k[g].parent,a.id);h&&(h.__endpointa={articleid:d,label:c},h.__endpointb={articleid:a.id,label:h.label},delete h.label,a.connection=new b.Appacitive.Connection(h));l.push(a)});return l};return e(c.values)};this.fetch=function(a,c){var d=this.toRequest();d.onSuccess=function(b){b&&b.status&&"200"==b.status.code?"function"==typeof a&&a(f(b)):(b=b||{},"function"==typeof c&&c(b.status||{message:"Server error",code:400}))};d.onError=
function(a){a=a||{};"function"==typeof c&&c(a.status||{message:"Server error",code:400})};b.Appacitive.http.send(d);return this}}})(global);
