 ...
 */
var global={};(function(){global.Appacitive||(global.Appacitive={runtime:{}},"undefined"!==typeof process&&process.versions&&process.versions.node?global.Appacitive.runtime.isNode=!0:"undefined"!==typeof window&&(global=window,global.Appacitive={runtime:{isBrowser:!0}}))})(this);
(function(l){var c=l.Appacitive,f=function(b){var e=c.Promise.buildPromise({success:b.onSuccess,error:b.onError}),k=new XDomainRequest;k.onload=function(){var d=k.responseText,b=k.contentType||"";if("application/json"==b.toLowerCase()||"application/javascript"==b.toLowerCase()||"application/json; charset=utf-8"==b.toLowerCase()||"application/json; charset=utf-8;"==b.toLowerCase())try{b=d,c.runtime.isBrowser||"{"!=b[0]&&(b=b.substr(1,b.length-1)),d=JSON.parse(b)}catch(h){return e.reject(k,new c.Error(c.Error.InvalidJson,
"Error while parsing received json "+d))}e.fulfill(d,this)};k.onerror=k.ontimeout=function(){k.responseData="IE's XDomainRequest does not supply error info.";k.status=c.Error.XDomainRequest;e.reject(k,new c.Error(c.Error.XDomainRequest,k.responseData,"Unknown"))};k.onprogress=function(){};-1===b.url.indexOf("?")?b.url+="?ua=ie":b.url+="&ua=ie";k.open(b.method,b.url,b.sync?!1:!0);k.send(b.data);return e},g=c.runtime.isBrowser?XMLHttpRequest:require("xmlhttprequest-with-globalagent").XMLHttpRequest;
...
"application/json; charset=utf-8"==b.value.toLowerCase()||"application/json; charset=utf-8;"==b.value.toLowerCase())&&(d=!1)});if(d)e=b.data;else if(b.data&&(e=b.data,"object"==typeof b.data))try{e=JSON.stringify(e)}catch(n){}var h=b.url.split("/")[2]||"";if(l.navigator&&_type.isObject(l.navigator.userAgent)&&_type.isFunction(l.navigator.userAgent.indexOf)&&-1!=l.navigator.userAgent.indexOf("MSIE 9")&&l.location&&l.location.host&&h!==l.location.host.toLowerCase())return b.data=e,new f(b);var m=new g;
m.onreadystatechange=function(){if(4==m.readyState)if(200<=m.status&&300>m.status||304==m.status){var b=m.responseText,d=m.getResponseHeader("content-type")||m.getResponseHeader("Content-Type")||"";if("application/json"==d.toLowerCase()||"application/javascript"==d.toLowerCase()||"application/json; charset=utf-8"==d.toLowerCase()||"application/json; charset=utf-8;"==d.toLowerCase())try{d=b,c.runtime.isBrowser||"{"!=d[0]&&(d=d.substr(1,d.length-1)),b=JSON.parse(d)}catch(h){return k.reject(m,new c.Error(c.Error.InvalidJson,
"Error while parsing received json "+b))}k.fulfill(b,m)}else k.reject(m,new c.Error(c.Error.ConnectionFailed,m.responseText,"Unknown"))};m.open(b.method,b.url,b.sync?!1:!0);for(h=0;h<b.headers.length;h+=1)m.setRequestHeader(b.headers[h].key,b.headers[h].value);c.runtime.isBrowser||m.setRequestHeader("User-Agent","Appacitive-NodeJSSDK");m.send(e);return k}})(global);
(function(l){var c=l.Appacitive,f=function(b){if(b&&b.send&&"function"==typeof b.send)b.onResponse=this.onResponse;else throw Error("No applicable httpTransport class found");var k=[],d={},g=0,h={},m=0;this.addProcessor=function(b){b&&(b.pre=b.pre||function(){},b.post=b.post||function(){},f(b.pre),t(b.post))};var f=function(b){g+=1;d[g]=b;return g},t=function(b){m+=1;h[m]=b;return m};this.enqueueRequest=function(b){k.push(b)};this.changeRequestForCors=function(b){var d={m:b.method.toUpperCase()};
b.headers.forEach(function(b){d[b.key]=b.value});b.prevHeaders=b.headers;b.headers=[];b.headers.push({key:"Content-Type",value:"text/plain; charset=utf-8"});b.method="POST";b.data&&(d.b=b.data);delete b.data;c.config.debug&&(-1===b.url.indexOf("?")?b.url+="?debug=true":b.url+="&debug=true");c.config.metadata&&(-1===b.url.indexOf("?")?b.url+="?metadata=true":b.url+="&metadata=true");try{b.data=JSON.stringify(d)}catch(h){}return b};this.notify=function(){if(0!==k.length){var c=[],m;for(m in h)h.hasOwnProperty(m)&&
c.push(h[m]);for(;0<k.length;){var g=k.shift(),n=[];for(m in d)d.hasOwnProperty(m)&&n.push(d[m](g));this.changeRequestForCors(g);b.send(g,c,n)}}};this.onResponse=function(b){console.dir(b)}},g=function(){var b=function(){throw Error("Not Implemented Exception");};this.inOnline=this.send=b;this.onResponse=function(c,d){b()};this.onError=function(c){b()}},b=function(){var b=new g;b.isOnline=function(){return!0};var k=function(d,k,h){d.options=d.options||{};new c._Http({method:d.method,url:d.url,headers:d.headers,
data:d.data,sync:d.options.sync,onSuccess:function(c,g){if(c){try{c=JSON.parse(c)}catch(t){}var f=c;if(k.length!=h.length)throw Error("Callback length and state length mismatch!");for(var u=0;u<k.length;u+=1)k[u].apply({},[f,h[u]]);if(200<=c.code&&300>=c.code||c.status&&200<=c.status.code&&300>=c.status.code)b.onResponse(d,c);else c=c||{},c=c.status||c,c.message=c.message||"Bad Request",c.code=c.code||"400",b.onError(d,{responseText:c})}else b.onError(d,{responseText:{code:"400",message:"Invalid request"}})},
onError:function(h,k){var g={};k?g=c.Error.toJSON(k):(g.message=h.responseData||h.responseText||"Bad Request",g.code=h.status||"400");b.onError(d,{responseText:g})}})};b.send=function(b,e,h){if(!c.Session.initialized)throw Error("Initialize Appacitive SDK");"function"==typeof b.beforeSend&&b.beforeSend(b);k(b,e,h)};return b};c.http=new function(){var e=new b,k=new f(e),d=!1;this.pause=function(){d=!0};this.unpause=function(){d=!1};this.addProcessor=function(b){var d=Error('Must provide a processor object with either a "pre" function or a "post" function.');
if(!b)throw d;if(!b.pre&&!b.post)throw d;k.addProcessor(b)};this.send=function(b){b.promise=c.Promise.is(b.promise)?b.promise:new c.Promise.buildPromise({error:b.onError});k.enqueueRequest(b);e.isOnline()&&!1===d&&k.notify();return b.promise};this.flush=function(b){b?k.notify():e.isOnline()&&k.notify()};this.onError=function(b,d){var k=d.responseText;c.logs.logRequest(b,k,k,"error");b.entity&&b.entity._triggerError&&b.entity._triggerError(b.options,new c.Error(k));b.promise.reject(new c.Error(k),
...
b.Appacitive;c&&c.http&&(c.http.addProcessor({pre:function(b){return b},post:function(b,e){try{var h=c.Session.isSessionValid(b);h.status?b&&(b.status&&b.status.code&&("19036"==b.status.code||"421"==b.status.code)||b.code&&("19036"==b.code||"421"==b.code))?c.Users.logout():c.Session.incrementExpiry():h.isSession&&(null!==c.Session.get()&&c.Session.resetSession(),c.http.send(e))}catch(g){}}}),c.http.addProcessor({pre:function(b){return{start:(new Date).getTime(),request:b}},post:function(b,c){c.request.timeTakenInMilliseconds=
...
+d}if("object"!=typeof b||"object"!=typeof d)return!1;if(b instanceof l.Appacitive.GeoCoord&&d instanceof l.Appacitive.GeoCoord)return b.toString()==d.toString();for(g=c.length;g--;)if(c[g]==b)return h[g]==d;var g=b.constructor,t=d.constructor;if(g!==t&&!(_types.isFunction(g)&&g instanceof g&&_types.isFunction(t)&&t instanceof t)&&"constructor"in b&&"constructor"in d)return!1;c.push(b);h.push(d);g=0;t=!0;if("[object Array]"==f){if(g=b.length,t=g==d.length)for(;g--&&(t=e(b[g],d[g],c,h)););}else{for(var r in b)if(Object.prototype.hasOwnProperty.call(b,
r)&&(g++,!(t=Object.prototype.hasOwnProperty.call(d,r)&&e(b[r],d[r],c,h))))break;if(t){for(r in d)if(Object.prototype.hasOwnProperty.call(d,r)&&!g--)break;t=!g}}c.pop();h.pop();return t};_type.isEqual=function(b,d){return e(b,d,[],[])};l.Appacitive.utils=l.Appacitive.utils||{};l.Appacitive.utils._type=_type})(global);
(function(l){var c=Array.prototype,f=Object.prototype,g=l.Appacitive;g.utils._each=function(b,g,d){if(null!=b)if(c.forEach&&b.forEach===c.forEach)b.forEach(g,d);else if(b.length===+b.length)for(var n=0,h=b.length;n<h&&g.call(d,b[n],n,b)!=={};n++);else for(n in b)if(f.hasOwnProperty.call(b,n)&&g.call(d,b[n],n,b)==={})break};g.utils._extend=function(b){g.utils._each(c.slice.call(arguments,1),function(c){if(c)for(var d in c)b[d]=c[d]});return b};g.utils._reject=function(b,c){return b.filter(function(b){return!c(b)})};
...
this.fileServiceUrl,c,escape(b))},getDownloadUrl:function(c,b){return String.format("{0}/download/{1}?expires={2}",this.fileServiceUrl,c,b)},getDeleteUrl:function(c){return String.format("{0}/delete/{1}",this.fileServiceUrl,c)}};this.query={params:function(c){var b=[];return""===location.search||-1===location.search.indexOf("?")?b:c?(c=c.toLowerCase(),location.search.split("?")[1].split("&").forEach(function(e,f){var d=f.split("="),n=d[1];2<d.length&&d.forEach(function(b,c){0!==b&&1!==b&&(n=n+"="+
...
b.prototype.resolve=b.prototype.fulfill;b.prototype.reject=function(b){if(this.state)return this;this.state=2;this.reason=this.value=b;this.done();return this};b.prototype.then=function(c,f){var d=this,n=new b;this.calls[this.calls.length]=[n,c,f];this.state&&g(function(){d.done()});return n};b.when=function(c){var k=[],d=[],n,h=0,m=new b;if(!c||f.isArray(c)&&0==c.length)return m.fulfill(k),m;var v=function(){h+=1;h==n&&(m.state||(0<d.length?m.reject(d,k?k:[]):m.fulfill(k?k:[])))},t=function(h){var f=
c[h];f instanceof b||f&&"function"===typeof f.then?g(function(){f.then(function(b){k[h]=b;v()},function(b){d[h]=b;v()})}):g(function(){try{k[h]=f.call()}catch(b){d[h]=b}v()})};f.isArray(c)||(c=[c]);n=c.length;for(var r=0;r<n;r+=1)t(r);return m};b.is=function(c){return c instanceof b?!0:!1};b.buildPromise=function(c){var g=new b;f.isObject(c)&&g.then(c.success,c.error);return g};b._continueUntil=function(c,g){return f.isFunction(c)&&c()?g().then(function(){return b._continueUntil(c,g)}):(new b).fulfill()};
c.Promise=b})(global);
...
(function(l){var c=l.Appacitive,f=c.utils._type;c.Session=new function(){this.initialized=!1;var g=function(){this.apikey="";this.isnonsliding=!1;this.usagecount=-1;this.windowtime=240},b=null,e=null,k=null,d=!1,n;this.useApiKey=!0;this.useMasterKey=!1;this.onSessionCreated=function(){};this.recreate=function(b){return c.Session.create(b)};this.create=function(d){if(!this.initialized)throw Error("Initialize Appacitive SDK");var h=new g;h.apikey=e;var f=new c._Request({method:"PUT",type:"application",
op:"getSessionCreateUrl",options:d,data:h,onSuccess:function(d){b=d.session.sessionkey;c.Session.useApiKey=!1;f.promise.fulfill(d);c.Session.onSessionCreated()}});return f.send()};c.http.addProcessor({pre:function(h){h.options=h.options||{};if(c.Session.useApiKey){var g=e;(h.options.useMasterKey||c.useMasterKey&&!h.options.useMasterKey)&&f.isString(n)&&0<n.length?g=n:f.isString(h.options.apikey)&&(g=h.options.apikey);h.headers.push({key:"ak",value:g})}else h.headers.push({key:"as",value:b});g=f.isString(h.options.userToken)&&
0<h.options.userToken.length?h.options.userToken:!1;if(!0===d||g){var t=-1,r=h.headers.filter(function(b,c){return"ut"==b.key?(t=c,!0):!1});if(h.options.ignoreUserToken)-1!=t&&h.headers.splice(t,1);else{var u=g||k;1==r.length?h.headers.forEach(function(b){"ut"==b.key&&(b.value=u)}):h.headers.push({key:"ut",value:u})}}}});this.setUserAuthHeader=function(b,h,e){try{b&&(d=!0,k=b,e||(h||(h=-1),-1==h&&(h=null),c.LocalStorage.set("Appacitive-UserToken",b),c.LocalStorage.set("Appacitive-UserTokenExpiry",
...
!1)};this.setApiKey=function(b){b&&(e=b,this.useApiKey=!0)};this.setMasterKey=function(b){n=b};this.reset=function(){this.removeUserAuthHeader();k=e=b=null;d=!1;n=null;this.useMasterKey=this.useApiKey=this.initialized=!1};var h="sandbox";this.environment=function(){if(1==arguments.length){var b=arguments[0];"sandbox"!=b&&"live"!=b&&(b="sandbox");h=b}return h}};c.getAppPrefix=function(f){return c.Session.environment()+"/"+c.appId+"/"+f};c.ping=function(f){if(!c.Session.initialized)throw Error("Initialize Appacitive SDK");
var b=new c._Request({method:"GET",type:"ping",op:"getPingUrl",options:f,onSuccess:function(c){return b.promise.fulfill(c.status)}});return b.send()};c.initialize=function(g){g=g||{};var b=new c.Promise;if(c.Session.initialized)return b.fulfill(c);g.masterKey&&0<g.masterKey.length&&c.Session.setMasterKey(g.masterKey);if(!g.apikey||0===g.apikey.length)if(g.masterKey)g.apikey=g.masterKey;else throw Error("apikey is mandatory");if(!g.appId||0===g.appId.length)throw Error("appId is mandatory");var e=
function(){c.Session.initialized=!0;b.fulfill(c.User.current())};c.Session.setApiKey(g.apikey);c.Session.environment(g.env||"sandbox");c.useApiKey=!0;c.appId=g.appId;c.Session.persistUserToken=g.persistUserToken;g.debug&&(c.config.debug=!0);f.isFunction(g.apiLog)&&(c.logs.apiLog=g.apiLog);f.isFunction(g.apiErrorLog)&&(c.logs.apiErrorLog=g.apiErrorLog);f.isFunction(g.exceptionLog)&&(c.logs.exceptionLog=g.exceptionLog);g.userToken?(-1==g.expiry?g.expiry=null:g.expiry||(g.expiry=845E4),c.Session.setUserAuthHeader(g.userToken,
g.expiry),g.user?(c.Users.setCurrentUser(g.user),e()):c.LocalStorage.get("Appacitive-User").then(function(b){b&&c.Users.setCurrentUser(b);e()})):c.runtime.isBrowser&&c.LocalStorage.multiGet("Appacitive-UserToken","Appacitive-UserTokenExpiry","Appacitive-UserTokenDate","Appacitive-User").then(function(b){var d=b["Appacitive-UserToken"],f=b["Appacitive-UserTokenExpiry"],h=b["Appacitive-User"];b=b["Appacitive-User"];if(d){f||(f=-1);if(h&&0<f&&new Date(h+1E3*f)<new Date)return;-1==f&&(f=null);b&&c.Users.setCurrentUser(b,
d,f)}e()});return b};c.reset=function(){c.Session.reset()}})(global);(function(l){var c=l.Appacitive;c&&c.http&&(c.http.addProcessor({pre:function(f){var g=c.Session.environment();f.options=f.options||{};_type.isString(f.options.env)&&(g=f.options.env);f.headers.push({key:"e",value:g})}}),c.Events.mixin(c))})(global);
...
this.getFieldType(),this.field.toLowerCase(),this.operator)}};d.prototype=new b;d.prototype.constructor=d;var n=function(c){c=c||"";if(!c.val1)throw Error("Specify field value1 ");if(!c.val2)throw Error("Specify field value2 ");this.val1=c.val1;this.val2=c.val2;b.call(this,c);delete this.value;this.toString=function(){return String.format("{0}{1} {2} ({3},{4})",this.getFieldType(),this.field.toLowerCase(),this.operator,this.val1.getValue(),this.val2.getValue())}};n.prototype=new b;n.prototype.constructor=
n;var h=function(d){d=d||"";if(!(d.geoCoord&&d.geoCoord instanceof c.GeoCoord))throw Error("withinCircle filter needs Appacitive.GeoCoord object as argument");b.call(this,d);this.value=d.geoCoord;this.unit=d.unit||"mi";this.distance=d.distance||5;this.toString=function(){return String.format("{0}{1} {2} {3},{4} {5}",this.getFieldType(),this.field.toLowerCase(),this.operator,this.value.getValue(),this.distance,this.unit)}};h.prototype=new b;h.prototype.constructor=n;var m=function(c){c=c||"";if(!c.geoCoords||
...
m.prototype=new b;m.prototype.constructor=n;var v=function(b){g.call(this);b=b||{};if(!b.tags||!f.isArray(b.tags)||0===b.tags.length)throw Error("Specify valid tags");this.tags=b.tags;this.operator=b.operator;this.toString=function(){return String.format("{0}('{1}')",this.operator,this.tags.join(","))}};v.prototype=new g;v.prototype.constructor=v;var t=function(b,c){if(!c||!c.length||2>c.length)throw Error("Provide valid or atleast 2 filters");this.operator=b;this.innerFilters=[];for(var d=0;d<c.length;d+=
1){if(!(c[d]instanceof g))throw Error("Invalid filter provided");this.innerFilters.push(c[d])}this.toString=function(){var b=this.operator,c="(";this.innerFilters.forEach(function(d){c=1===c.length?c+(" "+d.toString()):c+String.format(" {0} {1} ",b,d.toString())});return c+=")"}};t.prototype=new g;t.prototype.constructor=t;var r={isEqualTo:"==",notEqualTo:"<>",isGreaterThan:">",isGreaterThanEqualTo:">=",isLessThan:"<",isLessThanEqualTo:"<=",like:"like",match:"match",between:"between",withinCircle:"within_circle",
withinPolygon:"within_polygon",or:"or",and:"and",taggedWithAll:"tagged_with_all",taggedWithOneOrMore:"tagged_with_one_or_more",isNull:"is null",containedIn:"in",isNotNull:"is not null",notIn:"not in"},u=function(b,d){if(null===b||void 0===b||0===b.length)throw Error("Specify value");this.value=b;this.type=d?d:typeof this.value;if("number"===this.type&&!f.isNumeric(this.value))throw Error("Value should be numeric for filter expression");this.getValue=function(){return"number"===this.type||f.isBoolean(this.value)||
f.isNumber(this.value)?this.value:"object"===this.type&&f.isDate(this.value)?"datetime('"+c.Date.toISOString(this.value)+"')":"object"==this.type&&this.value instanceof c.GeoCoord?this.value.toString():"'"+this.value.toString()+"'"}},B=function(c,f,g){g||(g=this);g.type=c;g.name=f;g.equalTo=function(c){return new b({field:this.name,fieldType:this.type,value:new u(c),operator:r.isEqualTo})};g.notEqualTo=function(c){return new b({field:this.name,fieldType:this.type,value:new u(c),operator:r.notEqualTo})};
g.greaterThan=function(c){return new b({field:this.name,fieldType:this.type,value:new u(c),operator:r.isGreaterThan})};g.greaterThanEqualTo=function(c){return new b({field:this.name,fieldType:this.type,value:new u(c),operator:r.isGreaterThanEqualTo})};g.lessThan=function(c){return new b({field:this.name,fieldType:this.type,value:new u(c),operator:r.isLessThan})};g.lessThanEqualTo=function(c){return new b({field:this.name,fieldType:this.type,value:new u(c),operator:r.isLessThanEqualTo})};g.like=function(c){return new b({field:this.name,
fieldType:this.type,value:new u("*"+c+"*"),operator:r.like})};g.match=function(c){return new b({field:this.name,fieldType:this.type,value:new u("*"+c+"*"),operator:r.match})};g.startsWith=function(c){return new b({field:this.name,fieldType:this.type,value:new u(c+"*"),operator:r.like})};g.endsWith=function(c){return new b({field:this.name,fieldType:this.type,value:new u("*"+c),operator:r.like})};g.contains=function(b){return new e({field:this.name,fieldType:this.type,value:b,operator:r.isEqualTo})};
g.containedIn=function(b){return new k({field:this.name,fieldType:this.type,value:b,operator:r.containedIn})};g.isNull=function(){return new d({field:this.name,fieldType:this.type,operator:r.isNull})};g.notIn=function(b){return new k({field:this.name,fieldType:this.type,value:b,operator:r.notIn})};g.isNotNull=function(){return new d({field:this.name,fieldType:this.type,operator:r.isNotNull})};g.between=function(b,c){return new n({field:this.name,fieldType:this.type,val1:new u(b),val2:new u(c),operator:r.between})};
g.withinCircle=function(b,c,d){return new h({field:this.name,fieldType:this.type,geoCoord:b,distance:c,unit:d,operator:r.withinCircle})};g.withinPolygon=function(b){return new m({field:this.name,fieldType:this.type,geoCoords:b,operator:r.withinPolygon})}},q=function(b){if(!b||0===b.length)throw Error("Specify field name");this.field=b;B("property",b,this);return this},P=function(b){if(!b||0===b.length)throw Error("Specify field name");this.field=b;var c=new B("aggregate",b);this.equalTo=function(b){return c.equalTo(b)};
this.notEqualTo=function(b){return c.notEqualTo(b)};this.greaterThan=function(b){return c.greaterThan(b)};this.greaterThanEqualTo=function(b){return c.greaterThanEqualTo(b)};this.lessThan=function(b){return c.lessThan(b)};this.lessThanEqualTo=function(b){return c.lessThanEqualTo(b)};this.between=function(b,d){return c.between(b,d)};this.contains=function(b){return c.contains(b)};return this},C=function(b){if(!b||0===b.length)throw Error("Specify field name");this.field=b;var c=new B("attribute",b);
...
return this};c.Filter={Property:function(b){return new q(b)},Aggregate:function(b){return new P(b)},Attribute:function(b){return new C(b)},Or:function(){return new t(r.or,arguments)},And:function(){return new t(r.and,arguments)},taggedWithOneOrMore:function(b){return new v({tags:b,operator:r.taggedWithOneOrMore})},taggedWithAll:function(b){return new v({tags:b,operator:r.taggedWithAll})}}})(global);
...
b.pagenumber,this.results.pageSize=b.pagesize,b.pagenumber*b.pagesize>=b.totalrecords&&(this.results.isLastPage=!0))};l.prototype.fields=function(){if(1===arguments.length){var b=arguments[0];f.isString(b)?this._fields=[b]:f.isArray(b)&&b.length&&(this._fields=b);return this}return this._fields};l.prototype._parse=function(b,f,h){b||(b=[]);var e="object"===this.type()?"Object":"Connection";return c[e]._parseResult(b,h.entity,f)};l.prototype.collection=function(b,e){e=e||{};f.isObject(b)&&(e=b,b=null);
...
1;this.pageNumber(c);return this.fetch(b)};l.prototype.count=function(b){var f=c.Promise.buildPromise(b);b=this.toRequest(b);b.onSuccess=function(b){b=b||{};b=b.paginginfo;var c=0,c=b?b.totalrecords:0;f.fulfill(c)};b.promise=f;b.entity=this;return c.http.send(b)};var k=function(d){var g=d||{};b.call(this,d);e.call(this,d);var h="",m="",k=g.queryType||"BasicQuery",t=g.type||g.relation,r=g.relation?"connection":"object",u=this;this._fields=[];g.entity&&(this.entity=g.entity);this.type=function(){return r};
this.entityType=function(){return t};this.queryType=function(){return k};this.filter=function(){return 1===arguments.length?(h=arguments[0],this):h};this.freeText=function(){if(1===arguments.length){var b=arguments[0];f.isString(b)?m=arguments[0]:f.isArray(b)&&b.length&&(m=arguments[0].join(" "));return this}return m};this.filter(g.filter||"");this.freeText(g.freeText||"");this.fields(g.fields||[]);this.setFilter=function(b){this.filter(b)};this.setFreeText=function(b){this.freeText(b)};this.setFields=
...
return b};this.toUrl=function(){return{url:c.config.apiBaseUrl+r+"/"+t+"/find/all?"+this.getQueryString(),description:"FindAll "+t+" "+r+"s"}};this.toRequest=function(b){var d=new c.HttpRequest,h=this.toUrl();d.url=h.url;d.options=b;d.description=h.description;d.method="get";return d};this.getOptions=function(){var b={},c;for(c in this)this.hasOwnProperty(c)&&!f.isFunction(this[c])&&(b[c]=this[c]);return b};this.fetch=function(b){var d=c.Promise.buildPromise(b);b=this.toRequest(b);b.onSuccess=function(b){u.results=
u._parse(b[r+"s"],b.__meta,g);u._setPaging(b.paginginfo);d.fulfill(u.results,b.paginginfo)};b.promise=d;b.entity=this;return c.http.send(b)};this.fetch=function(b){var d=c.Promise.buildPromise(b);b=this.toRequest(b);b.onSuccess=function(b){u.results=u._parse(b[r+"s"],b.__meta,g);u._setPaging(b.paginginfo);d.fulfill(u.results,b.paginginfo)};b.promise=d;b.entity=this;return c.http.send(b)}};g(k.prototype,l.prototype,e.prototype,b.prototype);c.Queries.FindAllQuery=function(b){b=b||{};if(!b.type&&!b.relation)throw Error("Specify either type or relation for basic filter query");
...
this.label+"&returnEdge="+this.returnEdge,description:"GetConnectedObjects for relation "+this.relation+" of type "+this.type+" for object "+this.objectId}};var m=function(b,d,f,e){var m=[];b.forEach(function(b){var h=b.__edge;delete b.__edge;var k=c.Object._create(g({__meta:f},b),!0);h&&(h.__endpointa=d,h.__endpointb={objectid:b.__id,label:h.__label,type:b.__type},delete h.label,k.connection=c.Connection._create(g({__meta:e},h),!0));m.push(k)});h.object&&(h.object.children[h.relation]=m);return m};
...
function(b){b=b||{};if(!b.relation)throw Error("Specify relation for GetConnectionsBetweenObjectsForRelationQuery query");var f=new c.Queries.GetConnectionsBetweenObjectsQuery(b,"GetConnectionsBetweenObjectsForRelationQuery");f.fetch=function(h){var e=c.Promise.buildPromise(h);h=this.toRequest(h);h.onSuccess=function(h){f.results=h.connection?[c.Connection._create(g({__meta:h.__meta},h.connection),!0,b.entity)]:null;e.fulfill(f.results?f.results[0]:null)};h.promise=e;h.entity=this;return c.http.send(h)};
return f};c.Queries.InterconnectsQuery=function(b){b=b||{};delete b.entity;if(!b.objectAId||!f.isString(b.objectAId)||0===b.objectAId.length)throw Error("Specify valid objectAId for InterconnectsQuery query");if(!(b.objectBIds&&f.isArray(b.objectBIds)&&0<b.objectBIds.length))throw Error("Specify list of objectBIds for InterconnectsQuery query");b.type&&delete b.type;b.queryType="InterconnectsQuery";k.call(this,b);this.objectAId=b.objectAId;this.objectBIds=b.objectBIds;this.toRequest=function(b){var d=
new c.HttpRequest,f=this.toUrl();d.url=f.url;d.options=b;d.description=f.description;d.method="post";d.data={object1id:this.objectAId,object2ids:this.objectBIds};return d};this.toUrl=function(){return{url:c.config.apiBaseUrl+"connection/interconnects?"+this.getQueryString(),description:"GetInterConnections between objects"}};return this};c.Queries.InterconnectsQuery.prototype=new k;c.Queries.InterconnectsQuery.prototype.constructor=c.Queries.InterconnectsQuery;c.Queries.GraphQuery=function(d,g,h){f.isObject(d)&&
(h=d,h.returnObjects=d.returnObjects||h.returnObjects,g=h.placeholders||{},d=h.name);if(!d||0===d.length)throw Error("Specify name of filter query");h=h||{};this.placeholders=g||{};this.returnObjects=h.returnObjects;b.call(this,h);e.call(this,h);this.name=d;this.queryType="GraphQuery";this.fields(h.fields||[]);var m=this;this.type=function(){return"object"};this.toRequest=function(b){var d=new c.HttpRequest,h=this.toUrl();d.url=h.url;d.options=b;d.description=h.description;d.method="post";this.data=
{};if(this.placeholders){this.data.placeholders=this.placeholders;for(var f in this.data.placeholders)this.data.placeholders[f]=this.data.placeholders[f]}d.data=this.data;return d};this.getQueryString=function(){var b=[];this.isPageDefault||b.push(this.pageString());this.isSortSet&&b.push(this.sortString());this._fields&&0<this._fields.length&&b.push("fields="+this._fields.join(","));return b.join("&")};this.toUrl=function(){return{url:c.config.apiBaseUrl+"search/"+this.name+"/"+(this.returnObjects?
"graphquery":"filter")+"?"+this.getQueryString(),description:"Filter Query with name "+this.name}};this.fetch=function(b){var d=c.Promise.buildPromise(b);b=this.toRequest(b);b.onSuccess=function(b){var c;m.returnObjects?(m.results=m._parse(b.objects,b.__meta,h),c=m.results):this.results=c=b.ids?b.ids:[];b.paginginfo&&m._setPaging(b.paginginfo);d.fulfill(c,b.paginginfo)};b.promise=d;b.entity=this;return c.http.send(b)}};g(c.Queries.GraphQuery.prototype,l.prototype,e.prototype,b.prototype);c.Queries.GraphAPI=
function(b,e,h){if(!b||0===b.length)throw Error("Specify name of project query");if(!e||!e.length)throw Error("Specify ids to project");this.name=b;this.data={ids:e};this.queryType="GraphApi";var m=this;if(h){this.data.placeholders=h;for(var k in this.data.placeholders)this.data.placeholders[k]=this.data.placeholders[k]}this.toRequest=function(b){var d=new c.HttpRequest,h=this.toUrl();d.url=h.url;d.description=h.description;d.method="post";d.data=this.data;d.options=b;return d};this.toUrl=function(){return{url:c.config.apiBaseUrl+
"search/"+this.name+"/project",description:"Project Query with name "+this.name}};var t=function(b){var d,h;for(h in b)if("status"!==h){d=b[h];break}var f=function(b,d,h,e,m){var t=[];b.forEach(function(b){var u=b.__children;delete b.__children;var k=b.__edge;delete b.__edge;b=c.Object._create(g({__meta:e},b),!0);b.children={};for(var r in u)b.children[r]=[],b.children[r]=f(u[r].values,u[r].parent,b.id,u[r].__nodemeta,u[r].__edgemeta);k&&(k.__endpointa={objectid:h,label:d},k.__endpointb={objectid:b.id,
label:k.__label},delete k.__label,b.connection=c.Connection._create(g({__meta:m},k),!0));t.push(b)});return t};return f(d.values,null,null,d.__nodemeta)};this.collection=function(b,d){d=d||{};f.isObject(b)&&(d=b,b=null);b||(b=this.results?ths.results:[]);var h;0<b.length&&b[0]instanceof c.BaseObject&&(h=c.Object._getClass(b[0].className));return new c.Collection(b,g(d,{model:h,query:this}))};this.fetch=function(b){var d=c.Promise.buildPromise(b);b=this.toRequest(b);b.onSuccess=function(b){m.results=
t(b);d.fulfill(m.results)};b.promise=d;b.entity=this;return c.http.send(b)}}})(global);
(function(l){var c=l.Appacitive,f=c.utils._type,g=c.utils._extend,b=c.utils._deepExtend,e=["__link","__endpointa","__endpointb"],k={__utcdatecreated:"datetime",__utclastupdateddate:"datetime"},d=function(b){return f.isString(b)||f.isNumber(b)||f.isBoolean(b)},n=function(b){return d(b)||f.isDate(b)||b instanceof c.GeoCoord},h=function(b){b=b||{};var c={},d;for(d in b.__meta)b.__meta[d].forEach(function(b){c[b]=d});return c},m={integer:function(b){if(b){var c=parseInt(b);if(!isNaN(c))return c}return b},
...
{},d;for(d in b){var h=b[d];f.isArray(h)?(c[d]=[],h.forEach(function(b){(b=v(b))&&c[d].push(b)})):c[d]=v(b[d])}return c};c._decode=function(b){var c={},d=g({},k,h(b));delete b.__meta;for(var e in b)f.isArray(b[e])?(c[e]=[],b[e].forEach(function(b){b=d[e]?m[d[e]](b):b;c[e].push(b)})):f.isString(b[e])?c[e]=d[e]?m[d[e]](b[e]):b[e]:c[e]=b[e];return c};l=function(d,h){var k={};h=h||{};d=d||{};d=b({},d);this.meta={};d.__meta=g(this.meta,d.__meta);h&&h.parse&&(d=this.parse(d));var v=c.utils._result(this,
"defaults");f.isObject(this.defaults)&&!h.setSnapShot&&(d=b({},v,d));h&&h.collection&&(this.collection=h.collection);d=c._decode(d);var q=this,l=function(d,h){d.__meta=g(q.meta,d.__meta);q.meta=d.__meta;C(d);var e=c._decode(d),m;for(m in e)m==q.idAttribute&&(q.id=e[m]),w[m]&&delete w[m],A[m]&&delete A[m],z[m]&&delete z[m],n(e[m])?h[m]=e[m]:f.isObject(e[m])?h[m]=b({},h[m],e[m]):f.isArray(e[m])?(h[m]=[],e[m].forEach(function(b){if(n(b)||"__link"==m)h[m].push(b);else throw Error("Multivalued property cannot add object or array as property of object");
})):h[m]=e[m]},C=function(b,d){var h={id:"id",__id:"id",__utclastupdateddate:"lastUpdatedAt",__utcdatecreated:"createdAt",__createdby:"createdBy",__updatedby:"lastUpdatedBy"};"id __id __utclastupdateddate __utcdatecreated __createdby __updatedby".split(" ").forEach(function(e){b[e]&&("__utcdatecreated"!==e&&"__utclastupdateddate"!==e||f.isDate(b[e])?q[h[e]]=b[e]:q[h[e]]=c.Date.parseISODate(b[e]),d&&delete b[e])})};this.base=c.Object.prototype;this.cid=parseInt(1E8*Math.random(),10);this.idAttribute=
"__id";var w={},A={},z={},x={};l(d,x);var p=x;h.setSnapShot&&l(p,k);!k[this.idAttribute]&&x[this.idAttribute]&&(k[this.idAttribute]=x[this.idAttribute]);this.id=k[this.idAttribute];x.__type?(x.__type=x.__type.toLowerCase(),this.entityType="type",this.type="object",this.className=x.__type):x.__relationtype&&(x.__relationtype=x.__relationtype.toLowerCase(),this.entityType="relation",this.type="connection",this.className=x.__relationtype);p.__attributes||(p.__attributes={});k.__attributes||(k.__attributes=
{});var y=[];p.__tags||(p.__tags=[]);k.__tags||(k.__tags=[]);this.attributes=p;var E="";C(this.attributes);var H="__id __revision __endpointa __endpointb __createdby __lastmodifiedby __type __relationtype __typeid __relationid __utcdatecreated __utclastupdateddate __tags __authType __link __acls __meta".split(" "),I=function(b){b=b||{};b.message=b.message||"Server error";b.code=b.code||"500";return b};this.getObject=function(){var d=c._encode(b({__meta:this.meta},p));"connection"==q.type&&(d.__endpointa=
p.__endpointa.toJSON(),d.__endpointb=p.__endpointb.toJSON());Object.prototype.hasOwnProperty("id")&&(d.__id=this.id);return d};var Q=function(){var c=b({__meta:this.meta},p);"connection"==q.type&&(p.__endpointa=p.__endpointa.toJSON(),p.__endpointb=p.__endpointb.toJSON());this.hasOwnProperty("id")&&this.id&&(c.__id=this.id);return c};this.toJSON=function(b){if(b&&"object"==this.type){var c=function(b){var d=[];b.forEach(function(b){var h=b.toJSON();if(b.children&&!Object.isEmpty(b.children)){h.children=
...
{}),p.__attributes[arguments[0]];if(2===arguments.length){if(!f.isString(arguments[1])&&null!==arguments[1])throw Error("only string values can be stored in attributes.");p.__attributes||(p.__attributes={});p.__attributes[arguments[0]]=arguments[1]}else throw Error(".attr() called with an incorrect number of arguments. 0, 1, 2 are supported.");D("__attributes");return p.__attributes};var J=function(){if(p.__attributes){if(!k.__attributes)return p.__attributes;var b=!1,c=JSON.parse(JSON.stringify(k.__attributes)),
d;for(d in p.__attributes)null==p.__attributes[d]||void 0==p.__attributes[d]?(c[d]=null,b=!0):p.__attributes[d]!=k.__attributes[d]?(c[d]=p.__attributes[d],b=!0):p.__attributes[d]==k.__attributes[d]&&delete c[d];return b?c:void 0}};this.getChangedAttributes=J;this.aggregate=function(){var b={},c;for(c in p){if(!p.hasOwnProperty(c))return;"$"==c[0]&&(b[c.substring(1)]=p[c])}if(0===arguments.length)return b;if(1==arguments.length)return b[arguments[0]];throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");
};this.tags=function(){return p.__tags?p.__tags:[]};this.addTag=function(b){if(!b||!f.isString(b)||!b.length)return this;p.__tags||(p.__tags=[]);p.__tags.push(b);p.__tags=Array.distinct(p.__tags);if(!y||!y.length)return D("__tags"),this;b=y.indexOf(b);-1!=b&&y.splice(b,1);D("__tags");return this};this.removeTag=function(b){if(!b||!f.isString(b)||!b.length)return this;y.push(b);y=Array.distinct(y);if(!p.__tags||!p.__tags.length)return D("__tags"),this;b=p.__tags.indexOf(b);-1!=b&&p.__tags.splice(b,
1);D("__tags");return this};var K=function(){if(p.__tags){if(!k.__tags)return p.__tags;var b=[];p.__tags.forEach(function(c){-1==k.__tags.indexOf(c)&&b.push(c)});return 0<b.length?b:void 0}};this.getChangedTags=K;this.getRemovedTags=function(){return _removetags};var L=function(b,c,d,h){if(!b||!f.isString(b)||0===b.length||0==b.trim().indexOf("__")||0===b.trim().indexOf("$")||void 0==c||null==c)return this;b=b.toLowerCase();try{var e=function(c){if(!n(c))throw Error("Multivalued property cannot have values of property as an object");
if(p[b]&&f.isArray(p[b]))if("additems"==d)p[b].push(c);else if("adduniqueitems"==d){var h=-1;p[b].find(function(b,d){return f.isEqual(b,c)?(h=d,!0):!1});-1==h&&p[b].push(c)}else"removeitems"==d&&p[b].removeAll(c);else p[b]="removeitems"==d?[]:[c];A[b]||(A[b]={additems:[],adduniqueitems:[],removeitems:[]});A[b][d].push(c)};f.isArray(c)?c.forEach(function(b){e(b)}):e(c);D(b,h)}catch(g){throw Error("Unable to add item to "+b);}return q};this.add=function(b,c,d){return L.apply(this,[b,c,"additems",d])};
this.addUnique=function(b,c,d){return L.apply(this,[b,c,"adduniqueitems",d])};this.remove=function(b,c,d){return L.apply(this,[b,c,"removeitems",d])};var F=function(b,c,d,h){var e=void 0;f.isEqual(d,c)||("__tags"==b?(b=K())&&0<b.length&&(e=b):"__attributes"==b?(b=J(),Object.isEmpty(b)||(e=b)):f.isArray(d)?A[b]&&!z[b]?e=h?A[b]:d:d.equals(c)||(e=d):e=w[b]&&!z[b]?h?{incrementby:w[b].value}:d:d);return e},G=function(d){var h=!1,e=b({},k),f;for(f in e)"$"==f[0]&&delete e[f];for(var g in p)f=F(g,e[g],p[g],
d),void 0===f?delete e[g]:(h=!0,e[g]=f);try{H.forEach(function(b){e[b]&&delete e[b]})}catch(m){}d&&(e=c._encode(e));g=K();d?(g&&0<g.length&&(e.__addtags=g,h=!0),y&&0<y.length&&(e.__removetags=y,h=!0)):g&&0<g.length&&(e.__tags=g,h=!0);(d=J())&&!Object.isEmpty(d)?(e.__attributes=d,h=!0):delete e.__attributes;"object"==q.type&&q._aclFactory&&(d=q._aclFactory.getChanged())&&(h=!0,e.__acls=d);return h&&!Object.isEmpty(e)?e:!1};this.changed=function(){return this.isNew()?this.toJSON():G()};this.hasChanged=
function(){return this.isNew()?!0:0===arguments.length?Object.isEmpty(G(!0))?!1:!0:1==arguments.length&&f.isString(arguments[0])&&0<arguments[0].length?void 0==F(arguments[0],k[arguments[0]],p[arguments[0]])?!1:!0:!1};this.changedAttributes=function(){if(this.isNew())return this.toJSON();if(0===arguments.length)return G();if(1==arguments.length&&f.isArray(arguments[0])&&arguments[0].length){var b={};arguments[0].forEach(function(c){c=F(c,k[c],p[c]);void 0!=c&&b.push(c)});return b}return!1};this.previous=
function(){return this.isNew()?null:1==arguments.length&&f.isString(arguments[0])&&arguments[0].length?k[arguments[0]]:null};this.previousAttributes=function(){return this.isNew()?null:g({},k)};this.fields=function(){if(1==arguments.length){var b=arguments[0];f.isString(b)?E=b:f.isArray(b)&&(E=b.join(","));return this}return E};this.get=function(b,c){if(b){if(c&&m[c.toLowerCase()]){if(m[c.toLowerCase()])return m[c.toLowerCase()](p[b]);throw Error('Invalid cast-type "'+c+'"" provided for get "'+b+
'"');}return p[b]}};this.tryGet=function(b,c,d){b=this.get(b,d);return void 0!==b?b:c};var D=function(b,c){if(c&&!c.silent){var d=F(b,k[b],p[b]);if(void 0!=d[b]||-1!=H.indexOf(b))q.trigger("change:"+b,q,d[b]||p[b],{}),c.ignoreChange||q.trigger("change",q,c)}},M=function(b){b&&!b.silent&&q.trigger("destroy",q,q.collection,b)};this._triggerError=function(b,c){b.silent||q.trigger("error",q,c,b)};var R=function(b,c,d){if(!b||!f.isString(b)||0===b.length||0===b.trim().indexOf("$"))return this;b=b.toLowerCase();
try{if(f.isNullOrUndefined(c))p[b]=null;else if(n(c))p[b]=c;else if(f.isObject(c))if(-1!==e.indexOf(b))p[b]=c;else throw Error("Property cannot have value as an object");else f.isArray(c)&&(p[b]=[],c.forEach(function(c){if(n(c))p[b].push(c);else throw Error("Multivalued property cannot have values of property as an object");}));delete w[b];delete A[b];delete z[b];f.isEqual(p[b],k[b])||(z[b]=!0);b==q.idAttribute&&(q.id=c);return this}catch(h){throw Error("Unable to set "+b);}};this.set=function(b,
c,d){var h,e;if(null==b)return this;null==b||"object"===typeof b?(e=b,d=c):(e={})[b]=c;d||(d={});if(!this._validate(e,d))return!1;this.idAttribute in e&&(this.id=e[this.idAttribute]);C(e);var f=!1;for(h in e)c=e[h],R.apply(this,[h,c,g({},d,{ignoreChange:!0})]);if(d&&!d.silent)for(h in e)if(void 0!=F(h,k[h],p[h])||-1!=H.indexOf(h))f=!0,q.trigger("change:"+b,q,p[b],{});f&&this.trigger("change",this,d);return this};this.unset=function(b,c){if(!b||!f.isString(b)||0===b.length||0===b.indexOf("__"))return this;
b=b.toLowerCase();delete p[b];D(b,c);return this};this._validate=function(b,c){if(!c.validate||!this.validate||!f.isFunction(this.validate))return!0;b=g({},this.attributes,b);var d=this.validationError=this.validate(b,c)||null;if(!d)return!0;this.trigger("invalid",this,d,g(c,{validationError:d}));return!1};this.isValid=function(b){return this._validate({},g(b||{},{validate:!0}))};this.has=function(b){return b&&f.isString(b)&&0!==b.length?p[b]&&!f.isUndefined(p[b])?!0:!1:!1};this.isNew=function(){return!(!f.isNullOrUndefined(this.id)||
this.has(this.idAttribute))};this.clone=function(){return"object"==this.type?c.Object._create(b({__meta:this.meta},this.getObject())):new c.connection._create(b({__meta:this.meta},this.getObject()))};this.copy=function(b,c){b&&(l(b,p),c&&l(b,k));return this};this.mergeWithPrevious=function(){l(p,k);q._aclFactory&&q._aclFactory.merge();C(k);y=[];w={};A={};z={};return this};var N=function(){l(k,p);q._aclFactory&&q._aclFactory.merge();C(p);y=[];w={};A={};z={}};this.rollback=function(){p=x={};N();return this};
var O=function(b,c,d,h){if(!b||!f.isString(b)||0===b.length||0===b.indexOf("__"))return this;b=b.toLowerCase();if(f.isObject(p[b])||f.isArray(p[b]))throw Error("Cannot increment/decrement array/object");try{f.isObject(c)?(h=c,c=d):c=!c||isNaN(Number(c))?d:Number(c)*d,p[b]=isNaN(Number(p[b]))?c:Number(p[b])+c,q.isNew()||(w[b]={value:(w[b]?w[b].value:0)+c})}catch(e){throw Error("Cannot perform increment/decrement operation");}D(b,h);return q};this.increment=function(b,c,d){return O(b,c,1,d)};this.decrement=
function(b,c,d){return O(b,c,-1,d)};this._findUnsavedChanges=function(){var b={object:null,isNested:!1};if(this.id)b.object=G(!0);else{var c=q.getObject();delete c.__meta;for(var d in c)"$"==d[0]&&delete c[d];c.__revision&&delete c.__revision;"object"==q.type&&q._aclFactory&&(d=q._aclFactory.getChanged())&&(c.__acls=d);c.__tags&&0==c.__tags.length&&delete c.__tags;Object.isEmpty(c.__attributes)&&delete c.__attributes;"connection"==q.type&&(c.__endpointa.objectid&&delete c.__endpointa.object,c.__endpointb.objectid&&
delete c.__endpointb.object);b.object=c}return b};this.getType=function(){var b=q.type;!p.__type||"user"!=p.__type.toLowerCase()&&"device"!=p.__type.toLowerCase()||(b=p.__type.toLowerCase());return b};this._parseOutput=function(b,d){var h=q.getType(),e;b=b||{};if(d&&d[h]){b&&b.parse&&(d[h]=this.parse(d[h]));var f=this.isNew(),m=!1;"connection"==q.type&&p.__endpointa&&d[h].__endpointa.label!=p.__endpointa.label&&(m=d[h].__endpointa,d[h].__endpointa=d[h].__endpointb,d[h].__endpointb=m,m=!0);k=c._decode(g({__meta:g(q.meta,
d.__meta)},d[h]));q.id=p[q.idAttribute]=d[h][q.idAttribute];N();f?("connection"==q.type&&(b._batch||(m?(p.__endpointa.object&&d.__bmeta&&(p.__endpointa.object.__meta=d.__bmeta),p.__endpointb.object&&d.__ameta&&(p.__endpointb.object.__meta=d.__ameta)):(p.__endpointa.object&&d.__ameta&&(p.__endpointa.object.__meta=d.__ameta),p.__endpointb.object&&d.__bmeta&&(p.__endpointb.object.__meta=d.__bmeta))),q.parseConnection(b._batch)),q.trigger("change:__id",q,q.id,{}),c.eventManager.fire(q.entityType+"."+
h+".created",q,{object:q}),q.created=!0):c.eventManager.fire(q.entityType+"."+h+"."+q.id+".updated",q,{object:q});b.silent||q.trigger("sync",q,d[h],b)}else d=d||{},d.status=d.status||{},e=I(d.status),q._triggerError(b,new c.Error(e)),q.isNew()?c.eventManager.fire(q.entityType+"."+h+".createFailed",q,{error:e}):c.eventManager.fire(q.entityType+"."+h+"."+q.id+".updateFailed",q,{object:e});return e};this._save=function(){return this.id?S.apply(this,arguments):T.apply(this,arguments)};var T=function(b){b=
b||{};var d=q.getType(),h=q._findUnsavedChanges(),e=new c._Request({method:"PUT",type:d,op:"getCreateUrl",args:[this.className,E],data:h.object,options:b,entity:q,onSuccess:function(c){(c=q._parseOutput(b,c))?e.promise.reject(c,q):e.promise.fulfill(q)}});return e.send()},S=function(b,d){c.Promise.is(d)||(d=c.Promise.buildPromise(b));var h=q._findUnsavedChanges();b=b||{};if(Object.isEmpty(h.object))d.fulfill(q);else{var e=q.type,f=[q.className,q.id,E];p&&p.__type&&("user"==p.__type.toLowerCase()||
"device"==p.__type.toLowerCase())&&(e=p.__type.toLowerCase(),f.splice(0,1));var g=new c._Request({method:"POST",type:e,op:"getUpdateUrl",args:f,data:h.object,options:b,entity:q,onSuccess:function(c){(c=q._parseOutput(b,c))?g.promise.reject(c,q):g.promise.fulfill(q)}});return g.send()}return d},U=function(b){if(!q.id)throw Error("Please specify id for get operation");b=b||{};var d=q.getType(),h=new c._Request({method:"GET",type:d,op:"getGetUrl",args:[this.className,q.id,E],options:b,entity:q,onSuccess:function(e){e&&
e[d]?(b&&b.parse&&(e[d]=q.parse(e[d])),k=c._decode(g({__meta:g(q.meta,e.__meta)},e[d])),l(k,p),C(p),q._aclFactory&&q._aclFactory._rollback(),e.connection&&(q.endpoints||q.endpointA&&q.endpointB||q.setupConnection(p.__endpointa,p.__endpointb)),b.silent||q.trigger("sync",q,e[d],b),c.eventManager.fire(q.entityType+"."+d+"."+q.id+".fetched",q,{object:q}),h.promise.fulfill(q)):(e=e||{},e.status=e.status||{},e.status=I(e.status),q._triggerError(b,new c.Error(e.status)),h.promise.reject(e.status,q))}});
return h.send()};this._fetch=function(b){return U.apply(this,[b])};this.del=this._destroy=function(b){b=b||{};var d=b.deleteConnections;f.isBoolean(b)&&(d=b,b={});b.wait||M(b);if(!q.id)return(new c.Promise.buildPromise(b)).fulfill();var h=q.getType(),e=new c._Request({method:"DELETE",type:h,op:"getDeleteUrl",args:[this.className,q.id,d],options:b,entity:this,onSuccess:function(d){d&&d.status?(p={},k={},b.wait&&M(b),e.promise.fulfill(d.status)):(d=d||{},d.status=d.status||{},d.status=I(d.status),q._triggerError(b,
new c.Error(d.status)),e.promise.reject(d.status,q))}});return e.send()};"object"==this.type&&(this._destroyWithConnections=function(b){return this.destroy(g({deleteConnections:!0},b))})};l.prototype.save=function(){return this._save.apply(this,arguments)};l.prototype.fetch=function(){return this._fetch.apply(this,arguments)};l.prototype.destroy=function(){return this._destroy.apply(this,arguments)};l.prototype.destroyWithConnections=function(){return this._destroyWithConnections.apply(this,arguments)};
...
(function(l){var c=function(){return Math.floor(65536*Math.random()).toString(16)};l.Appacitive.GUID=function(){var f=c()+c()+"-"+c()+"-"+c()+"-"+c()+"-"+c()+c()+c(),g="",b,e,k,d,n,h,m=0,f=f.replace(/\r\n/g,"\n");e="";for(k=0;k<f.length;k++)d=f.charCodeAt(k),128>d?e+=String.fromCharCode(d):(127<d&&2048>d?e+=String.fromCharCode(d>>6|192):(e+=String.fromCharCode(d>>12|224),e+=String.fromCharCode(d>>6&63|128)),e+=String.fromCharCode(d&63|128));for(f=e;m<f.length;)b=f.charCodeAt(m++),e=f.charCodeAt(m++),
k=f.charCodeAt(m++),d=b>>2,b=(b&3)<<4|e>>4,n=(e&15)<<2|k>>6,h=k&63,isNaN(e)?n=h=64:isNaN(k)&&(h=64),g=g+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(d)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(n)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h);return g.toString()}})(global);
(function(l){var c=l.Appacitive,f=c.utils._type,g=["allow","deny"],b=["create","read","update","delete","manageaccess"],e=function(c){var d=[];c.forEach(function(c){f.isString(c)&&-1!=b.indexOf(c.toLowerCase())&&d.push(c.toLowerCase())});return d};c._Acl=function(k,d){var n=k||[];f.isArray(n)||(n=[]);var h={};d&&(h=JSON.parse(JSON.stringify(n)));this.acls=n=JSON.parse(JSON.stringify(n));var m=[],v=function(b,d,h,f){if(!h)throw Error("Specify valid user or usergroup");h instanceof c.Object&&"user"==
h.typeName&&!h.isNew()&&(h=h.id);var k=n.filter(function(b){return b.sid==h&&b.type==d});k&&0!=k.length?k=k[0]:(k={sid:h,type:d,deny:[],allow:[]},n.push(k));k.allow||(k.allow=[]);k.deny||(k.deny=[]);f=e(f);var t=m.filter(function(b){return b.sid==h&&b.type==d});t&&0!=t.length?t=t[0]:(t={sid:h,type:d},m.push(t));f.forEach(function(c){for(var d=0;d<g.length;d+=1){var h=k[g[d]].indexOf(c);if(-1!=h){k[g[d]].splice(h,1);break}}"dontcare"!=b&&k[b].push(c);t[c]=b});return this},t=function(b,c,d,h){if(!d)throw Error("Please provide valid id or name for setting acls");
if(!h)throw Error("Please provide valid access permissions for setting acls");f.isArray(h)||(h=[h]);f.isArray(d)?d.forEach(function(d){v(b,c,d,h)}):v(b,c,d,h);return this},r=function(){n.allowUser=function(b,c){return t.apply(this,["allow","user",b,c])};n.allowGroup=function(b,c){return t.apply(this,["allow","usergroup",b,c])};n.denyUser=function(b,c){return t.apply(this,["deny","user",b,c])};n.denyGroup=function(b,c){return t.apply(this,["deny","usergroup",b,c])};n.resetUser=function(b,c){return t.apply(this,
...
["deny","usergroup",["anonymous"],b])};n.resetLoggedIn=function(b){return t.apply(this,["dontcare","usergroup",["anonymous"],b])}};this._rollback=function(){m=[];n=JSON.parse(JSON.stringify(h));r();return this};this.toJSON=this.getChanged=function(){var c=[];m.forEach(function(d){var h={sid:d.sid,type:d.type,allow:[],deny:[],dontcare:[]};b.forEach(function(b){d[b]&&h[d[b]].push(b)});g.forEach(function(b){0==h[b].length&&delete h[b]});0==h.dontcare.length&&delete h.dontcare;c.push(h)});return 0==c.length?
null:c};this.merge=function(){m=[];return this};r();return this};c.Group=new function(){var b=function(b,e,h,g){if(!e||!f.isString(e)||0===e.length)throw Error("Please specify valid groupname");f.isArray(h)||(h=[h]);var k={};k[b]=[];h.forEach(function(h){h&&(h instanceof c.Object&&"user"==h.typeName&&!h.isNew()?k[b].push(h.id):f.isString(h)&&k[b].push(h))});if(0==k[b].length)throw Error("Please specify valid members as second argument");var t=new c._Request({method:"POST",type:"usergroup",op:"getUpdateUrl",
args:[e],data:k,entity:this,options:g,onSuccess:function(b){t.promise.fulfill(b)}});return t.send()};this.addMembers=function(c,e,h){return b("add",c,e)};this.removeMembers=function(c,e,h){return b("remove",c,e)}}})(global);
...
(function(l){var c=l.Appacitive,f=c.utils._type,g=c.utils._extend,b=function(b,d){b=b||{};b.__type="user";c.Object.call(this,b,d);return this},e=null;b.currentUser=b.current=function(){return e};var k=function(b,d,e){var g=this.get("__id");if(!g||!f.isString(g)||0===g.length)throw Error("Please specify valid userid");if(!b||!f.isString(b)||0===b.length)throw Error("Please specify valid oldPassword");if(!d||!f.isString(d)||0===d.length)throw Error("Please specify valid newPassword");var k=this,u=new c._Request({method:"POST",
type:"user",op:"getUpdatePasswordUrl",args:[g],options:e,data:{oldpassword:b,newpassword:d},entity:this,onSuccess:function(b){u.promise.fulfill(k)}});return u.send()},d=function(b,d){var e=this.get("__id");if(!this.get("__id"))return this.set("__link",b),c.Promise.buildPromise(d).fulfill(this);var g=this,k=new c._Request({method:"POST",type:"user",op:"getLinkAccountUrl",args:[e],options:d,data:b,entity:this,onSuccess:function(c){c=g.get("__link");f.isArray(c)||(c=c?[c]:[]);c.push(b);g.copy({__link:c},
...
return(new c.User(b)).save(d)};b.createUser=b.createNewUser;b.signup=function(b,d){var e=this,f=c.Promise.buildPromise(d);this.createUser(b).then(function(){e.login(b.username,b.password).then(function(){f.fulfill.apply(f,arguments)},function(b){f.reject.apply(f,arguments)})},function(){f.reject.apply(f,arguments)});return f};b.authenticateUser=function(b,d,k){d=d||{};b.expiry||(b.expiry=864E5);var n=this,r;f.isString(k)&&f.isObject(d.user)&&(b.user=d.user instanceof l.Appacitive.User?d.user.toJSON():
d.user,delete b.user.__meta,r=d.user);var u=new c._Request({method:"POST",type:"user",op:"getAuthenticateUserUrl",options:d,data:b,onSuccess:function(d){d&&d.user?(k&&(d.user.__authType=k),g(d.user,{__meta:d.__meta}),r instanceof l.Appacitive.User&&(d.user=r.copy(d.user,!0)),n.setCurrentUser(d.user,d.token,b.expiry),c.User.trigger("login",e,e,d.token),u.promise.fulfill({user:e,token:d.token})):u.promise.reject(d.status)}});return u.send()};b.login=function(b,c,d){if(!b||!c||0==b.length||0==c.length)throw Error("Please specify username and password");
...
getObject:function(b){return this.models.map(function(c){return c.getObject(b)})},add:function(b,c){c=c||{};var g,d,n,h,m,l={},t={},r=[],u=c.sort,B;b=f.isArray(b)?b.slice():[b];g=0;for(d=b.length;g<d;g++){b[g]=this._prepareModel(b[g]);n=b[g];if(!n)throw Error("Can't add an invalid model to a collection");h=n.cid;if(l[h]||this._byCid[h])throw Error("Duplicate cid: can't add the same model to a collection twice");(m=n.id)&&((B=t[m])||(B=this._byId[m]))?(B.copy(n.getObject(),c.setSnapShot),B.children=
n.children):(t[m]=n,l[h]=n,r.push(n),this._addReference(n,c))}this.models.splice.apply(this.models,[null!=c.at?c.at:this.models.length,0].concat(r));u&&this.comparator&&this.sort({silent:!0});this.length=this.models.length;if(c.silent)return this;g=0;for(d=r.length;g<d;g++)n=r[g],c.index=g,n.trigger("add",n,this,c);return this},remove:function(b,c){var g,d,l,h;c=c||{};b=f.isArray(b)?b.slice():[b];g=0;for(d=b.length;g<d;g++)if(h=this.getByCid(b[g])||this.get(b[g]))delete this._byId[h.id],delete this._byCid[h.cid],
...
f.isObject(g)&&(d.isNew()&&(g.isNew()?e.__endpointa.name=""+d.endpointA.object.cid:e.__endpointa.objectid=d.endpointA.object.id),n.apply(b,[g]));g=d.endpointB.object;f.isObject(g)&&(d.isNew()&&(g.isNew()?e.__endpointb.name=""+d.endpointB.object.cid:e.__endpointb.objectid=d.endpointB.object.id),n.apply(b,[g]));if(e){var g=c.find(function(b){return d.id&&d.id==b.connection.__id||d.cid==b.name}),h={connection:e};g&&(g.connection=e,h=g);d.isNew()?h.name=""+d.cid:h.connection.__id=d.id;g||c.push(h)}});
return c};c.Batch.prototype.add=function(){var b=this;f.isArray(arguments[0])?arguments[0].forEach(function(c){n.apply(b,[c])}):n.apply(this,arguments);return this};c.Batch.prototype.removeObjects=function(){var b=this,c=arguments;f.isArray(c[0])?arguments[0].forEach(function(d){k.apply(b,[d,c[1],c[2]])}):k.apply(this,c);return this};c.Batch.prototype.removeConnections=function(){var b=this,c=arguments;f.isArray(c[0])?arguments[0].forEach(function(e){d.apply(b,[e,c[1],c[2]])}):d.apply(this,c);return this};
...
b.connection;e.connections.forEach(function(e){if(e.cid==b.name||e.id==f.__id||e.get("__id")==f.__id){var g={__meta:c[e.className]};g[e.getType()]=f;e._parseOutput(d,g)}})})},r=function(b,d){var e;b&&b.edges&&b.nodes&&0<=b.edges.length&&0<=b.nodes.length?(v.call(this,b.nodes,b.__meta.__type,d),t.call(this,b.edges,b.__meta.__rel,d),d.silent||this.trigger("sync",this,{objects:this.objects,connections:this.connections},d)):(b=b||{},b.status=b.status||{},e=(e=b.status)||{},e.message=e.message||"Server error",
...
op:"getBatchUrl",data:d,options:b,entity:this,onSuccess:function(c){(c=r.apply(e,[c,b]))?f.promise.reject(c,e):f.promise.fulfill(e)}});return f.send()};c.Events.mixin(c.Batch.prototype)})(global);
...
b)})};this.save=function(b,c){"number"!==typeof b&&(c=b,b=-1);return this.fileId&&f.isString(this.fileId)&&0<this.fileId.length?l(b,c):d(b,c)};var d=function(d,g){if(!b.fileData)throw Error("Please specify filedata");if(!b.contentType)try{b.contentType=b.fileData.type}catch(l){}b.contentType&&f.isString(b.contentType)&&0!==b.contentType.length||(b.contentType="text/plain");var n=c.Promise.buildPromise(g),r=c.config.apiBaseUrl+c.storage.urlFactory.file.getUploadUrl(b.contentType,b.fileId?b.fileId:
"");e(r,function(c){k(c.url,b.fileData,b.contentType,function(){b.fileId=c.id;b.getDownloadUrl(d,g).then(function(c){return n.fulfill(c,b)},function(b){return n.reject(b)})},n)},n," Get upload url for file ",g);return n},l=function(d,g){if(!b.fileData)throw Error("Please specify filedata");if(!b.contentType)try{b.contentType=b.fileData.type}catch(l){}b.contentType&&f.isString(b.contentType)&&0!==b.contentType.length||(b.contentType="text/plain");var n=c.Promise.buildPromise(g),r=c.config.apiBaseUrl+
c.storage.urlFactory.file.getUpdateUrl(b.fileId,b.contentType);e(r,function(c){k(c.url,b.fileData,b.contentType,function(){b.getDownloadUrl(d,g).then(function(c){n.fulfill(c,b)},function(b){n.reject(b)})},n)},n," Get update url for file "+b.fileId,g);return n};this.destroy=function(d){if(!this.fileId)throw Error("Please specify fileId to delete");var e=c.Promise.buildPromise(d),f=new c.HttpRequest;f.url=c.config.apiBaseUrl+c.storage.urlFactory.file.getDeleteUrl(this.fileId);f.method="DELETE";f.description=
...
(function(l){var c=l.Appacitive,f=c.utils._type,g=c.runtime.isBrowser&&"object"==typeof window.localStorage&&f.isFunction(window.localStorage.getItem);c.LocalStorage=new function(){var b=g?window.localStorage:{};this.set=function(e,g){g=g||"";if(!f.isString(e))return this;if(f.isObject(g)||f.isArray(g))try{g=JSON.stringify(g)}catch(d){}var l=c.getAppPrefix(e);b[l]=g;return this};this.get=function(e){var k=new c.Promise;if(!f.isString(e))return k.fulfill(null,e);var d;d=c.getAppPrefix(e);(d=g?b.getItem(d):
b[d])||(d=null);if(d&&"{"===d[0])try{d=JSON.parse(d)}catch(l){}return k.fulfill(d,e)};this.multiGet=function(){var b=new c.Promise,f=this,d=Array.prototype.slice.call(arguments);if(1<arguments.length){var g={},h=[];d.forEach(function(b){Array.isArray(b)&&(b=b.join());b.replace(/\s/g,"").split(",").forEach(function(c){c=f.get(b);c.then(function(b,c){g[c]=b});h.push(c)})});c.Promise.when(h).then(function(){b.fulfill(g)});return b}throw Error("Appacitive.LocalStorage.multiGet requires atleast one argument");
};this.remove=function(e){if(!f.isString(e))return this;e=c.getAppPrefix(e);try{delete b[e]}catch(g){}}}})(global);
(function(l){var c=l.Appacitive;l=c.utils._type;"undefined"!=typeof document&&l.isString(document.cookie)&&(c.Cookie=new function(){this.setCookie=function(f,g,b,e){f=c.getAppPrefix(f);var k="";b&&(k=new Date,k.setTime(k.getTime()+6E4*b),k.toGMTString());k=e?"; expires=Thu, 01-Jan-1970 00:00:01 GMT":c.Session.persistUserToken?"; expires="+(new Date("2020-12-31")).toGMTString():"";b="domain="+window.location.hostname;"localhost"==window.location.hostname&&(b="");document.cookie=f+"="+g+k+"; path=/;"+
b};this.readCookie=function(f){f=c.getAppPrefix(f);f+="=";for(var g=document.cookie.split(";"),b=0;b<g.length;b++){for(var e=g[b];" "==e.charAt(0);)e=e.substring(1,e.length);if(0===e.indexOf(f))return e.substring(f.length,e.length)}return null};this.eraseCookie=function(c){this.setCookie(c,"",-1,!0)}})})(global);"object"===typeof module&&module.exports&&"function"===typeof require&&(module.exports=global.Appacitive);
