...
l.pageNumber=999999999;var h=this,k=this.toRequest();k.onSuccess=function(a){l.pageSize=e;l.pageNumber=d;a=a||{};var k=a.paginginfo,f=0;if(k)f=k.totalrecords;else if(a.status&&a.status.code&&"200"==a.status.code)f=0;else{a=a.status||{message:"Server error",code:400};"function"===typeof c&&c(a,h);return}"function"===typeof b&&b(f)};k.onError=function(a){l.pageSize=e;l.pageNumber=d;a=a||{message:"Server error",code:400};"function"===typeof c&&c(a,h)};a.Appacitive.http.send(k);return this}};a.Appacitive.Queries.FindAllQuery=
...
f.relation)+"."+f.type+".created",f,{object:f}),"function"==typeof e&&e(f)):(k=k||{},k.status=k.status||{},k.status=l(k.status),a.Appacitive.eventManager.fire((f.schema||f.relation)+"."+f.type+".createFailed",f,{error:k.status}),"function"==typeof h&&h(k.status,f))};g.onError=function(a){a=l(a);"function"==typeof h&&h(a,f)};a.Appacitive.http.send(g);return this},x=function(k,h,f){k=k||function(){};h=h||function(){};var g=function(g){var n=t(!0),m;for(m in n)"$"==m[0]&&delete n[m];if(Object.isEmpty(n))"function"==
typeof k&&k(e);else{"string"==typeof f?r=value:f="object"==typeof f&&f.length?f.join(","):r;m=new a.Appacitive.HttpRequest;var q=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[e.type].getUpdateUrl(b.__schematype||b.__relationtype,c.__id?c.__id:b.__id,f,g),w=e.type;b&&(b.__schematype&&("user"==b.__schematype.toLowerCase()||"device"==b.__schematype.toLowerCase()))&&(w=b.__schematype.toLowerCase(),q=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[b.__schematype.toLowerCase()].getUpdateUrl(c.__id,
f,g));m.url=q;m.method="post";m.data=n;m.onSuccess=function(g){g&&g[w]?(u.length=0,c=g[e.type],d(c,b),p=[],a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+w+"."+b.__id+".updated",e,{object:e}),"function"==typeof k&&k(e)):(g=g||{},g.status=g.status||{},g.status=l(g.status),"14008"==g.status.code&&0<u.length?x(k,h,f):(a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+w+"."+b.__id+".updateFailed",e,{object:g.status}),"function"==typeof h&&h(g.status,e)))};m.onError=function(a){a=a||
{};a.message=a.message||"Server error";a.code=a.code||"500";"14008"==a.code&&0<u.length?x(k,h,f):"function"==typeof h&&h(a,e)};a.Appacitive.http.send(m)}};if(0<u.length){var n=["__revision"];u.forEach(function(a){n.push(a.key)});z(function(a){u.forEach(function(b){var c=v.integer(a[b.key]);c||(c=0);e.set(b.key,c+b.amount)});g(a.__revision)},h,n,!0)}else g();return this},z=function(k,h,f,g){k=k||function(){};h=h||function(){};if(b.__id){"string"==typeof f?r=value:f="object"==typeof f&&f.length?f.join(","):
r;f=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[e.type].getGetUrl(b.__schematype||b.__relationtype,b.__id,f);var n=new a.Appacitive.HttpRequest;n.url=f;n.method="get";n.onSuccess=function(a){a&&a[e.type]?g?"function"==typeof k&&k(a[e.type]):(c=a[e.type],d(c,b),a.connection&&(e.endpoints||e.endpointA&&e.endpointB||e.setupConnection(b.__endpointa,b.__endpointb)),e.___collection&&"article"==e.___collection.collectionType&&e.___collection.addToCollection(e),"function"==typeof k&&k(e)):
...
if(!c.id)throw Error("Specify id to fetch");var f=new a.Appacitive.Connection({__relationtype:c.relation,__id:c.id});f.fields=c.fields;f.fetch(b,d)};var c=function(c){var b=[];c||(c=[]);c.forEach(function(c){b.push(new a.Appacitive.Connection(c))});return b},d=function(e,b,d){e.onSuccess=function(a){a&&a.status&&"200"==a.status.code?"function"===typeof b&&b(c(a.connections),a.paginginfo):(a=a||{},"function"===typeof d&&d(a.status||{message:"Server error",code:400}))};e.onError=function(a){a=a||{message:"Server error",
code:400};"function"===typeof d&&d(a)};a.Appacitive.http.send(e)};a.Appacitive.Connection.multiGet=function(c,b,f){c=c||{};if(!c.relation||"string"!==typeof c.relation||0===c.relation.length)throw Error("Specify valid relation");if(c.ids&&0<c.ids.length){var h=new a.Appacitive.HttpRequest;h.url=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.connection.getMultiGetUrl(c.relation,c.ids.join(","),c.fields);h.method="get";return d(h,b,f)}"function"===typeof b&&b([])};a.Appacitive.Connection.multiDelete=
function(c,b,d){c=c||{};if(!c.relation||"string"!==typeof c.relation||0===c.relation.length)throw Error("Specify valid relation");if(c.ids&&0<c.ids.length){var f=new a.Appacitive.HttpRequest;f.url=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.connection.getMultiDeleteUrl(c.relation);f.method="post";f.data={idlist:c.ids};f.onSuccess=function(a){a&&"200"==a.code?"function"===typeof b&&b():(a=a||{},"function"===typeof d&&d(a||{message:"Server error",code:400}))};f.onError=function(a){a=
a||{};"function"===typeof d&&d(a||{message:"Server error",code:400})};a.Appacitive.http.send(f)}else"function"===typeof b&&b()};a.Appacitive.Connection.getInterconnects=function(c,b,f){c=new a.Appacitive.Queries.InterconnectsQuery(c);d(c.toRequest(),request,b,f)};a.Appacitive.Connection.getBetweenArticles=function(c,b,f){c=new a.Appacitive.Queries.GetConnectionsBetweenArticlesQuery(c);d(c.toRequest(),b,f)};a.Appacitive.Connection.getBetweenArticlesForRelation=function(c,b,d){(new a.Appacitive.Queries.GetConnectionsBetweenArticlesForRelationQuery(c)).fetch(b,
d)}})(global);
(function(a){a.Appacitive.Users=new function(){var f=null;this.currentUser=function(){return f};var g=function(b,c,d,e,f){var g=b.get("__id");if(!g||"string"!==typeof g||0===g.length)throw Error("Please specify valid userid");if(!c||"string"!==typeof c||0===c.length)throw Error("Please specify valid oldPassword");if(!d||"string"!==typeof d||0===d.length)throw Error("Please specify valid newPassword");e=e||function(){};f=f||function(){};c={oldpassword:c,newpassword:d};d=new a.Appacitive.HttpRequest;d.url=
a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.user.getUpdatePasswordUrl(g);d.method="post";d.data=c;d.onSuccess=function(a){a&&"200"==a.code?"function"==typeof e&&e(b):f(a,b)};d.onError=f;a.Appacitive.http.send(d)},c=function(b,c,d){var e=b.get("__id");e&&"string"===typeof e&&0!==e.length||"function"===typeof c&&c(b.linkedAccounts(),b);c=c||function(){};d=d||function(){};var f=new a.Appacitive.HttpRequest;f.url=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.user.getGetAllLinkedAccountsUrl(e);
...
f)}})})(global);
(function(a){a.Appacitive.Cloud=new function(){var a=[],g=function(){if(2!==arguments.length)throw"Invalid no. of arguments provided to cloud function declare";if("string"!==typeof arguments[0])throw"Error: Provide name fo cloud api";if("function"!==typeof arguments[1])throw"Error: Invalid api function provided for cloud api";var c=arguments[0];if(!/^[A-Za-z][A-Za-z_0-9]*$/.test(c))throw"Error: Invalid name for api function "+c;a[c.toLowerCase()]=arguments[1]};this.declare=function(){g.apply(null,arguments)};
this.declare.toString=function(){return"function () { [native code] }"};var c=function(){if(2>arguments.length||"string"!==typeof arguments[0]||"object"!==typeof arguments[1])throw new "Error: Invalid list of arguments passed to cloud api";var c=arguments[0],e=arguments[1].request,b=arguments[1].response;if("function"==typeof a[c]){var g=a[c];setTimeout(function(){g.apply(null,[e,b])},0)}else throw{code:"404",message:"Error: Api with name "+arguments[0]+" doesn't exits"};};this.execute=function(){c.apply(null,
