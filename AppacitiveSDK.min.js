...
function(c){return new g(this,c)}};(function(c){c.Appacitive&&c.Appacitive.http&&(c.Appacitive.http.addProcessor({pre:function(c){return c},post:function(b,e){try{var g=c.Appacitive.Session.isSessionValid(b);g.status?b&&(b.status&&b.status.code&&"19036"==b.status.code||b.code&&"19036"==b.code)?c.Appacitive.Users.logout():c.Appacitive.Session.incrementExpiry():g.isSession&&(null!==c.Appacitive.Session.get()&&c.Appacitive.Session.resetSession(),c.Appacitive.http.send(e))}catch(k){}}}),c.Appacitive.http.addProcessor({pre:function(c){return{start:(new Date).getTime(),
