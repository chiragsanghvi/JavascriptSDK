...
1;0>=c&&(c=1);this.pageNumber(c);this.fetch(a,b);return this};this.count=function(b,c){b=b||function(){};c=c||function(){};var e=m.pageSize,d=m.pageNumber;m.pageSize=1;m.pageNumber=999999999;var h=this,k=this.toRequest();k.onSuccess=function(a){m.pageSize=e;m.pageNumber=d;a=a||{};var k=a.paginginfo,f=0;if(k)f=k.totalrecords;else if(a.status&&a.status.code&&"200"==a.status.code)f=0;else{a=a.status||{message:"Server error",code:400};"function"===typeof c&&c(a,h);return}"function"===typeof b&&b(f)};
k.onError=function(a){m.pageSize=e;m.pageNumber=d;a=a||{message:"Server error",code:400};"function"===typeof c&&c(a,h)};a.Appacitive.http.send(k);return this}};a.Appacitive.Queries.FindAllQuery=function(a){a=a||{};if(!a.schema&&!a.relation||a.schema&&a.relation)throw Error("Specify either schema or relation for basic filter query");a.queryType="BasicFilterQuery";c.call(this,a);return this};a.Appacitive.Queries.FindAllQuery.prototype=new c;a.Appacitive.Queries.FindAllQuery.prototype.constructor=a.Appacitive.Queries.FindAllQuery;
...
this.name=c;this.data={};this.queryType="GraphFilterQuery";if(e){this.data.placeholders=e;for(var b in this.data.placeholders)this.data.placeholders[b]=encodeURIComponent(String.addSlashes(this.data.placeholders[b]))}this.toRequest=function(){var b=new a.Appacitive.HttpRequest;b.url=this.toUrl();b.method="post";b.data=this.data;return b};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+"search/"+this.name+"/filter"};this.fetch=function(b,c){var e=this.toRequest();e.onSuccess=function(a){a&&
a.status&&"200"==a.status.code?"function"===typeof b&&b(a.ids?a.ids:[]):(a=a||{},"function"===typeof c&&c(a.status||{message:"Server error",code:400}))};e.onError=function(a){a=a||{};"function"===typeof c&&c(a.status||{message:"Server error",code:400})};a.Appacitive.http.send(e);return this}};a.Appacitive.Queries.GraphProjectQuery=function(c,e,b){if(!c||0===c.length)throw Error("Specify name of project query");if(!e||!e.length)throw Error("Specify ids to project");this.name=c;this.data={ids:e};this.queryType=
"GraphProjectQuery";if(b){this.data.placeholders=b;for(var f in this.data.placeholders)this.data.placeholders[f]=encodeURIComponent(String.addSlashes(this.data.placeholders[f]))}this.toRequest=function(){var b=new a.Appacitive.HttpRequest;b.url=this.toUrl();b.method="post";b.data=this.data;return b};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+"search/"+this.name+"/project"};var h=function(b){var c,e;for(e in b)if("status"!==e){c=b[e];break}var d=function(b,c,e){var m=[];b.forEach(function(b){var h=
b.__children;delete b.__children;var k=b.__edge;delete b.__edge;b=new a.Appacitive.Article(b,!0);b.children={};for(var f in h)b.children[f]=[],b.children[f]=d(h[f].values,h[f].parent,b.id);k&&(k.__endpointa={articleid:e,label:c},k.__endpointb={articleid:b.id(),label:k.__label},delete k.__label,b.connection=new a.Appacitive.Connection(k));m.push(b)});return m};return d(c.values)};this.fetch=function(b,c){var e=this.toRequest();e.onSuccess=function(a){a&&a.status&&"200"==a.status.code?"function"===
typeof b&&b(h(a)):(a=a||{},"function"===typeof c&&c(a.status||{message:"Server error",code:400}))};e.onError=function(a){a=a||{};"function"===typeof c&&c(a.status||{message:"Server error",code:400})};a.Appacitive.http.send(e);return this}}})(global);
