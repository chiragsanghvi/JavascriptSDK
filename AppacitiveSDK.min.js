/*
 * AppacitiveSDK.min.js v0.995 - Javascript SDK to integrate applictions using Appacitive
 * Copyright (c) 2013 Appacitive Software Pvt Ltd
 * MIT license  : http://www.apache.org/licenses/LICENSE-2.0.html
 * Project      : https://github.com/chiragsanghvi/JavascriptSDK
 * Contact      : support@appacitive.com | csanghvi@appacitive.com
 * Build time 	: Wed Jul 17 13:09:18 IST 2013
 */
...
a.method||(a.method="GET");a.headers||(a.headers=[]);var b={},d=!0;a.headers.forEach(function(a){"content-type"==a.key.toLowerCase()&&(d=!0,"application/json"==a.value.toLowerCase()||"application/javascript"==a.value.toLowerCase())&&(d=!1)});if(d)b=a.data;else if(a.data&&(b=a.data,"object"==typeof a.data))try{b=JSON.stringify(b)}catch(k){}a.onSuccess&&"function"==typeof a.onSuccess||(a.onSuccess=function(){});a.onError&&"function"==typeof a.onError||(a.onError=function(){});if(-1!=navigator.userAgent.indexOf("MSIE 8")||
-1!=navigator.userAgent.indexOf("MSIE 9"))return a.data=b,new c(a);var l=new f;l.onreadystatechange=function(){if(4==this.readyState)if(200<=this.status&&300>this.status||304==this.status){var c=this.responseText;try{var b=this.getResponseHeader("content-type")||this.getResponseHeader("Content-Type");if("application/json"==b.toLowerCase()||"application/javascript"==b.toLowerCase())b=c,global.Appacitive.runtime.isBrowser||"{"!=b[0]&&(b=b.substr(1,b.length-1)),c=JSON.parse(b)}catch(d){}a.onSuccess(c,
this)}else a.onError({code:this.status,message:this.statusText},this)};l.open(a.method,a.url,!0);for(var e=0;e<a.headers.length;e+=1)l.setRequestHeader(a.headers[e].key,a.headers[e].value);global.Appacitive.runtime.isBrowser||l.setRequestHeader("User-Agent","Appacitive-NodeJSSDK");l.send(b);return l},a=function(){var a=new e;a.isOnline=function(){return!0};var c=function(c,b,f){new d({method:c.method,url:c.url,headers:c.headers,data:c.data,onSuccess:function(d,e){if(d){try{d=JSON.parse(d)}catch(m){}var r=
...
typeof this.value&&this.value instanceof date?"datetime('"+e.Date.toISOString(this.value)+"')":this.value.toString()}},k=function(a){this.value=a;this.getValue=function(){return"object"==typeof this.value&&this.value instanceof Date?"date('"+e.Date.toISODate(this.value)+"')":"date('"+this.value+"'')"}},l=function(a){this.value=a;this.getValue=function(){return"object"==typeof this.value&&this.value instanceof Date?"time('"+e.Date.toISOTime(this.value)+"')":"time('"+this.value+"'')"}},n=function(a){this.value=
a;this.getValue=function(){return"object"==typeof this.value&&this.value instanceof Date?"datetime('"+e.Date.toISOString(this.value)+"')":"datetime('"+this.value+"'')"}},p=function(b,e,f){f||(f=this);f.type=b;f.name=e;f.equalTo=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:"=="})};f.equalToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"=="})};f.equalToTime=function(a){return new c({field:this.name,fieldType:this.type,
value:new l(a),operator:"=="})};f.equalToDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:"=="})};f.greaterThan=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:">"})};f.greaterThanDate=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:">"})};f.greaterThanTime=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:">"})};f.greaterThanDateTime=function(a){return new c({field:this.name,
fieldType:this.type,value:new n(a),operator:">"})};f.greaterThanEqualTo=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:">="})};f.greaterThanEqualToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:">="})};f.greaterThanEqualToTime=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:">="})};f.greaterThanEqualToDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),
operator:">="})};f.lessThan=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:"<"})};f.lessThanDate=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"<"})};f.lessThanTime=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"<"})};f.lessThanDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:"<"})};f.lessThanEqualTo=function(a){return new c({field:this.name,
fieldType:this.type,value:new h(a),operator:"<="})};f.lessThanEqualToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"<="})};f.lessThanEqualToTime=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"<="})};f.lessThanEqualToDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:"<="})};f.like=function(a){return new c({field:this.name,fieldType:this.type,value:new h("*"+a+"*"),operator:"like"})};
...
fieldType:this.type,val1:new k(b),val2:new k(c),operator:"between"})};f.betweenTime=function(b,c){return new a({field:this.name,fieldType:this.type,val1:new l(b),val2:new l(c),operator:"between"})};f.betweenDateTime=function(b,c){return new a({field:this.name,fieldType:this.type,val1:new n(b),val2:new n(c),operator:"between"})};f.withinCircle=function(a,b,c){return new g({field:this.name,fieldType:this.type,geoCoord:a,distance:b,unit:c,operator:"within_circle"})};f.withinPolygon=function(a){return new m({field:this.name,
...
arguments[0]||"__UtcLastUpdatedDate",this):a};this.isAscending=function(){return 1==arguments.length?(c="undefined"==typeof arguments[0]?!1:arguments[0],this):c};this.orderBy(b.orderBy);this.isAscending(b.isAscending)};f.prototype.toString=function(){return"orderBy="+this.orderBy()+"&isAsc="+this.isAscending()};var c=function(c){var a=c||{},g="",m="",h="",k=a.queryType||"BasicQuery",l=new e(c),n=new f(c),p=a.schema||a.relation,q=a.relation?"connection":"article";this.type=function(){return q};this.entityType=
...
"");this.setFilter=function(a){this.filter(a)};this.setFreeText=function(a){this.freeText(a)};this.setFields=function(a){this.fields(a)};this.extendOptions=function(b){for(var c in b)a[c]=b[c];l=new e(a);n=new f(a);return this};this.getQueryString=function(){var a=l.toString()+"&"+n.toString();if(this.filter()){var b=this.filter().toString();0<b.trim().length&&(a+="&query="+b)}this.freeText()&&0<this.freeText().trim().length&&(a+="&freetext="+this.freeText()+"&language=en");this.fields()&&0<this.fields().trim().length&&
...
!0))});return c};this.fetch=function(a,c){var d=this.toRequest();d.onSuccess=function(b){b&&b.status&&"200"==b.status.code?"function"==typeof a&&a(r(b[q+"s"]),b.paginginfo):(b=b||{},"function"==typeof c&&c(b.status||{message:"Server error",code:400}))};d.onError=function(a){a=a||{};"function"==typeof c&&c(a.status||{message:"Server error",code:400})};b.Appacitive.http.send(d);return this};this.count=function(a,c){a=a||function(){};c=c||function(){};var d=l.pageSize,g=l.pageNumber;l.pageSize=1;l.pageNumber=
999999999;var k=this,e=this.toRequest();e.onSuccess=function(b){l.pageSize=d;l.pageNumber=g;b=b||{};var e=b.paginginfo,h=0;if(e)h=e.totalrecords;else if(b.status&&b.status.code&&"200"==b.status.code)h=0;else{b=b.status||{message:"Server error",code:400};"function"==typeof c&&c(b,k);return}"function"==typeof a&&a(h)};e.onError=function(a){l.pageSize=d;l.pageNumber=g;a=a||{message:"Server error",code:400};"function"==typeof c&&c(a,k)};b.Appacitive.http.send(e);return this}};b.Appacitive.Queries.FindAllQuery=
...
a.data=this.data;return a};this.toUrl=function(){return b.Appacitive.config.apiBaseUrl+"search/"+this.name+"/project"};var f=function(a){var b,c;for(c in a)if("status"!==c){b=a[c];break}var d=function(a,b,c){var e=[];a.forEach(function(a){var g=a.__children;delete a.__children;var k=a.__edge;delete a.__edge;a=new Appacitive.Article(a,!0);a.children={};for(var h in g)a.children[h]=[],a.children[h]=d(g[h].values,g[h].parent,a.id);k&&(k.__endpointa={articleid:c,label:b},k.__endpointb={articleid:a.id,
label:k.label},delete k.label,a.connection=new Appacitive.Connection(k));e.push(a)});return e};return d(b.values)};this.fetch=function(a,c){var d=this.toRequest();d.onSuccess=function(b){b&&b.status&&"200"==b.status.code?"function"==typeof a&&a(f(b)):(b=b||{},"function"==typeof c&&c(b.status||{message:"Server error",code:400}))};d.onError=function(a){a=a||{};"function"==typeof c&&c(a.status||{message:"Server error",code:400})};b.Appacitive.http.send(d);return this}}})(global);
...
a.__attributes||(a.__attributes={});a.__attributes[arguments[0]]=arguments[1]}else throw Error(".attributes() called with an incorrect number of arguments. 0, 1, 2 are supported.");}return a.__attributes};var l=function(){var b=!1,d=JSON.parse(JSON.stringify(c.__attributes)),e;for(e in a.__attributes)"undefined"==typeof a.__attributes[e]||null===a.__attributes[e]?(d[e]=null,b=!0):a.__attributes[e]!=c.__attributes[e]?(d[e]=a.__attributes[e],b=!0):a.__attributes[e]==c.__attributes[e]&&delete d[e];return b?
d:null};this.getChangedAttributes=l;this.aggregates=function(){var b={},c;for(c in a){if(!a.hasOwnProperty(c))return;"$"==c[0]&&(b[c]=a[c])}if(0===arguments.length)return b;if(1==arguments.length)return b[arguments[0]];throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");};var n=[];a.__tags||(a.__tags=[]);c.__tags||(c.__tags=[]);this.tags=function(){return a.__tags?a.__tags:[]};this.addTag=function(b){if(!b||"string"!=typeof b||!b.length)return this;a.__tags.push(b);
...
function(b){var d=!1,e=JSON.parse(JSON.stringify(c)),g;for(g in a)"undefined"==typeof a[g]||null===a[g]?(e[g]=null,d=!0):a[g]!=c[g]?"__tags"==g||"__attributes"==g?delete e[g]:(e[g]=a[g],d=!0):a[g]==c[g]&&delete e[g];try{m.forEach(function(a){e[a]&&delete e[a]})}catch(k){}b?(a.__tags&&0<a.__tags.length&&(e.__addtags=p(),d=!0),n&&0<n.length&&(e.__removetags=n,d=!0)):a.__tags&&0<a.__tags.length&&(e.__tags=p(),d=!0);(b=l())?(e.__attributes=b,d=!0):delete e.__attributes;return d?e:!1};this.changed=function(){return q()};
...
u.apply(this,arguments):t.apply(this,arguments);return this};var t=function(e,g){e=e||function(){};g=g||function(){};var h=this,l=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[this.type].getCreateUrl(a.__schematype||a.__relationtype,r);!a.__schematype||"user"!=a.__schematype.toLowerCase()&&"device"!=a.__schematype.toLowerCase()||(l=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[a.__schematype.toLowerCase()].getCreateUrl());var f=new b.Appacitive.HttpRequest;f.url=
l;f.method="put";a.__revision&&delete a.__revision;f.data=a;f.onSuccess=function(f){var l=null;f&&(f.article||f.connection||f.user||f.device)&&(l=f.article||f.connection||f.user||f.device);f&&l?(c=l,a.__id=l.__id,d(l,a),h.connectionCollections&&0<h.connectionCollections.length&&h.connectionCollections.forEach(function(b){b.getQuery().extendOptions({articleId:a.__id})}),"connection"==h.type&&h.parseConnection(),b.Appacitive.eventManager.fire((h.schema||h.relation)+"."+h.type+".created",h,{object:h}),
"function"==typeof e&&e(h)):(f=f||{},f.status=f.status||{},f.status=k(f.status),b.Appacitive.eventManager.fire((h.schema||h.relation)+"."+h.type+".createFailed",h,{error:f.status}),"function"==typeof g&&g(f.status,h))};f.onError=function(a){a=k(a);"function"==typeof g&&g(a,h)};b.Appacitive.http.send(f);return this},u=function(e,g){e=e||function(){};g=g||function(){};var f=q(!0),h=this;if(f){var l=new b.Appacitive.HttpRequest,m=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[this.type].getUpdateUrl(a.__schematype||
a.__relationtype,c.__id?c.__id:a.__id,r);a&&(a.__schematype&&("user"==a.__schematype.toLowerCase()||"device"==a.__schematype.toLowerCase()))&&(m=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[a.__schematype.toLowerCase()].getUpdateUrl(c.__id));l.url=m;l.method="post";l.data=f;l.onSuccess=function(f){f&&(f.article||f.connection||f.user||f.device)?(c=f.article||f.connection||f.user||f.device,d(c,a),n=[],b.Appacitive.eventManager.fire((h.schema||h.relation)+"."+h.type+"."+a.__id+".updated",
h,{object:h}),"function"==typeof e&&e(h)):(f=f||{},f.status=f.status||{},f.status=k(f.status),b.Appacitive.eventManager.fire((h.schema||h.relation)+"."+h.type+"."+a.__id+".updateFailed",h,{object:f.status}),"function"==typeof g&&g(f.status,h))};l.onError=function(a){a=a||{};a.message=a.message||"Server error";a.code=a.code||"500";"function"==typeof g&&g(a,h)};b.Appacitive.http.send(l)}else"function"==typeof e&&e(h);return this};this.fetch=function(e,g){e=e||function(){};g=g||function(){};if(a.__id){var f=
this,h=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[this.type].getGetUrl(a.__schematype||a.__relationtype,a.__id,r),l=new b.Appacitive.HttpRequest;l.url=h;l.method="get";l.onSuccess=function(b){b&&(b.article||b.connection||b.user||b.device)?(c=b.article||b.connection||b.user||b.device,d(c,a),f.___collection&&"article"==f.___collection.collectionType&&f.___collection.addToCollection(f),"function"==typeof e&&e(f)):(b=b||{},b.status=b.status||{},b.status=k(b),"function"==typeof g&&
g(b.status,f))};l.onError=function(a){a=k(a);"function"==typeof g&&g(a,f)};b.Appacitive.http.send(l);return this}"function"==typeof g&&g({code:"400",message:"Please specify id for get operation"},this)};this.del=function(c,d,e){if(a.__id){c=c||function(){};d=d||function(){};var f=this,h=b.Appacitive.config.apiBaseUrl,h=h+b.Appacitive.storage.urlFactory[this.type].getDeleteUrl(a.__schematype||a.__relationtype,a.__id);a&&(a.__schematype&&("user"==a.__schematype.toLowerCase()||"device"==a.__schematype.toLowerCase()))&&
(h=b.Appacitive.config.apiBaseUrl,h+=b.Appacitive.storage.urlFactory[a.__schematype.toLowerCase()].getDeleteUrl(a.__id));e&&!0===e&&(h=-1==h.indexOf("?")?h+"?deleteconnections=true":h+"&deleteconnections=true");e=new b.Appacitive.HttpRequest;e.url=h;e.method="delete";e.onSuccess=function(b){"200"==b.code?(f.___collection&&f.___collection.removeById(a.__id),"function"==typeof c&&c(b)):(b=k(b),"function"==typeof d&&d(b,f))};e.onError=function(a){a=k(a);"function"==typeof d&&d(a,f)};b.Appacitive.http.send(e)}else this.___collection&&
...
(function(b){var e=function(){return Math.floor(65536*Math.random()).toString(16)};b.Appacitive.GUID=function(){var b=e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e(),c="",d,a,g,m,h,k,l=0,b=b.replace(/\r\n/g,"\n");a="";for(g=0;g<b.length;g++)m=b.charCodeAt(g),128>m?a+=String.fromCharCode(m):(127<m&&2048>m?a+=String.fromCharCode(m>>6|192):(a+=String.fromCharCode(m>>12|224),a+=String.fromCharCode(m>>6&63|128)),a+=String.fromCharCode(m&63|128));for(b=a;l<b.length;)d=b.charCodeAt(l++),a=b.charCodeAt(l++),
g=b.charCodeAt(l++),m=d>>2,d=(d&3)<<4|a>>4,h=(a&15)<<2|g>>6,k=g&63,isNaN(a)?h=k=64:isNaN(g)&&(k=64),c=c+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(m)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(d)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k);return c.toString()}})(global);
