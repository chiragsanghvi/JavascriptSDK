...
[],k;for(k in d)d.hasOwnProperty(k)&&a.push(d[k]);for(;0<c.length;){var g=c.shift(),f=[];for(k in e)e.hasOwnProperty(k)&&f.push(e[k](g));this.changeRequestForCors(g);b.send(g,a,f)}}};this.onResponse=function(b){console.dir(b)}},f=function(){var b=function(){throw Error("Not Implemented Exception");};this.inOnline=this.send=b;this.onResponse=function(c,a){b()};this.onError=function(c){b()}},g=null,g=global.Appacitive.runtime.isBrowser?XMLHttpRequest:require("xmlhttprequest").XMLHttpRequest,c=function(b){var c=
...
try{var e=this.getResponseHeader("content-type")||this.getResponseHeader("Content-Type");if("application/json"==e.toLowerCase()||"application/javascript"==e.toLowerCase()||"application/json; charset=utf-8"==e.toLowerCase()||"application/json; charset=utf-8;"==e.toLowerCase())e=c,global.Appacitive.runtime.isBrowser||"{"!=e[0]&&(e=e.substr(1,e.length-1)),c=JSON.parse(e)}catch(a){}b.onSuccess(c,this)}else b.onError({code:this.status,message:this.statusText},this)};l.open(b.method,b.url,!0);for(var f=
0;f<b.headers.length;f+=1)l.setRequestHeader(b.headers[f].key,b.headers[f].value);global.Appacitive.runtime.isBrowser||l.setRequestHeader("User-Agent","Appacitive-NodeJSSDK");l.send(e);return l}b.data=e;return new c(b)},e=function(){var b=new f;b.isOnline=function(){return!0};var c=function(c,e,a){new d({method:c.method,url:c.url,headers:c.headers,data:c.data,onSuccess:function(d,g){if(d){try{d=JSON.parse(d)}catch(m){}var f=d;if(e.length!=a.length)throw Error("Callback length and state length mismatch!");
...
value:a,operator:"=="})};g.between=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new h(a),val2:new h(b),operator:"between"})};g.betweenDate=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new k(a),val2:new k(b),operator:"between"})};g.betweenTime=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new l(a),val2:new l(b),operator:"between"})};g.betweenDateTime=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new n(a),
val2:new n(b),operator:"between"})};g.withinCircle=function(a,c,e){return new b({field:this.name,fieldType:this.type,geoCoord:a,distance:c,unit:e,operator:"within_circle"})};g.withinPolygon=function(a){return new m({field:this.name,fieldType:this.type,geoCoords:a,operator:"within_polygon"})}};_propertyExpression=function(a){if(!a||0==a.length)throw Error("Specify field name");this.field=a;p("property",a,this);return this};_aggregateExpression=function(a){if(!a||0==a.length)throw Error("Specify field name");
...
"");this.setFilter=function(a){this.filter(a)};this.setFreeText=function(a){this.freeText(a)};this.setFields=function(a){this.fields(a)};this.extendOptions=function(a){for(var b in a)e[b]=a[b];l=new f(e);n=new g(e);return this};this.getQueryString=function(){var a=l.toString()+"&"+n.toString();if(this.filter()){var b=this.filter().toString();0<b.trim().length&&(a+="&query="+b)}this.freeText()&&0<this.freeText().trim().length&&(a+="&freetext="+this.freeText()+"&language=en");this.fields()&&0<this.fields().trim().length&&
...
!0))});return c};this.fetch=function(b,c){var e=this.toRequest();e.onSuccess=function(a){a&&a.status&&"200"==a.status.code?"function"==typeof b&&b(u(a[r+"s"]),a.paginginfo):(a=a||{},"function"==typeof c&&c(a.status||{message:"Server error",code:400}))};e.onError=function(a){a=a||{};"function"==typeof c&&c(a.status||{message:"Server error",code:400})};a.Appacitive.http.send(e);return this};this.count=function(b,c){b=b||function(){};c=c||function(){};var e=l.pageSize,d=l.pageNumber;l.pageSize=1;l.pageNumber=
999999999;var k=this,h=this.toRequest();h.onSuccess=function(a){l.pageSize=e;l.pageNumber=d;a=a||{};var h=a.paginginfo,g=0;if(h)g=h.totalrecords;else if(a.status&&a.status.code&&"200"==a.status.code)g=0;else{a=a.status||{message:"Server error",code:400};"function"==typeof c&&c(a,k);return}"function"==typeof b&&b(g)};h.onError=function(a){l.pageSize=e;l.pageNumber=d;a=a||{message:"Server error",code:400};"function"==typeof c&&c(a,k)};a.Appacitive.http.send(h);return this}};a.Appacitive.Queries.FindAllQuery=
...
"function"==typeof e&&e(g)):(k=k||{},k.status=k.status||{},k.status=l(k.status),a.Appacitive.eventManager.fire((g.schema||g.relation)+"."+g.type+".createFailed",g,{error:k.status}),"function"==typeof h&&h(k.status,g))};f.onError=function(a){a=l(a);"function"==typeof h&&h(a,g)};a.Appacitive.http.send(f);return this},x=function(k,h,g){k=k||function(){};h=h||function(){};var f=function(f){var m=u(!0),n;for(n in m)"$"==n[0]&&delete m[n];if(Object.isEmpty(m))"function"==typeof k&&k(e);else{"string"==typeof g?
...
r;n.method="post";n.data=m;n.onSuccess=function(f){f&&f[v]?(t.length=0,c=f[e.type],d(c,b),p=[],a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+v+"."+b.__id+".updated",e,{object:e}),"function"==typeof k&&k(e)):(f=f||{},f.status=f.status||{},f.status=l(f.status),"14008"==f.status.code&&0<t.length?x(k,h,g):(a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+v+"."+b.__id+".updateFailed",e,{object:f.status}),"function"==typeof h&&h(f.status,e)))};n.onError=function(a){a=a||{};a.message=
a.message||"Server error";a.code=a.code||"500";"14008"==a.code&&0<t.length?x(k,h,g):"function"==typeof h&&h(a,e)};a.Appacitive.http.send(n)}};if(0<t.length){var m=["__revision"];t.forEach(function(a){m.push(a.key)});z(function(a){t.forEach(function(b){var c=w.integer(a[b.key]);c||(c=0);e.set(b.key,c+b.amount)});f(a.__revision)},h,m,!0)}else f();return this},z=function(k,h,g,f){k=k||function(){};h=h||function(){};if(b.__id){"string"==typeof g?q=value:g="object"==typeof g&&g.length?g.join(","):q;g=
...
c){k(b,c,a)},function(a){"function"==typeof b&&b(a,m)});return this};this.count=function(a,b){c.count(a,b);return this};this.fetchByPageNumber=function(a,b,e){c.getOptions().pageQuery.pageNumber=e;this.fetch(a,b);return this};this.fetchNextPage=function(a,b){c.getOptions().pageQuery.pageNumber+=1;this.fetch(a,b);return this};this.fetchPreviousPage=function(a,b){var e=c.getOptions().pageQuery;e.pageNumber-=1;0===e.pageNumber&&(e.pageNumber=1);this.fetch(a,b);return this};this.createNewConnection=function(b){b=
