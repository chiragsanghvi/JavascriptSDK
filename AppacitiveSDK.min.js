...
0!==b.length?this._object[b]&&!g.isUndefined(this._object[b])?!0:!1:!1};l.prototype.isNew=function(){return!(!g.isNullOrUndefined(this.id)||this.has(this.idAttribute))};l.prototype.clone=function(){return"object"==this.type?c.Object._create(b({__meta:this.meta},this.getObject())):c.Connection._create(b({__meta:this.meta},this.getObject()))};l.prototype.copy=function(b,c){b&&(this._copy(b,this._object),c&&this._copy(b,this._snapshot));return this};l.prototype.mergeWithPrevious=function(){this._copy(this._object,
