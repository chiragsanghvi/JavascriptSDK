...
c=function(c){var b=global.Appacitive.Promise.buildPromise({success:c.onSuccess,error:c.onError}),e=new XDomainRequest;e.onload=function(){var c=e.responseText;try{var h=e.contentType;if("application/json"==h.toLowerCase()||"application/javascript"==h.toLowerCase()||"application/json; charset=utf-8"==h.toLowerCase()||"application/json; charset=utf-8;"==h.toLowerCase())h=c,global.Appacitive.runtime.isBrowser||"{"!=h[0]&&(h=h.substr(1,h.length-1)),c=JSON.parse(h)}catch(l){}b.fulfill(c,this)};e.onerror=
...
(" "+h.toString()):c+String.format(" {0} {1} ",b,h.toString())});return c+=")"}};p.prototype=new e;p.prototype.constructor=p;var k={isEqualTo:"==",isGreaterThan:">",isGreaterThanEqualTo:">=",isLessThan:"<",isLessThanEqualTo:"<=",like:"like",match:"match",between:"between",withinCircle:"within_circle",withinPolygon:"within_polygon",or:"or",and:"and",taggedWithAll:"tagged_with_all",taggedWithOneOrMore:"tagged_with_one_or_more"},q=function(b,c){if(null===b||void 0===b||0===b.length)throw Error("Specify value");
...
function(e){e=e||{};if(!e.relation)throw Error("Specify relation for connected objects query");if(!e.objectId)throw Error("Specify objectId for connected objects query");if(!e.type)throw Error("Specify type of object id for connected objects query");var h=e.type;delete e.type;e.queryType="ConnectedObjectsQuery";c.call(this,e);this.objectId=e.objectId;this.relation=e.relation;this.type=h;e.object instanceof b.Appacitive.Object&&(this.object=e.object);this.returnEdge=!0;void 0===e.returnEdge||(null===
e.returnEdge||e.returnEdge||this.prev)||(this.returnEdge=!1);this.label="";var f=this;_type.isString(e.label)&&0<e.label.length&&(this.label="&label="+e.label);this.toRequest=function(){var c=new b.Appacitive.HttpRequest;c.url=this.toUrl();c.method="get";return c};this.toUrl=function(){return b.Appacitive.config.apiBaseUrl+"connection/"+this.relation+"/"+this.type+"/"+this.objectId+"/find?"+this.getQueryString()+this.label+"&returnEdge="+this.returnEdge};var m=function(c,h){var e=[];c.forEach(function(c){var g=
c.__edge;delete c.__edge;var f=b.Appacitive.Object._create(c,!0);g&&(g.__endpointa=h,g.__endpointb={objectid:c.__id,label:g.__label,type:c.__type},delete g.label,f.connection=b.Appacitive.Connection._create(g,!0));e.push(f)});f.object&&(f.object.children[f.relation]=e);return e};this.fetch=function(c){var p=b.Appacitive.Promise.buildPromise(c);c=this.toRequest();c.onSuccess=function(b){f.results=m(b.nodes?b.nodes:[],{objectid:e.objectId,type:h,label:b.parent});f._setPaging(b.paginginfo);p.fulfill(f.results,
...
h){e=c[h];break}var f=function(c,e,h){var l=[];c.forEach(function(c){var g=c.__children;delete c.__children;var k=c.__edge;delete c.__edge;c=b.Appacitive.Object._create(c,!0);c.children={};for(var m in g)c.children[m]=[],c.children[m]=f(g[m].values,g[m].parent,c.id);k&&(k.__endpointa={objectid:h,label:e},k.__endpointb={objectid:c.id(),label:k.__label},delete k.__label,c.connection=b.Appacitive.Connection._create(k,!0));l.push(c)});return l};return f(e.values)};this.fetch=function(c){var e=b.Appacitive.Promise.buildPromise(c);
