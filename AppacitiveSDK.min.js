...
function(b,c){a.__id?u.apply(this,arguments):v.apply(this,arguments);return this};var v=function(k,g,e){k=k||function(){};g=g||function(){};"string"==typeof e?p=value:e="object"==typeof e&&e.length?e.join(","):p;var h=this;e=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[this.type].getCreateUrl(a.__schematype||a.__relationtype,e);!a.__schematype||"user"!=a.__schematype.toLowerCase()&&"device"!=a.__schematype.toLowerCase()||(e=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[a.__schematype.toLowerCase()].getCreateUrl());
var f=new b.Appacitive.HttpRequest;f.url=e;f.method="put";a.__revision&&delete a.__revision;f.data=a;f.onSuccess=function(e){var f=null;e&&(e.article||e.connection||e.user||e.device)&&(f=e.article||e.connection||e.user||e.device);e&&f?(c=f,a.__id=f.__id,d(f,a),h.connectionCollections&&0<h.connectionCollections.length&&h.connectionCollections.forEach(function(b){b.getQuery().extendOptions({articleId:a.__id})}),"connection"==h.type&&h.parseConnection(),b.Appacitive.eventManager.fire((h.schema||h.relation)+
"."+h.type+".created",h,{object:h}),"function"==typeof k&&k(h)):(e=e||{},e.status=e.status||{},e.status=l(e.status),b.Appacitive.eventManager.fire((h.schema||h.relation)+"."+h.type+".createFailed",h,{error:e.status}),"function"==typeof g&&g(e.status,h))};f.onError=function(a){a=l(a);"function"==typeof g&&g(a,h)};b.Appacitive.http.send(f);return this},u=function(e,k,h){e=e||function(){};k=k||function(){};var g=q(!0),f=this;if(g){"string"==typeof h?p=value:h="object"==typeof h&&h.length?h.join(","):
p;var m=new b.Appacitive.HttpRequest;h=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[this.type].getUpdateUrl(a.__schematype||a.__relationtype,c.__id?c.__id:a.__id,h);a&&(a.__schematype&&("user"==a.__schematype.toLowerCase()||"device"==a.__schematype.toLowerCase()))&&(h=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[a.__schematype.toLowerCase()].getUpdateUrl(c.__id));m.url=h;m.method="post";m.data=g;m.onSuccess=function(h){h&&(h.article||h.connection||h.user||h.device)?
(c=h.article||h.connection||h.user||h.device,d(c,a),n=[],b.Appacitive.eventManager.fire((f.schema||f.relation)+"."+f.type+"."+a.__id+".updated",f,{object:f}),"function"==typeof e&&e(f)):(h=h||{},h.status=h.status||{},h.status=l(h.status),b.Appacitive.eventManager.fire((f.schema||f.relation)+"."+f.type+"."+a.__id+".updateFailed",f,{object:h.status}),"function"==typeof k&&k(h.status,f))};m.onError=function(a){a=a||{};a.message=a.message||"Server error";a.code=a.code||"500";"function"==typeof k&&k(a,
f)};b.Appacitive.http.send(m)}else"function"==typeof e&&e(f);return this};this.fetch=function(h,e,k){h=h||function(){};e=e||function(){};if(a.__id){"string"==typeof k?p=value:k="object"==typeof k&&k.length?k.join(","):p;var g=this;k=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[this.type].getGetUrl(a.__schematype||a.__relationtype,a.__id,k);var f=new b.Appacitive.HttpRequest;f.url=k;f.method="get";f.onSuccess=function(b){b&&(b.article||b.connection||b.user||b.device)?(c=b.article||
b.connection||b.user||b.device,d(c,a),g.___collection&&"article"==g.___collection.collectionType&&g.___collection.addToCollection(g),"function"==typeof h&&h(g)):(b=b||{},b.status=b.status||{},b.status=l(b),"function"==typeof e&&e(b.status,g))};f.onError=function(a){a=l(a);"function"==typeof e&&e(a,g)};b.Appacitive.http.send(f);return this}"function"==typeof e&&e({code:"400",message:"Please specify id for get operation"},this)};this.del=function(c,d,h){if(a.__id){c=c||function(){};d=d||function(){};
var e=this,k=b.Appacitive.config.apiBaseUrl,k=k+b.Appacitive.storage.urlFactory[this.type].getDeleteUrl(a.__schematype||a.__relationtype,a.__id);a&&(a.__schematype&&("user"==a.__schematype.toLowerCase()||"device"==a.__schematype.toLowerCase()))&&(k=b.Appacitive.config.apiBaseUrl,k+=b.Appacitive.storage.urlFactory[a.__schematype.toLowerCase()].getDeleteUrl(a.__id));h&&!0===h&&(k=-1==k.indexOf("?")?k+"?deleteconnections=true":k+"&deleteconnections=true");h=new b.Appacitive.HttpRequest;h.url=k;h.method=
"delete";h.onSuccess=function(b){"200"==b.code?(e.___collection&&e.___collection.removeById(a.__id),"function"==typeof c&&c(b)):(b=l(b),"function"==typeof d&&d(b,e))};h.onError=function(a){a=l(a);"function"==typeof d&&d(a,e)};b.Appacitive.http.send(h)}else this.___collection&&this.___collection.removeByCId(g),"function"==typeof c&&c(this)}};b.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())}})(global);
