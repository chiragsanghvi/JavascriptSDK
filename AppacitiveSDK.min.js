...
f.Date.toISODate(this.value)+"')":"date('"+this.value+"')"}},u=function(b){this.value=b;this.getValue=function(){return this.value instanceof Date?"time('"+f.Date.toISOTime(this.value)+"')":"time('"+this.value+"')"}},v=function(b){this.value=b;this.getValue=function(){return this.value instanceof Date?"datetime('"+f.Date.toISOString(this.value)+"')":"datetime('"+this.value+"')"}},t=function(b,c,f){f||(f=this);f.type=b;f.name=c;f.equalTo=function(b){return new h({field:this.name,fieldType:this.type,
value:new q(b),operator:n.isEqualTo})};f.equalToNumber=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b,"number"),operator:n.isEqualTo})};f.equalToDate=function(b){return new h({field:this.name,fieldType:this.type,value:new r(b),operator:n.isEqualTo})};f.equalToTime=function(b){return new h({field:this.name,fieldType:this.type,value:new u(b),operator:n.isEqualTo})};f.equalToDateTime=function(b){return new h({field:this.name,fieldType:this.type,value:new v(b),operator:n.isEqualTo})};
f.greaterThan=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b,"number"),operator:n.isGreaterThan})};f.greaterThanDate=function(b){return new h({field:this.name,fieldType:this.type,value:new r(b),operator:n.isGreaterThan})};f.greaterThanTime=function(b){return new h({field:this.name,fieldType:this.type,value:new u(b),operator:n.isGreaterThan})};f.greaterThanDateTime=function(b){return new h({field:this.name,fieldType:this.type,value:new v(b),operator:n.isGreaterThan})};
...
value:new v(b),operator:n.isGreaterThanEqualTo})};f.lessThan=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b,"number"),operator:n.isLessThan})};f.lessThanDate=function(b){return new h({field:this.name,fieldType:this.type,value:new r(b),operator:n.isLessThan})};f.lessThanTime=function(b){return new h({field:this.name,fieldType:this.type,value:new u(b),operator:n.isLessThan})};f.lessThanDateTime=function(b){return new h({field:this.name,fieldType:this.type,value:new v(b),
...
value:new v(b),operator:n.isLessThanEqualTo})};f.like=function(b){return new h({field:this.name,fieldType:this.type,value:new q("*"+b+"*"),operator:n.like})};f.match=function(b){return new h({field:this.name,fieldType:this.type,value:new q("*"+b+"*"),operator:n.match})};f.startsWith=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b+"*"),operator:n.like})};f.endsWith=function(b){return new h({field:this.name,fieldType:this.type,value:new q("*"+b),operator:n.like})};f.contains=
...
(c=arguments[0],this):c};this.isAscending=function(){return 1===arguments.length?(f=void 0===arguments[0]||null==arguments[0]?!1:arguments[0],this):f};this.orderBy(b.orderBy);this.isAscending(b.isAscending)};b.prototype.toString=function(){return this.orderBy()&&0<this.orderBy().length?"orderBy="+this.orderBy()+"&isAsc="+this.isAscending():""};var h=function(e){var g=e||{},h="",k="",p="",m=g.queryType||"BasicQuery",n=new f(e),q=new b(e),r=g.type||g.relation,u=g.relation?"connection":"object",v="object"==
u?"data":"connection",t=this;this.type=function(){return u};this.entityType=function(){return r};this.queryType=function(){return m};this.pageQuery=function(){return n};this.pageNumber=function(){return 1===arguments.length?(n.pageNumber(arguments[0]),this):n.pageNumber()};this.pageSize=function(){return 1===arguments.length?(n.pageSize(arguments[0]),this):n.pageSize()};this.sortQuery=function(){return q};this.orderBy=function(){return 1===arguments.length?(q.orderBy(arguments[0]),this):q.orderBy()};
this.isAscending=function(){return 1===arguments.length?(q.isAscending(arguments[0]),this):q.isAscending()};this.filter=function(){return 1===arguments.length?(h=arguments[0],this):h};this.freeText=function(){if(1===arguments.length){var b=arguments[0];_type.isString(b)?k=arguments[0]:_type.isArray(b)&&b.length&&(k=arguments[0].join(" "));return this}return k};this.fields=function(){if(1===arguments.length){var b=arguments[0];_type.isString(b)?p=b:_type.isArray(b)&&b.length&&(p=b.join(","));return this}return p};
this.filter(g.filter||"");this.freeText(g.freeText||"");this.fields(g.fields||"");this.setFilter=function(b){this.filter(b)};this.setFreeText=function(b){this.freeText(b)};this.setFields=function(b){this.fields(b)};this.extendOptions=function(c){for(var e in c)g[e]=c[e];n=new f(g);q=new b(g);return this};this.getQueryString=function(){var b=n.toString(),c=q.toString();c&&(b+="&"+c);this.filter()&&(c=this.filter().toString(),0<c.trim().length&&(b+="&query="+c));this.freeText()&&0<this.freeText().trim().length&&
(b+="&freetext="+this.freeText()+"&language=en");this.fields()&&0<this.fields().trim().length&&(b+="&fields="+this.fields());return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+v+"/"+r+"/find/all?"+this.getQueryString()};this.toRequest=function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};this.getOptions=function(){var b={},c;for(c in this)this.hasOwnProperty(c)&&!_type.isFunction(this[c])&&(b[c]=this[c]);return b};this._setPaging=function(b){b&&
(n.pageNumber(b.pagenumber),n.pageSize(b.pagesize),this.results=this.results||[],this.results.isLastPage=!1,this.results.total=b.totalrecords,this.results.pageNumber=b.pagenumber,this.results.pageSize=b.pagesize,b.pagenumber*b.pagesize>=b.totalrecords&&(this.results.isLastPage=!0))};var w=function(b){var e=[];b||(b=[]);var g="object"===u?"Object":"Connection";r&&"user"==r.toLowerCase()&&(g="User");b.forEach(function(b){e.push(new c.Appacitive[g](b,!0))});return e};this.fetch=function(b){var e=c.Appacitive.Promise.buildPromise(b);
b=this.toRequest();b.onSuccess=function(b){t.results=w(b[u+"s"]);t._setPaging(b.paginginfo);e.fulfill(t.results,b.paginginfo)};b.promise=e;b.entity=this;return c.Appacitive.http.send(b)};this.fetchNext=function(b){var c=this.pageNumber();this.pageNumber(++c);return this.fetch(b)};this.fetchPrev=function(b){var c=this.pageNumber(),c=c-1;0>=c&&(c=1);this.pageNumber(c);return this.fetch(b)};this.count=function(b){var e=c.Appacitive.Promise.buildPromise(b);b=this.toRequest();b.onSuccess=function(b){b=
...
b=k.__tags.indexOf(b);-1!=b&&k.__tags.splice(b,1);return this};var t=function(){if(!k.__tags)return[];if(!h.__tags)return k.__tags;var b=[];k.__tags.forEach(function(c){-1==h.__tags.indexOf(c)&&b.push(c)});return 0<b.length?b:null};this.getChangedTags=t;this.getRemovedTags=function(){return _removetags};var w=function(b){var c=!1,e=JSON.parse(JSON.stringify(h)),g;for(g in k)null==k[g]||void 0==k[g]?(e[g]=null,c=!0):k[g]!=h[g]?"__tags"==g||"__attributes"==g?delete e[g]:(e[g]=k[g],c=!0):k[g]==h[g]&&
delete e[g];try{q.forEach(function(b){e[b]&&delete e[b]})}catch(f){}g=t();b?(g&&(e.__addtags=g,c=!0),m&&0<m.length&&(e.__removetags=m,c=!0)):g&&(e.__addtags=g,c=!0);(b=v())?(e.__attributes=b,c=!0):delete e.__attributes;for(var l in e)"$"==l[0]&&delete e[l];return c&&!Object.isEmpty(e)?e:!1};this.changed=function(){return w()};this.hasChanged=function(){var b=w(!0);return 0===arguments.length?Object.isEmpty(b)?!1:!0:1==arguments.length&&_type.isString(arguments[0])&&0<arguments[0].length&&b&&b[arguments[0]]?
!0:!1};this.changedAttributes=function(){var b=w(!0);if(0===arguments.length)return b;if(1==arguments.length&&_type.isArray(arguments[0])&&arguments[0].length){var c={};arguments[0].forEach(function(e){b[e]&&c.push(b[e])});return c}return!1};this.previous=function(){return 1==arguments.length&&_type.isString(arguments[0])&&arguments[0].length?h[arguments[0]]:null};this.previousAttributes=function(){return h};this.fields=function(){if(1==arguments.length){var b=arguments[0];_type.isString(b)?n=b:_type.isArray(b)&&
(n=b.join(","));return this}return n};var x={integer:function(b){if(b){var c=parseInt(b);if(!isNaN(c))return c}return b},decimal:function(b){if(b){var c=parseFloat(b);if(!isNaN(c))return c}return b},"boolean":function(b){return void 0!==b&&null!==b&&("true"===b.toString().toLowerCase()||!0===b||0<b)?!0:!1},date:function(b){if(b){var e=c.Appacitive.Date.parseISODate(b);if(e)return e}return b},datetime:function(b){if(b){var e=c.Appacitive.Date.parseISODate(b);if(e)return e}return b},time:function(b){if(b){var e=
c.Appacitive.Date.parseISOTime(b);if(e)return e}return b},string:function(b){return b?b.toString():b},geocode:function(b){if(!_type.isString(b)||0==b.trim().length)return!1;b=b.split(",");return 2!==b.length?!1:new c.Appacitive.GeoCoord(b[0],b[1])}};this.get=function(b,c){if(b){if(c&&x[c.toLowerCase()]){if(x[c.toLowerCase()])return x[c.toLowerCase()](k[b]);throw Error('Invalid cast-type "'+c+'"" provided for get "'+b+'"');}return k[b]}};this.tryGet=function(b,c,e){b=this.get(b,e);return void 0!==
