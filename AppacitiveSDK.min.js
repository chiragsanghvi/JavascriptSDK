...
"string"!=typeof arguments[0]||"object"!=typeof arguments[1])throw new {code:400,message:"Invalid list of arguments passed to incoke cloud api"};var a=arguments[0],g=this.apis.filter(function(b){return b.name==a}),c=arguments[1].request,d=arguments[1].response;if(0<g.length){var e=g[0].method;setTimeout(function(){e.apply(null,[c,d])},0)}else throw{code:"404",message:"Api with name "+arguments[0]+" doesn't exits"};}}})(global);
