...
h=function(b){var e=global.Appacitive.Promise.buildPromise({success:b.onSuccess,error:b.onError}),g=new XDomainRequest;g.onload=function(){var b=g.responseText;try{var c=g.contentType;if("application/json"==c.toLowerCase()||"application/javascript"==c.toLowerCase()||"application/json; charset=utf-8"==c.toLowerCase()||"application/json; charset=utf-8;"==c.toLowerCase())c=b,global.Appacitive.runtime.isBrowser||"{"!=c[0]&&(c=c.substr(1,c.length-1)),b=JSON.parse(c)}catch(h){}e.fulfill(b,this)};g.onerror=
...
b.value.toLowerCase()||"application/json; charset=utf-8"==b.value.toLowerCase()||"application/json; charset=utf-8;"==b.value.toLowerCase())&&(f=!1)});if(f)g=e.data;else if(e.data&&(g=e.data,_type.isObject(e.data)))try{g=JSON.stringify(g)}catch(n){}e.onSuccess&&_type.isFunction(e.onSuccess)||(e.onSuccess=function(){});e.onError&&_type.isFunction(e.onError)||(e.onError=function(){});if(!global.navigator||-1==global.navigator.userAgent.indexOf("MSIE 8")&&-1==global.navigator.userAgent.indexOf("MSIE 9")){var q=
...
this)}else c.reject(this)};q.open(e.method,e.url,!0);for(var r=0;r<e.headers.length;r+=1)q.setRequestHeader(e.headers[r].key,e.headers[r].value);global.Appacitive.runtime.isBrowser||q.setRequestHeader("User-Agent","Appacitive-NodeJSSDK");q.send(g);return c}e.data=g;return new h(e)},g=function(){var b=new f;b.isOnline=function(){return!0};var g=function(g,c,h){new e({method:g.method,url:g.url,headers:g.headers,data:g.data,onSuccess:function(e,k){if(e){try{e=JSON.parse(e)}catch(f){}var t=e;if(c.length!=
h.length)throw Error("Callback length and state length mismatch!");for(var v=0;v<c.length;v+=1)c[v].apply({},[t,h[v]]);if("200"<=e.code&&"300">=e.code||e.status&&"200"<=e.status.code&&"300">=e.status.code)b.onResponse(g,e);else e=e||{},e=e.status||e,e.message=e.message||"Bad Request",e.code=e.code||"400",b.onError(g,{responseText:JSON.stringify(e)})}else b.onError(g,{responseText:JSON.stringify({code:"400",message:"Invalid request"})})},onError:function(e){b.onError(g,e)}})};b.send=function(b,e,c){if(!global.Appacitive.Session.initialized)throw Error("Initialize Appacitive SDK");
_type.isFunction(b.beforeSend)&&b.beforeSend(b);g(b,e,c)};return b};global.Appacitive.http=new function(){var b=new g,e=new c(b),h=!1;this.pause=function(){h=!0};this.unpause=function(){h=!1};this.addProcessor=function(b){var g=Error('Must provide a processor object with either a "pre" function or a "post" function.');if(!b)throw g;if(!b.pre&&!b.post)throw g;e.addProcessor(b)};this.send=function(g){g.promise=global.Appacitive.Promise.is(g.promise)?g.promise:new global.Appacitive.Promise.buildPromise({error:g.onError});
e.enqueueRequest(g);b.isOnline()&&!1===h&&e.notify();return g.promise};this.flush=function(g){g?e.notify():b.isOnline()&&e.notify()};this.onError=function(b,e){var g;if(e&&e.responseText)try{var c=JSON.parse(e.responseText);c&&(g={code:c.code,error:c.message})}catch(h){}g=g||{code:e.status,message:e.responseText};global.Appacitive.logs.logRequest(b,g,g,"error");b.promise.reject(g,b.entity)};b.onError=this.onError;this.onResponse=function(b,e){if(b.onSuccess)if(b.context)b.onSuccess.apply(b.context,
...
Date?"datetime('"+f.Date.toISOString(this.value)+"')":"datetime('"+this.value+"')"}},v=function(b,c,f){f||(f=this);f.type=b;f.name=c;f.equalTo=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b),operator:n.isEqualTo})};f.equalToNumber=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b,"number"),operator:n.isEqualTo})};f.equalToDate=function(b){return new h({field:this.name,fieldType:this.type,value:new r(b),operator:n.isEqualTo})};f.equalToTime=function(b){return new h({field:this.name,
fieldType:this.type,value:new u(b),operator:n.isEqualTo})};f.equalToDateTime=function(b){return new h({field:this.name,fieldType:this.type,value:new t(b),operator:n.isEqualTo})};f.greaterThan=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b),operator:n.isGreaterThan})};f.greaterThanDate=function(b){return new h({field:this.name,fieldType:this.type,value:new r(b),operator:n.isGreaterThan})};f.greaterThanTime=function(b){return new h({field:this.name,fieldType:this.type,value:new u(b),
operator:n.isGreaterThan})};f.greaterThanDateTime=function(b){return new h({field:this.name,fieldType:this.type,value:new t(b),operator:n.isGreaterThan})};f.greaterThanEqualTo=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b),operator:n.isGreaterThanEqualTo})};f.greaterThanEqualToDate=function(b){return new h({field:this.name,fieldType:this.type,value:new r(b),operator:n.isGreaterThanEqualTo})};f.greaterThanEqualToTime=function(b){return new h({field:this.name,fieldType:this.type,
value:new u(b),operator:n.isGreaterThanEqualTo})};f.greaterThanEqualToDateTime=function(b){return new h({field:this.name,fieldType:this.type,value:new t(b),operator:n.isGreaterThanEqualTo})};f.lessThan=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b),operator:n.isLessThan})};f.lessThanDate=function(b){return new h({field:this.name,fieldType:this.type,value:new r(b),operator:n.isLessThan})};f.lessThanTime=function(b){return new h({field:this.name,fieldType:this.type,value:new u(b),
operator:n.isLessThan})};f.lessThanDateTime=function(b){return new h({field:this.name,fieldType:this.type,value:new t(b),operator:n.isLessThan})};f.lessThanEqualTo=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b),operator:n.isLessThanEqualTo})};f.lessThanEqualToDate=function(b){return new h({field:this.name,fieldType:this.type,value:new r(b),operator:n.isLessThanEqualTo})};f.lessThanEqualToTime=function(b){return new h({field:this.name,fieldType:this.type,value:new u(b),
operator:n.isLessThanEqualTo})};f.lessThanEqualToDateTime=function(b){return new h({field:this.name,fieldType:this.type,value:new t(b),operator:n.isLessThanEqualTo})};f.like=function(b){return new h({field:this.name,fieldType:this.type,value:new q("*"+b+"*"),operator:n.like})};f.match=function(b){return new h({field:this.name,fieldType:this.type,value:new q("*"+b+"*"),operator:n.match})};f.startsWith=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b+"*"),operator:n.like})};
f.endsWith=function(b){return new h({field:this.name,fieldType:this.type,value:new q("*"+b),operator:n.like})};f.contains=function(b){return new e({field:this.name,fieldType:this.type,value:b,operator:n.isEqualTo})};f.between=function(b,c){return new g({field:this.name,fieldType:this.type,val1:new q(b),val2:new q(c),operator:n.between})};f.betweenDate=function(b,c){return new g({field:this.name,fieldType:this.type,val1:new r(b),val2:new r(c),operator:n.between})};f.betweenTime=function(b,c){return new g({field:this.name,
fieldType:this.type,val1:new u(b),val2:new u(c),operator:n.between})};f.betweenDateTime=function(b,c){return new g({field:this.name,fieldType:this.type,val1:new t(b),val2:new t(c),operator:n.between})};f.withinCircle=function(b,c,e){return new l({field:this.name,fieldType:this.type,geoCoord:b,distance:c,unit:e,operator:n.withinCircle})};f.withinPolygon=function(b){return new k({field:this.name,fieldType:this.type,geoCoords:b,operator:n.withinPolygon})}},x=function(b){if(!b||0===b.length)throw Error("Specify field name");
this.field=b;v("property",b,this);return this},w=function(b){if(!b||0===b.length)throw Error("Specify field name");this.field=b;var c=new v("aggregate",b);this.equalTo=function(b){return c.equalTo(b)};this.greaterThan=function(b){return c.greaterThan(b)};this.greaterThanEqualTo=function(b){return c.greaterThanEqualTo(b)};this.lessThan=function(b){return c.lessThan(b)};this.lessThanEqualTo=function(b){return c.lessThanEqualTo(b)};this.between=function(b,e){return c.between(b,e)};return this},y=function(b){if(!b||
0===b.length)throw Error("Specify field name");this.field=b;var c=new v("attribute",b);this.like=function(b){return c.like(b)};this.like=function(b){return c.match(b)};this.startWith=function(b){return c.startsWith(b)};this.endsWith=function(b){return c.endsWith(b)};this.equalTo=function(b){return c.equalTo(b)};this.contains=function(b){return c.contains(b)};return this};f.Filter={Property:function(b){return new x(b)},Aggregate:function(b){return new w(b)},Attribute:function(b){return new y(b)},Or:function(){return new m(n.or,
arguments)},And:function(){return new m(n.and,arguments)},taggedWithOneOrMore:function(b){return new p({tags:b,operator:n.taggedWithOneOrMore})},taggedWithAll:function(b){return new p({tags:b,operator:n.taggedWithAll})}}})(global);
