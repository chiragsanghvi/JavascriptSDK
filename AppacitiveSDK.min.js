...
"')":"time('"+this.value+"'')"}},n=function(a){this.value=a;this.getValue=function(){return"object"==typeof this.value&&this.value instanceof Date?"datetime('"+e.Date.toISOString(this.value)+"')":"datetime('"+this.value+"'')"}},r=function(b,e,f){f||(f=this);f.type=b;f.name=e;f.equalTo=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"=="})};f.equalToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"=="})};f.equalToTime=
...
function(){return r};this.queryType=function(){return k};this.pageQuery=function(){return h};this.pageNumber=function(){return 1==arguments.length?(h.pageNumber(arguments[0]),this):h.pageNumber};this.pageSize=function(){return 1==arguments.length?(h.pageSize(arguments[0]),this):h.pageSize};this.sortQuery=function(){return n};this.orderby=function(){return 1==arguments.length?(n.orderby(arguments[0]),this):n.orderby};this.isAscending=function(){return 1==arguments.length?(n.isAscending(arguments[0]),
...
this.relation+"/"+this.schema+"/"+this.articleId+"/find?"+this.getQueryString()+this.label};var g=function(a,b){var c=[];a.forEach(function(a){var d=a.__edge;delete a.__edge;d.__endpointa=b;d.__endpointb={article:a,label:d.__label,type:a.__schematype};delete d.label;a=new Appacitive.Connection(d,!0);c.push(a)});return c};this.fetch=function(c,l){var k=this.toRequest();k.onSuccess=function(b){b&&b.status&&"200"==b.status.code?"function"==typeof c&&c(g(b.nodes?b.nodes:[],{articleid:d.articleId,type:a,
label:b.parent}),b.paginginfo):(b=b||{},"function"==typeof l&&l(b.status||{message:"Server error",code:400}))};k.onError=function(a){a=a||{};"function"==typeof l&&l(a.status||{message:"Server error",code:400})};b.Appacitive.http.send(k);return this};return this};b.Appacitive.Queries.ConnectedArticlesQuery.prototype=new c;b.Appacitive.Queries.ConnectedArticlesQuery.prototype.constructor=b.Appacitive.Queries.ConnectedArticlesQuery;b.Appacitive.Queries.GetConnectionsQuery=function(d){d=d||{};if(!d.relation)throw Error("Specify relation for GetConnectionsQuery query");
...
!0);a.children={};for(var g in l)a.children[g]=[],a.children[g]=e(l[g].values,l[g].parent,a.id);h&&(h.__endpointa={articleid:d,label:c},h.__endpointb={articleid:a.id,label:h.__label},delete h.__label,a.connection=new b.Appacitive.Connection(h));k.push(a)});return k};return e(c.values)};this.fetch=function(a,c){var d=this.toRequest();d.onSuccess=function(b){b&&b.status&&"200"==b.status.code?"function"==typeof a&&a(f(b)):(b=b||{},"function"==typeof c&&c(b.status||{message:"Server error",code:400}))};
...
if(2==arguments.length){if("string"!==typeof arguments[1]&&null!=arguments[1])throw Error("only string values can be stored in attributes.");a.__attributes||(a.__attributes={});a.__attributes[arguments[0]]=arguments[1]}else throw Error(".attr() called with an incorrect number of arguments. 0, 1, 2 are supported.");}return a.__attributes};var h=function(){if(!c.__attributes)return null;var b=!1,d=JSON.parse(JSON.stringify(c.__attributes)),e;for(e in a.__attributes)"undefined"==typeof a.__attributes[e]||
null===a.__attributes[e]?(d[e]=null,b=!0):a.__attributes[e]!=c.__attributes[e]?(d[e]=a.__attributes[e],b=!0):a.__attributes[e]==c.__attributes[e]&&delete d[e];return b?d:null};this.getChangedAttributes=h;this.aggregates=function(){var b={},c;for(c in a){if(!a.hasOwnProperty(c))return;"$"==c[0]&&(b[c]=a[c])}if(0===arguments.length)return b;if(1==arguments.length)return b[arguments[0]];throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");};var n=[];a.__tags||
...
1);return this};var r=function(){if(!a.__tags)return[];if(!c.__tags)return a.__tags;var b=[];a.__tags.every(function(a){-1==c.__tags.indexOf(a)&&b.push(a)});return b};this.getChangedTags=r;this.getRemovedTags=function(){return _removetags};var q=function(b){var d=!1,e=JSON.parse(JSON.stringify(c)),k;for(k in a)"undefined"==typeof a[k]||null===a[k]?(e[k]=null,d=!0):a[k]!=c[k]?"__tags"==k||"__attributes"==k?delete e[k]:(e[k]=a[k],d=!0):a[k]==c[k]&&delete e[k];try{m.forEach(function(a){e[a]&&delete e[a]})}catch(l){}b?
(a.__tags&&0<a.__tags.length&&(e.__addtags=r(),d=!0),n&&0<n.length&&(e.__removetags=n,d=!0)):a.__tags&&0<a.__tags.length&&(e.__tags=r(),d=!0);(b=h())?(e.__attributes=b,d=!0):delete e.__attributes;return d?e:!1};this.changed=function(){return q()};this.hasChanged=function(){var a=q(!0);return 0===arguments.length?Object.isEmpty(a)?!1:!0:1==arguments.length&&"string"==typeof arguments[0]&&0<arguments[0].length&&a&&a[arguments[0]]?!0:!1};this.changedAttributes=function(){var a=q(!0);if(0===arguments.length)return a;
...
{integer:function(a){if(a){var b=parseInt(a);if(!isNaN(b))return b}return a},decimal:function(a){if(a){var b=parseFloat(a);if(!isNaN(b))return b}return a},"boolean":function(a){return"true"==a||!0==a||0<a?!0:!1},date:function(a){if(a){var b=Appacitive.Date.parseISODate(a);if(b)return b}return a},datetime:function(a){if(a){var b=Appacitive.Date.parseISODate(a);if(b)return b}return a},time:function(a){if(a){var b=Appacitive.Date.parseISOTime(a);if(b)return b}return a},string:function(a){return a?a.toSting():
a}};this.get=function(b,c){if(b)return c&&t[c.toLowerCase()]?t[c.toLowerCase()](a[b]):a[b]};this.tryGet=function(a,b,c){a=this.get(a,c);return void 0!=a?a:b};this.set=function(b,c){if(!b||"string"!=typeof b||0==b.length||0==b.trim().indexOf("$"))return this;null==c||"undefined"==c?a[b]=null:"string"==typeof c?a[b]=c:"number"==typeof c||"boolean"==typeof c?a[b]=c+"":"object"==typeof c&&(c instanceof Date?a[b]=Appacitive.Date.toISOString(c):0<=c.length?a[b]=c:-1!==l.indexOf(b)&&(a[b]=c));return this};
this.unset=function(b){if(!b||"string"!=typeof b||0==b.length||0==b.indexOf("__"))return this;try{delete a[b]}catch(c){}return this};this.has=function(b){return b&&"string"==typeof b&&0!=b.length?a[b]&&"undefined"!=typeof a[b]?!0:!1:!1};this.isNew=function(){return a.__id&&a.__id.length?!1:!0};this.clone=function(){return"article"==this.type?new b.Appacitive.Article(this.toJSON()):new b.Appacitive.connection(a)};this.copy=function(b,e){b&&(d(b,a),e&&d(b,c));return this};this.save=function(b,c){a.__id?
u.apply(this,arguments):v.apply(this,arguments);return this};var v=function(e,l,h){e=e||function(){};l=l||function(){};"string"==typeof h?p=value:h="object"==typeof h&&h.length?h.join(","):p;var g=this;h=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[this.type].getCreateUrl(a.__schematype||a.__relationtype,h);!a.__schematype||"user"!=a.__schematype.toLowerCase()&&"device"!=a.__schematype.toLowerCase()||(h=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[a.__schematype.toLowerCase()].getCreateUrl());
...
(c=g.article||g.connection||g.user||g.device,d(c,a),n=[],b.Appacitive.eventManager.fire((f.schema||f.relation)+"."+f.type+"."+a.__id+".updated",f,{object:f}),"function"==typeof e&&e(f)):(g=g||{},g.status=g.status||{},g.status=k(g.status),b.Appacitive.eventManager.fire((f.schema||f.relation)+"."+f.type+"."+a.__id+".updateFailed",f,{object:g.status}),"function"==typeof h&&h(g.status,f))};m.onError=function(a){a=a||{};a.message=a.message||"Server error";a.code=a.code||"500";"function"==typeof h&&h(a,
f)};b.Appacitive.http.send(m)}else"function"==typeof e&&e(f);return this};this.fetch=function(e,g,h){e=e||function(){};g=g||function(){};if(a.__id){"string"==typeof h?p=value:h="object"==typeof h&&h.length?h.join(","):p;var l=this;h=b.Appacitive.config.apiBaseUrl+b.Appacitive.storage.urlFactory[this.type].getGetUrl(a.__schematype||a.__relationtype,a.__id,h);var f=new b.Appacitive.HttpRequest;f.url=h;f.method="get";f.onSuccess=function(b){b&&(b.article||b.connection||b.user||b.device)?(c=b.article||
b.connection||b.user||b.device,d(c,a),l.___collection&&"article"==l.___collection.collectionType&&l.___collection.addToCollection(l),"function"==typeof e&&e(l)):(b=b||{},b.status=b.status||{},b.status=k(b),"function"==typeof g&&g(b.status,l))};f.onError=function(a){a=k(a);"function"==typeof g&&g(a,l)};b.Appacitive.http.send(f);return this}"function"==typeof g&&g({code:"400",message:"Please specify id for get operation"},this)};this.del=function(c,d,e){if(a.__id){c=c||function(){};d=d||function(){};
var h=this,l=b.Appacitive.config.apiBaseUrl,l=l+b.Appacitive.storage.urlFactory[this.type].getDeleteUrl(a.__schematype||a.__relationtype,a.__id);a&&(a.__schematype&&("user"==a.__schematype.toLowerCase()||"device"==a.__schematype.toLowerCase()))&&(l=b.Appacitive.config.apiBaseUrl,l+=b.Appacitive.storage.urlFactory[a.__schematype.toLowerCase()].getDeleteUrl(a.__id));e&&!0===e&&(l=-1==l.indexOf("?")?l+"?deleteconnections=true":l+"&deleteconnections=true");e=new b.Appacitive.HttpRequest;e.url=l;e.method=
"delete";e.onSuccess=function(b){"200"==b.code?(h.___collection&&h.___collection.removeById(a.__id),"function"==typeof c&&c(b)):(b=k(b),"function"==typeof d&&d(b,h))};e.onError=function(a){a=k(a);"function"==typeof d&&d(a,h)};b.Appacitive.http.send(e)}else this.___collection&&this.___collection.removeByCId(g),"function"==typeof c&&c(this)}};b.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())}})(global);
