...
null),"function"===typeof d&&d(c)):e(a,c)};g.onError=e;a.Appacitive.http.send(g)}else"function"===typeof d&&d(c)};this.setCurrentUser=function(c,k,l){if(!c)throw Error("Cannot set null object as user");var n=c;if(n instanceof a.Appacitive.User)if(n.get("__id")&&0!==n.get("__id").length)c=n.toJSON();else throw Error("Specify user __id");else n=new a.Appacitive.User(c,!0);a.Appacitive.localStorage.set("Appacitive-User",c);l||(l=60);f=n;k&&a.Appacitive.Session.setUserAuthHeader(k,l);f.logout=function(b){a.Appacitive.Users.logout(b)};
...
b.get("__id")+".updated",b,{object:b});"function"===typeof c&&c(b)},d);return this};f.logout=function(b){a.Appacitive.Users.logout(b)};f.checkin=function(a,b,c){d(a,this,b,c);return this};a.Appacitive.eventManager.clearAndSubscribe("user.article."+n.get("__id")+".updated",function(b,c){a.Appacitive.localStorage.set("Appacitive-User",c.object.getArticle())});return f};a.Appacitive.User=function(b){b=b||{};b.__schematype="user";a.Appacitive.Article.call(this,b);return this};a.Appacitive.User.prototype=
