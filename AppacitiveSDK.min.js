...
a;this.getValue=function(){return"object"==typeof this.value&&this.value instanceof Date?"datetime('"+e.Date.toISOString(this.value)+"')":"datetime('"+this.value+"'')"}},r=function(b,e,f){f||(f=this);f.type=b;f.name=e;f.equalTo=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"=="})};f.equalToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"=="})};f.equalToTime=function(a){return new c({field:this.name,fieldType:this.type,
