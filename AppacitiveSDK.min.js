...
String.stripSlashes=function(a){if(!a)return a;a=a.replace(/\\'/g,"'");a=a.replace(/\\"/g,'"');a=a.replace(/\\0/g,"\x00");return a=a.replace(/\\\\/g,"\\")};
...
function(){var a=this.operator,b="(";this.innerFilters.forEach(function(c){b=1===b.length?b+(" "+c.toString()):b+String.format(" {0} {1} ",a,c.toString())});return b+=")"}};k.prototype=new g;k.prototype.constructor=k;var l=function(a,b){if(null===a||void 0===a||0===a.length)throw Error("Specify value");this.value=a;this.type=b?b:typeof this.value;this.getValue=function(){return"string"===this.type?"'"+encodeURIComponent(String.addSlashes(this.value))+"'":"number"===this.type||"boolean"===typeof this.value?
...
q=function(a){this.value=a;this.getValue=function(){return"object"===typeof this.value&&this.value instanceof Date?"datetime('"+f.Date.toISOString(this.value)+"')":"datetime('"+this.value+"')"}},t=function(a,k,h){h||(h=this);h.type=a;h.name=k;h.equalTo=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"=="})};h.equalToNumber=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a,"number"),operator:"=="})};h.equalToDate=function(a){return new c({field:this.name,
fieldType:this.type,value:new n(a),operator:"=="})};h.equalToTime=function(a){return new c({field:this.name,fieldType:this.type,value:new p(a),operator:"=="})};h.equalToDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new q(a),operator:"=="})};h.greaterThan=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:">"})};h.greaterThanDate=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:">"})};h.greaterThanTime=
function(a){return new c({field:this.name,fieldType:this.type,value:new p(a),operator:">"})};h.greaterThanDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new q(a),operator:">"})};h.greaterThanEqualTo=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:">="})};h.greaterThanEqualToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:">="})};h.greaterThanEqualToTime=function(a){return new c({field:this.name,
...
function(a){return new c({field:this.name,fieldType:this.type,value:new q(a),operator:"<"})};h.lessThanEqualTo=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"<="})};h.lessThanEqualToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:"<="})};h.lessThanEqualToTime=function(a){return new c({field:this.name,fieldType:this.type,value:new p(a),operator:"<="})};h.lessThanEqualToDateTime=function(a){return new c({field:this.name,
fieldType:this.type,value:new q(a),operator:"<="})};h.like=function(a){return new c({field:this.name,fieldType:this.type,value:new l("*"+a+"*"),operator:"like"})};h.startsWith=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a+"*"),operator:"like"})};h.endsWith=function(a){return new c({field:this.name,fieldType:this.type,value:new l("*"+a),operator:"like"})};h.contains=function(a){return new d({field:this.name,fieldType:this.type,value:a,operator:"=="})};h.between=function(a,
b){return new e({field:this.name,fieldType:this.type,val1:new l(a),val2:new l(b),operator:"between"})};h.betweenDate=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new n(a),val2:new n(b),operator:"between"})};h.betweenTime=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new p(a),val2:new p(b),operator:"between"})};h.betweenDateTime=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new q(a),val2:new q(b),operator:"between"})};h.withinCircle=
function(a,c,e){return new b({field:this.name,fieldType:this.type,geoCoord:a,distance:c,unit:e,operator:"within_circle"})};h.withinPolygon=function(a){return new m({field:this.name,fieldType:this.type,geoCoords:a,operator:"within_polygon"})}},r=function(a){if(!a||0===a.length)throw Error("Specify field name");this.field=a;t("property",a,this);return this},v=function(a){if(!a||0===a.length)throw Error("Specify field name");this.field=a;var b=new t("aggregate",a);this.equalTo=function(a){return b.equalTo(a)};
...
delete d[a]})}catch(f){}a?(b.__tags&&0<b.__tags.length&&(d.__addtags=q(),e=!0),p&&0<p.length&&(d.__removetags=p,e=!0)):b.__tags&&0<b.__tags.length&&(d.__tags=q(),e=!0);(a=n())?(d.__attributes=a,e=!0):delete d.__attributes;for(var k in d)"$"==k[0]&&delete d[k];return e&&!Object.isEmpty(d)?d:!1};this.changed=function(){return t()};this.hasChanged=function(){var a=t(!0);return 0===arguments.length?Object.isEmpty(a)?!1:!0:1==arguments.length&&"string"==typeof arguments[0]&&0<arguments[0].length&&a&&a[arguments[0]]?
...
f.relation)+"."+f.type+".created",f,{object:f}),"function"==typeof e&&e(f)):(k=k||{},k.status=k.status||{},k.status=l(k.status),a.Appacitive.eventManager.fire((f.schema||f.relation)+"."+f.type+".createFailed",f,{error:k.status}),"function"==typeof h&&h(k.status,f))};g.onError=function(a){a=l(a);"function"==typeof h&&h(a,f)};a.Appacitive.http.send(g);return this},x=function(h,k,f){h=h||function(){};k=k||function(){};var g=function(g){var n=t(!0),m;for(m in n)"$"==m[0]&&delete n[m];if(Object.isEmpty(n))"function"==
typeof h&&h(e);else{"string"==typeof f?r=value:f="object"==typeof f&&f.length?f.join(","):r;m=new a.Appacitive.HttpRequest;var q=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[e.type].getUpdateUrl(b.__schematype||b.__relationtype,c.__id?c.__id:b.__id,f,g),w=e.type;b&&(b.__schematype&&("user"==b.__schematype.toLowerCase()||"device"==b.__schematype.toLowerCase()))&&(w=b.__schematype.toLowerCase(),q=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[b.__schematype.toLowerCase()].getUpdateUrl(c.__id,
f,g));m.url=q;m.method="post";m.data=n;m.onSuccess=function(g){g&&g[w]?(u.length=0,c=g[e.type],d(c,b),p=[],a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+w+"."+b.__id+".updated",e,{object:e}),"function"==typeof h&&h(e)):(g=g||{},g.status=g.status||{},g.status=l(g.status),"14008"==g.status.code&&0<u.length?x(h,k,f):(a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+w+"."+b.__id+".updateFailed",e,{object:g.status}),"function"==typeof k&&k(g.status,e)))};m.onError=function(a){a=a||
{};a.message=a.message||"Server error";a.code=a.code||"500";"14008"==a.code&&0<u.length?x(h,k,f):"function"==typeof k&&k(a,e)};a.Appacitive.http.send(m)}};if(0<u.length){var n=["__revision"];u.forEach(function(a){n.push(a.key)});z(function(a){u.forEach(function(b){var c=v.integer(a[b.key]);c||(c=0);e.set(b.key,c+b.amount)});g(a.__revision)},k,n,!0)}else g();return this},z=function(h,k,f,g){h=h||function(){};k=k||function(){};if(b.__id){"string"==typeof f?r=value:f="object"==typeof f&&f.length?f.join(","):
r;f=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[e.type].getGetUrl(b.__schematype||b.__relationtype,b.__id,f);var n=new a.Appacitive.HttpRequest;n.url=f;n.method="get";n.onSuccess=function(a){a&&a[e.type]?g?"function"==typeof h&&h(a[e.type]):(c=a[e.type],d(c,b),a.connection&&(e.endpoints||e.endpointA&&e.endpointB||e.setupConnection(b.__endpointa,b.__endpointb)),e.___collection&&"article"==e.___collection.collectionType&&e.___collection.addToCollection(e),"function"==typeof h&&h(e)):
(a=a||{},a.status=a.status||{},a.status=l(a.status),"function"==typeof k&&k(a.status,e))};n.onError=function(a){a=l(a);"function"==typeof k&&k(a,e)};a.Appacitive.http.send(n);return e}"function"==typeof k&&k({code:"400",message:"Please specify id for get operation"},e)};this.fetch=function(a,b,c){z(a,b,c)};this.del=function(c,e,d){if(b.__id){c=c||function(){};e=e||function(){};var k=this,h=a.Appacitive.config.apiBaseUrl,h=h+a.Appacitive.storage.urlFactory[this.type].getDeleteUrl(b.__schematype||b.__relationtype,
...
a.Appacitive.Connection.multiDelete=function(c,b,d){c=c||{};if(!c.relation||"string"!==typeof c.relation||0===c.relation.length)throw Error("Specify valid relation");if(c.ids&&0<c.ids.length){var f=new a.Appacitive.HttpRequest;f.url=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.connection.getMultiDeleteUrl(c.relation);f.method="post";f.data={idlist:c.ids};f.onSuccess=function(a){a&&"200"==a.code?"function"===typeof b&&b():(a=a||{},"function"===typeof d&&d(a||{message:"Server error",
code:400}))};f.onError=function(a){a=a||{};"function"===typeof d&&d(a||{message:"Server error",code:400})};a.Appacitive.http.send(f)}else"function"===typeof b&&b()};a.Appacitive.Connection.findAll=function(c,b,d){return(new a.Appacitive.Queries.FindAllQuery(c)).fetch(b,d)};a.Appacitive.Connection.getInterconnects=function(c,b,d){return(new a.Appacitive.Queries.InterconnectsQuery(c)).fetch(b,d)};a.Appacitive.Connection.getBetweenArticles=function(c,b,d){return(new a.Appacitive.Queries.GetConnectionsBetweenArticlesQuery(c)).fetch(b,
