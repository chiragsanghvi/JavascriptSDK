...
this.name=c;this.data={};this.queryType="GraphFilterQuery";if(e){this.data.placeholders=e;for(var b in this.data.placeholders)this.data.placeholders[b]=String.addSlashes(this.data.placeholders[b])}this.toRequest=function(){var b=new a.Appacitive.HttpRequest;b.url=this.toUrl();b.method="post";b.data=this.data;return b};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+"search/"+this.name+"/filter"};this.fetch=function(b,c){var e=this.toRequest();e.onSuccess=function(a){a&&a.status&&"200"==
...
if(b){this.data.placeholders=b;for(var f in this.data.placeholders)this.data.placeholders[f]=String.addSlashes(this.data.placeholders[f])}this.toRequest=function(){var b=new a.Appacitive.HttpRequest;b.url=this.toUrl();b.method="post";b.data=this.data;return b};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+"search/"+this.name+"/project"};var h=function(b){var c,e;for(e in b)if("status"!==e){c=b[e];break}var d=function(b,c,e){var h=[];b.forEach(function(b){var m=b.__children;delete b.__children;
var k=b.__edge;delete b.__edge;b=new a.Appacitive.Article(b,!0);b.children={};for(var f in m)b.children[f]=[],b.children[f]=d(m[f].values,m[f].parent,b.id);k&&(k.__endpointa={articleid:e,label:c},k.__endpointb={articleid:b.id(),label:k.__label},delete k.__label,b.connection=new a.Appacitive.Connection(k));h.push(b)});return h};return d(c.values)};this.fetch=function(b,c){var e=this.toRequest();e.onSuccess=function(a){a&&a.status&&"200"==a.status.code?"function"===typeof b&&b(h(a)):(a=a||{},"function"===
typeof c&&c(a.status||{message:"Server error",code:400}))};e.onError=function(a){a=a||{};"function"===typeof c&&c(a.status||{message:"Server error",code:400})};a.Appacitive.http.send(e);return this}}})(global);
