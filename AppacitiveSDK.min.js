...
d=function(a){if(!a.url)throw Error("Please specify request url");a.method||(a.method="GET");a.headers||(a.headers=[]);var b={},d=!0;a.headers.forEach(function(a){"content-type"==a.key.toLowerCase()&&(d=!0,"application/json"==a.value.toLowerCase()||"application/javascript"==a.value.toLowerCase())&&(d=!1)});if(d)b=a.data;else if(a.data&&(b=a.data,"object"==typeof a.data))try{b=JSON.stringify(b)}catch(l){}a.onSuccess&&"function"==typeof a.onSuccess||(a.onSuccess=function(){});a.onError&&"function"==
...
"boolean"==typeof this.value?this.value:"object"==typeof this.value&&this.value instanceof date?"datetime('"+e.Date.toISOString(this.value)+"')":this.value.toString()}},l=function(a){this.value=a;this.getValue=function(){return"object"==typeof this.value&&this.value instanceof Date?"date('"+e.Date.toISODate(this.value)+"')":"date('"+this.value+"'')"}},h=function(a){this.value=a;this.getValue=function(){return"object"==typeof this.value&&this.value instanceof Date?"time('"+e.Date.toISOTime(this.value)+
"')":"time('"+this.value+"'')"}},n=function(a){this.value=a;this.getValue=function(){return"object"==typeof this.value&&this.value instanceof Date?"datetime('"+e.Date.toISOString(this.value)+"')":"datetime('"+this.value+"'')"}},r=function(b,e,f){f||(f=this);f.type=b;f.name=e;f.equalTo=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"=="})};f.equalToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"=="})};f.equalToTime=
function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:"=="})};f.equalToDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:"=="})};f.greaterThan=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:">"})};f.greaterThanDate=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:">"})};f.greaterThanTime=function(a){return new c({field:this.name,fieldType:this.type,
value:new h(a),operator:">"})};f.greaterThanDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:">"})};f.greaterThanEqualTo=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:">="})};f.greaterThanEqualToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:">="})};f.greaterThanEqualToTime=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:">="})};f.greaterThanEqualToDateTime=
function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:">="})};f.lessThan=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"<"})};f.lessThanDate=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"<"})};f.lessThanTime=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:"<"})};f.lessThanDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),
operator:"<"})};f.lessThanEqualTo=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"<="})};f.lessThanEqualToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"<="})};f.lessThanEqualToTime=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:"<="})};f.lessThanEqualToDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:"<="})};f.like=function(a){return new c({field:this.name,
fieldType:this.type,value:new k("*"+a+"*"),operator:"like"})};f.startsWith=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a+"*"),operator:"like"})};f.endsWith=function(a){return new c({field:this.name,fieldType:this.type,value:new k("*"+a),operator:"like"})};f.contains=function(a){return new d({field:this.name,fieldType:this.type,value:a,operator:"=="})};f.between=function(b,c){return new a({field:this.name,fieldType:this.type,val1:new k(b),val2:new k(c),operator:"between"})};
f.betweenDate=function(b,c){return new a({field:this.name,fieldType:this.type,val1:new l(b),val2:new l(c),operator:"between"})};f.betweenTime=function(b,c){return new a({field:this.name,fieldType:this.type,val1:new h(b),val2:new h(c),operator:"between"})};f.betweenDateTime=function(b,c){return new a({field:this.name,fieldType:this.type,val1:new n(b),val2:new n(c),operator:"between"})};f.withinCircle=function(a,b,c){return new g({field:this.name,fieldType:this.type,geoCoord:a,distance:b,unit:c,operator:"within_circle"})};
...
arguments[0]||"__UtcLastUpdatedDate",this):a};this.isAscending=function(){return 1==arguments.length?(c="undefined"==typeof arguments[0]?!1:arguments[0],this):c};this.orderBy(b.orderBy);this.isAscending(b.isAscending)};f.prototype.toString=function(){return"orderBy="+this.orderBy()+"&isAsc="+this.isAscending()};var c=function(c){var a=c||{},g="",m="",k="",l=a.queryType||"BasicQuery",h=new e(c),n=new f(c),r=a.schema||a.relation,q=a.relation?"connection":"article";this.type=function(){return q};this.entityType=
function(){return r};this.queryType=function(){return l};this.pageQuery=function(){return h};this.pageNumber=function(){return 1==arguments.length?(h.pageNumber(arguments[0]),this):h.pageNumber};this.pageSize=function(){return 1==arguments.length?(h.pageSize(arguments[0]),this):h.pageSize};this.sortQuery=function(){return n};this.orderby=function(){return 1==arguments.length?(n.orderby(arguments[0]),this):n.orderby};this.isAscending=function(){return 1==arguments.length?(n.isAscending(arguments[0]),
...
!0))});return c};this.fetch=function(a,c){var d=this.toRequest();d.onSuccess=function(b){b&&b.status&&"200"==b.status.code?"function"==typeof a&&a(p(b[q+"s"]),b.paginginfo):(b=b||{},"function"==typeof c&&c(b.status||{message:"Server error",code:400}))};d.onError=function(a){a=a||{};"function"==typeof c&&c(a.status||{message:"Server error",code:400})};b.Appacitive.http.send(d);return this};this.count=function(a,c){a=a||function(){};c=c||function(){};var d=h.pageSize,l=h.pageNumber;h.pageSize=1;h.pageNumber=
999999999;var k=this,g=this.toRequest();g.onSuccess=function(b){h.pageSize=d;h.pageNumber=l;b=b||{};var g=b.paginginfo,e=0;if(g)e=g.totalrecords;else if(b.status&&b.status.code&&"200"==b.status.code)e=0;else{b=b.status||{message:"Server error",code:400};"function"==typeof c&&c(b,k);return}"function"==typeof a&&a(e)};g.onError=function(a){h.pageSize=d;h.pageNumber=l;a=a||{message:"Server error",code:400};"function"==typeof c&&c(a,k)};b.Appacitive.http.send(g);return this}};b.Appacitive.Queries.FindAllQuery=
...
if(2==arguments.length){if("string"!==typeof arguments[1]&&null!=arguments[1])throw Error("only string values can be stored in attributes.");a.__attributes||(a.__attributes={});a.__attributes[arguments[0]]=arguments[1]}else throw Error(".attr() called with an incorrect number of arguments. 0, 1, 2 are supported.");}return a.__attributes};var h=function(){if(!c.__attributes)return null;var b=!1,d=JSON.parse(JSON.stringify(c.__attributes)),l;for(l in a.__attributes)"undefined"==typeof a.__attributes[l]||
null===a.__attributes[l]?(d[l]=null,b=!0):a.__attributes[l]!=c.__attributes[l]?(d[l]=a.__attributes[l],b=!0):a.__attributes[l]==c.__attributes[l]&&delete d[l];return b?d:null};this.getChangedAttributes=h;this.aggregates=function(){var b={},c;for(c in a){if(!a.hasOwnProperty(c))return;"$"==c[0]&&(b[c]=a[c])}if(0===arguments.length)return b;if(1==arguments.length)return b[arguments[0]];throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");};var n=[];a.__tags||
...
1);return this};var r=function(){if(!a.__tags)return[];if(!c.__tags)return a.__tags;var b=[];a.__tags.every(function(a){-1==c.__tags.indexOf(a)&&b.push(a)});return b};this.getChangedTags=r;this.getRemovedTags=function(){return _removetags};var q=function(b){var d=!1,l=JSON.parse(JSON.stringify(c)),k;for(k in a)"undefined"==typeof a[k]||null===a[k]?(l[k]=null,d=!0):a[k]!=c[k]?"__tags"==k||"__attributes"==k?delete l[k]:(l[k]=a[k],d=!0):a[k]==c[k]&&delete l[k];try{m.forEach(function(a){l[a]&&delete l[a]})}catch(e){}b?
(a.__tags&&0<a.__tags.length&&(l.__addtags=r(),d=!0),n&&0<n.length&&(l.__removetags=n,d=!0)):a.__tags&&0<a.__tags.length&&(l.__tags=r(),d=!0);(b=h())?(l.__attributes=b,d=!0):delete l.__attributes;return d?l:!1};this.changed=function(){return q()};this.hasChanged=function(){var a=q(!0);return 0===arguments.length?Object.isEmpty(a)?!1:!0:1==arguments.length&&"string"==typeof arguments[0]&&0<arguments[0].length&&a&&a[arguments[0]]?!0:!1};this.changedAttributes=function(){var a=q(!0);if(0===arguments.length)return a;
...
!b.toRequest)throw Error("Invalid  appacitive query passed to connectionCollection");if(-1==k.indexOf(b.queryType()))throw Error("ConnectionCollection only accepts "+k.join(", "));a.length=0;d.length=0;c=b;return this}return c};var k=["BasicFilterQuery","ConnectedArticlesQuery","GetConnectionsQuery"];this.reset=function(){f=g=null;a.length=0;d.length=0;c=null};this.setOptions=e;e(g);this.get=function(a){if(a!=parseInt(a,10))return null;a=parseInt(a,10);return"number"!=typeof a||a>=d.length?null:d.slice(a,
a+1)[0]};this.addToCollection=function(a){if(!a||a.get("__relationtype")!=f)throw Error("Null connection passed or relation type mismatch");var b=null;d.forEach(function(c,d){c.get("__id")==a.get("__id")&&(b=d)});null!==b?d.splice(b,1):d.push(a);return this};this.getConnection=function(a,b,c){b=d.filter(function(b){return b.get("__id")==a});return 1==b.length?b[0]:null};this.getAll=function(){return Array.prototype.slice.call(d)};this.getAllConnections=function(){return Array.prototype.slice.call(d).map(function(a){return a.getConnection()})};
this.removeById=function(a){if(!a)return!1;var b=null;d.forEach(function(c,d){c.getConnection().__id&&c.getConnection().__id==a&&(b=d)});null!==b&&d.splice(b,1);return this};this.removeByCId=function(a){if(!a)return!1;var b=null;d.forEach(function(c,d){c.cid&&c.cid==a&&(b=d)});null!==b&&d.splice(b,1);return this};var l=function(b,g,k){"GetConnectionsBetweenArticlesForRelationQuery"==c.queryType&&(b=[b]);b.length&&0!==b.length||(b=[]);b.forEach(function(b){b.___collection=m;if(b.endpointA.article||
b.endpointB.article){var c=b.endpointA.article||b.endpointB.article;c.___collection=m;a.push(c)}try{b.___collection.connectedArticle||delete b.connectedArticle}catch(g){}d.push(b)});"function"==typeof k&&k(g,m)};this.getConnectedArticle=function(b){if(!a||0===a.length)return null;var c=a.filter(function(a){return a.get("__id")==b});return 0<c.length?c[0]:null};this.fetch=function(a,b){d.length=0;c.fetch(function(b,c){l(b,c,a)},function(a){"function"==typeof b&&b(a,m)});return this};this.count=function(a,
b){c.count(a,b);return this};this.fetchByPageNumber=function(a,b,d){c.getOptions().pageQuery.pageNumber=d;this.fetch(a,b);return this};this.fetchNextPage=function(a,b){c.getOptions().pageQuery.pageNumber+=1;this.fetch(a,b);return this};this.fetchPreviousPage=function(a,b){var d=c.getOptions().pageQuery;d.pageNumber-=1;0===d.pageNumber&&(d.pageNumber=1);this.fetch(a,b);return this};this.createNewConnection=function(a){a=a||{};a.__relationtype=f;a=new b.Appacitive.Connection(a);a.___collection=m;d.push(a);
return a};this.map=function(){return d.map.apply(this,arguments)};this.forEach=function(a,b){return d.forEach(a,b||this)};this.filter=function(){return d.filter.apply(this,arguments)}}})(global);
