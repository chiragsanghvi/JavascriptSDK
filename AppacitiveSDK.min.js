...
for(var _type=function(a){if(null===a)return"null";if(a&&(1===a.nodeType||9===a.nodeType))return"element";var f=Object.prototype.toString.call(a).match(/\[object (.*?)\]/)[1].toLowerCase();if("number"===f){if(isNaN(a))return"nan";if(!isFinite(a))return"infinity"}return f},types="Null Undefined Object Array String Number Boolean Function RegExp Element NaN Infinite".split(" "),generateMethod=function(a){_type["is"+a]=function(f){return _type(f)===a.toLowerCase()}},i=0;i<types.length;i++)generateMethod(types[i]);
...
function(){var a=this.operator,b="(";this.innerFilters.forEach(function(c){b=1===b.length?b+(" "+c.toString()):b+String.format(" {0} {1} ",a,c.toString())});return b+=")"}};k.prototype=new g;k.prototype.constructor=k;var m=function(a,b){if(null===a||void 0===a||0===a.length)throw Error("Specify value");this.value=a;this.type=b?b:typeof this.value;this.getValue=function(){return"string"===this.type?"'"+encodeURIComponent(String.addSlashes(this.value))+"'":"number"===this.type||"boolean"===typeof this.value?
this.value:"object"===this.type&&this.value instanceof date?"datetime('"+f.Date.toISOString(this.value)+"')":this.value.toString()}},n=function(a){this.value=a;this.getValue=function(){return"object"===typeof this.value&&this.value instanceof Date?"date('"+f.Date.toISODate(this.value)+"')":"date('"+this.value+"')"}},p=function(a){this.value=a;this.getValue=function(){return"object"===typeof this.value&&this.value instanceof Date?"time('"+f.Date.toISOTime(this.value)+"')":"time('"+this.value+"')"}},
q=function(a){this.value=a;this.getValue=function(){return"object"===typeof this.value&&this.value instanceof Date?"datetime('"+f.Date.toISOString(this.value)+"')":"datetime('"+this.value+"')"}},t=function(a,k,h){h||(h=this);h.type=a;h.name=k;h.equalTo=function(a){return new c({field:this.name,fieldType:this.type,value:new m(a),operator:"=="})};h.equalToNumber=function(a){return new c({field:this.name,fieldType:this.type,value:new m(a,"number"),operator:"=="})};h.equalToDate=function(a){return new c({field:this.name,
fieldType:this.type,value:new n(a),operator:"=="})};h.equalToTime=function(a){return new c({field:this.name,fieldType:this.type,value:new p(a),operator:"=="})};h.equalToDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new q(a),operator:"=="})};h.greaterThan=function(a){return new c({field:this.name,fieldType:this.type,value:new m(a),operator:">"})};h.greaterThanDate=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:">"})};h.greaterThanTime=
function(a){return new c({field:this.name,fieldType:this.type,value:new p(a),operator:">"})};h.greaterThanDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new q(a),operator:">"})};h.greaterThanEqualTo=function(a){return new c({field:this.name,fieldType:this.type,value:new m(a),operator:">="})};h.greaterThanEqualToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:">="})};h.greaterThanEqualToTime=function(a){return new c({field:this.name,
fieldType:this.type,value:new p(a),operator:">="})};h.greaterThanEqualToDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new q(a),operator:">="})};h.lessThan=function(a){return new c({field:this.name,fieldType:this.type,value:new m(a),operator:"<"})};h.lessThanDate=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:"<"})};h.lessThanTime=function(a){return new c({field:this.name,fieldType:this.type,value:new p(a),operator:"<"})};h.lessThanDateTime=
function(a){return new c({field:this.name,fieldType:this.type,value:new q(a),operator:"<"})};h.lessThanEqualTo=function(a){return new c({field:this.name,fieldType:this.type,value:new m(a),operator:"<="})};h.lessThanEqualToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:"<="})};h.lessThanEqualToTime=function(a){return new c({field:this.name,fieldType:this.type,value:new p(a),operator:"<="})};h.lessThanEqualToDateTime=function(a){return new c({field:this.name,
fieldType:this.type,value:new q(a),operator:"<="})};h.like=function(a){return new c({field:this.name,fieldType:this.type,value:new m("*"+a+"*"),operator:"like"})};h.startsWith=function(a){return new c({field:this.name,fieldType:this.type,value:new m(a+"*"),operator:"like"})};h.endsWith=function(a){return new c({field:this.name,fieldType:this.type,value:new m("*"+a),operator:"like"})};h.contains=function(a){return new d({field:this.name,fieldType:this.type,value:a,operator:"=="})};h.between=function(a,
b){return new e({field:this.name,fieldType:this.type,val1:new m(a),val2:new m(b),operator:"between"})};h.betweenDate=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new n(a),val2:new n(b),operator:"between"})};h.betweenTime=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new p(a),val2:new p(b),operator:"between"})};h.betweenDateTime=function(a,b){return new e({field:this.name,fieldType:this.type,val1:new q(a),val2:new q(b),operator:"between"})};h.withinCircle=
function(a,c,e){return new b({field:this.name,fieldType:this.type,geoCoord:a,distance:c,unit:e,operator:"within_circle"})};h.withinPolygon=function(a){return new l({field:this.name,fieldType:this.type,geoCoords:a,operator:"within_polygon"})}},r=function(a){if(!a||0===a.length)throw Error("Specify field name");this.field=a;t("property",a,this);return this},v=function(a){if(!a||0===a.length)throw Error("Specify field name");this.field=a;var b=new t("aggregate",a);this.equalTo=function(a){return b.equalTo(a)};
this.greaterThan=function(a){return b.greaterThan(a)};this.greaterThanEqualTo=function(a){return b.greaterThanEqualTo(a)};this.lessThan=function(a){return b.lessThan(a)};this.lessThanEqualTo=function(a){return b.lessThanEqualTo(a)};this.between=function(a,c){return b.between(a,c)};return this},u=function(a){if(!a||0===a.length)throw Error("Specify field name");this.field=a;var b=new t("attribute",a);this.like=function(a){return b.like(a)};this.startWith=function(a){return b.startsWith(a)};this.endsWith=
function(a){return b.endsWith(a)};this.equalTo=function(a){return b.equalTo(a)};this.contains=function(a){return b.contains(a)};return this};f.Filter={Property:function(a){return new r(a)},Aggregate:function(a){return new v(a)},Attribute:function(a){return new u(a)},Or:function(){return new k("or",arguments)},And:function(){return new k("and",arguments)},taggedWithOneOrMore:function(a){return new h({tags:a,operator:"tagged_with_one_or_more"})},taggedWithAll:function(a){return new h({tags:a,operator:"tagged_with_all"})}}})(global);
...
this.entityType=function(){return p};this.queryType=function(){return k};this.pageQuery=function(){return m};this.pageNumber=function(){return 1===arguments.length?(m.pageNumber(arguments[0]),this):m.pageNumber()};this.pageSize=function(){return 1===arguments.length?(m.pageSize(arguments[0]),this):m.pageSize()};this.sortQuery=function(){return n};this.orderBy=function(){return 1===arguments.length?(n.orderBy(arguments[0]),this):n.orderBy()};this.isAscending=function(){return 1===arguments.length?
...
1;0>=c&&(c=1);this.pageNumber(c);this.fetch(a,b);return this};this.count=function(b,c){b=b||function(){};c=c||function(){};var e=this.toRequest();e.onSuccess=function(a){a=a||{};var e=a.paginginfo,d=0;if(e)d=e.totalrecords;else if(a.status&&a.status.code&&"200"==a.status.code)d=0;else{a=a.status||{message:"Server error",code:400};"function"===typeof c&&c(a,that);return}"function"===typeof b&&b(d)};e.onError=function(a){a=a||{message:"Server error",code:400};"function"===typeof c&&c(a,that)};a.Appacitive.http.send(e);
return this}};a.Appacitive.Queries.FindAllQuery=function(a){a=a||{};if(!a.schema&&!a.relation||a.schema&&a.relation)throw Error("Specify either schema or relation for basic filter query");a.queryType="BasicFilterQuery";c.call(this,a);return this};a.Appacitive.Queries.FindAllQuery.prototype=new c;a.Appacitive.Queries.FindAllQuery.prototype.constructor=a.Appacitive.Queries.FindAllQuery;a.Appacitive.Queries.ConnectedArticlesQuery=function(d){d=d||{};if(!d.relation)throw Error("Specify relation for connected articles query");
if(!d.articleId)throw Error("Specify articleId for connected articles query");if(!d.schema)throw Error("Specify schema of article id for connected articles query");var e=d.schema;delete d.schema;d.queryType="ConnectedArticlesQuery";c.call(this,d);this.articleId=d.articleId;this.relation=d.relation;this.schema=e;this.prev=d.prev;this.returnEdge=!0;void 0===d.returnEdge||null===d.returnEdge||d.returnEdge||this.prev||(this.returnEdge=!1);this.label="";var b=this;d.label&&"string"===typeof d.label&&0<
d.label.length&&(this.label="&label="+d.label);this.toRequest=function(){var b=new a.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+"connection/"+this.relation+"/"+this.schema+"/"+this.articleId+"/find?"+this.getQueryString()+this.label+"&returnEdge="+this.returnEdge};var f=function(b,c){var e=[];b.forEach(function(b){var d=null;if(b.__edge){d=b.__edge;delete b.__edge;d.__endpointa=c;d.__endpointb={articleid:b.__id,label:d.__label,
type:b.__schematype};delete d.label;var h=new a.Appacitive.Connection(d,!0),d=new a.Appacitive.Article(b,!0);d.connection=h}else d=new a.Appacitive.Article(b,!0);e.push(d)});return e},h=function(b,c){var e=[];b.forEach(function(b){var d=b.__edge;delete b.__edge;d.__endpointa=c;d.__endpointb={article:b,label:d.__label,type:b.__schematype};delete d.label;b=new a.Appacitive.Connection(d,!0);e.push(b)});return e};this.fetch=function(c,m){var g=this.toRequest();g.onSuccess=function(a){if(a&&a.status&&
"200"==a.status.code){var g=f;b.prev&&(g=h);b.results=g(a.nodes?a.nodes:[],{articleid:d.articleId,type:e,label:a.parent});b._setPaging(a.paginginfo);"function"===typeof c&&c(b.results,a.paginginfo)}else a=a||{},"function"===typeof m&&m(a.status||{message:"Server error",code:400})};g.onError=function(a){a=a||{};"function"===typeof m&&m(a.status||{message:"Server error",code:400})};a.Appacitive.http.send(g);return this};return this};a.Appacitive.Queries.ConnectedArticlesQuery.prototype=new c;a.Appacitive.Queries.ConnectedArticlesQuery.prototype.constructor=
a.Appacitive.Queries.ConnectedArticlesQuery;a.Appacitive.Queries.GetConnectionsQuery=function(d){d=d||{};if(!d.relation)throw Error("Specify relation for GetConnectionsQuery query");if(!d.articleId)throw Error("Specify articleId for GetConnectionsQuery query");if(!d.label||0===d.label.trim().length)throw Error("Specify label for GetConnectionsQuery query");d.schema&&delete d.schema;d.queryType="GetConnectionsQuery";c.call(this,d);this.articleId=d.articleId;this.relation=d.relation;this.label=d.label;
this.toRequest=function(){var c=new a.Appacitive.HttpRequest;c.url=this.toUrl();c.method="get";return c};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+"connection/"+this.relation+"/find/all?"+this.getQueryString()+"&articleid="+this.articleId+"&label="+this.label};return this};a.Appacitive.Queries.GetConnectionsQuery.prototype=new c;a.Appacitive.Queries.GetConnectionsQuery.prototype.constructor=a.Appacitive.Queries.GetConnectionsQuery;a.Appacitive.Queries.GetConnectionsBetweenArticlesQuery=
function(d,e){d=d||{};if(!d.articleAId||"string"!==typeof d.articleAId||0===d.articleAId.length)throw Error("Specify valid articleAId for GetConnectionsBetweenArticlesQuery query");if(!d.articleBId||"string"!==typeof d.articleBId||0===d.articleBId.length)throw Error("Specify articleBId for GetConnectionsBetweenArticlesQuery query");d.schema&&delete d.schema;d.queryType=e||"GetConnectionsBetweenArticlesQuery";c.call(this,d);this.articleAId=d.articleAId;this.articleBId=d.articleBId;this.label="GetConnectionsBetweenArticlesForRelationQuery"===
this.queryType()&&d.label&&"string"===typeof d.label&&0<d.label.length?"&label="+d.label:"";this.relation=d.relation&&"string"===typeof d.relation&&0<d.relation.length?d.relation+"/":"";this.toRequest=function(){var b=new a.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+"connection/"+this.relation+"find/"+this.articleAId+"/"+this.articleBId+"?"+this.getQueryString()+this.label};return this};a.Appacitive.Queries.GetConnectionsBetweenArticlesQuery.prototype=
new c;a.Appacitive.Queries.GetConnectionsBetweenArticlesQuery.prototype.constructor=a.Appacitive.Queries.GetConnectionsBetweenArticlesQuery;a.Appacitive.Queries.GetConnectionsBetweenArticlesForRelationQuery=function(c){c=c||{};if(!c.relation)throw Error("Specify relation for GetConnectionsBetweenArticlesForRelationQuery query");c=new a.Appacitive.Queries.GetConnectionsBetweenArticlesQuery(c,"GetConnectionsBetweenArticlesForRelationQuery");c.fetch=function(c,b){var d=this.toRequest();d.onSuccess=function(d){d&&
d.status&&"200"==d.status.code?"function"===typeof c&&c(d.connection?new a.Appacitive.Connection(d.connection):null):(d=d||{},"function"===typeof b&&b(d.status||{message:"Server error",code:400}))};d.onError=function(a){a=a||{};"function"===typeof b&&b(a.status||{message:"Server error",code:400})};a.Appacitive.http.send(d);return this};return c};a.Appacitive.Queries.InterconnectsQuery=function(d){d=d||{};if(!d.articleAId||"string"!==typeof d.articleAId||0===d.articleAId.length)throw Error("Specify valid articleAId for InterconnectsQuery query");
if(!(d.articleBIds&&"object"===typeof d.articleBIds&&0<d.articleBIds.length))throw Error("Specify list of articleBIds for InterconnectsQuery query");d.schema&&delete d.schema;d.queryType="InterconnectsQuery";c.call(this,d);this.articleAId=d.articleAId;this.articleBIds=d.articleBIds;this.toRequest=function(){var c=new a.Appacitive.HttpRequest;c.url=this.toUrl();c.method="post";c.data={article1id:this.articleAId,article2ids:this.articleBIds};return c};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+
"connection/interconnects?"+this.getQueryString()};return this};a.Appacitive.Queries.InterconnectsQuery.prototype=new c;a.Appacitive.Queries.InterconnectsQuery.prototype.constructor=a.Appacitive.Queries.InterconnectsQuery;a.Appacitive.Queries.GraphFilterQuery=function(c,e){if(!c||0===c.length)throw Error("Specify name of filter query");this.name=c;this.data={};this.queryType="GraphFilterQuery";if(e){this.data.placeholders=e;for(var b in this.data.placeholders)this.data.placeholders[b]=encodeURIComponent(String.addSlashes(this.data.placeholders[b]))}this.toRequest=
function(){var b=new a.Appacitive.HttpRequest;b.url=this.toUrl();b.method="post";b.data=this.data;return b};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+"search/"+this.name+"/filter"};this.fetch=function(b,c){var e=this.toRequest();e.onSuccess=function(a){a&&a.status&&"200"==a.status.code?"function"===typeof b&&b(a.ids?a.ids:[]):(a=a||{},"function"===typeof c&&c(a.status||{message:"Server error",code:400}))};e.onError=function(a){a=a||{};"function"===typeof c&&c(a.status||{message:"Server error",
code:400})};a.Appacitive.http.send(e);return this}};a.Appacitive.Queries.GraphProjectQuery=function(c,e,b){if(!c||0===c.length)throw Error("Specify name of project query");if(!e||!e.length)throw Error("Specify ids to project");this.name=c;this.data={ids:e};this.queryType="GraphProjectQuery";if(b){this.data.placeholders=b;for(var f in this.data.placeholders)this.data.placeholders[f]=encodeURIComponent(String.addSlashes(this.data.placeholders[f]))}this.toRequest=function(){var b=new a.Appacitive.HttpRequest;
b.url=this.toUrl();b.method="post";b.data=this.data;return b};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+"search/"+this.name+"/project"};var h=function(b){var c,e;for(e in b)if("status"!==e){c=b[e];break}var d=function(b,c,e){var h=[];b.forEach(function(b){var m=b.__children;delete b.__children;var k=b.__edge;delete b.__edge;b=new a.Appacitive.Article(b,!0);b.children={};for(var f in m)b.children[f]=[],b.children[f]=d(m[f].values,m[f].parent,b.id);k&&(k.__endpointa={articleid:e,label:c},
k.__endpointb={articleid:b.id(),label:k.__label},delete k.__label,b.connection=new a.Appacitive.Connection(k));h.push(b)});return h};return d(c.values)};this.fetch=function(b,c){var e=this.toRequest();e.onSuccess=function(a){a&&a.status&&"200"==a.status.code?"function"===typeof b&&b(h(a)):(a=a||{},"function"===typeof c&&c(a.status||{message:"Server error",code:400}))};e.onError=function(a){a=a||{};"function"===typeof c&&c(a.status||{message:"Server error",code:400})};a.Appacitive.http.send(e);return this}}})(global);
...
-1!=a&&b.__tags.splice(a,1);return this};var q=function(){if(!b.__tags)return[];if(!c.__tags)return b.__tags;var a=[];b.__tags.forEach(function(b){-1==c.__tags.indexOf(b)&&a.push(b)});return a};this.getChangedTags=q;this.getRemovedTags=function(){return _removetags};var t=function(a){var e=!1,d=JSON.parse(JSON.stringify(c)),m;for(m in b)"undefined"==typeof b[m]||null===b[m]?(d[m]=null,e=!0):b[m]!=c[m]?"__tags"==m||"__attributes"==m?delete d[m]:(d[m]=b[m],e=!0):b[m]==c[m]&&delete d[m];try{h.forEach(function(a){d[a]&&
...
f.relation)+"."+f.type+".created",f,{object:f}),"function"==typeof e&&e(f)):(k=k||{},k.status=k.status||{},k.status=m(k.status),a.Appacitive.eventManager.fire((f.schema||f.relation)+"."+f.type+".createFailed",f,{error:k.status}),"function"==typeof h&&h(k.status,f))};g.onError=function(a){a=m(a);"function"==typeof h&&h(a,f)};a.Appacitive.http.send(g);return this},x=function(h,k,f){h=h||function(){};k=k||function(){};var g=function(g){var l=t(!0),n;for(n in l)"$"==n[0]&&delete l[n];if(Object.isEmpty(l))"function"==
typeof h&&h(e);else{"string"==typeof f?r=value:f="object"==typeof f&&f.length?f.join(","):r;n=new a.Appacitive.HttpRequest;var q=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[e.type].getUpdateUrl(b.__schematype||b.__relationtype,c.__id?c.__id:b.__id,f,g),w=e.type;b&&b.__schematype&&("user"==b.__schematype.toLowerCase()||"device"==b.__schematype.toLowerCase())&&(w=b.__schematype.toLowerCase(),q=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[b.__schematype.toLowerCase()].getUpdateUrl(c.__id,
f,g));n.url=q;n.method="post";n.data=l;n.onSuccess=function(g){g&&g[w]?(u.length=0,c=g[e.type],d(c,b),p=[],a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+w+"."+b.__id+".updated",e,{object:e}),"function"==typeof h&&h(e)):(g=g||{},g.status=g.status||{},g.status=m(g.status),"14008"==g.status.code&&0<u.length?x(h,k,f):(a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+w+"."+b.__id+".updateFailed",e,{object:g.status}),"function"==typeof k&&k(g.status,e)))};n.onError=function(a){a=a||
{};a.message=a.message||"Server error";a.code=a.code||"500";"14008"==a.code&&0<u.length?x(h,k,f):"function"==typeof k&&k(a,e)};a.Appacitive.http.send(n)}};if(0<u.length){var l=["__revision"];u.forEach(function(a){l.push(a.key)});z(function(a){u.forEach(function(b){var c=v.integer(a[b.key]);c||(c=0);e.set(b.key,c+b.amount)});g(a.__revision)},k,l,!0)}else g();return this},z=function(h,k,f,g){h=h||function(){};k=k||function(){};if(b.__id){"string"==typeof f?r=value:f="object"==typeof f&&f.length?f.join(","):
r;f=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[e.type].getGetUrl(b.__schematype||b.__relationtype,b.__id,f);var l=new a.Appacitive.HttpRequest;l.url=f;l.method="get";l.onSuccess=function(a){a&&a[e.type]?g?"function"==typeof h&&h(a[e.type]):(c=a[e.type],d(c,b),a.connection&&(e.endpoints||e.endpointA&&e.endpointB||e.setupConnection(b.__endpointa,b.__endpointb)),e.___collection&&"article"==e.___collection.collectionType&&e.___collection.addToCollection(e),"function"==typeof h&&h(e)):
(a=a||{},a.status=a.status||{},a.status=m(a.status),"function"==typeof k&&k(a.status,e))};l.onError=function(a){a=m(a);"function"==typeof k&&k(a,e)};a.Appacitive.http.send(l);return e}"function"==typeof k&&k({code:"400",message:"Please specify id for get operation"},e)};this.fetch=function(a,b,c){z(a,b,c)};this.del=function(c,e,d){if(b.__id){c=c||function(){};e=e||function(){};var h=this,k=a.Appacitive.config.apiBaseUrl,k=k+a.Appacitive.storage.urlFactory[this.type].getDeleteUrl(b.__schematype||b.__relationtype,
...
null),"function"===typeof d&&d(c)):e(a,c)};g.onError=e;a.Appacitive.http.send(g)}else"function"===typeof d&&d(c)};this.setCurrentUser=function(c,k,m){if(!c)throw Error("Cannot set null object as user");var l=c;if(l instanceof a.Appacitive.User)if(l.get("__id")&&0!==l.get("__id").length)c=l.toJSON();else throw Error("Specify user __id");else l=new a.Appacitive.User(c,!0);a.Appacitive.localStorage.set("Appacitive-User",c);m||(m=60);f=l;k&&a.Appacitive.Session.setUserAuthHeader(k,m);f.logout=function(b){a.Appacitive.Users.logout(b)};
