...
-1==global.navigator.userAgent.indexOf("MSIE 8")&&-1==global.navigator.userAgent.indexOf("MSIE 9")){var k=new f;k.onreadystatechange=function(){if(4==this.readyState)if(200<=this.status&&300>this.status||304==this.status){var c=this.responseText;try{var b=this.getResponseHeader("content-type")||this.getResponseHeader("Content-Type");if("application/json"==b.toLowerCase()||"application/javascript"==b.toLowerCase())b=c,global.Appacitive.runtime.isBrowser||"{"!=b[0]&&(b=b.substr(1,b.length-1)),c=JSON.parse(b)}catch(d){}a.onSuccess(c,
...
this.relation+"/"+this.schema+"/"+this.articleId+"/find?"+this.getQueryString()+this.label};var g=function(a,c){var d=[];a.forEach(function(a){var g=a.__edge;delete a.__edge;a=new b.Appacitive.Article(a,!0);g.__endpointa=c;g.__endpointb={article:a,label:g.label,type:a.entityType};delete g.label;g=new Appacitive.Connection(g,!0);d.push(g)});return d};this.fetch=function(c,h){var l=this.toRequest();l.onSuccess=function(b){b&&b.status&&"200"==b.status.code?"function"==typeof c&&c(g(b.nodes,{articleid:d.articleId,
type:a,label:b.parent})):(b=b||{},"function"==typeof h&&h(b.status||{message:"Server error",code:400}))};l.onError=function(a){a=a||{};"function"==typeof h&&h(a.status||{message:"Server error",code:400})};b.Appacitive.http.send(l);return this};return this};b.Appacitive.Queries.ConnectedArticlesQuery.prototype=new c;b.Appacitive.Queries.ConnectedArticlesQuery.prototype.constructor=b.Appacitive.Queries.ConnectedArticlesQuery;b.Appacitive.Queries.GetConnectionsQuery=function(d){d=d||{};if(!d.relation)throw Error("Specify relation for GetConnectionsQuery query");
...
function(b){var d=!1,e=JSON.parse(JSON.stringify(c)),g;for(g in a)"undefined"==typeof a[g]||null===a[g]?(e[g]=null,d=!0):a[g]!=c[g]?"__tags"==g||"__attributes"==g?delete e[g]:(e[g]=a[g],d=!0):a[g]==c[g]&&delete e[g];try{m.forEach(function(a){e[a]&&delete e[a]})}catch(l){}b?(a.__tags&&0<a.__tags.length&&(e.__addtags=p(),d=!0),n&&0<n.length&&(e.__removetags=n,d=!0)):a.__tags&&0<a.__tags.length&&(e.__tags=p(),d=!0);(b=k())?(e.__attributes=b,d=!0):delete e.__attributes;return d?e:!1};this.changed=function(){return q()};
