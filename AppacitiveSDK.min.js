...
this.getObject=function(){return JSON.parse(JSON.stringify(a))};this.properties=function(){var a=this.attributes();delete a.__attributes;delete a.__tags};this.id=function(){return 1===arguments.length?(this.set("__id",arguments[0]),this):this.get("__id")};a.__attributes||(a.__attributes={});c.__attributes||(c.__attributes={});this.attr=function(){if(0===arguments.length)a.__attributes||(a.__attributes={});else{if(1==arguments.length)return a.__attributes||(a.__attributes={}),a.__attributes[arguments[0]];
