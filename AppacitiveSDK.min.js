...
typeof a.onError||(a.onError=function(){});if(!global.navigator||-1==global.navigator.userAgent.indexOf("MSIE 8")&&-1==global.navigator.userAgent.indexOf("MSIE 9")){var k=new f;k.onreadystatechange=function(){if(4==this.readyState)if(200<=this.status&&300>this.status||304==this.status){var c=this.responseText;try{var b=this.getResponseHeader("content-type")||this.getResponseHeader("Content-Type");if("application/json"==b.toLowerCase()||"application/javascript"==b.toLowerCase())b=c,global.Appacitive.runtime.isBrowser||
"{"!=b[0]&&(b=b.substr(1,b.length-1)),c=JSON.parse(b)}catch(d){}a.onSuccess(c,this)}else a.onError({code:this.status,message:this.statusText},this)};k.open(a.method,a.url,!0);for(var e=0;e<a.headers.length;e+=1)k.setRequestHeader(a.headers[e].key,a.headers[e].value);global.Appacitive.runtime.isBrowser||k.setRequestHeader("User-Agent","Appacitive-NodeJSSDK");k.send(b);return k}a.data=b;return new c(a)},a=function(){var a=new e;a.isOnline=function(){return!0};var c=function(c,b,f){new d({method:c.method,
...
"boolean"==typeof this.value?this.value:"object"==typeof this.value&&this.value instanceof date?"datetime('"+e.Date.toISOString(this.value)+"')":this.value.toString()}},l=function(a){this.value=a;this.getValue=function(){return"object"==typeof this.value&&this.value instanceof Date?"date('"+e.Date.toISODate(this.value)+"')":"date('"+this.value+"'')"}},k=function(a){this.value=a;this.getValue=function(){return"object"==typeof this.value&&this.value instanceof Date?"time('"+e.Date.toISOTime(this.value)+
"')":"time('"+this.value+"'')"}},n=function(a){this.value=a;this.getValue=function(){return"object"==typeof this.value&&this.value instanceof Date?"datetime('"+e.Date.toISOString(this.value)+"')":"datetime('"+this.value+"'')"}},r=function(b,e,f){f||(f=this);f.type=b;f.name=e;f.equalTo=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:"=="})};f.equalToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"=="})};f.equalToTime=
function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"=="})};f.equalToDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:"=="})};f.greaterThan=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:">"})};f.greaterThanDate=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:">"})};f.greaterThanTime=function(a){return new c({field:this.name,fieldType:this.type,
value:new k(a),operator:">"})};f.greaterThanDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:">"})};f.greaterThanEqualTo=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:">="})};f.greaterThanEqualToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:">="})};f.greaterThanEqualToTime=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:">="})};f.greaterThanEqualToDateTime=
function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:">="})};f.lessThan=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:"<"})};f.lessThanDate=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"<"})};f.lessThanTime=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"<"})};f.lessThanDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),
operator:"<"})};f.lessThanEqualTo=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a),operator:"<="})};f.lessThanEqualToDate=function(a){return new c({field:this.name,fieldType:this.type,value:new l(a),operator:"<="})};f.lessThanEqualToTime=function(a){return new c({field:this.name,fieldType:this.type,value:new k(a),operator:"<="})};f.lessThanEqualToDateTime=function(a){return new c({field:this.name,fieldType:this.type,value:new n(a),operator:"<="})};f.like=function(a){return new c({field:this.name,
fieldType:this.type,value:new h("*"+a+"*"),operator:"like"})};f.startsWith=function(a){return new c({field:this.name,fieldType:this.type,value:new h(a+"*"),operator:"like"})};f.endsWith=function(a){return new c({field:this.name,fieldType:this.type,value:new h("*"+a),operator:"like"})};f.contains=function(a){return new d({field:this.name,fieldType:this.type,value:a,operator:"=="})};f.between=function(b,c){return new a({field:this.name,fieldType:this.type,val1:new h(b),val2:new h(c),operator:"between"})};
f.betweenDate=function(b,c){return new a({field:this.name,fieldType:this.type,val1:new l(b),val2:new l(c),operator:"between"})};f.betweenTime=function(b,c){return new a({field:this.name,fieldType:this.type,val1:new k(b),val2:new k(c),operator:"between"})};f.betweenDateTime=function(b,c){return new a({field:this.name,fieldType:this.type,val1:new n(b),val2:new n(c),operator:"between"})};f.withinCircle=function(a,b,c){return new g({field:this.name,fieldType:this.type,geoCoord:a,distance:b,unit:c,operator:"within_circle"})};
...
function(){return r};this.queryType=function(){return l};this.pageQuery=function(){return k};this.pageNumber=function(){return 1==arguments.length?(k.pageNumber(arguments[0]),this):k.pageNumber};this.pageSize=function(){return 1==arguments.length?(k.pageSize(arguments[0]),this):k.pageSize};this.sortQuery=function(){return n};this.orderby=function(){return 1==arguments.length?(n.orderby(arguments[0]),this):n.orderby};this.isAscending=function(){return 1==arguments.length?(n.isAscending(arguments[0]),
...
c;this.data={ids:a};this.queryType="GraphProjectQuery";g&&(this.data.placeholders=g);this.toRequest=function(){var a=new b.Appacitive.HttpRequest;a.url=this.toUrl();a.method="post";a.data=this.data;return a};this.toUrl=function(){return b.Appacitive.config.apiBaseUrl+"search/"+this.name+"/project"};var e=function(a){var c,d;for(d in a)if("status"!==d){c=a[d];break}var e=function(a,c,d){var l=[];a.forEach(function(a){var g=a.__children;delete a.__children;var h=a.__edge;delete a.__edge;a=new b.Appacitive.Article(a,
!0);a.children={};for(var k in g)a.children[k]=[],a.children[k]=e(g[k].values,g[k].parent,a.id);h&&(h.__endpointa={articleid:d,label:c},h.__endpointb={articleid:a.id,label:h.__label},delete h.__label,a.connection=new b.Appacitive.Connection(h));l.push(a)});return l};return e(c.values)};this.fetch=function(a,c){var d=this.toRequest();d.onSuccess=function(b){b&&b.status&&"200"==b.status.code?"function"==typeof a&&a(e(b)):(b=b||{},"function"==typeof c&&c(b.status||{message:"Server error",code:400}))};
...
if(2==arguments.length){if("string"!==typeof arguments[1]&&null!=arguments[1])throw Error("only string values can be stored in attributes.");a.__attributes||(a.__attributes={});a.__attributes[arguments[0]]=arguments[1]}else throw Error(".attr() called with an incorrect number of arguments. 0, 1, 2 are supported.");}return a.__attributes};var k=function(){if(!c.__attributes)return null;var b=!1,d=JSON.parse(JSON.stringify(c.__attributes)),e;for(e in a.__attributes)"undefined"==typeof a.__attributes[e]||
null===a.__attributes[e]?(d[e]=null,b=!0):a.__attributes[e]!=c.__attributes[e]?(d[e]=a.__attributes[e],b=!0):a.__attributes[e]==c.__attributes[e]&&delete d[e];return b?d:null};this.getChangedAttributes=k;this.aggregates=function(){var b={},c;for(c in a){if(!a.hasOwnProperty(c))return;"$"==c[0]&&(b[c]=a[c])}if(0===arguments.length)return b;if(1==arguments.length)return b[arguments[0]];throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");};var n=[];a.__tags||
...
1);return this};var r=function(){if(!a.__tags)return[];if(!c.__tags)return a.__tags;var b=[];a.__tags.every(function(a){-1==c.__tags.indexOf(a)&&b.push(a)});return b};this.getChangedTags=r;this.getRemovedTags=function(){return _removetags};var q=function(b){var d=!1,e=JSON.parse(JSON.stringify(c)),g;for(g in a)"undefined"==typeof a[g]||null===a[g]?(e[g]=null,d=!0):a[g]!=c[g]?"__tags"==g||"__attributes"==g?delete e[g]:(e[g]=a[g],d=!0):a[g]==c[g]&&delete e[g];try{m.forEach(function(a){e[a]&&delete e[a]})}catch(h){}b?
(a.__tags&&0<a.__tags.length&&(e.__addtags=r(),d=!0),n&&0<n.length&&(e.__removetags=n,d=!0)):a.__tags&&0<a.__tags.length&&(e.__tags=r(),d=!0);(b=k())?(e.__attributes=b,d=!0):delete e.__attributes;return d?e:!1};this.changed=function(){return q()};this.hasChanged=function(){var a=q(!0);return 0===arguments.length?Object.isEmpty(a)?!1:!0:1==arguments.length&&"string"==typeof arguments[0]&&0<arguments[0].length&&a&&a[arguments[0]]?!0:!1};this.changedAttributes=function(){var a=q(!0);if(0===arguments.length)return a;
