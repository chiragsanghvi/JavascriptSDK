...
Array.prototype.sortBy=function(c,e){c=_lookupIterator(c,e);return this.map(function(b,f){return{value:b,criteria:c.call(e,b,f,this)}},this).sort(function(b,c){var h=b.criteria,e=c.criteria;return h<e?-1:h>e?1:0}).pluck("value")};
...
(function(){global="undefined"===typeof window?process:window;global.Appacitive||(global.Appacitive={runtime:{isNode:"undefined"!=typeof process,isBrowser:"undefined"!=typeof window}});var c=function(b){if(b&&b.send&&_type.isFunction(b.send))b.onResponse=this.onResponse;else throw Error("No applicable httpTransport class found");var c=[],h={},f=0,e={},l=0;this.addProcessor=function(b){b&&(b.pre=b.pre||function(){},b.post=b.post||function(){},r(b.pre),t(b.post))};var r=function(b){f+=1;h[f]=b;return f},
t=function(b){l+=1;e[l]=b;return l};this.enqueueRequest=function(b){c.push(b)};this.changeRequestForCors=function(b){var g={m:b.method.toUpperCase()};b.headers.forEach(function(b){g[b.key]=b.value});b.prevHeaders=b.headers;b.headers=[];b.headers.push({key:"Content-Type",value:"text/plain; charset=utf-8"});b.method="POST";b.data&&(g.b=b.data);delete b.data;global.Appacitive.config.debug&&(-1===b.url.indexOf("?")?b.url+="?debug=true":b.url+="&debug=true");try{b.data=JSON.stringify(g)}catch(c){}return b};
this.notify=function(){if(0!==c.length){var f=[],l;for(l in e)e.hasOwnProperty(l)&&f.push(e[l]);for(;0<c.length;){var q=c.shift(),p=[];for(l in h)h.hasOwnProperty(l)&&p.push(h[l](q));this.changeRequestForCors(q);b.send(q,f,p)}}};this.onResponse=function(b){console.dir(b)}},e=function(){var b=function(){throw Error("Not Implemented Exception");};this.inOnline=this.send=b;this.onResponse=function(c,h){b()};this.onError=function(c){b()}},b=null,b=global.Appacitive.runtime.isBrowser?XMLHttpRequest:require("xmlhttprequest-with-globalagent").XMLHttpRequest,
f=function(b){var c=global.Appacitive.Promise.buildPromise({success:b.onSuccess,error:b.onError}),h=new XDomainRequest;h.onload=function(){var b=h.responseText;try{var g=h.contentType;if("application/json"==g.toLowerCase()||"application/javascript"==g.toLowerCase()||"application/json; charset=utf-8"==g.toLowerCase()||"application/json; charset=utf-8;"==g.toLowerCase())g=b,global.Appacitive.runtime.isBrowser||"{"!=g[0]&&(g=g.substr(1,g.length-1)),b=JSON.parse(g)}catch(f){}c.fulfill(b,this)};h.onerror=
h.ontimeout=function(){c.reject(h)};h.onprogress=function(){};-1===b.url.indexOf("?")?b.url+="?ua=ie":b.url+="&ua=ie";h.open(b.method,b.url,!0);h.send(b.data);return c},h=function(g){if(!g.url)throw Error("Please specify request url");g.method||(g.method="GET");g.headers||(g.headers=[]);var c={};g.onSuccess&&_type.isFunction(g.onSuccess)||(g.onSuccess=function(){});g.onError&&_type.isFunction(g.onError)||(g.onError=function(){});var h=global.Appacitive.Promise.buildPromise({success:g.onSuccess,error:g.onError}),
e=!0;g.headers.forEach(function(b){"content-type"==b.key.toLowerCase()&&(e=!0,"application/json"==b.value.toLowerCase()||"application/javascript"==b.value.toLowerCase()||"application/json; charset=utf-8"==b.value.toLowerCase()||"application/json; charset=utf-8;"==b.value.toLowerCase())&&(e=!1)});if(e)c=g.data;else if(g.data&&(c=g.data,_type.isObject(g.data)))try{c=JSON.stringify(c)}catch(k){}if(!global.navigator||-1==global.navigator.userAgent.indexOf("MSIE 8")&&-1==global.navigator.userAgent.indexOf("MSIE 9")){var l=
new b;l.onreadystatechange=function(){if(4==this.readyState)if(200<=this.status&&300>this.status||304==this.status){var b=this.responseText;try{var c=this.getResponseHeader("content-type")||this.getResponseHeader("Content-Type");if("application/json"==c.toLowerCase()||"application/javascript"==c.toLowerCase()||"application/json; charset=utf-8"==c.toLowerCase()||"application/json; charset=utf-8;"==c.toLowerCase())c=b,global.Appacitive.runtime.isBrowser||"{"!=c[0]&&(c=c.substr(1,c.length-1)),b=JSON.parse(c)}catch(g){}h.fulfill(b,
this)}else h.reject(this)};l.open(g.method,g.url,!0);for(var r=0;r<g.headers.length;r+=1)l.setRequestHeader(g.headers[r].key,g.headers[r].value);global.Appacitive.runtime.isBrowser||l.setRequestHeader("User-Agent","Appacitive-NodeJSSDK");l.send(c);return h}g.data=c;return new f(g)},l=function(){var b=new e;b.isOnline=function(){return!0};var c=function(c,f,e){new h({method:c.method,url:c.url,headers:c.headers,data:c.data,onSuccess:function(h,m){if(h){try{h=JSON.parse(h)}catch(l){}var u=h;if(f.length!=
...
(function(c){var e={},b=Array.prototype.forEach,f=Object.prototype.hasOwnProperty,h=Array.prototype.slice,l=0,g=function(){return{keys:Object.keys,uniqueId:function(b){var c=++l+"";return b?b+c:c},has:function(b,c){return f.call(b,c)},each:function(c,h,g){if(null!=c)if(b&&c.forEach===b)c.forEach(h,g);else if(c.length===+c.length)for(var f=0,k=c.length;f<k&&h.call(g,c[f],f,c)!==e;f++);else for(f in c)if(this.has(c,f)&&h.call(g,c[f],f,c)===e)break},once:function(c){var b=!1,h;return function(){if(b)return h;
b=!0;h=c.apply(this,arguments);c=null;return h}}}}(),m;m={on:function(c,b,h){if(!p(this,"on",c,[b,h])||!b)return this;this._events||(this._events={});(this._events[c]||(this._events[c]=[])).push({callback:b,context:h,ctx:h||this});return this},once:function(c,b,h){if(!p(this,"once",c,[b,h])||!b)return this;var e=this,f=g.once(function(){e.off(c,f);b.apply(this,arguments)});f._callback=b;return this.on(c,f,h)},off:function(c,b,h){var e,f,k,m,l,n,x,w;if(!this._events||!p(this,"off",c,[b,h]))return this;
if(!c&&!b&&!h)return this._events={},this;m=c?[c]:g.keys(this._events);l=0;for(n=m.length;l<n;l++)if(c=m[l],k=this._events[c]){this._events[c]=e=[];if(b||h)for(x=0,w=k.length;x<w;x++)f=k[x],(b&&b!==f.callback&&b!==f.callback._callback||h&&h!==f.context)&&e.push(f);e.length||delete this._events[c]}return this},trigger:function(c){if(!this._events)return this;var b=h.call(arguments,1);if(!p(this,"trigger",c,b))return this;var g=this._events[c],e=this._events.all;g&&k(g,b);e&&k(e,arguments);return this},
stopListening:function(c,b,h){var g=this._listeners;if(!g)return this;var e=!b&&!h;"object"===typeof b&&(h=this);c&&((g={})[c._listenerId]=c);for(var f in g)g[f].off(b,h,this),e&&delete this._listeners[f];return this}};var n=/\s+/,p=function(c,b,h,g){if(!h)return!0;if("object"===typeof h){for(var e in h)c[b].apply(c,[e,h[e]].concat(g));return!1}if(n.test(h)){h=h.split(n);e=0;for(var f=h.length;e<f;e++)c[b].apply(c,[h[e]].concat(g));return!1}return!0},k=function(c,b){var h,g=-1,e=c.length,f=b[0],k=
b[1],m=b[2];switch(b.length){case 0:for(;++g<e;)(h=c[g]).callback.call(h.ctx);break;case 1:for(;++g<e;)(h=c[g]).callback.call(h.ctx,f);break;case 2:for(;++g<e;)(h=c[g]).callback.call(h.ctx,f,k);break;case 3:for(;++g<e;)(h=c[g]).callback.call(h.ctx,f,k,m);break;default:for(;++g<e;)(h=c[g]).callback.apply(h.ctx,b)}};g.each({listenTo:"on",listenToOnce:"once"},function(c,b){m[b]=function(b,h,e){var f=this._listeners||(this._listeners={}),k=b._listenerId||(b._listenerId=g.uniqueId("l"));f[k]=b;"object"===
...
(function(c){var e=function(b){var e;if(!b||!_type.isObject(b))throw Error("Please specify request options");this.promise=c.Appacitive.Promise.buildPromise(b.callbacks);var h=this.request=new c.Appacitive.HttpRequest;e=c.Appacitive.storage.urlFactory[b.type];var l=b.op.replace("get","").replace("Url","")+" "+b.type;e=c.Appacitive.config.apiBaseUrl+e[b.op].apply(e,b.args||[]);h.url=e;h.description=l;h.method=b.method||"get";h.data=b.data||{};h.onSuccess=b.onSuccess;h.onError=b.onError;h.promise=this.promise;
h.options=b.callbacks;b.entity&&(h.entity=b.entity);return this};e.prototype.send=function(){return c.Appacitive.http.send(this.request)};c.Appacitive._Request=e})(global);
(function(c){c.Appacitive.Session=new function(){this.initialized=!1;var e=function(){this.apikey="";this.isnonsliding=!1;this.usagecount=-1;this.windowtime=240},b=null,f=null,h=null,l=!1;this.useApiKey=!0;this.onSessionCreated=function(){};this.recreate=function(b){return c.Appacitive.Session.create(b)};this.create=function(h){if(!this.initialized)throw Error("Intialize Appacitive SDK");var g=new e;g.apikey=f;var l=new c.Appacitive._Request({method:"PUT",type:"application",op:"getSessionCreateUrl",
callbacks:h,data:g,onSuccess:function(h){b=h.session.sessionkey;c.Appacitive.Session.useApiKey=!1;l.promise.fulfill(h);c.Appacitive.Session.onSessionCreated()}});return l.send()};c.Appacitive.http.addProcessor({pre:function(g){c.Appacitive.Session.useApiKey?g.headers.push({key:"ak",value:f}):g.headers.push({key:"as",value:b});!0===l&&(1==g.headers.filter(function(c){return"ut"==c.key}).length?g.headers.forEach(function(c){"ut"==c.key&&(c.value=h)}):g.headers.push({key:"ut",value:h}))}});this.setUserAuthHeader=
function(b,g,e){try{b&&(l=!0,h=b,e||(g||(g=-1),-1==g&&(g=null),c.Appacitive.localStorage.set("Appacitive-UserToken",b),c.Appacitive.localStorage.set("Appacitive-UserTokenExpiry",g),c.Appacitive.localStorage.set("Appacitive-UserTokenDate",(new Date).getTime())))}catch(f){}};this.incrementExpiry=function(){try{c.Appacitive.runtime.isBrowser&&l&&c.Appacitive.localStorage.set("Appacitive-UserTokenDate",(new Date).getTime())}catch(b){}};this.removeUserAuthHeader=function(b,g){var e=c.Appacitive.Promise.buildPromise(g);
b||c.Appacitive.User.trigger("logout",{});c.Appacitive.localStorage.remove("Appacitive-User");if(h&&b)try{var f=new c.Appacitive.HttpRequest(g);f.url=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory.user.getInvalidateTokenUrl(h);f.method="POST";f.data={};f.type="user";f.options=g;f.description="InvalidateToken user";f.onSuccess=f.onError=function(){l=!1;h=null;c.Appacitive.localStorage.remove("Appacitive-UserToken");c.Appacitive.localStorage.remove("Appacitive-UserTokenExpiry");c.Appacitive.localStorage.remove("Appacitive-UserTokenDate");
e.fulfill()};c.Appacitive.http.send(f);return e}catch(q){}else return l=!1,h=null,c.Appacitive.localStorage.remove("Appacitive-UserToken"),c.Appacitive.localStorage.remove("Appacitive-UserTokenExpiry"),c.Appacitive.localStorage.remove("Appacitive-UserTokenDate"),e.fulfill()};this.isSessionValid=function(c){if(c.status){if(c.status.code&&("420"==c.status.code||"19027"==c.status.code||"19002"==c.status.code))return{status:!1,isSession:"19027"==c.status.code||"420"==c.status.code?!0:!1}}else if(c.code&&
("420"==c.code||"19027"==c.code||"19002"==c.code))return{status:!1,isSession:"19027"==c.code||"420"==c.code?!0:!1};return{status:!0}};this.resetSession=function(){b=null;this.useApiKey=!0};this.get=function(){return b};this.setSession=function(c){c&&(b=c,this.useApiKey=!1)};this.setApiKey=function(c){c&&(f=c,this.useApiKey=!0)};var g="sandbox";this.environment=function(){if(1==arguments.length){var c=arguments[0];"sandbox"!=c&&"live"!=c&&(c="sandbox");g=c}return g}};c.Appacitive.getAppPrefix=function(e){return c.Appacitive.Session.environment()+
"/"+c.Appacitive.appId+"/"+e};c.Appacitive.initialize=function(e){e=e||{};if(!c.Appacitive.Session.initialized){if(!e.apikey||0===e.apikey.length)throw Error("apikey is mandatory");if(!e.appId||0===e.appId.length)throw Error("appId is mandatory");c.Appacitive.Session.setApiKey(e.apikey);c.Appacitive.Session.environment(e.env||"sandbox");c.Appacitive.useApiKey=!0;c.Appacitive.appId=e.appId;c.Appacitive.Session.initialized=!0;c.Appacitive.Session.persistUserToken=e.persistUserToken;e.debug&&(c.Appacitive.config.debug=
!0);_type.isFunction(e.apiLog)&&(c.Appacitive.logs.apiLog=e.apiLog);_type.isFunction(e.apiErrorLog)&&(c.Appacitive.logs.apiErrorLog=e.apiErrorLog);_type.isFunction(e.exceptionLog)&&(c.Appacitive.logs.exceptionLog=e.exceptionLog);if(e.userToken)if(-1==e.expiry?e.expiry=null:e.expiry||(e.expiry=3600),c.Appacitive.Session.setUserAuthHeader(e.userToken,e.expiry),e.user)c.Appacitive.Users.setCurrentUser(e.user);else{var b=c.Appacitive.localStorage.get("Appacitive-User");b&&c.Appacitive.Users.setCurrentUser(b)}else if(c.Appacitive.runtime.isBrowser&&
(e=c.Appacitive.localStorage.get("Appacitive-UserToken"))){var f=c.Appacitive.localStorage.get("Appacitive-UserTokenExpiry"),b=c.Appacitive.localStorage.get("Appacitive-UserTokenDate");f||(f=-1);b&&0<f&&new Date(b+1E3*f)<new Date||(-1==f&&(f=null),(b=c.Appacitive.localStorage.get("Appacitive-User"))&&c.Appacitive.Users.setCurrentUser(b,e,f))}}}})(global);
(function(c){c.Appacitive&&c.Appacitive.http&&(c.Appacitive.http.addProcessor({pre:function(e){e.headers.push({key:"e",value:c.Appacitive.Session.environment()})}}),c.Appacitive.Events.mixin(c.Appacitive))})(global);
(function(c){var e=c.Appacitive;e.GeoCoord=function(c,b){var h=function(c,b){if(isNaN(c)||isNaN(b))throw Error("Invalid Latitiude or longitiude provided");if(-90>c||90<c)throw Error("Latitude "+c+" should be in range of  -90.0 to 90.");if(-180>b||180<b)throw Error("Latitude "+b+" should be in range of  -180.0 to 180.");},g=function(c){if("string"!==typeof c||0==c.length)return!1;c=c.split(",");if(2!==c.length)return!1;try{return new e.GeoCoord(c[0],c[1])}catch(b){return!1}};if(_type.isString(c)&&
!b&&(g=g(c)))return g;c&&b?(h(c,b),this.lat=c,this.lng=b):this.lng=this.lat=0;this.toJSON=function(){return{latitude:this.lat,longitude:this.lng}};this.getValue=function(){return String.format("{0},{1}",c,b)};this.toString=function(){return this.getValue()}};var b=function(){this.toString=function(){};this.Or=function(){var c=Array.prototype.slice.call(arguments,0);c.splice(0,0,this);return new p(k.or,c)};this.And=function(){var c=Array.prototype.slice.call(arguments,0);c.splice(0,0,this);return new p(k.and,
...
this.toString=function(){return String.format("{0}('{1}')",this.operator,this.tags.join(","))}};n.prototype=new b;n.prototype.constructor=n;var p=function(c,h){if(!h||!h.length||2>h.length)throw Error("Provide valid or atleast 2 filters");this.operator=c;this.innerFilters=[];for(var g=0;g<h.length;g+=1){if(!(h[g]instanceof b))throw Error("Invalid filter provided");this.innerFilters.push(h[g])}this.toString=function(){var c=this.operator,b="(";this.innerFilters.forEach(function(h){b=1===b.length?b+
(" "+h.toString()):b+String.format(" {0} {1} ",c,h.toString())});return b+=")"}};p.prototype=new b;p.prototype.constructor=p;var k={isEqualTo:"==",isGreaterThan:">",isGreaterThanEqualTo:">=",isLessThan:"<",isLessThanEqualTo:"<=",like:"like",match:"match",between:"between",withinCircle:"within_circle",withinPolygon:"within_polygon",or:"or",and:"and",taggedWithAll:"tagged_with_all",taggedWithOneOrMore:"tagged_with_one_or_more"},q=function(c,b){if(null===c||void 0===c||0===c.length)throw Error("Specify value");
...
function(c,b){return new l({field:this.name,fieldType:this.type,val1:new u(c),val2:new u(b),operator:k.between})};e.withinCircle=function(c,b,h){return new g({field:this.name,fieldType:this.type,geoCoord:c,distance:b,unit:h,operator:k.withinCircle})};e.withinPolygon=function(c){return new m({field:this.name,fieldType:this.type,geoCoords:c,operator:k.withinPolygon})}},B=function(c){if(!c||0===c.length)throw Error("Specify field name");this.field=c;v("property",c,this);return this},A=function(c){if(!c||
0===c.length)throw Error("Specify field name");this.field=c;var b=new v("aggregate",c);this.equalTo=function(c){return b.equalTo(c)};this.greaterThan=function(c){return b.greaterThan(c)};this.greaterThanEqualTo=function(c){return b.greaterThanEqualTo(c)};this.lessThan=function(c){return b.lessThan(c)};this.lessThanEqualTo=function(c){return b.lessThanEqualTo(c)};this.between=function(c,h){return b.between(c,h)};return this},y=function(c){if(!c||0===c.length)throw Error("Specify field name");this.field=
...
this.filter(f.filter||"");this.freeText(f.freeText||"");this.fields(f.fields||"");this.setFilter=function(c){this.filter(c)};this.setFreeText=function(c){this.freeText(c)};this.setFields=function(c){this.fields(c)};this.extendOptions=function(c){for(var h in c)f[h]=c[h];k=new e(f);q=new b(f);return this};this.getQueryString=function(){var c=k.toString(),b=q.toString();b&&(c+="&"+b);this.filter()&&(b=encodeURIComponent(this.filter().toString()),0<b.trim().length&&(c+="&query="+b));this.freeText()&&
0<this.freeText().trim().length&&(c+="&freetext="+encodeURIComponent(this.freeText())+"&language=en");this.fields()&&0<this.fields().trim().length&&(c+="&fields="+this.fields());return c};this.toUrl=function(){return{url:c.Appacitive.config.apiBaseUrl+t+"/"+r+"/find/all?"+this.getQueryString(),description:"FindAll "+r+" "+t+"s"}};this.toRequest=function(b){var h=new c.Appacitive.HttpRequest,g=this.toUrl();h.url=g.url;h.options=b;h.description=g.description;h.method="get";return h};this.getOptions=
function(){var c={},b;for(b in this)this.hasOwnProperty(b)&&!_type.isFunction(this[b])&&(c[b]=this[b]);return c};this._setPaging=function(c){c&&(k.pageNumber(c.pagenumber),k.pageSize(c.pagesize),this.results=this.results||[],this.results.isLastPage=!1,this.results.total=c.totalrecords,this.results.pageNumber=c.pagenumber,this.results.pageSize=c.pagesize,c.pagenumber*c.pagesize>=c.totalrecords&&(this.results.isLastPage=!0))};this.fetch=function(b){var h=c.Appacitive.Promise.buildPromise(b);b=this.toRequest(b);
b.onSuccess=function(b){var g;(g=b[t+"s"])||(g=[]);g=c.Appacitive["object"===t?"Object":"Connection"]._parseResult(g,f.entity);u.results=g;u._setPaging(b.paginginfo);h.fulfill(u.results,b.paginginfo)};b.promise=h;b.entity=this;return c.Appacitive.http.send(b)};this.collection=function(b,h){h=h||{};b=b||[];_type.isObject(b)&&(h=b,b=null);b||(b=this.results?this.results:[]);var g=f.entity;!g&&(0<b.length&&b[0]instanceof c.Appacitive.BaseObject)&&(g="object"==b[0].type?"Object":"Connection",g=c.Appacitive[g]._getClass(b[0].className));
g||(g="object"===t?"Object":"Connection",c.Appacitive[g]._getClass(this[g]));return new Appacitive.Collection(b,_extend(h,{model:this.model,query:this}))};this.fetchNext=function(c){var b=this.pageNumber();this.pageNumber(++b);return this.fetch(c)};this.fetchPrev=function(c){var b=this.pageNumber(),b=b-1;0>=b&&(b=1);this.pageNumber(b);return this.fetch(c)};this.count=function(b){var h=c.Appacitive.Promise.buildPromise(b);b=this.toRequest(b);b.onSuccess=function(c){c=c||{};c=c.paginginfo;var b=0,b=
c?c.totalrecords:0;h.fulfill(b)};b.promise=h;b.entity=this;return c.Appacitive.http.send(b)}};c.Appacitive.Query=f;c.Appacitive.Queries.FindAllQuery=function(c){c=c||{};if(!c.type&&!c.relation)throw Error("Specify either type or relation for basic filter query");c.queryType="FindAllQuery";f.call(this,c);return this};c.Appacitive.Queries.FindAllQuery.prototype=new f;c.Appacitive.Queries.FindAllQuery.prototype.constructor=c.Appacitive.Queries.FindAllQuery;c.Appacitive.Queries.ConnectedObjectsQuery=
...
b.returnEdge||b.returnEdge||this.prev)||(this.returnEdge=!1);this.label="";var g=this;_type.isString(b.label)&&0<b.label.length&&(this.label="&label="+b.label);this.toUrl=function(){return{url:c.Appacitive.config.apiBaseUrl+"connection/"+this.relation+"/"+this.type+"/"+this.objectId+"/find?"+this.getQueryString()+this.label+"&returnEdge="+this.returnEdge,description:"GetConnectedObjects for relation "+this.relation+" of type "+this.type+" for object "+this.objectId}};var m=function(b,h){var e=[];
b.forEach(function(b){var g=b.__edge;delete b.__edge;var f=c.Appacitive.Object._create(b,!0);g&&(g.__endpointa=h,g.__endpointb={objectid:b.__id,label:g.__label,type:b.__type},delete g.label,f.connection=c.Appacitive.Connection._create(g,!0));e.push(f)});g.object&&(g.object.children[g.relation]=e);return e};this.fetch=function(f){var p=c.Appacitive.Promise.buildPromise(f);f=this.toRequest(f);f.onSuccess=function(c){g.results=m(c.nodes?c.nodes:[],{objectid:b.objectId,type:e,label:c.parent});g._setPaging(c.paginginfo);
...
b=b.split(",");return 2!==b.length?!1:new c.Appacitive.GeoCoord(b[0],b[1])}};this.get=function(c,b){if(c){if(b&&x[b.toLowerCase()]){if(x[b.toLowerCase()])return x[b.toLowerCase()](k[c]);throw Error('Invalid cast-type "'+b+'"" provided for get "'+c+'"');}return k[c]}};this.tryGet=function(c,b,g){c=this.get(c,g);return void 0!==c?c:b};var w=function(c,b){if(b&&!b.silent){var g=z();g[c]&&(n.trigger("change:"+c,n,g[c],{}),n.trigger("change",n,b))}},E=function(c){c&&!c.silent&&n.trigger("destroy",n,n.collection,
c)};this.set=function(b,e,m){m=m||{};if(!b||!_type.isString(b)||0===b.length||0===b.trim().indexOf("$"))return this;b=b.toLowerCase();try{if(void 0==e||null==e)k[b]=null;else if(_type.isString(e))k[b]=e;else if(_type.isNumber(e)||_type.isBoolean(e))k[b]=e+"";else if(e instanceof Date)k[b]="date"==dataType?c.Appacitive.Date.toISODate(e):"time"==dataType?c.Appacitive.Date.toISOTime(e):c.Appacitive.Date.toISOString(e);else if(_type.isObject(e))if(-1!==u.indexOf(b))k[b]=e;else if(e instanceof c.Appacitive.GeoCoord)k[b]=
e.toString();else throw Error("Property cannot have value as an object");else _type.isArray(e)&&(k[b]=[],e.forEach(function(c){if(_type.isString(c))k[b].push(c);else if(_type.isNumber(c)||_type.isBoolean(c))k[b].push(c+"");else{if(e instanceof Date)throw Error("Multivalued property cannot have values of property as date");throw Error("Multivalued property cannot have values of property as an object");}}),"tags"!==b||"__link"!==b)&&(k[b].push=function(c){var g=this.length;if(_type.isString(c))this[g]=
c;else if(_type.isNumber(c)||_type.isBoolean(c))this[g]=c+"";else throw Error("Multivalued property cannot have values of property as an object");w(b,m);return this});delete h[b];delete l[b];delete g[b];k[b]!==f[b]&&(_type.isArray(k[b])&&!k[b].equals(f[b])||_type.isString(k[b])||_type.isObject(k[b]))&&(g[b]=!0);w(b,m);return this}catch(n){throw Error("Unable to set "+b);}};this.unset=function(c,b){if(!c||!_type.isString(c)||0===c.length||0===c.indexOf("__"))return this;c=c.toLowerCase();delete k[c];
w(c,b);return this};this.has=function(c){return c&&_type.isString(c)&&0!==c.length?k[c]&&!_type.isUndefined(k[c])?!0:!1:!1};this.isNew=function(){return k.__id&&k.__id.length?!1:!0};this.clone=function(){return"object"==this.type?c.Appacitive.Object._create(this.toJSON()):new c.Appacitive.connection._create(this.toJSON())};this.copy=function(c,b){c&&(m(c,k),b&&m(c,f));return this};this.mergeWithPrevious=function(){m(k,f);q=[];h={};l={};g={};return this};var C=function(){m(f,k);q=[];h={};l={};g={}};
this.rollback=function(){k=p={};C();return this};var D=function(c,b,g,e){if(!c||!_type.isString(c)||0===c.length||0===c.indexOf("__"))return this;c=c.toLowerCase();if(_type.isObject(k[c])||_type.isArray(k[c]))throw Error("Cannot increment/decrement array/object");try{_type.isObject(b)?(e=b,b=g):b=!b||isNaN(Number(b))?g:Number(b)*g,k[c]=isNaN(Number(k[c]))?b:Number(k[c])+b,n.isNew()||(h[c]={value:(h[c]?h[c].value:0)+b})}catch(f){throw Error("Cannot perform increment/decrement operation");}w(c,e);return n};
this.increment=function(c,b,g){return D(c,b,1,g)};this.decrement=function(c,b,g){return D(c,b,-1,g)};this.save=function(){return k.__id?F.apply(this,arguments):G.apply(this,arguments)};var G=function(b){var g=n.type;!k.__type||"user"!=k.__type.toLowerCase()&&"device"!=k.__type.toLowerCase()||(g=k.__type.toLowerCase());for(var e in k)"$"==e[0]&&delete k[e];k.__revision&&delete k.__revision;"object"==g&&(e=n._aclFactory.getChanged())&&(k.__acls=e);var h=new c.Appacitive._Request({method:"PUT",type:g,
op:"getCreateUrl",args:[this.className,r],data:k,callbacks:b,entity:n,onSuccess:function(e){var m=null;e&&e[g]?(f=m=e[g],k.__id=m.__id,C(),"connection"==n.type?n.parseConnection():n._aclFactory.merge(),c.Appacitive.eventManager.fire(n.entityType+"."+g+".created",n,{object:n}),n.created=!0,n.trigger("sync",n,e[g],b),h.promise.fulfill(n)):(c.Appacitive.eventManager.fire(n.entityType+"."+g+".createFailed",n,{error:e.status}),h.promise.reject(e.status,n))}});return h.send()},F=function(b,g){c.Appacitive.Promise.is(g)||
(g=c.Appacitive.Promise.buildPromise(b));var e=z(!0),h;for(h in e)"$"==h[0]&&delete e[h];if(Object.isEmpty(e))g.fulfill(n);else{var m=n.type;h=[n.className,f.__id?f.__id:k.__id,r];k&&(k.__type&&("user"==k.__type.toLowerCase()||"device"==k.__type.toLowerCase()))&&(m=k.__type.toLowerCase(),h.splice(0,1));var l=new c.Appacitive._Request({method:"POST",type:m,op:"getUpdateUrl",args:h,data:e,callbacks:b,entity:n,onSuccess:function(g){g&&g[m]?(f=g[m],n._aclFactory.merge(),C(),delete n.created,n.trigger("sync",
n,g[m],b),c.Appacitive.eventManager.fire(n.entityType+"."+m+"."+k.__id+".updated",n,{object:n}),l.promise.fulfill(n)):(g=g||{},g.status=g.status||{},g.status=v(g.status),c.Appacitive.eventManager.fire(n.entityType+"."+m+"."+k.__id+".updateFailed",n,{object:g.status}),l.promise.reject(g.status,n))}});return l.send()}return g},H=function(b){if(!k.__id)throw Error("Please specify id for get operation");var g=this.type;k&&(k.__type&&("user"==k.__type.toLowerCase()||"device"==k.__type.toLowerCase()))&&
(g=k.__type.toLowerCase());var e=new c.Appacitive._Request({method:"GET",type:g,op:"getGetUrl",args:[this.className,k.__id,r],callbacks:b,entity:n,onSuccess:function(c){c&&c[g]?(f=c[g],m(f,k),c.connection&&(n.endpoints||n.endpointA&&n.endpointB||n.setupConnection(k.__endpointa,k.__endpointb)),n.trigger("sync",n,c[g],b),e.promise.fulfill(n)):(c=c||{},c.status=c.status||{},c.status=v(c.status),e.promise.reject(c.status,n))}});return e.send()};this.fetch=function(c){return H.apply(this,[c])};this.del=
this.destroy=function(b){b=b||{};var g=b.deleteConnections;_type.isBoolean(b)&&(g=b,b={});b.wait||E(b);if(!k.__id)return(new c.Appacitive.Promise.buildPromise(b)).fulfill();var e=this.type;!k.__type||"user"!=k.__type.toLowerCase()&&"device"!=k.__type.toLowerCase()||(e=k.__type.toLowerCase());var h=new c.Appacitive._Request({method:"DELETE",type:e,op:"getDeleteUrl",args:[this.className,k.__id,g],callbacks:b,entity:this,onSuccess:function(c){h.promise.fulfill(c);c&&c.status?(b.wait&&E(b),h.promise.fulfill(c.status)):
(c=c||{},c.status=c.status||{},c.status=v(c.status),h.promise.reject(c.status,n))}});return h.send()};"object"==this.type&&(this.destroyWithConnections=function(c){return this.destroy(_extend({deleteConnections:!0},c))})};c.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())};c.Appacitive.Events.mixin(c.Appacitive.BaseObject.prototype)})(global);
...
m.typeName&&!m.isNew())&&(m=m.id());var l=g.filter(function(c){return c.sid==m&&c.type==h});l&&0!=l.length?l=l[0]:(l={sid:m,type:h,deny:[],allow:[]},g.push(l));l.allow||(l.allow=[]);l.deny||(l.deny=[]);k=f(k);var p=n.filter(function(c){return c.sid==m&&c.type==h});p&&0!=p.length?p=p[0]:(p={sid:m,type:h},n.push(p));k.forEach(function(c){for(var g=0;g<e.length;g+=1){var h=l[e[g]].indexOf(c);if(-1!=h){l[e[g]].splice(h,1);break}}"inherit"!=b&&l[b].push(c);p[c]=b});return this},k=function(c,b,g,e){if(!g)throw Error("Please provide valid id or name for setting acls");
...
["deny","usergroup",["anonymous"],c])};g.resetLoggedIn=function(c){return k.apply(this,["inherit","usergroup",["anonymous"],c])}};this._rollback=function(){n=[];g=JSON.parse(JSON.stringify(m));q();return this};this.getChanged=function(){var c=[];n.forEach(function(g){var h={sid:g.sid,type:g.type,allow:[],deny:[],inherit:[]};b.forEach(function(c){g[c]&&h[g[c]].push(c)});e.forEach(function(c){0==h[c].length&&delete h[c]});0==h.inherit.length&&delete h.inherit;c.push(h)});return 0==c.length?null:c};
this.merge=function(){n=[];return this};q();return this};c.Appacitive.Group=new function(){var b=function(b,g,e){if(!g||!_type.isString(g)||0===g.length)throw Error("Please specify valid groupname");_type.isArray(e)||(e=[e]);var h={};h[b]=[];e.forEach(function(g){g&&(g instanceof c.Appacitive.Object&&"user"==g.typeName&&!g.isNew()?h[b].push(g.id()):h[b].push(g))});if(0==h[b].length)throw Error("Please specify valid members as second argument");var f=new c.Appacitive._Request({method:"POST",type:"usergroup",
op:"getUpdateUrl",args:[g],data:h,entity:this,onSuccess:function(c){f.promise.fulfill(c)}});return f.send()};this.addMembers=function(c,g){return b("add",c,g)};this.removeMembers=function(c,g){return b("remove",c,g)}}})(global);
...
b.ids.length)throw Error("Specify ids to delete");var f=new c.Appacitive._Request({method:"GET",type:"connection",op:"getMultiGetUrl",args:[b.relation,b.ids.join(","),b.fields],callbacks:e,onSuccess:function(c){f.promise.fulfill(l(c.connections,b.entity))}});return f.send()};c.Appacitive.Connection.multiDelete=function(b,e){b=b||{};e=e||{};var f=[];this.className&&(b.relation=this.className);_type.isArray(b)&&0<b.length&&(f=b,b={relation:f[0].className,ids:f.map(function(b){return b.id()}).filter(function(b){return b})});
if(!b.relation||!_type.isString(b.relation)||0===b.relation.length)throw Error("Specify valid relation");if(!b.ids||0===b.ids.length)throw Error("Specify ids to delete");var h=new c.Appacitive._Request({method:"POST",data:{idlist:b.ids},type:"connection",op:"getMultiDeleteUrl",args:[b.relation],callbacks:callbacks,onSuccess:function(b){e&&!e.silent&&f.forEach(function(b){b.trigger("destroy",b,b.collection,e)});h.promise.fulfill()}});return h.send()};c.Appacitive.Connection.findAll=c.Appacitive.Connection.findAllQuery=
...
e.length)return c.Appacitive.Promise.buildPromise(b).fulfill(this.linkedAccounts(),this);var f=this,h=new c.Appacitive._Request({method:"GET",type:"user",op:"getGetAllLinkedAccountsUrl",args:[e],callbacks:b,entity:this,onSuccess:function(){var b=a.identities||[];0<b.length?f.set("__link",b):f.set("__link",null);h.promise.fulfill(b,f)}});return h.send()};e.prototype.checkin=function(b,e){var f=this.get("__id");f&&_type.isString(f)&&0!==f.length||onSuccess&&_type.isFunction(onSuccess)&&onSuccess();
if(!(b&&b instanceof c.Appacitive.GeoCoord))throw Error("Invalid coordinates provided");var h=this,k=new c.Appacitive._Request({method:"POST",type:"user",op:"getCheckinUrl",args:[f,b.lat,b.lngerId],callbacks:e,entity:this,onSuccess:function(){k.promise.fulfill(h)}});return k.send()};e.prototype.linkFacebook=function(b,c){if(!b||!_type.isString(b))throw Error("Please provide accessToken");return h.apply(this,[{authtype:"facebook",accesstoken:b,name:"facebook"},c])};e.prototype.linkTwitter=function(b,
c){if(!_type.isObject(b)||!b.oAuthToken||!b.oAuthTokenSecret)throw Error("Twitter Token and Token Secret required for linking");var e={authtype:"twitter",oauthtoken:b.oAuthToken,oauthtokensecret:b.oAuthTokenSecret};b.consumerKey&&b.consumerSecret&&(e.consumersecret=b.consumerSecret,e.consumerkey=b.consumerKey);return h.apply(this,[e,c])};e.prototype.unlink=function(b,e){if(!_.isString(b))throw Error("Specify aouth account type for unlinking");var f=this.get("__id");if(!this.get("__id"))return this.set("__link",
null),promise.fulfill(this),promise;var h=this,k=new c.Appacitive._Request({method:"POST",type:"user",op:"getDelinkAccountUrl",args:[f,b],callbacks:e,entity:this,onSuccess:function(c){(c=h.get("__link"))?_type.isArray(c)||(c=[c]):c=[];if(0<=c.length){var e=null;c.forEach(function(c,f){c.name==b.toLowerCase()&&(e=f)});null!=e&&c.splice(e,1);h.copy({__link:c},!0)}else h.copy({__link:[]},!0);k.promise.fulfill(h)}});return k.send()};e.prototype.clone=function(){return new c.Appacitive.User(this.getObject())};
c.Appacitive.User=c.Appacitive.Object.extend("user",e.prototype);delete c.Appacitive.User._create;delete c.Appacitive.User._parseResult;delete c.Appacitive.User.multiDelete;e.deleteUser=function(b,e){if(!b)throw Error("Specify userid for user delete");return(new c.Appacitive.Object({__type:"user",__id:b})).del(!0,e)};e.deleteCurrentUser=function(e){var f=c.Appacitive.Promise.buildPromise(e);if(null===b)return c.Appacitive.Session.removeUserAuthHeader(),f.fulfill(),f;e=b.get("__id");this.deleteUser(e).then(function(){b=
null;c.Appacitive.Session.removeUserAuthHeader();f.fulfill()},function(){f.reject(arguments)});return f};e.createNewUser=function(b,e){b=b||{};b.__type="user";if(!b.username||!b.password||!b.firstname||0===b.username.length||0===b.password.length||0===b.firstname.length)throw Error("username, password and firstname are mandatory");return(new c.Appacitive.User(b)).save(e)};e.createUser=e.createNewUser;e.signup=function(b,e){var f=this,h=c.Appacitive.Promise.buildPromise(e);this.createUser(b).then(function(){f.login(b.username,
b.password).then(function(){h.fulfill.apply(h,arguments)},function(b){h.reject.apply(h,arguments)})},function(){h.reject(arguments)});return h};e.authenticateUser=function(e,f,h){e.expiry||(e.expiry=864E5);var l=this,k=new c.Appacitive._Request({method:"POST",type:"user",op:"getAuthenticateUserUrl",callbacks:f,data:e,onSuccess:function(f){f&&f.user?(h&&(f.user.__authType=h),l.setCurrentUser(f.user,f.token,e.expiry),c.Appacitive.User.trigger("login",b,b,f.token),k.promise.fulfill({user:b,token:f.token})):
...
!b.oAuthTokenSecret)throw Error("Twitter Token and Token Secret required for linking");var e={type:"twitter",oauthtoken:b.oAuthToken,oauthtokensecret:b.oAuthTokenSecret,expiry:864E5,createnew:!0};b.consumerKey&&b.consumerSecret&&(e.consumersecret=b.consumerSecret,e.consumerkey=b.consumerKey);return this.authenticateUser(e,c,"TWITTER")};e.validateCurrentUser=function(b,e){var f=c.Appacitive.Promise.buildPromise({success:e});e&&_type.isBoolean(e)&&(b=e,e=function(){});var h=c.Appacitive.localStorage.get("Appacitive-UserToken");
if(!h)return f.fulfill(!1),f;if(b)f.fulfill(!0);else try{var k=this;this.getUserByToken(h).then(function(b){k.setCurrentUser(b,h);f.fulfill(!0)},function(){f.fulfill(!1)})}catch(l){f.fulfill(!1)}return f};var l=function(b,e,f){var h=new c.Appacitive._Request({method:"GET",type:"user",op:b,callbacks:f,args:e,onSuccess:function(b){b&&b.user?h.promise.fulfill(new c.Appacitive.User(b.user)):h.promise.reject(b.status)}});return h.send()};e.getUserByToken=function(b,e){if(!b||!_type.isString(b)||0===b.length)throw Error("Please specify valid token");
c.Appacitive.Session.setUserAuthHeader(b,0,!0);return l("getUserByTokenUrl",[b],e)};e.getUserByUsername=function(b,c){if(!b||!_type.isString(b)||0===b.length)throw Error("Please specify valid username");return l("getUserByUsernameUrl",[b],c)};e.logout=function(e){b=null;return c.Appacitive.Session.removeUserAuthHeader(e)};e.sendResetPasswordEmail=function(b,e,f){if(!b||!_type.isString(b)||0===b.length)throw Error("Please specify valid username");if(!e||!_type.isString(e)||0===e.length)throw Error("Plase specify subject for email");
var h=new c.Appacitive._Request({method:"POST",type:"user",op:"getSendResetPasswordEmailUrl",callbacks:f,data:{username:b,subject:e},onSuccess:function(){h.promise.fulfill()}});return h.send()};e.resetPassword=function(b,e,f){if(!b)throw Error("Please specify token");if(!e||0===e.length)throw Error("Please specify password");var h=new c.Appacitive._Request({method:"POST",type:"user",op:"getResetPasswordUrl",callbacks:f,data:{newpassword:e},args:[b],onSuccess:function(){h.promise.fulfill()}});return h.send()};
e.validateResetPasswordToken=function(b,e){if(!b)throw Error("Please specify token");var f=new c.Appacitive._Request({method:"POST",type:"user",op:"getValidateResetPasswordUrl",callbacks:e,data:{},args:[b],onSuccess:function(b){f.promise.fulfill(b.user)}});return f.send()};c.Appacitive.Users=c.Appacitive.User;c.Appacitive.Events.mixin(c.Appacitive.User)})(global);
...
(function(c){c.Appacitive.Push=new function(){this.send=function(e,b){if(!e)throw Error("Please specify push options");var f=new c.Appacitive._Request({method:"POST",type:"push",op:"getPushUrl",callbacks:b,data:e,entity:e,onSuccess:function(b){f.promise.fulfill(b.id)}});return f.send()};this.getNotification=function(e,b){if(!e)throw Error("Please specify notification id");var f=new c.Appacitive._Request({method:"GET",type:"push",op:"getGetNotificationUrl",args:[e],callbacks:b,onSuccess:function(b){f.promise.fulfill(b.pushnotification)}});
return f.send()};this.getAllNotifications=function(e,b){e?(e.pnum=e.pnum||1,e.psize=e.psize||20):e={pnum:1,psize:20};var f=new c.Appacitive._Request({method:"GET",type:"push",op:"getGetAllNotificationsUrl",args:[e],callbacks:b,onSuccess:function(b){f.promise.fulfill(b.pushnotifications,b.paginginfo)}});return f.send()}}})(global);
(function(c){c.Appacitive.File=function(e){e=e||{};this.fileId=e.fileId;this.contentType=e.contentType;this.fileData=e.fileData;var b=this,f=function(e,f,h,g){var l=new c.Appacitive.HttpRequest;l.url=e;l.method="GET";l.description=g;l.onSuccess=f;l.promise=h;l.entity=b;c.Appacitive.http.send(l)},h=function(e,f,h,g,l){(new FormData).append("fileToUpload",f);var r=new c.Appacitive.HttpRequest;r.url=e;r.method="PUT";r.log=!1;r.description="Upload file";r.data=f;r.headers.push({key:"content-type",value:h});
r.send().then(g,function(){l.reject(d,b)})};this.save=function(b){return this.fileId&&_type.isString(this.fileId)&&0<this.fileId.length?g(b):l(b)};var l=function(e){if(!b.fileData)throw Error("Please specify filedata");if(!b.contentType)try{b.contentType=b.fileData.type}catch(g){}b.contentType&&_type.isString(b.contentType)&&0!==b.contentType.length||(b.contentType="text/plain");var l=c.Appacitive.Promise.buildPromise(e);e=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory.file.getUploadUrl(b.contentType,
b.fileId?b.fileId:"");f(e,function(c){h(c.url,b.fileData,b.contentType,function(){b.fileId=c.id;b.getDownloadUrl().then(function(c){return l.fulfill(c,b)},function(b){return l.reject(b)})},l)},l," Get upload url for file ");return l},g=function(e){if(!b.fileData)throw Error("Please specify filedata");if(!b.contentType)try{b.contentType=b.fileData.type}catch(g){}b.contentType&&_type.isString(b.contentType)&&0!==b.contentType.length||(b.contentType="text/plain");var l=c.Appacitive.Promise.buildPromise(e);
e=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory.file.getUpdateUrl(b.fileId,b.contentType);f(e,function(c){h(c.url,b.fileData,b.contentType,function(){b.getDownloadUrl().then(function(c){l.fulfill(c,b)},function(b){l.reject(b)})},l)},l," Get update url for file "+b.fileId);return l};this.deleteFile=function(e){if(!this.fileId)throw Error("Please specify fileId to delete");var f=c.Appacitive.Promise.buildPromise(e);e=new c.Appacitive.HttpRequest;e.url=c.Appacitive.config.apiBaseUrl+
c.Appacitive.storage.urlFactory.file.getDeleteUrl(this.fileId);e.method="DELETE";e.description="Delete file with id "+this.fileId;e.onSuccess=function(b){f.fulfill()};e.promise=f;e.entity=b;return c.Appacitive.http.send(e)};this.getDownloadUrl=function(e,h){if(!this.fileId)throw Error("Please specify fileId to download");"number"!==typeof e&&(h=e,e=-1);var g=c.Appacitive.Promise.buildPromise(h),k=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory.file.getDownloadUrl(this.fileId,e);f(k,
function(c){b.url=c.uri;g.fulfill(c.uri)},g," Get download url for file "+this.fileId);return g};this.getUploadUrl=function(e){b.contentType&&_type.isString(b.contentType)&&0!==b.contentType.length||(b.contentType="text/plain");var h=c.Appacitive.Promise.buildPromise(e);e=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory.file.getUploadUrl(this.contentType,this.fileId?this.fileId:"");f(e,function(c){b.url=c.url;h.fulfill(c.url,b)},h," Get upload url for file "+this.fileId);return h}}})(global);
(function(c){c.Appacitive.Date={};var e=function(b){return 10>b?"0"+b:b};c.Appacitive.Date.parseISODate=function(b){try{if(!/^([0-9]{1,4})-([0-9]{1,2})-([0-9]{1,2})T([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2})(.([0-9]+))?Z?$/.exec(b))return new Date(b);var c=b.split("T"),e=c[0].split("-"),l=c[1].split("Z")[0].split(":"),g=l[2].split("."),m=Number(l[0]),n=new Date;n.setUTCFullYear(Number(e[0]));n.setUTCMonth(Number(e[1])-1);n.setUTCDate(Number(e[2]));n.setUTCHours(Number(m));n.setUTCMinutes(Number(l[1]));
n.setUTCSeconds(Number(g[0]));g[1]&&n.setUTCMilliseconds(Number(g[1].substring(0,3)));return n}catch(p){return null}};c.Appacitive.Date.toISOString=function(b){try{return b=b.toISOString(),b=b.replace("Z","0000Z")}catch(c){return null}};c.Appacitive.Date.toISODate=function(b){if(b instanceof Date)return String.format("{0}-{1}-{2}",b.getFullYear(),e(b.getMonth()+1),e(b.getDate()));throw Error("Invalid date provided Appacitive.Date.toISODate method");};c.Appacitive.Date.toISOTime=function(b){var c=
