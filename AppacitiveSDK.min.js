...
f=function(a){var c=global.Appacitive.Promise.buildPromise({success:a.onSuccess,error:a.onError}),e=new XDomainRequest;e.onload=function(){var a=e.responseText;try{var h=e.contentType;if("application/json"==h.toLowerCase()||"application/javascript"==h.toLowerCase()||"application/json; charset=utf-8"==h.toLowerCase()||"application/json; charset=utf-8;"==h.toLowerCase())h=a,global.Appacitive.runtime.isBrowser||"{"!=h[0]&&(h=h.substr(1,h.length-1)),a=JSON.parse(h)}catch(b){}c.fulfill(a,this)};e.onerror=
...
(function(a){a.Appacitive.eventManager=new function(){function a(){var f=function(){return Math.floor(65536*Math.random()).toString(16)};return f()+f()+"-"+f()+"-"+f()+"-"+f()+"-"+f()+f()+f()}var c={};this.subscribe=function(f,b){if("string"!=typeof f||"function"!=typeof b)throw Error("Incorrect subscription call");"undefined"==typeof c[f]&&(c[f]=[]);var e=a();c[f].push({callback:b,id:e});return e};this.unsubscribe=function(a){if(!a)return!1;var b=-1,e=null,h;for(h in c)for(var k=0;k<c[h].length;k+=
...
Date?"datetime('"+g.Date.toISOString(this.value)+"')":"datetime('"+this.value+"')"}},t=function(a,c,g){g||(g=this);g.type=a;g.name=c;g.equalTo=function(a){return new f({field:this.name,fieldType:this.type,value:new l(a),operator:"=="})};g.equalToNumber=function(a){return new f({field:this.name,fieldType:this.type,value:new l(a,"number"),operator:"=="})};g.equalToDate=function(a){return new f({field:this.name,fieldType:this.type,value:new p(a),operator:"=="})};g.equalToTime=function(a){return new f({field:this.name,
...
g.withinPolygon=function(a){return new k({field:this.name,fieldType:this.type,geoCoords:a,operator:"within_polygon"})}},u=function(a){if(!a||0===a.length)throw Error("Specify field name");this.field=a;t("property",a,this);return this},v=function(a){if(!a||0===a.length)throw Error("Specify field name");this.field=a;var b=new t("aggregate",a);this.equalTo=function(a){return b.equalTo(a)};this.greaterThan=function(a){return b.greaterThan(a)};this.greaterThanEqualTo=function(a){return b.greaterThanEqualTo(a)};
this.lessThan=function(a){return b.lessThan(a)};this.lessThanEqualTo=function(a){return b.lessThanEqualTo(a)};this.between=function(a,e){return b.between(a,e)};return this},w=function(a){if(!a||0===a.length)throw Error("Specify field name");this.field=a;var b=new t("attribute",a);this.like=function(a){return b.like(a)};this.startWith=function(a){return b.startsWith(a)};this.endsWith=function(a){return b.endsWith(a)};this.equalTo=function(a){return b.equalTo(a)};this.contains=function(a){return b.contains(a)};
return this};g.Filter={Property:function(a){return new u(a)},Aggregate:function(a){return new v(a)},Attribute:function(a){return new w(a)},Or:function(){return new n("or",arguments)},And:function(){return new n("and",arguments)},taggedWithOneOrMore:function(a){return new m({tags:a,operator:"tagged_with_one_or_more"})},taggedWithAll:function(a){return new m({tags:a,operator:"tagged_with_all"})}}})(global);
(function(a){a.Appacitive.Queries={};var g=function(a){a=a||{};var e=1,h=20;this.pageNumber=function(){return 1==arguments.length?(e=arguments[0]||1,this):e};this.pageSize=function(){return 1==arguments.length?(h=arguments[0]||20,this):h};this.pageNumber(a.pageNumber);this.pageSize(a.pageSize)};g.prototype.toString=function(){return"psize="+this.pageSize()+"&pnum="+this.pageNumber()};var c=function(a){a=a||{};var e="__UtcLastUpdatedDate",h=!1;this.orderBy=function(){return 1===arguments.length?(e=
arguments[0]||"__UtcLastUpdatedDate",this):e};this.isAscending=function(){return 1===arguments.length?(h=_type.isUndefined(arguments[0])?!1:arguments[0],this):h};this.orderBy(a.orderBy);this.isAscending(a.isAscending)};c.prototype.toString=function(){return"orderBy="+this.orderBy()+"&isAsc="+this.isAscending()};var f=function(b){var e=b||{},h="",f="",m="",n=e.queryType||"BasicQuery",l=new g(b),p=new c(b),q=e.schema||e.relation,r=e.relation?"connection":"article",t=this;this.type=function(){return r};
...
this.results=this.results||[],this.results.isLastPage=!0,this.results.total=a.totalrecords,this.results.pageNumber=a.pagenumber,this.results.pageSize=a.pagesize,a.pagenumber*a.pagesize<=a.totalrecords&&(this.results.isLastPage=!0))};var u=function(b){var e=[];b||(b=[]);var h="article"===r?"Article":"Connection";q&&"user"==q.toLowerCase()&&(h="User");b.forEach(function(b){e.push(new a.Appacitive[h](b,!0))});return e};this.fetch=function(b){var e=a.Appacitive.Promise.buildPromise(b);b=this.toRequest();
b.onSuccess=function(a){t.results=u(a[r+"s"]);t._setPaging(a.paginginfo);e.fulfill(t.results,a.paginginfo)};b.promise=e;b.entity=this;return a.Appacitive.http.send(b)};this.fetchNext=function(a){var b=this.pageNumber();this.pageNumber(++b);return this.fetch(a)};this.fetchPrev=function(a){var b=this.pageNumber(),b=b-1;0>=b&&(b=1);this.pageNumber(b);return this.fetch(a)};this.count=function(b){var e=a.Appacitive.Promise.buildPromise(b);b=this.toRequest();b.onSuccess=function(a){a=a||{};a=a.paginginfo;
...
b.returnEdge||(null===b.returnEdge||b.returnEdge||this.prev)||(this.returnEdge=!1);this.label="";var h=this;_type.isString(b.label)&&0<b.label.length&&(this.label="&label="+b.label);this.toRequest=function(){var b=new a.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+"connection/"+this.relation+"/"+this.schema+"/"+this.articleId+"/find?"+this.getQueryString()+this.label+"&returnEdge="+this.returnEdge};var c=function(b,
e){var c=[];b.forEach(function(b){var h=null;if(b.__edge){h=b.__edge;delete b.__edge;h.__endpointa=e;h.__endpointb={articleid:b.__id,label:h.__label,type:b.__schematype};delete h.label;var f=new a.Appacitive.Connection(h,!0),h=new a.Appacitive.Article(b,!0);h.connection=f}else h=new a.Appacitive.Article(b,!0);c.push(h)});h.article&&(h.article.children[h.relation]=c);return c};this.fetch=function(f){var g=a.Appacitive.Promise.buildPromise(f);f=this.toRequest();f.onSuccess=function(a){var f=c;h.prev&&
(f=prevParseNodes);h.results=f(a.nodes?a.nodes:[],{articleid:b.articleId,type:e,label:a.parent});h._setPaging(a.paginginfo);g.fulfill(h.results,a.paginginfo)};f.promise=g;f.entity=this;return a.Appacitive.http.send(f)};return this};a.Appacitive.Queries.ConnectedArticlesQuery.prototype=new f;a.Appacitive.Queries.ConnectedArticlesQuery.prototype.constructor=a.Appacitive.Queries.ConnectedArticlesQuery;a.Appacitive.Queries.GetConnectionsQuery=function(b){b=b||{};if(!b.relation)throw Error("Specify relation for GetConnectionsQuery query");
...
function(b,e){if(!b||0===b.length)throw Error("Specify name of filter query");this.name=b;this.data={};this.queryType="GraphFilterQuery";if(e){this.data.placeholders=e;for(var h in this.data.placeholders)this.data.placeholders[h]=String.addSlashes(this.data.placeholders[h])}this.toRequest=function(){var b=new a.Appacitive.HttpRequest;b.url=this.toUrl();b.method="post";b.data=this.data;return b};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+"search/"+this.name+"/filter"};this.fetch=function(b){var e=
a.Appacitive.Promise.buildPromise(b);b=this.toRequest();b.onSuccess=function(a){e.fulfill(a.ids?a.ids:[])};b.promise=e;b.entity=this;return a.Appacitive.http.send(b)}};a.Appacitive.Queries.GraphProjectQuery=function(b,e,h){if(!b||0===b.length)throw Error("Specify name of project query");if(!e||!e.length)throw Error("Specify ids to project");this.name=b;this.data={ids:e};this.queryType="GraphProjectQuery";if(h){this.data.placeholders=h;for(var c in this.data.placeholders)this.data.placeholders[c]=
String.addSlashes(this.data.placeholders[c])}this.toRequest=function(){var b=new a.Appacitive.HttpRequest;b.url=this.toUrl();b.method="post";b.data=this.data;return b};this.toUrl=function(){return a.Appacitive.config.apiBaseUrl+"search/"+this.name+"/project"};var f=function(b){var e,h;for(h in b)if("status"!==h){e=b[h];break}var c=function(b,e,h){var f=[];b.forEach(function(b){var g=b.__children;delete b.__children;var k=b.__edge;delete b.__edge;b=new a.Appacitive.Article(b,!0);b.children={};for(var m in g)b.children[m]=
[],b.children[m]=c(g[m].values,g[m].parent,b.id);k&&(k.__endpointa={articleid:h,label:e},k.__endpointb={articleid:b.id(),label:k.__label},delete k.__label,b.connection=new a.Appacitive.Connection(k));f.push(b)});return f};return c(e.values)};this.fetch=function(b){var e=a.Appacitive.Promise.buildPromise(b);b=this.toRequest();b.onSuccess=function(a){e.fulfill(f(a))};b.promise=e;b.entity=this;return a.Appacitive.http.send(b)}}})(global);
(function(a){a.Appacitive.BaseObject=function(g,c){var f={},b=function(a,b){for(var e in a)if(_type.isString(a[e]))b[e]=a[e];else if(_type.isObject("object"==a[e])){b[e]=0<=a[e].length?[]:{};for(var h in a[e])b[e][h]=a[e][h]}else b[e]=a[e]},e=this,h={};b(g,h);c&&b(h,f);!f.__id&&h.__id&&(f.__id=h.__id);h.__schematype?(h.__schematype=h.__schematype.toLowerCase(),this.schema=this.entityType=h.__schematype,this.type="user"==h.__schematype||"device"==h.__schematype?h.__schematype:"article"):h.__relationtype&&
...
this.type?new a.Appacitive.Article(this.toJSON()):new a.Appacitive.connection(h)};this.copy=function(a,e){a&&(b(a,h),e&&b(a,f));return this};var v=[],w=function(a,b,h){if(!a||!_type.isString(a)||0===a.length||0===a.indexOf("__"))return this;b=!b||isNaN(parseInt(b))?h:parseInt(b)*h;v.push({key:a.toLowerCase(),amount:b});return e};this.increment=function(a,b){return w(a,b,1)};this.decrement=function(a,b){return w(a,b,-1)};this.save=function(){return h.__id?y.apply(this,arguments):z.apply(this,arguments)};
var z=function(c){var g=a.Appacitive.Promise.buildPromise(c);fields=t;c=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[this.type].getCreateUrl(h.__schematype||h.__relationtype,fields);!h.__schematype||"user"!=h.__schematype.toLowerCase()&&"device"!=h.__schematype.toLowerCase()||(c=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[h.__schematype.toLowerCase()].getCreateUrl());for(var k in h)"$"==k[0]&&delete h[k];h.__revision&&delete h.__revision;k=new a.Appacitive.HttpRequest;
k.url=c;k.method="put";k.data=h;k.onSuccess=function(c){var k=null;c&&(c.article||c.connection||c.user||c.device)&&(k=c.article||c.connection||c.user||c.device);c&&k?(f=k,h.__id=k.__id,b(k,h),"connection"==e.type&&e.parseConnection(),a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+e.type+".created",e,{object:e}),g.fulfill(e)):(a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+e.type+".createFailed",e,{error:c.status}),g.reject(c.status,e))};k.promise=g;k.entity=this;return a.Appacitive.http.send(k)},
y=function(c,g){a.Appacitive.Promise.is(g)||(g=a.Appacitive.Promise.buildPromise(c));var k=function(k){var m=r(!0),l;for(l in m)"$"==l[0]&&delete m[l];if(Object.isEmpty(m))g.fulfill(e);else{fields=t;l=new a.Appacitive.HttpRequest;var q=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[e.type].getUpdateUrl(h.__schematype||h.__relationtype,f.__id?f.__id:h.__id,fields,k),x=e.type;h&&(h.__schematype&&("user"==h.__schematype.toLowerCase()||"device"==h.__schematype.toLowerCase()))&&(x=h.__schematype.toLowerCase(),
q=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[h.__schematype.toLowerCase()].getUpdateUrl(f.__id,fields,k));l.url=q;l.method="post";l.data=m;l.onSuccess=function(k){k&&k[x]?(v.length=0,f=k[e.type],b(f,h),p=[],a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+x+"."+h.__id+".updated",e,{object:e}),g.fulfill(e)):"14008"==k.status.code&&0<v.length?y(c,g):(a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+x+"."+h.__id+".updateFailed",e,{object:k.status}),g.reject(k.status,
e))};l.onError=function(a){a=n(a);"14008"==a.code&&0<v.length?y(c,g):g.reject(a,e)};a.Appacitive.http.send(l)}};if(0<v.length){var m=["__revision"];v.forEach(function(a){m.push(a.key)});a.Appacitive.Article.get({schema:this.get("__schematype"),id:this.id(),fields:m}).then(function(a){a=a.toJSON();v.forEach(function(b){var c=u.integer(a[b.key]);c||(c=0);e.set(b.key,c+b.amount)});k(a.__revision)},function(a){g.reject(a)})}else k();return g},A=function(c){if(!h.__id)throw Error("Please specify id for get operation");
var g=new a.Appacitive.Promise.buildPromise(c);fields=t;c=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[e.type].getGetUrl(h.__schematype||h.__relationtype,h.__id,fields);var k=new a.Appacitive.HttpRequest;k.url=c;k.method="get";k.onSuccess=function(a){a&&a[e.type]?(f=a[e.type],b(f,h),a.connection&&(e.endpoints||e.endpointA&&e.endpointB||e.setupConnection(h.__endpointa,h.__endpointb)),g.fulfill(e)):(a=a||{},a.status=a.status||{},a.status=n(a.status),g.reject(a.status,e))};k.entity=
this;k.promise=g;return a.Appacitive.http.send(k)};this.fetch=function(a){return A(a)};this.del=this.destroy=function(b,e){_type.isBoolean(b)?(e=b,b=null):_type.isBoolean(e)||(e=!1);var c=new a.Appacitive.Promise.buildPromise(b),f=a.Appacitive.config.apiBaseUrl,f=f+a.Appacitive.storage.urlFactory[this.type].getDeleteUrl(h.__schematype||h.__relationtype,h.__id);h&&(h.__schematype&&("user"==h.__schematype.toLowerCase()||"device"==h.__schematype.toLowerCase()))&&(f=a.Appacitive.config.apiBaseUrl,f+=
a.Appacitive.storage.urlFactory[h.__schematype.toLowerCase()].getDeleteUrl(h.__id));e&&!0===e&&(f=-1==f.indexOf("?")?f+"?deleteconnections=true":f+"&deleteconnections=true");var g=new a.Appacitive.HttpRequest;g.url=f;g.method="delete";g.onSuccess=function(a){c.fulfill(a)};g.promise=c;g.entity=this;return a.Appacitive.http.send(g)}};a.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())}})(global);
...
{};for(var h in a.children)c.children[h]=e(a.children[h])}a.connection&&(c.__connection=a.connection.toJSON());b.push(c)});return b};return e([this])[0]}return this.getObject()};return this};a.Appacitive.Article.prototype=new a.Appacitive.BaseObject;a.Appacitive.Article.prototype.constructor=a.Appacitive.Article;var g=function(c){var f=[];c.forEach(function(b){f.push(new a.Appacitive.Article(b,!0))});return f};a.Appacitive._parseArticles=g;a.Appacitive.Article.multiDelete=function(c,f){c=c||{};if(!c.schema||
...
c.articleId=this.get("__id");return new a.Appacitive.Queries.GetConnectionsQuery(c)};a.Appacitive.Article.prototype.getConnectedArticles=function(c){if(this.isNew())throw Error("Cannot fetch connections for new article");c=c||{};_type.isString(c)&&(c={relation:c});c.schema=this.entityType;c.articleId=this.get("__id");c.article=this;return new a.Appacitive.Queries.ConnectedArticlesQuery(c)};a.Appacitive.Article.findAll=function(c){return new a.Appacitive.Queries.FindAllQuery(c)}})(global);
(function(a){var g=function(b,e,c){var f={label:b.label};b.articleid&&(f.articleid=b.articleid);if(b.article)_type.isFunction(b.article.getArticle)?b.article.get("__id")?f.articleid=b.article.get("__id"):f.article=b.article.getArticle():_type.isObject(b.article)&&b.article instanceof a.Appacitive.Article&&(b.article.__id?f.articleid=b.article.__id:f.article=b.article,b.article=new a.Appacitive.Article(b.article));else if(!f.articleid&&!f.article)throw Error("Incorrectly configured endpoints provided to setupConnection");
c["endpoint"+e]=b;return f},c=function(b,e,c){b.article&&_type.isObject(b.article)?(c["endpoint"+e]?c["endpoint"+e]&&c["endpoint"+e].article&&c["endpoint"+e].article instanceof a.Appacitive.Article?c["endpoint"+e].article.copy(b.article,!0):c["endpoint"+e].article=new a.Appacitive.Article(b.article,!0):(c["endpoint"+e]={},c["endpoint"+e].article=new a.Appacitive.Article(b.article,!0)),c["endpoint"+e].articleid=b.article.__id,c["endpoint"+e].label=b.label,c["endpoint"+e].type=b.type):c["endpoint"+
e]=b};a.Appacitive.Connection=function(b,e){b=b||{};_type.isString(b)&&(b={__relationtype:b});if(!b.__relationtype&&!b.relation)throw Error("Cannot set connection without relation");b.relation&&(b.__relationtype=b.relation,delete b.relation);b.endpoints&&2===b.endpoints.length&&(b.__endpointa=b.endpoints[0],b.__endpointb=b.endpoints[1],delete b.endpoints);a.Appacitive.BaseObject.call(this,b,e);this.type="connection";this.getConnection=this.getObject;this.parseConnection=function(){var a="A",e="B";
b.__endpointa.label.toLowerCase()!==this.get("__endpointb").label.toLowerCase()||(b.__endpointa.label.toLowerCase()==b.__endpointb.label.toLowerCase()||b.__endpointa.articleid!=this.get("__endpointb").articleid&&b.__endpointa.articleid)||(a="B",e="A");c(this.get("__endpointa"),a,this);c(this.get("__endpointb"),e,this);this.endpoints=function(){if(1===arguments.length&&_type.isString(arguments[0])){if(this.endpointA.label.toLowerCase()===arguments[0].toLowerCase())return this.endpointA;if(this.endpointB.label.toLowerCase()===
arguments[0].toLowerCase())return this.endpointB;throw Error("Invalid label provided");}var a=[];a.push(this.endpointA);a.push(this.endpointB);return a};return this};e?this.parseConnection(b):b.__endpointa&&b.__endpointb&&this.setupConnection(this.get("__endpointa"),this.get("__endpointb"));return this};a.Appacitive.Connection.prototype=new a.Appacitive.BaseObject;a.Appacitive.Connection.prototype.constructor=a.Appacitive.Connection;a.Appacitive.Connection.prototype.setupConnection=function(a,e){if(!(a&&
(a.articleid||a.article)&&a.label&&e&&(e.articleid||e.article)&&e.label))throw Error("Incorrect endpoints configuration passed.");this.set("__endpointa",g(a,"A",this));this.set("__endpointb",g(e,"B",this));this.endpoints=function(){if(1===arguments.length&&_type.isString(arguments[0])){if(this.endpointA.label.toLowerCase()===arguments[0].toLowerCase())return this.endpointA;if(this.endpointB.label.toLowerCase()===arguments[0].toLowerCase())return this.endpointB;throw Error("Invalid label provided");
}var a=[];a.push(this.endpointA);a.push(this.endpointB);return a}};a.Appacitive.Connection.get=function(b,e){b=b||{};if(!b.relation)throw Error("Specify relation");if(!b.id)throw Error("Specify id to fetch");var c=new a.Appacitive.Connection({__relationtype:b.relation,__id:b.id});c.fields=b.fields;return c.fetch(e)};var f=function(b){var e=[];b||(b=[]);b.forEach(function(b){e.push(new a.Appacitive.Connection(b,!0))});return e};a.Appacitive.Connection._parseConnections=f;a.Appacitive.Connection.multiGet=
function(b,e){b=b||{};if(!b.relation||!_type.isString(b.relation)||0===b.relation.length)throw Error("Specify valid relation");if(!b.ids||0===b.ids.length)throw Error("Specify ids to delete");var c=a.Appacitive.Promise.buildPromise(e),g=new a.Appacitive.HttpRequest;g.url=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.connection.getMultiGetUrl(b.relation,b.ids.join(","),b.fields);g.method="get";g.onSuccess=function(a){c.fulfill(f(a.connections))};g.promise=c;return a.Appacitive.http.send(g)};
a.Appacitive.Connection.multiDelete=function(b,e){b=b||{};var c=a.Appacitive.Promise.buildPromise(e);if(!b.relation||!_type.isString(b.relation)||0===b.relation.length)throw Error("Specify valid relation");if(!b.ids||0===b.ids.length)throw Error("Specify ids to get");var f=new a.Appacitive.HttpRequest;f.url=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.connection.getMultiDeleteUrl(b.relation);f.method="post";f.data={idlist:b.ids};f.onSuccess=function(a){c.fulfill()};f.promise=c;return a.Appacitive.http.send(f)};
a.Appacitive.Connection.findAll=function(b){return new a.Appacitive.Queries.FindAllQuery(b)};a.Appacitive.Connection.getInterconnects=function(b){return new a.Appacitive.Queries.InterconnectsQuery(b)};a.Appacitive.Connection.getBetweenArticles=function(b){return new a.Appacitive.Queries.GetConnectionsBetweenArticlesQuery(b)};a.Appacitive.Connection.getBetweenArticlesForRelation=function(b){return new a.Appacitive.Queries.GetConnectionsBetweenArticlesForRelationQuery(b)}})(global);
(function(a){a.Appacitive.Users=new function(){var g=null;this.current=function(){return g};var c=function(b,c,f){var g=this.get("__id");if(!g||!_type.isString(g)||0===g.length)throw Error("Please specify valid userid");if(!b||!_type.isString(b)||0===b.length)throw Error("Please specify valid oldPassword");if(!c||!_type.isString(c)||0===c.length)throw Error("Please specify valid newPassword");var n=a.Appacitive.Promise.buildPromise(f);b={oldpassword:b,newpassword:c};c=new a.Appacitive.HttpRequest;
...
c.fulfill()},function(){c.reject(arguments)});return c};this.createUser=this.createNewUser=function(b,c){b=b||{};b.__schematype="user";if(!b.username||!b.password||!b.firstname||0===b.username.length||0===b.password.length||0===b.firstname.length)throw Error("username, password and firstname are mandatory");return(new a.Appacitive.User(b)).save(c)};this.signup=function(b,c){var f=this,g=a.Appacitive.Promise.buildPromise(c);this.createUser(b).then(function(){f.login(b.username,b.password).then(function(){g.fulfill(arguments)},
function(a){g.reject(arguments)})},function(){g.reject(arguments)});return g};this.authenticateUser=function(b,c,f){var m=a.Appacitive.Promise.buildPromise(c);b.expiry||(b.expiry=864E5);var n=this;c=new a.Appacitive.HttpRequest;c.method="post";c.url=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.user.getAuthenticateUserUrl();c.data=b;c.onSuccess=function(a){a&&a.user?(f&&(a.user.__authType=f),n.setCurrentUser(a.user,a.token,b.expiry),m.fulfill({user:g,token:a.token})):m.reject(a.status)};
c.promise=m;return a.Appacitive.http.send(c)};this.login=function(a,b,c){if(!a||!b||0==a.length||0==b.length)throw Error("Please specify username and password");return this.authenticateUser({username:a,password:b,expiry:864E5},c,"BASIC")};this.loginWithFacebook=function(a,b){if(!a||!_type.isString(a))throw Error("Please provide accessToken");return that.authenticateUser({accesstoken:a,type:"facebook",expiry:864E5,createnew:!0},b,"FB")};this.loginWithTwitter=function(a,b){if(!_type.isObject(a)||!a.oAuthToken||
!a.oAuthTokenSecret)throw Error("Twitter Token and Token Secret required for linking");var c={type:"twitter",oauthtoken:a.oAuthToken,oauthtokensecret:a.oAuthTokenSecret,expiry:864E5,createnew:!0};a.consumerKey&&a.consumerSecret&&(c.consumersecret=a.consumerSecret,c.consumerkey=a.consumerKey);return that.authenticateUser(c,b,"TWITTER")};this.validateCurrentUser=function(b,c){var f=a.Appacitive.Promise.buildPromise({success:c});c&&_type.isBoolean(c)&&(b=c,c=function(){});var g=a.Appacitive.Cookie.readCookie("Appacitive-UserToken");
...
f(e,function(a){b(a.url,c.fileData,c.contentType,function(){c.getDownloadUrl().then(function(a){h.fulfill(a,c)},function(a){h.reject(a)})},h)},h);return h};this.deleteFile=function(b){if(!this.fileId)throw Error("Please specify fileId to delete");var f=a.Appacitive.Promise.buildPromise(b);b=new a.Appacitive.HttpRequest;b.url=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory.file.getDeleteUrl(this.fileId);b.method="DELETE";b.onSuccess=function(a){f.fulfill()};b.promise=f;b.entity=c;return a.Appacitive.http.send(b)};
