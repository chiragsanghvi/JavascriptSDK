...
[h,a,b];this.state&&g(function(){e.done()});return h};c.when=function(a){var b=[],e=[],h,k=0,m=new c;if(!a)return m.fulfill(b),m;var n=function(){k+=1;k==h&&(m.state||(0<e.length?m.reject(e,b):m.fulfill(b)))},l=function(h){var k=a[h];k instanceof c||k&&"function"===typeof k.then?g(function(){k.then(function(a){b[h]=a;n()},function(a){e[h]=a;n()})}):g(function(){try{b[h]=k.call()}catch(a){e[h]=a}n()})};Array.isArray(a)||(a=[a]);h=a.length;for(var p=0;p<h;p+=1)l(p);return m};c.is=function(a){return a instanceof
c?!0:!1};c.buildPromise=function(a){var b=new c;_type.isObject(a)&&b.then(a.success,a.error);return b};a.Appacitive.Promise=c})(global);
...
h.__attributes[arguments[0]];if(2===arguments.length){if(!_type.isString(arguments[1])&&null!==arguments[1])throw Error("only string values can be stored in attributes.");h.__attributes||(h.__attributes={});h.__attributes[arguments[0]]=arguments[1]}else throw Error(".attr() called with an incorrect number of arguments. 0, 1, 2 are supported.");}return h.__attributes};var l=function(){if(!f.__attributes)return null;var a=!1,b=JSON.parse(JSON.stringify(f.__attributes)),e;for(e in h.__attributes)null==
h.__attributes[e]||void 0==h.__attributes[e]?(b[e]=null,a=!0):h.__attributes[e]!=f.__attributes[e]?(b[e]=h.__attributes[e],a=!0):h.__attributes[e]==f.__attributes[e]&&delete b[e];return a?b:null};this.getChangedAttributes=l;this.aggregate=function(){var a={},b;for(b in h){if(!h.hasOwnProperty(b))return;"$"==b[0]&&(a[b.substring(1)]=h[b])}if(0===arguments.length)return a;if(1==arguments.length)return a[arguments[0]];throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");
};var p=[];h.__tags||(h.__tags=[]);f.__tags||(f.__tags=[]);this.tags=function(){return h.__tags?h.__tags:[]};this.addTag=function(a){if(!a||!_type.isString(a)||!a.length)return this;h.__tags||(h.__tags=[]);h.__tags.push(a);h.__tags=Array.distinct(h.__tags);if(!p||!p.length)return this;a=p.indexOf(a);-1!=a&&p.splice(a,1);return this};this.removeTag=function(a){if(!a||!_type.isString(a)||!a.length)return this;p.push(a);p=Array.distinct(p);if(!h.__tags||!h.__tags.length)return this;a=h.__tags.indexOf(a);
-1!=a&&h.__tags.splice(a,1);return this};var q=function(){if(!h.__tags)return[];if(!f.__tags)return h.__tags;var a=[];h.__tags.forEach(function(b){-1==f.__tags.indexOf(b)&&a.push(b)});return a};this.getChangedTags=q;this.getRemovedTags=function(){return _removetags};var r=function(a){var b=!1,e=JSON.parse(JSON.stringify(f)),c;for(c in h)null==h[c]||void 0==h[c]?(e[c]=null,b=!0):h[c]!=f[c]?"__tags"==c||"__attributes"==c?delete e[c]:(e[c]=h[c],b=!0):h[c]==f[c]&&delete e[c];try{k.forEach(function(a){e[a]&&
delete e[a]})}catch(g){}a?(h.__tags&&0<h.__tags.length&&(e.__addtags=q(),b=!0),p&&0<p.length&&(e.__removetags=p,b=!0)):h.__tags&&0<h.__tags.length&&(e.__tags=q(),b=!0);(a=l())?(e.__attributes=a,b=!0):delete e.__attributes;for(var m in e)"$"==m[0]&&delete e[m];return b&&!Object.isEmpty(e)?e:!1};this.changed=function(){return r()};this.hasChanged=function(){var a=r(!0);return 0===arguments.length?Object.isEmpty(a)?!1:!0:1==arguments.length&&_type.isString(arguments[0])&&0<arguments[0].length&&a&&a[arguments[0]]?
!0:!1};this.changedAttributes=function(){var a=r(!0);if(0===arguments.length)return a;if(1==arguments.length&&_type.isArray(arguments[0])&&arguments[0].length){var b={};arguments[0].forEach(function(e){a[e]&&b.push(a[e])});return b}return!1};this.previous=function(){return 1==arguments.length&&_type.isString(arguments[0])&&arguments[0].length?f[arguments[0]]:null};this.previousAttributes=function(){return f};var u="";this.fields=function(){if(1==arguments.length){var a=arguments[0];_type.isString(a)?
u=a:_type.isArray(a)&&(u=a.join(","));return this}return u};var t={integer:function(a){if(a){var b=parseInt(a);if(!isNaN(b))return b}return a},decimal:function(a){if(a){var b=parseFloat(a);if(!isNaN(b))return b}return a},"boolean":function(a){return void 0!==a&&null!==a&&("true"===a.toString().toLowerCase()||!0===a||0<a)?!0:!1},date:function(b){if(b){var e=a.Appacitive.Date.parseISODate(b);if(e)return e}return b},datetime:function(b){if(b){var e=a.Appacitive.Date.parseISODate(b);if(e)return e}return b},
time:function(b){if(b){var e=a.Appacitive.Date.parseISOTime(b);if(e)return e}return b},string:function(a){return a?a.toSting():a}};this.get=function(a,b){if(a){if(b&&t[b.toLowerCase()]){if(t[b.toLowerCase()])return t[b.toLowerCase()](h[a]);throw Error('Invalid cast-type "'+b+'"" provided for get "'+a+'"');}return h[a]}};this.tryGet=function(a,b,e){a=this.get(a,e);return void 0!==a?a:b};this.set=function(b,e){if(!b||!_type.isString(b)||0===b.length||0===b.trim().indexOf("$"))return this;void 0==e||
null==e?h[b]=null:_type.isString(e)?h[b]=e:_type.isNumber(e)||_type.isBoolean(e)?h[b]=e+"":_type.isObject(e)&&(e instanceof Date?h[b]=a.Appacitive.Date.toISOString(e):0<=e.length?h[b]=e:-1!==m.indexOf(b)&&(h[b]=e));return this};this.unset=function(a){if(!a||!_type.isString(a)||0===a.length||0===a.indexOf("__"))return this;try{delete h[a]}catch(b){}return this};this.has=function(a){return a&&_type.isString(a)&&0!==a.length?h[a]&&!_type.isUndefined(h[a])?!0:!1:!1};this.isNew=function(){return h.__id&&
h.__id.length?!1:!0};this.clone=function(){return"article"==this.type?new a.Appacitive.Article(this.toJSON()):new a.Appacitive.connection(h)};this.copy=function(a,e){a&&(b(a,h),e&&b(a,f));return this};var v=[],w=function(a,b,c){if(!a||!_type.isString(a)||0===a.length||0===a.indexOf("__"))return this;b=!b||isNaN(parseInt(b))?c:parseInt(b)*c;v.push({key:a.toLowerCase(),amount:b});return e};this.increment=function(a,b){return w(a,b,1)};this.decrement=function(a,b){return w(a,b,-1)};this.save=function(){return h.__id?
x.apply(this,arguments):z.apply(this,arguments)};var z=function(c){var g=a.Appacitive.Promise.buildPromise(c);c=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[this.type].getCreateUrl(h.__schematype||h.__relationtype,u);!h.__schematype||"user"!=h.__schematype.toLowerCase()&&"device"!=h.__schematype.toLowerCase()||(c=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[h.__schematype.toLowerCase()].getCreateUrl());for(var k in h)"$"==k[0]&&delete h[k];h.__revision&&delete h.__revision;
k=new a.Appacitive.HttpRequest;k.url=c;k.method="put";k.data=h;k.onSuccess=function(c){var k=null;c&&(c.article||c.connection||c.user||c.device)&&(k=c.article||c.connection||c.user||c.device);c&&k?(f=k,h.__id=k.__id,b(k,h),"connection"==e.type&&e.parseConnection(),a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+e.type+".created",e,{object:e}),e.created=!0,g.fulfill(e)):(a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+e.type+".createFailed",e,{error:c.status}),g.reject(c.status,
e))};k.promise=g;k.entity=this;return a.Appacitive.http.send(k)},x=function(c,g){a.Appacitive.Promise.is(g)||(g=a.Appacitive.Promise.buildPromise(c));var k=function(k){var m=r(!0),l;for(l in m)"$"==l[0]&&delete m[l];if(Object.isEmpty(m))g.fulfill(e);else{l=u;var q=new a.Appacitive.HttpRequest,y=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[e.type].getUpdateUrl(h.__schematype||h.__relationtype,f.__id?f.__id:h.__id,l,k),t=e.type;h&&(h.__schematype&&("user"==h.__schematype.toLowerCase()||
"device"==h.__schematype.toLowerCase()))&&(t=h.__schematype.toLowerCase(),y=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[h.__schematype.toLowerCase()].getUpdateUrl(f.__id,l,k));q.url=y;q.method="post";q.data=m;q.onSuccess=function(k){k&&k[t]?(v.length=0,f=k[e.type],b(f,h),p=[],delete e.created,a.Appacitive.eventManager.fire((e.schema||e.relation)+"."+t+"."+h.__id+".updated",e,{object:e}),g.fulfill(e)):"14008"==k.status.code&&0<v.length?x(c,g):(a.Appacitive.eventManager.fire((e.schema||
e.relation)+"."+t+"."+h.__id+".updateFailed",e,{object:k.status}),g.reject(k.status,e))};q.onError=function(a){a=n(a);"14008"==a.code&&0<v.length?x(c,g):g.reject(a,e)};a.Appacitive.http.send(q)}};if(0<v.length){var m=["__revision"];v.forEach(function(a){m.push(a.key)});a.Appacitive.Article.get({schema:this.get("__schematype"),id:this.id(),fields:m}).then(function(a){a=a.toJSON();v.forEach(function(b){var c=t.integer(a[b.key]);c||(c=0);e.set(b.key,c+b.amount)});k(a.__revision)},function(a){g.reject(a)})}else k();
return g},A=function(c){if(!h.__id)throw Error("Please specify id for get operation");var g=new a.Appacitive.Promise.buildPromise(c);c=a.Appacitive.config.apiBaseUrl+a.Appacitive.storage.urlFactory[e.type].getGetUrl(h.__schematype||h.__relationtype,h.__id,u);var k=new a.Appacitive.HttpRequest;k.url=c;k.method="get";k.onSuccess=function(a){a&&a[e.type]?(f=a[e.type],b(f,h),a.connection&&(e.endpoints||e.endpointA&&e.endpointB||e.setupConnection(h.__endpointa,h.__endpointb)),g.fulfill(e)):(a=a||{},a.status=
a.status||{},a.status=n(a.status),g.reject(a.status,e))};k.entity=this;k.promise=g;return a.Appacitive.http.send(k)};this.fetch=function(a){return A(a)};this.del=this.destroy=function(b,e){_type.isBoolean(b)?(e=b,b=null):_type.isBoolean(e)||(e=!1);var c=new a.Appacitive.Promise.buildPromise(b);if(!h.__id)return c.fulfill(),c;var f=a.Appacitive.config.apiBaseUrl,f=f+a.Appacitive.storage.urlFactory[this.type].getDeleteUrl(h.__schematype||h.__relationtype,h.__id);h&&(h.__schematype&&("user"==h.__schematype.toLowerCase()||
"device"==h.__schematype.toLowerCase()))&&(f=a.Appacitive.config.apiBaseUrl,f+=a.Appacitive.storage.urlFactory[h.__schematype.toLowerCase()].getDeleteUrl(h.__id));e&&!0===e&&(f=-1==f.indexOf("?")?f+"?deleteconnections=true":f+"&deleteconnections=true");var g=new a.Appacitive.HttpRequest;g.url=f;g.method="delete";g.onSuccess=function(a){c.fulfill(a)};g.promise=c;g.entity=this;return a.Appacitive.http.send(g)}};a.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())}})(global);
...
l.method="post";l.data=b;l.onSuccess=function(a){a=n.get("__link");_type.isArray(a)||(a=a?[a]:[]);a.push(b);n.copy({__link:a},!0);g.fulfill(n)};l.promise=g;l.entity=this;return a.Appacitive.http.send(l)};this.setCurrentUser=function(b,f,k){if(!b)throw Error("Cannot set null object as user");var m=b;if(m instanceof a.Appacitive.User)if(m.get("__id")&&0!==m.get("__id").length)b=m.toJSON();else throw Error("Specify user __id");else m=new a.Appacitive.User(b,!0);a.Appacitive.localStorage.set("Appacitive-User",
...
m.reject(a.status)};c.promise=m;return a.Appacitive.http.send(c)};this.login=function(a,b,c){if(!a||!b||0==a.length||0==b.length)throw Error("Please specify username and password");return this.authenticateUser({username:a,password:b,expiry:864E5},c,"BASIC")};this.loginWithFacebook=function(a,b){if(!a||!_type.isString(a))throw Error("Please provide accessToken");return this.authenticateUser({accesstoken:a,type:"facebook",expiry:864E5,createnew:!0},b,"FB")};this.loginWithTwitter=function(a,b){if(!_type.isObject(a)||
!a.oAuthToken||!a.oAuthTokenSecret)throw Error("Twitter Token and Token Secret required for linking");var c={type:"twitter",oauthtoken:a.oAuthToken,oauthtokensecret:a.oAuthTokenSecret,expiry:864E5,createnew:!0};a.consumerKey&&a.consumerSecret&&(c.consumersecret=a.consumerSecret,c.consumerkey=a.consumerKey);return this.authenticateUser(c,b,"TWITTER")};this.validateCurrentUser=function(b,c){var f=a.Appacitive.Promise.buildPromise({success:c});c&&_type.isBoolean(c)&&(b=c,c=function(){});var g=a.Appacitive.Cookie.readCookie("Appacitive-UserToken");
...
(function(a){a.Appacitive.File=function(g){g=g||{};this.fileId=g.fileId;this.contentType=g.contentType;this.fileData=g.fileData;var c=this,f=function(b,e,f){var g=new a.Appacitive.HttpRequest;g.url=b;g.method="GET";g.onSuccess=e;g.promise=f;g.entity=c;a.Appacitive.http.send(g)},b=function(b,e,f,g,h){(new FormData).append("fileToUpload",e);var q=new a.Appacitive.HttpRequest;q.url=b;q.method="PUT";q.data=e;q.headers.push({key:"content-type",value:f});q.onSuccess=g;q.send().then(g,function(){h.reject(d,
...
(function(a){a.Appacitive.localStorage=new (a.Appacitive.runtime.isBrowser?function(){var g=a.Appacitive.runtime.isBrowser?window.localStorage:{getItem:function(){return null}};this.set=function(c,f){f=f||"";if(!c)return!1;if(_type.isObject(f)||_type.isArray(f))try{f=JSON.stringify(f)}catch(b){}c=a.Appacitive.getAppPrefix(c);g[c]=f;return this};this.get=function(c){if(!c)return null;c=a.Appacitive.getAppPrefix(c);c=g.getItem(c);if(!c)return null;if("{"===c[0])try{c=JSON.parse(c)}catch(f){}return c};
this.remove=function(c){if(c){c=a.Appacitive.getAppPrefix(c);try{delete g[c]}catch(f){}}}}:function(){var g=[];this.set=function(c,f){f=f||"";if(!c||_type.isString(c))return!1;c=a.Appacitive.getAppPrefix(c);g[c]=f;return this};this.get=function(c){if(!c||_type.isString(c))return null;c=a.Appacitive.getAppPrefix(c);return(c=g[c])?c:null};this.remove=function(c){if(c&&!_type.isString(c)){c=a.Appacitive.getAppPrefix(c);try{delete g[c]}catch(f){}}}})})(global);
