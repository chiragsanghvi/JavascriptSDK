...
(a=a||{},a.status=a.status||{},a.status=l(a),"function"==typeof h&&h(a.status,e))};m.onError=function(a){a=l(a);"function"==typeof h&&h(a,e)};a.Appacitive.http.send(m);return e}"function"==typeof h&&h({code:"400",message:"Please specify id for get operation"},e)};this.fetch=function(a,b,c){z(a,b,c)};this.del=function(c,e,d){if(b.__id){c=c||function(){};e=e||function(){};var h=this,k=a.Appacitive.config.apiBaseUrl,k=k+a.Appacitive.storage.urlFactory[this.type].getDeleteUrl(b.__schematype||b.__relationtype,
