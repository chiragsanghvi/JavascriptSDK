...
this.onError=a.onError||function(){};this.send=function(a){return new d(this,a)}};(function(a){a.Appacitive&&a.Appacitive.http&&(a.Appacitive.http.addProcessor({pre:function(a){return a},post:function(c,b){try{a.Appacitive.Session.isSessionValid(c)?c&&(c.status&&c.status.code&&"8036"==c.status.code||c.code&&"8036"==c.code)?a.Appacitive.Users.logout(function(){},!0):a.Appacitive.Session.incrementExpiry():(null!=a.Appacitive.Session.get()&&a.Appacitive.Session.resetSession(),a.Appacitive.http.send(b))}catch(d){}}}),
a.Appacitive.http.addProcessor({pre:function(a){return(new Date).getTime()},post:function(a,c){var b=(new Date).getTime()-c;a._timeTakenInMilliseconds=b}}))})(global)})();
...
c;this.data={ids:a};this.queryType="GraphProjectQuery";e&&(this.data.placeholders=e);this.toRequest=function(){var a=new b.Appacitive.HttpRequest;a.url=this.toUrl();a.method="post";a.data=this.data;return a};this.toUrl=function(){return b.Appacitive.config.apiBaseUrl+"search/"+this.name+"/project"};var f=function(a){var c,d;for(d in a)if("status"!==d){c=a[d];break}var e=function(a,c,d){var l=[];a.forEach(function(a){var k=a.__children;delete a.__children;var g=a.__edge;delete a.__edge;a=new b.Appacitive.Article(a,
!0);a.children={};for(var h in k)a.children[h]=[],a.children[h]=e(k[h].values,k[h].parent,a.id);g&&(g.__endpointa={articleid:d,label:c},g.__endpointb={articleid:a.id,label:g.label},delete g.label,a.connection=new b.Appacitive.Connection(g));l.push(a)});return l};return e(c.values)};this.fetch=function(a,c){var d=this.toRequest();d.onSuccess=function(b){b&&b.status&&"200"==b.status.code?"function"==typeof a&&a(f(b)):(b=b||{},"function"==typeof c&&c(b.status||{message:"Server error",code:400}))};d.onError=
...
function(b){var d=!1,e=JSON.parse(JSON.stringify(c)),l;for(l in a)"undefined"==typeof a[l]||null===a[l]?(e[l]=null,d=!0):a[l]!=c[l]?"__tags"==l||"__attributes"==l?delete e[l]:(e[l]=a[l],d=!0):a[l]==c[l]&&delete e[l];try{m.forEach(function(a){e[a]&&delete e[a]})}catch(k){}b?(a.__tags&&0<a.__tags.length&&(e.__addtags=p(),d=!0),n&&0<n.length&&(e.__removetags=n,d=!0)):a.__tags&&0<a.__tags.length&&(e.__tags=p(),d=!0);(b=h())?(e.__attributes=b,d=!0):delete e.__attributes;return d?e:!1};this.changed=function(){return q()};
