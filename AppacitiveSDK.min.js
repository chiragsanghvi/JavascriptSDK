...
this.declare.toString=function(){return"function () { [native code] }"};var h=function(){if(2>arguments.length||"string"!==typeof arguments[0]||"object"!==typeof arguments[1])throw new "Error: Invalid list of arguments passed to cloud api";var b=arguments[0],g=arguments[1].request,h=arguments[1].response;if("function"==typeof c[b]){var k=c[b];setTimeout(function(){k.apply(null,[g,h])},0)}else throw{code:"404",message:"Error: Api with name "+arguments[0]+" doesn't exits"};};this.execute=function(){h.apply(null,
arguments)};this.execute.toString=function(){return"function () { [native code] }"}}})(global);"undefined"===typeof module||global.Appacitive.runtime.isBrowser||(module.exports=global.Appacitive);
