...
c.ontimeout=function(){e.reject(c)};c.onprogress=function(){};-1===b.url.indexOf("?")?b.url+="?ua=ie":b.url+="&ua=ie";c.open(b.method,b.url,!0);c.send(b.data);return e},e=function(e){if(!e.url)throw Error("Please specify request url");e.method||(e.method="GET");e.headers||(e.headers=[]);var c={};e.onSuccess&&_type.isFunction(e.onSuccess)||(e.onSuccess=function(){});e.onError&&_type.isFunction(e.onError)||(e.onError=function(){});var g=global.Appacitive.Promise.buildPromise({success:e.onSuccess,error:e.onError}),
f=!0;e.headers.forEach(function(b){"content-type"==b.key.toLowerCase()&&(f=!0,"application/json"==b.value.toLowerCase()||"application/javascript"==b.value.toLowerCase()||"application/json; charset=utf-8"==b.value.toLowerCase()||"application/json; charset=utf-8;"==b.value.toLowerCase())&&(f=!1)});if(f)c=e.data;else if(e.data&&(c=e.data,_type.isObject(e.data)))try{c=JSON.stringify(c)}catch(n){}if(!global.navigator||-1==global.navigator.userAgent.indexOf("MSIE 8")&&-1==global.navigator.userAgent.indexOf("MSIE 9")){var q=
...
h.length)throw Error("Callback length and state length mismatch!");for(var v=0;v<g.length;v+=1)g[v].apply({},[t,h[v]]);if("200"<=e.code&&"300">=e.code||e.status&&"200"<=e.status.code&&"300">=e.status.code)b.onResponse(c,e);else e=e||{},e=e.status||e,e.message=e.message||"Bad Request",e.code=e.code||"400",b.onError(c,{responseText:JSON.stringify(e)})}else b.onError(c,{responseText:JSON.stringify({code:"400",message:"Invalid request"})})},onError:function(e){var g={};g.message=e.responseText||"Bad Request";
g.code=e.status||"400";b.onError(c,{responseText:JSON.stringify(g)})}})};b.send=function(b,e,g){if(!global.Appacitive.Session.initialized)throw Error("Initialize Appacitive SDK");_type.isFunction(b.beforeSend)&&b.beforeSend(b);c(b,e,g)};return b};global.Appacitive.http=new function(){var b=new g,e=new c(b),h=!1;this.pause=function(){h=!0};this.unpause=function(){h=!1};this.addProcessor=function(b){var c=Error('Must provide a processor object with either a "pre" function or a "post" function.');if(!b)throw c;
if(!b.pre&&!b.post)throw c;e.addProcessor(b)};this.send=function(c){c.promise=global.Appacitive.Promise.is(c.promise)?c.promise:new global.Appacitive.Promise.buildPromise({error:c.onError});e.enqueueRequest(c);b.isOnline()&&!1===h&&e.notify();return c.promise};this.flush=function(c){c?e.notify():b.isOnline()&&e.notify()};this.onError=function(b,e){var c;if(e&&e.responseText)try{var g=JSON.parse(e.responseText);g&&(c={code:g.code,message:g.message})}catch(h){}c=c||{code:e.status,message:e.responseText};
global.Appacitive.logs.logRequest(b,c,c,"error");b.promise.reject(c,b.entity)};b.onError=this.onError;this.onResponse=function(b,e){if(b.onSuccess)if(b.context)b.onSuccess.apply(b.context,[e]);else b.onSuccess(e);global.Appacitive.logs.logRequest(b,e,e?e.status:null,"successful")};b.onResponse=this.onResponse};global.Appacitive.HttpRequest=function(b){b=b||{};this.url=b.url||"";this.data=b.data||{};this.headers=b.headers||[];this.method=b.method||"GET";this.onSuccess=b.onSuccess||function(){};this.onError=
b.onError||function(){};this.send=function(b){return new e(this,b)}};(function(b){b.Appacitive&&b.Appacitive.http&&(b.Appacitive.http.addProcessor({pre:function(b){return b},post:function(e,c){try{var g=b.Appacitive.Session.isSessionValid(e);g.status?e&&(e.status&&e.status.code&&"19036"==e.status.code||e.code&&"19036"==e.code)?b.Appacitive.Users.logout():b.Appacitive.Session.incrementExpiry():g.isSession&&(null!==b.Appacitive.Session.get()&&b.Appacitive.Session.resetSession(),b.Appacitive.http.send(c))}catch(h){}}}),
b.Appacitive.http.addProcessor({pre:function(b){return{start:(new Date).getTime(),request:b}},post:function(b,e){e.request.timeTakenInMilliseconds=(new Date).getTime()-e.start}}))})(global)})(this);
...
h[g].apply(e,this.value)}catch(k){c.Appacitive.log&&(c.Appacitive.logs.exceptions.push(k),console.log(JSON.stringify({name:k.name,message:k.message,stack:k.stack},null,2)));if(0==e.calls.length)throw k;e.reject(k)}f instanceof b||b.is(f)?f.then(function(b){e.fulfill(b)},function(b){e.reject(b)}):1===g?e.fulfill(f):e.reject(f)}else 1===g?e.fulfill(f):e.reject(f)};b.prototype.fulfill=function(){if(this.state)return this;this.state=1;this.value=arguments;this.done();return this};b.prototype.resolve=
b.prototype.fulfill;b.prototype.reject=function(){if(this.state)return this;this.state=2;this.reason=this.value=arguments;this.done();return this};b.prototype.then=function(c,e){var g=this,l=new b;this.calls[this.calls.length]=[l,c,e];this.state&&f(function(){g.done()});return l};b.when=function(c){var e=[],g=[],l,k=0,p=new b;if(!c)return p.fulfill(e),p;var m=function(){k+=1;k==l&&(p.state||(0<g.length?p.reject(g,e):p.fulfill(e)))},n=function(k){var l=c[k];l instanceof b||l&&"function"===typeof l.then?
f(function(){l.then(function(b){e[k]=b;m()},function(b){g[k]=b;m()})}):f(function(){try{e[k]=l.call()}catch(b){g[k]=b}m()})};Array.isArray(c)||(c=[c]);l=c.length;for(var q=0;q<l;q+=1)n(q);return p};b.is=function(c){return c instanceof b?!0:!1};b.buildPromise=function(c){var e=new b;_type.isObject(c)&&e.then(c.success,c.error);return e};c.Appacitive.Promise=b})(global);
...
b[c]&&(b[c].length=0);return this};this.clearAndSubscribe=function(b,c){this.clearSubscriptions(b);this.subscribe(b,c)};this.dump=function(){console.dir(b)}}})(global);(function(c){c.Appacitive.config={apiBaseUrl:"https://apis.appacitive.com/v1.0/"};"undefined"!=typeof XDomainRequest&&(c.Appacitive.config.apiBaseUrl=window.location.protocol+"//apis.appacitive.com/v1.0/")})(global);
...
(function(c){var f=c.Appacitive;f.GeoCoord=function(b,c){var e=function(b,c){if(isNaN(b)||isNaN(c))throw Error("Invalid Latitiude or longitiude provided");if(-90>b||90<b)throw Error("Latitude "+b+" should be in range of  -90.0 to 90.");if(-180>c||180<c)throw Error("Latitude "+c+" should be in range of  -180.0 to 180.");},g=function(b){if("string"!==typeof b||0==b.length)return!1;b=b.split(",");if(2!==b.length)return!1;try{return new f.GeoCoord(b[0],b[1])}catch(c){return!1}};if(_type.isString(b)&&
!c&&(g=g(b)))return g;b&&c?(e(b,c),this.lat=b,this.lng=c):this.lng=this.lat=0;this.toJSON=function(){return{latitude:this.lat,longitude:this.lng}};this.getValue=function(){return String.format("{0},{1}",b,c)};this.toString=function(){return this.getValue()}};var b=function(){this.toString=function(){};this.Or=function(){var b=Array.prototype.slice.call(arguments,0);b.splice(0,0,this);return new m(n.or,b)};this.And=function(){var b=Array.prototype.slice.call(arguments,0);b.splice(0,0,this);return new m(n.and,
b)}},h=function(c){b.call(this);c=c||{};this.fieldType=c.fieldType;this.field=c.field||"";this.value=c.value;this.operator=c.operator;this.getFieldType=function(){switch(this.fieldType){case "property":return"*";case "attribute":return"@";case "aggregate":return"$";default:return"*"}};this.toString=function(){return String.format("{0}{1} {2} {3}",this.getFieldType(),this.field.toLowerCase(),this.operator,this.value.getValue())}};h.prototype=new b;h.prototype.constructor=h;var e=function(b){b=b||"";
if(!_type.isArray(b.value)||!b.value.length)throw Error("Specify field value as array");h.call(this,b);this.toString=function(){for(var b=[],c=0;c<this.value.length;c+=1)b.push(String.format("{0}{1} {2} {3}",this.getFieldType(),this.field.toLowerCase(),this.operator,_type.isString(this.value[c])?"'"+this.value[c]+"'":_type.isNumber(this.value[c])?this.value[c]:this.value[c].toString()));return"("+b.join(" or ")+")"}};e.prototype=new h;e.prototype.constructor=e;var g=function(b){b=b||"";if(!b.val1)throw Error("Specify field value1 ");
if(!b.val2)throw Error("Specify field value2 ");this.val1=b.val1;this.val2=b.val2;h.call(this,b);delete this.value;this.toString=function(){return String.format("{0}{1} {2} ({3},{4})",this.getFieldType(),this.field.toLowerCase(),this.operator,this.val1.getValue(),this.val2.getValue())}};g.prototype=new h;g.prototype.constructor=g;var l=function(b){b=b||"";if(!(b.geoCoord&&b.geoCoord instanceof f.GeoCoord))throw Error("withinCircle filter needs Appacitive.GeoCoord object as argument");h.call(this,
...
f.Date.toISODate(this.value)+"')":"date('"+this.value+"')"}},u=function(b){this.value=b;this.getValue=function(){return this.value instanceof Date?"time('"+f.Date.toISOTime(this.value)+"')":"time('"+this.value+"')"}},t=function(b){this.value=b;this.getValue=function(){return this.value instanceof Date?"datetime('"+f.Date.toISOString(this.value)+"')":"datetime('"+this.value+"')"}},v=function(b,c,f){f||(f=this);f.type=b;f.name=c;f.equalTo=function(b){return new h({field:this.name,fieldType:this.type,
value:new q(b),operator:n.isEqualTo})};f.equalToNumber=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b,"number"),operator:n.isEqualTo})};f.equalToDate=function(b){return new h({field:this.name,fieldType:this.type,value:new r(b),operator:n.isEqualTo})};f.equalToTime=function(b){return new h({field:this.name,fieldType:this.type,value:new u(b),operator:n.isEqualTo})};f.equalToDateTime=function(b){return new h({field:this.name,fieldType:this.type,value:new t(b),operator:n.isEqualTo})};
f.greaterThan=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b,"number"),operator:n.isGreaterThan})};f.greaterThanDate=function(b){return new h({field:this.name,fieldType:this.type,value:new r(b),operator:n.isGreaterThan})};f.greaterThanTime=function(b){return new h({field:this.name,fieldType:this.type,value:new u(b),operator:n.isGreaterThan})};f.greaterThanDateTime=function(b){return new h({field:this.name,fieldType:this.type,value:new t(b),operator:n.isGreaterThan})};
f.greaterThanEqualTo=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b,"number"),operator:n.isGreaterThanEqualTo})};f.greaterThanEqualToDate=function(b){return new h({field:this.name,fieldType:this.type,value:new r(b),operator:n.isGreaterThanEqualTo})};f.greaterThanEqualToTime=function(b){return new h({field:this.name,fieldType:this.type,value:new u(b),operator:n.isGreaterThanEqualTo})};f.greaterThanEqualToDateTime=function(b){return new h({field:this.name,fieldType:this.type,
value:new t(b),operator:n.isGreaterThanEqualTo})};f.lessThan=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b,"number"),operator:n.isLessThan})};f.lessThanDate=function(b){return new h({field:this.name,fieldType:this.type,value:new r(b),operator:n.isLessThan})};f.lessThanTime=function(b){return new h({field:this.name,fieldType:this.type,value:new u(b),operator:n.isLessThan})};f.lessThanDateTime=function(b){return new h({field:this.name,fieldType:this.type,value:new t(b),
operator:n.isLessThan})};f.lessThanEqualTo=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b,"number"),operator:n.isLessThanEqualTo})};f.lessThanEqualToDate=function(b){return new h({field:this.name,fieldType:this.type,value:new r(b),operator:n.isLessThanEqualTo})};f.lessThanEqualToTime=function(b){return new h({field:this.name,fieldType:this.type,value:new u(b),operator:n.isLessThanEqualTo})};f.lessThanEqualToDateTime=function(b){return new h({field:this.name,fieldType:this.type,
value:new t(b),operator:n.isLessThanEqualTo})};f.like=function(b){return new h({field:this.name,fieldType:this.type,value:new q("*"+b+"*"),operator:n.like})};f.match=function(b){return new h({field:this.name,fieldType:this.type,value:new q("*"+b+"*"),operator:n.match})};f.startsWith=function(b){return new h({field:this.name,fieldType:this.type,value:new q(b+"*"),operator:n.like})};f.endsWith=function(b){return new h({field:this.name,fieldType:this.type,value:new q("*"+b),operator:n.like})};f.contains=
function(b){return new e({field:this.name,fieldType:this.type,value:b,operator:n.isEqualTo})};f.between=function(b,c){return new g({field:this.name,fieldType:this.type,val1:new q(b,"number"),val2:new q(c,"number"),operator:n.between})};f.betweenDate=function(b,c){return new g({field:this.name,fieldType:this.type,val1:new r(b),val2:new r(c),operator:n.between})};f.betweenTime=function(b,c){return new g({field:this.name,fieldType:this.type,val1:new u(b),val2:new u(c),operator:n.between})};f.betweenDateTime=
function(b,c){return new g({field:this.name,fieldType:this.type,val1:new t(b),val2:new t(c),operator:n.between})};f.withinCircle=function(b,c,e){return new l({field:this.name,fieldType:this.type,geoCoord:b,distance:c,unit:e,operator:n.withinCircle})};f.withinPolygon=function(b){return new k({field:this.name,fieldType:this.type,geoCoords:b,operator:n.withinPolygon})}},x=function(b){if(!b||0===b.length)throw Error("Specify field name");this.field=b;v("property",b,this);return this},w=function(b){if(!b||
0===b.length)throw Error("Specify field name");this.field=b;var c=new v("aggregate",b);this.equalTo=function(b){return c.equalTo(b)};this.greaterThan=function(b){return c.greaterThan(b)};this.greaterThanEqualTo=function(b){return c.greaterThanEqualTo(b)};this.lessThan=function(b){return c.lessThan(b)};this.lessThanEqualTo=function(b){return c.lessThanEqualTo(b)};this.between=function(b,e){return c.between(b,e)};return this},y=function(b){if(!b||0===b.length)throw Error("Specify field name");this.field=
b;var c=new v("attribute",b);this.like=function(b){return c.like(b)};this.like=function(b){return c.match(b)};this.startWith=function(b){return c.startsWith(b)};this.endsWith=function(b){return c.endsWith(b)};this.equalTo=function(b){return c.equalTo(b)};this.contains=function(b){return c.contains(b)};return this};f.Filter={Property:function(b){return new x(b)},Aggregate:function(b){return new w(b)},Attribute:function(b){return new y(b)},Or:function(){return new m(n.or,arguments)},And:function(){return new m(n.and,
arguments)},taggedWithOneOrMore:function(b){return new p({tags:b,operator:n.taggedWithOneOrMore})},taggedWithAll:function(b){return new p({tags:b,operator:n.taggedWithAll})}}})(global);
(function(c){c.Appacitive.Queries={};var f=function(b){b=b||{};var c=1,f=20;this.pageNumber=function(){return 1==arguments.length?(c=arguments[0]||1,this):c};this.pageSize=function(){return 1==arguments.length?(f=arguments[0]||20,this):f};this.pageNumber(b.pageNumber);this.pageSize(b.pageSize)};f.prototype.toString=function(){return"psize="+this.pageSize()+"&pnum="+this.pageNumber()};var b=function(b){b=b||{};var c=null,f=!1;this.orderBy=function(){return 1===arguments.length&&_type.isString(arguments[0])?
(c=arguments[0],this):c};this.isAscending=function(){return 1===arguments.length?(f=void 0===arguments[0]||null==arguments[0]?!1:arguments[0],this):f};this.orderBy(b.orderBy);this.isAscending(b.isAscending)};b.prototype.toString=function(){return this.orderBy()&&0<this.orderBy().length?"orderBy="+this.orderBy()+"&isAsc="+this.isAscending():""};var h=function(e){var g=e||{},h="",k="",p="",m=g.queryType||"BasicQuery",n=new f(e),q=new b(e),r=g.type||g.relation,u=g.relation?"connection":"object",t=this;
this.type=function(){return u};this.entityType=function(){return r};this.queryType=function(){return m};this.pageQuery=function(){return n};this.pageNumber=function(){return 1===arguments.length?(n.pageNumber(arguments[0]),this):n.pageNumber()};this.pageSize=function(){return 1===arguments.length?(n.pageSize(arguments[0]),this):n.pageSize()};this.sortQuery=function(){return q};this.orderBy=function(){return 1===arguments.length?(q.orderBy(arguments[0]),this):q.orderBy()};this.isAscending=function(){return 1===
arguments.length?(q.isAscending(arguments[0]),this):q.isAscending()};this.filter=function(){return 1===arguments.length?(h=arguments[0],this):h};this.freeText=function(){if(1===arguments.length){var b=arguments[0];_type.isString(b)?k=arguments[0]:_type.isArray(b)&&b.length&&(k=arguments[0].join(" "));return this}return k};this.fields=function(){if(1===arguments.length){var b=arguments[0];_type.isString(b)?p=b:_type.isArray(b)&&b.length&&(p=b.join(","));return this}return p};this.filter(g.filter||
"");this.freeText(g.freeText||"");this.fields(g.fields||"");this.setFilter=function(b){this.filter(b)};this.setFreeText=function(b){this.freeText(b)};this.setFields=function(b){this.fields(b)};this.extendOptions=function(c){for(var e in c)g[e]=c[e];n=new f(g);q=new b(g);return this};this.getQueryString=function(){var b=n.toString(),c=q.toString();c&&(b+="&"+c);this.filter()&&(c=encodeURIComponent(this.filter().toString()),0<c.trim().length&&(b+="&query="+c));this.freeText()&&0<this.freeText().trim().length&&
(b+="&freetext="+encodeURIComponent(this.freeText())+"&language=en");this.fields()&&0<this.fields().trim().length&&(b+="&fields="+this.fields());return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+u+"/"+r+"/find/all?"+this.getQueryString()};this.toRequest=function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};this.getOptions=function(){var b={},c;for(c in this)this.hasOwnProperty(c)&&!_type.isFunction(this[c])&&(b[c]=this[c]);return b};this._setPaging=
function(b){b&&(n.pageNumber(b.pagenumber),n.pageSize(b.pagesize),this.results=this.results||[],this.results.isLastPage=!1,this.results.total=b.totalrecords,this.results.pageNumber=b.pagenumber,this.results.pageSize=b.pagesize,b.pagenumber*b.pagesize>=b.totalrecords&&(this.results.isLastPage=!0))};var v=function(b){var e=[];b||(b=[]);var g="object"===u?"Object":"Connection";r&&"user"==r.toLowerCase()&&(g="User");b.forEach(function(b){e.push(new c.Appacitive[g](b,!0))});return e};this.fetch=function(b){var e=
c.Appacitive.Promise.buildPromise(b);b=this.toRequest();b.onSuccess=function(b){t.results=v(b[u+"s"]);t._setPaging(b.paginginfo);e.fulfill(t.results,b.paginginfo)};b.promise=e;b.entity=this;return c.Appacitive.http.send(b)};this.fetchNext=function(b){var c=this.pageNumber();this.pageNumber(++c);return this.fetch(b)};this.fetchPrev=function(b){var c=this.pageNumber(),c=c-1;0>=c&&(c=1);this.pageNumber(c);return this.fetch(b)};this.count=function(b){var e=c.Appacitive.Promise.buildPromise(b);b=this.toRequest();
b.onSuccess=function(b){b=b||{};b=b.paginginfo;var c=0,c=b?b.totalrecords:0;e.fulfill(c)};b.promise=e;b.entity=this;return c.Appacitive.http.send(b)}};c.Appacitive.Queries.FindAllQuery=function(b){b=b||{};if(!b.type&&!b.relation||b.type&&b.relation)throw Error("Specify either type or relation for basic filter query");b.queryType="BasicFilterQuery";h.call(this,b);return this};c.Appacitive.Queries.FindAllQuery.prototype=new h;c.Appacitive.Queries.FindAllQuery.prototype.constructor=c.Appacitive.Queries.FindAllQuery;
c.Appacitive.Queries.ConnectedObjectsQuery=function(b){b=b||{};if(!b.relation)throw Error("Specify relation for connected objects query");if(!b.objectId)throw Error("Specify objectId for connected objects query");if(!b.type)throw Error("Specify type of object id for connected objects query");var g=b.type;delete b.type;b.queryType="ConnectedObjectsQuery";h.call(this,b);this.objectId=b.objectId;this.relation=b.relation;this.type=g;b.object instanceof c.Appacitive.Object&&(this.object=b.object);this.returnEdge=
!0;void 0===b.returnEdge||(null===b.returnEdge||b.returnEdge||this.prev)||(this.returnEdge=!1);this.label="";var f=this;_type.isString(b.label)&&0<b.label.length&&(this.label="&label="+b.label);this.toRequest=function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+"connection/"+this.relation+"/"+this.type+"/"+this.objectId+"/find?"+this.getQueryString()+this.label+"&returnEdge="+this.returnEdge};var k=function(b,
e){var g=[];b.forEach(function(b){var f=null;if(b.__edge){f=b.__edge;delete b.__edge;f.__endpointa=e;f.__endpointb={objectid:b.__id,label:f.__label,type:b.__type};delete f.label;var h=new c.Appacitive.Connection(f,!0),f=new c.Appacitive.Object(b,!0);f.connection=h}else f=new c.Appacitive.Object(b,!0);g.push(f)});f.object&&(f.object.children[f.relation]=g);return g};this.fetch=function(h){var m=c.Appacitive.Promise.buildPromise(h);h=this.toRequest();h.onSuccess=function(c){var h=k;f.prev&&(h=prevParseNodes);
f.results=h(c.nodes?c.nodes:[],{objectid:b.objectId,type:g,label:c.parent});f._setPaging(c.paginginfo);m.fulfill(f.results,c.paginginfo)};h.promise=m;h.entity=this;return c.Appacitive.http.send(h)};return this};c.Appacitive.Queries.ConnectedObjectsQuery.prototype=new h;c.Appacitive.Queries.ConnectedObjectsQuery.prototype.constructor=c.Appacitive.Queries.ConnectedObjectsQuery;c.Appacitive.Queries.GetConnectionsQuery=function(b){b=b||{};if(!b.relation)throw Error("Specify relation for GetConnectionsQuery query");
if(!b.objectId)throw Error("Specify objectId for GetConnectionsQuery query");if(!b.label||0===b.label.trim().length)throw Error("Specify label for GetConnectionsQuery query");b.type&&delete b.type;b.queryType="GetConnectionsQuery";h.call(this,b);this.objectId=b.objectId;this.relation=b.relation;this.label=b.label;this.toRequest=function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+"connection/"+this.relation+
"/find/all?"+this.getQueryString()+"&objectid="+this.objectId+"&label="+this.label};return this};c.Appacitive.Queries.GetConnectionsQuery.prototype=new h;c.Appacitive.Queries.GetConnectionsQuery.prototype.constructor=c.Appacitive.Queries.GetConnectionsQuery;c.Appacitive.Queries.GetConnectionsBetweenObjectsQuery=function(b,g){b=b||{};if(!b.objectAId||!_type.isString(b.objectAId)||0===b.objectAId.length)throw Error("Specify valid objectAId for GetConnectionsBetweenObjectsQuery query");if(!b.objectBId||
!_type.isString(b.objectBId)||0===b.objectBId.length)throw Error("Specify objectBId for GetConnectionsBetweenObjectsQuery query");b.type&&delete b.type;b.queryType=g||"GetConnectionsBetweenObjectsQuery";h.call(this,b);this.objectAId=b.objectAId;this.objectBId=b.objectBId;this.label="GetConnectionsBetweenObjectsForRelationQuery"===this.queryType()&&b.label&&_type.isString(b.label)&&0<b.label.length?"&label="+b.label:"";this.relation=b.relation&&_type.isString(b.relation)&&0<b.relation.length?b.relation+
"/":"";this.toRequest=function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();b.method="get";return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+"connection/"+this.relation+"find/"+this.objectAId+"/"+this.objectBId+"?"+this.getQueryString()+this.label};return this};c.Appacitive.Queries.GetConnectionsBetweenObjectsQuery.prototype=new h;c.Appacitive.Queries.GetConnectionsBetweenObjectsQuery.prototype.constructor=c.Appacitive.Queries.GetConnectionsBetweenObjectsQuery;c.Appacitive.Queries.GetConnectionsBetweenObjectsForRelationQuery=
function(b){b=b||{};if(!b.relation)throw Error("Specify relation for GetConnectionsBetweenObjectsForRelationQuery query");b=new c.Appacitive.Queries.GetConnectionsBetweenObjectsQuery(b,"GetConnectionsBetweenObjectsForRelationQuery");b.fetch=function(b){var e=c.Appacitive.Promise.buildPromise(b);b=this.toRequest();b.onSuccess=function(b){e.fulfill(b.connection?new c.Appacitive.Connection(b.connection,!0):null)};b.promise=e;b.entity=this;return c.Appacitive.http.send(b)};return b};c.Appacitive.Queries.InterconnectsQuery=
function(b){b=b||{};if(!b.objectAId||!_type.isString(b.objectAId)||0===b.objectAId.length)throw Error("Specify valid objectAId for InterconnectsQuery query");if(!(b.objectBIds&&_type.isArray(b.objectBIds)&&0<b.objectBIds.length))throw Error("Specify list of objectBIds for InterconnectsQuery query");b.type&&delete b.type;b.queryType="InterconnectsQuery";h.call(this,b);this.objectAId=b.objectAId;this.objectBIds=b.objectBIds;this.toRequest=function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();
b.method="post";b.data={object1id:this.objectAId,object2ids:this.objectBIds};return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+"connection/interconnects?"+this.getQueryString()};return this};c.Appacitive.Queries.InterconnectsQuery.prototype=new h;c.Appacitive.Queries.InterconnectsQuery.prototype.constructor=c.Appacitive.Queries.InterconnectsQuery;c.Appacitive.Queries.GraphFilterQuery=function(b,g){if(!b||0===b.length)throw Error("Specify name of filter query");this.name=b;this.data=
{};this.queryType="GraphFilterQuery";if(g){this.data.placeholders=g;for(var f in this.data.placeholders)this.data.placeholders[f]=this.data.placeholders[f]}this.toRequest=function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();b.method="post";b.data=this.data;return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+"search/"+this.name+"/filter"};this.fetch=function(b){var e=c.Appacitive.Promise.buildPromise(b);b=this.toRequest();b.onSuccess=function(b){e.fulfill(b.ids?b.ids:
[])};b.promise=e;b.entity=this;return c.Appacitive.http.send(b)}};c.Appacitive.Queries.GraphProjectQuery=function(b,g,f){if(!b||0===b.length)throw Error("Specify name of project query");if(!g||!g.length)throw Error("Specify ids to project");this.name=b;this.data={ids:g};this.queryType="GraphProjectQuery";if(f){this.data.placeholders=f;for(var h in this.data.placeholders)this.data.placeholders[h]=this.data.placeholders[h]}this.toRequest=function(){var b=new c.Appacitive.HttpRequest;b.url=this.toUrl();
b.method="post";b.data=this.data;return b};this.toUrl=function(){return c.Appacitive.config.apiBaseUrl+"search/"+this.name+"/project"};var p=function(b){var e,g;for(g in b)if("status"!==g){e=b[g];break}var f=function(b,e,g){var h=[];b.forEach(function(b){var k=b.__children;delete b.__children;var l=b.__edge;delete b.__edge;b=new c.Appacitive.Object(b,!0);b.children={};for(var p in k)b.children[p]=[],b.children[p]=f(k[p].values,k[p].parent,b.id);l&&(l.__endpointa={objectid:g,label:e},l.__endpointb=
...
(function(c){c.Appacitive.BaseObject=function(f,b){var h={},e=function(b,e){for(var g in b)if(_type.isString(b[g]))e[g]=b[g];else if(b[g]instanceof Date)e[g]=c.Appacitive.Date.toISOString(b[g]);else if(_type.isObject(b[g]))if(b[g]instanceof c.Appacitive.GeoCoord)e[g]=b[g].toString();else{e[g]||(e[g]={});for(var f in b[g])e[g][f]=b[g][f]}else if(_type.isArray(b[g])){if(e[g]=[],b[g].forEach(function(b){if(_type.isString(b))e[g].push(b);else if(_type.isNumber(b)||_type.isBoolean(b))e[g].push(value+"");
else if(b instanceof Date)e[g].push(c.Appacitive.Date.toISOString(b));else if("__link"==g)e[g].push(b);else throw Error("Multivalued property cannot have values of property as an object");}),"__tags"!==g||"__link"!==g)e[g].push=function(b){var e=this.length;if(_type.isString(b))this[e]=b;else if(_type.isNumber(b)||_type.isBoolean(b))this[e]=b+"";else if(b instanceof Date)this[e]=c.Appacitive.Date.toISOString(b);else throw Error("Multivalued property cannot have values of property as an object");return this}}else e[g]=
b[g]},g=this,l={};e(f,l);var k=l;b&&e(k,h);!h.__id&&l.__id&&(h.__id=l.__id);l.__type?(l.__type=l.__type.toLowerCase(),this.entityType="type",this.type="object"):l.__relationtype&&(l.__relationtype=l.__relationtype.toLowerCase(),this.entityType="relation",this.type="connection");this.cid=parseInt(1E6*Math.random(),10);k.__attributes||(k.__attributes={});h.__attributes||(h.__attributes={});var p=[],m=[];k.__tags||(k.__tags=[]);h.__tags||(h.__tags=[]);var n="",q="__id __revision __endpointa __endpointb __createdby __lastmodifiedby __type __relationtype __typeid __relationid __utcdatecreated __utclastupdateddate __tags __authType __link".split(" "),
...
else{if(1===arguments.length)return k.__attributes||(k.__attributes={}),k.__attributes[arguments[0]];if(2===arguments.length){if(!_type.isString(arguments[1])&&null!==arguments[1])throw Error("only string values can be stored in attributes.");k.__attributes||(k.__attributes={});k.__attributes[arguments[0]]=arguments[1]}else throw Error(".attr() called with an incorrect number of arguments. 0, 1, 2 are supported.");}return k.__attributes};var t=function(){if(!k.__attributes)return null;if(!h.__attributes)return k.__attributes;
var b=!1,c=JSON.parse(JSON.stringify(h.__attributes)),e;for(e in k.__attributes)null==k.__attributes[e]||void 0==k.__attributes[e]?(c[e]=null,b=!0):k.__attributes[e]!=h.__attributes[e]?(c[e]=k.__attributes[e],b=!0):k.__attributes[e]==h.__attributes[e]&&delete c[e];return b?c:null};this.getChangedAttributes=t;this.aggregate=function(){var b={},c;for(c in k){if(!k.hasOwnProperty(c))return;"$"==c[0]&&(b[c.substring(1)]=k[c])}if(0===arguments.length)return b;if(1==arguments.length)return b[arguments[0]];
throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");};this.tags=function(){return k.__tags?k.__tags:[]};this.addTag=function(b){if(!b||!_type.isString(b)||!b.length)return this;k.__tags||(k.__tags=[]);k.__tags.push(b);k.__tags=Array.distinct(k.__tags);if(!m||!m.length)return this;b=m.indexOf(b);-1!=b&&m.splice(b,1);return this};this.removeTag=function(b){if(!b||!_type.isString(b)||!b.length)return this;m.push(b);m=Array.distinct(m);if(!k.__tags||!k.__tags.length)return this;
b=k.__tags.indexOf(b);-1!=b&&k.__tags.splice(b,1);return this};var v=function(){if(!k.__tags)return[];if(!h.__tags)return k.__tags;var b=[];k.__tags.forEach(function(c){-1==h.__tags.indexOf(c)&&b.push(c)});return 0<b.length?b:null};this.getChangedTags=v;this.getRemovedTags=function(){return _removetags};var x=function(b){var c=!1,e=JSON.parse(JSON.stringify(h)),g;for(g in k)null==k[g]||void 0==k[g]?(e[g]=null,c=!0):k[g]!=h[g]?"__tags"==g||"__attributes"==g?delete e[g]:(e[g]=k[g],c=!0):k[g]==h[g]&&
delete e[g];try{q.forEach(function(b){e[b]&&delete e[b]})}catch(f){}g=v();b?(g&&(e.__addtags=g,c=!0),m&&0<m.length&&(e.__removetags=m,c=!0)):g&&(e.__addtags=g,c=!0);(b=t())?(e.__attributes=b,c=!0):delete e.__attributes;for(var l in e)"$"==l[0]&&delete e[l];return c&&!Object.isEmpty(e)?e:!1};this.changed=function(){return x()};this.hasChanged=function(){var b=x(!0);return 0===arguments.length?Object.isEmpty(b)?!1:!0:1==arguments.length&&_type.isString(arguments[0])&&0<arguments[0].length&&b&&b[arguments[0]]?
!0:!1};this.changedAttributes=function(){var b=x(!0);if(0===arguments.length)return b;if(1==arguments.length&&_type.isArray(arguments[0])&&arguments[0].length){var c={};arguments[0].forEach(function(e){b[e]&&c.push(b[e])});return c}return!1};this.previous=function(){return 1==arguments.length&&_type.isString(arguments[0])&&arguments[0].length?h[arguments[0]]:null};this.previousAttributes=function(){return h};this.fields=function(){if(1==arguments.length){var b=arguments[0];_type.isString(b)?n=b:_type.isArray(b)&&
(n=b.join(","));return this}return n};var w={integer:function(b){if(b){var c=parseInt(b);if(!isNaN(c))return c}return b},decimal:function(b){if(b){var c=parseFloat(b);if(!isNaN(c))return c}return b},"boolean":function(b){return void 0!==b&&null!==b&&("true"===b.toString().toLowerCase()||!0===b||0<b)?!0:!1},date:function(b){if(b){var e=c.Appacitive.Date.parseISODate(b);if(e)return e}return b},datetime:function(b){if(b){var e=c.Appacitive.Date.parseISODate(b);if(e)return e}return b},time:function(b){if(b){var e=
c.Appacitive.Date.parseISOTime(b);if(e)return e}return b},string:function(b){return b?b.toString():b},geocode:function(b){if(!_type.isString(b)||0==b.trim().length)return!1;b=b.split(",");return 2!==b.length?!1:new c.Appacitive.GeoCoord(b[0],b[1])}};this.get=function(b,c){if(b){if(c&&w[c.toLowerCase()]){if(w[c.toLowerCase()])return w[c.toLowerCase()](k[b]);throw Error('Invalid cast-type "'+c+'"" provided for get "'+b+'"');}return k[b]}};this.tryGet=function(b,c,e){b=this.get(b,e);return void 0!==
b?b:c};this.set=function(b,e){if(!b||!_type.isString(b)||0===b.length||0===b.trim().indexOf("$"))return this;if(void 0==e||null==e)k[b]=null;else if(_type.isString(e))k[b]=e;else if(_type.isNumber(e)||_type.isBoolean(e))k[b]=e+"";else if(e instanceof Date)k[b]=c.Appacitive.Date.toISOString(e);else if(_type.isObject(e))if(-1!==r.indexOf(b))k[b]=e;else if(e instanceof c.Appacitive.GeoCoord)k[b]=e.toString();else throw Error("Property cannot have value as an object");else _type.isArray(e)&&(k[b]=[],
e.forEach(function(e){if(_type.isString(e))k[b].push(e);else if(_type.isNumber(e)||_type.isBoolean(e))k[b].push(e+"");else if(e instanceof Date)k[b].push(c.Appacitive.Date.toISOString(e));else throw Error("Multivalued property cannot have values of property as an object");}),"tags"!==b||"__link"!==b)&&(k[b].push=function(b){var e=this.length;if(_type.isString(b))this[e]=b;else if(_type.isNumber(b)||_type.isBoolean(b))this[e]=b+"";else if(b instanceof Date)this[e]=c.Appacitive.Date.toISOString(b);
else throw Error("Multivalued property cannot have values of property as an object");return this});return this};this.unset=function(b){if(!b||!_type.isString(b)||0===b.length||0===b.indexOf("__"))return this;try{delete k[b]}catch(c){}return this};this.has=function(b){return b&&_type.isString(b)&&0!==b.length?k[b]&&!_type.isUndefined(k[b])?!0:!1:!1};this.isNew=function(){return k.__id&&k.__id.length?!1:!0};this.clone=function(){return"object"==this.type?new c.Appacitive.Object(this.toJSON()):new c.Appacitive.connection(k)};
...
function(){return k.__id?z.apply(this,arguments):B.apply(this,arguments)};var B=function(b){var e=g.type;!k.__type||"user"!=k.__type.toLowerCase()&&"device"!=k.__type.toLowerCase()||(e=k.__type.toLowerCase());for(var f in k)"$"==f[0]&&delete k[f];k.__revision&&delete k.__revision;var l=new c.Appacitive._Request({method:"PUT",type:e,op:"getCreateUrl",args:[k.__type||k.__relationtype,n],data:k,callbacks:b,entity:g,onSuccess:function(b){var e=null;b&&(b.object||b.connection||b.user||b.device)&&(e=b.object||
b.connection||b.user||b.device);b&&e?(h=e,k.__id=e.__id,y(),"connection"==g.type&&g.parseConnection(),c.Appacitive.eventManager.fire(g.entityType+"."+g.type+".created",g,{object:g}),g.created=!0,l.promise.fulfill(g)):(c.Appacitive.eventManager.fire(g.entityType+"."+g.type+".createFailed",g,{error:b.status}),l.promise.reject(b.status,g))}});return l.send()},z=function(b,e){c.Appacitive.Promise.is(e)||(e=c.Appacitive.Promise.buildPromise(b));var f=function(f){var l=x(!0),m;for(m in l)"$"==m[0]&&delete l[m];
if(Object.isEmpty(l))e.fulfill(g);else{m=n;var q=new c.Appacitive.HttpRequest,r=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory[g.type].getUpdateUrl(k.__type||k.__relationtype,h.__id?h.__id:k.__id,m,f),t=g.type;k&&(k.__type&&("user"==k.__type.toLowerCase()||"device"==k.__type.toLowerCase()))&&(t=k.__type.toLowerCase(),r=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory[k.__type.toLowerCase()].getUpdateUrl(h.__id,m,f));q.url=r;q.method="post";q.data=l;q.onSuccess=function(f){f&&
f[t]?(h=f[t],y(),delete g.created,c.Appacitive.eventManager.fire(g.entityType+"."+t+"."+k.__id+".updated",g,{object:g}),e.fulfill(g)):"14008"==f.status.code&&0<p.length?z(b,e):(c.Appacitive.eventManager.fire(g.entityType+"."+t+"."+k.__id+".updateFailed",g,{object:f.status}),e.reject(f.status,g))};q.onError=function(c){c=u(c);"14008"==c.code&&0<p.length?z(b,e):e.reject(c,g)};c.Appacitive.http.send(q)}};if(0<p.length){var l=["__revision"];p.forEach(function(b){l.push(b.key)});var m={id:this.id(),fields:l};
"object"==this.type?m.type=this.get("__type"):m.relation=this.get("__type");c.Appacitive["object"==this.type?"Article":"Connection"].get(m).then(function(b){b=b.toJSON();p.forEach(function(c){var e=w.integer(b[c.key]);e||(e=0);g.set(c.key,e+c.amount)});f(b.__revision)},function(b){e.reject(b)})}else f();return e},C=function(b){if(!k.__id)throw Error("Please specify id for get operation");var f=this.type;k&&(k.__type&&("user"==k.__type.toLowerCase()||"device"==k.__type.toLowerCase()))&&(f=k.__type.toLowerCase());
var l=new c.Appacitive._Request({method:"GET",type:f,op:"getGetUrl",args:[k.__type||k.__relationtype,k.__id,n],callbacks:b,entity:g,onSuccess:function(b){b&&b[f]?(h=b[f],e(h,k),b.connection&&(g.endpoints||g.endpointA&&g.endpointB||g.setupConnection(k.__endpointa,k.__endpointb)),l.promise.fulfill(g)):(b=b||{},b.status=b.status||{},b.status=u(b.status),l.promise.reject(b.status,g))}});return l.send()};this.fetch=function(b){return C.apply(this,[b])};this.del=this.destroy=function(b,e){_type.isBoolean(b)?
(e=b,b=null):_type.isBoolean(e)||(e=!1);if(!k.__id)return(new c.Appacitive.Promise.buildPromise(b)).fulfill();var g=this.type;!k.__type||"user"!=k.__type.toLowerCase()&&"device"!=k.__type.toLowerCase()||(g=k.__type.toLowerCase());var f=new c.Appacitive._Request({method:"DELETE",type:g,op:"getDeleteUrl",args:[k.__type||k.__relationtype,k.__id,e],callbacks:b,entity:this,onSuccess:function(b){f.promise.fulfill(b)}});return f.send()}};c.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())}})(global);
...
(function(c){c.Appacitive.Object=function(b,f){b=b||{};_type.isString(b)&&(b={__type:b});if(!b.__type)throw Error("Cannot set object without __type");c.Appacitive.BaseObject.call(this,b,f);this.type="object";this.getObject=this.getObject;this.children={};this.toJSON=function(b){if(b){var c=function(b){var e=[];b.forEach(function(b){var f=b.getObject();if(b.children&&!Object.isEmpty(b.children)){f.children={};for(var h in b.children)f.children[h]=c(b.children[h])}b.connection&&(f.__connection=b.connection.toJSON());
e.push(f)});return e};return c([this])[0]}return this.getObject()};return this};c.Appacitive.Object.prototype=new c.Appacitive.BaseObject;c.Appacitive.Object.prototype.constructor=c.Appacitive.Object;var f=function(b){var f=[];b.forEach(function(b){f.push(new c.Appacitive.Object(b,!0))});return f};c.Appacitive._parseObjects=f;c.Appacitive.Object.multiDelete=function(b,f){b=b||{};if(!b.type||!_type.isString(b.type)||0===b.type.length)throw Error("Specify valid type");if("user"===b.type.toLowerCase()||
"device"===b.type.toLowerCase())throw Error("Cannot delete user and devices using multidelete");if(!b.ids||0===b.ids.length)throw Error("Specify ids to delete");var e=new c.Appacitive._Request({method:"POST",data:{idlist:b.ids},type:"object",op:"getMultiDeleteUrl",args:[b.type],callbacks:f,onSuccess:function(b){e.promise.fulfill()}});return e.send()};c.Appacitive.Object.multiGet=function(b,h){b=b||{};if(!b.type||!_type.isString(b.type)||0===b.type.length)throw Error("Specify valid type");if(!b.ids||
0===b.ids.length)throw Error("Specify ids to delete");var e=new c.Appacitive._Request({method:"GET",type:"object",op:"getMultiGetUrl",args:[b.type,b.ids.join(","),b.fields],callbacks:h,onSuccess:function(b){e.promise.fulfill(f(b.objects))}});return e.send()};c.Appacitive.Object.get=function(b,f){b=b||{};if(!b.type)throw Error("Specify type");if(!b.id)throw Error("Specify id to fetch");var e={},e="user"===b.type.toLowerCase()?new c.Appacitive.User({__id:b.id}):new c.Appacitive.Object({__type:b.type,
__id:b.id});e.fields=b.fields;return e.fetch(f)};c.Appacitive.Object.prototype.getConnections=function(b){if(this.isNew())throw Error("Cannot fetch connections for new object");b.objectId=this.get("__id");return new c.Appacitive.Queries.GetConnectionsQuery(b)};c.Appacitive.Object.prototype.getConnectedObjects=function(b){if(this.isNew())throw Error("Cannot fetch connections for new object");b=b||{};_type.isString(b)&&(b={relation:b});b.type=this.get("__type");b.objectId=this.get("__id");b.object=
this;return new c.Appacitive.Queries.ConnectedObjectsQuery(b)};c.Appacitive.Object.prototype.fetchConnectedObjects=c.Appacitive.Object.prototype.getConnectedObjects;c.Appacitive.Object.findAll=function(b){return new c.Appacitive.Queries.FindAllQuery(b)}})(global);
(function(c){var f=function(b,g,f){var h={label:b.label};b.objectid&&(h.objectid=b.objectid);if(b.object)_type.isFunction(b.object.getObject)?b.object.get("__id")?h.objectid=b.object.get("__id"):h.object=b.object.getObject():_type.isObject(b.object)&&(b.object.__id?h.objectid=b.object.__id:h.object=b.object,b.object=new c.Appacitive.Object(b.object));else if(!h.objectid&&!h.object)throw Error("Incorrectly configured endpoints provided to setupConnection");f["endpoint"+g]=b;return h},b=function(b,
g,f){b.object&&_type.isObject(b.object)?(f["endpoint"+g]?f["endpoint"+g]&&f["endpoint"+g].object&&f["endpoint"+g].object instanceof c.Appacitive.Object?f["endpoint"+g].object.copy(b.object,!0):f["endpoint"+g].object=new c.Appacitive.Object(b.object,!0):(f["endpoint"+g]={},f["endpoint"+g].object=new c.Appacitive.Object(b.object,!0)),f["endpoint"+g].objectid=b.object.__id,f["endpoint"+g].label=b.label,f["endpoint"+g].type=b.type):f["endpoint"+g]=b};c.Appacitive.Connection=function(e,g){e=e||{};_type.isString(e)&&
(e={__relationtype:e});if(!e.__relationtype&&!e.relation)throw Error("Cannot set connection without relation");e.relation&&(e.__relationtype=e.relation,delete e.relation);e.endpoints&&2===e.endpoints.length&&(e.__endpointa=e.endpoints[0],e.__endpointb=e.endpoints[1],delete e.endpoints);c.Appacitive.BaseObject.call(this,e,g);this.type="connection";this.getConnection=this.getObject;this.parseConnection=function(){var c="A",g="B";e.__endpointa.label.toLowerCase()!==this.get("__endpointb").label.toLowerCase()||
(e.__endpointa.label.toLowerCase()==e.__endpointb.label.toLowerCase()||e.__endpointa.objectid!=this.get("__endpointb").objectid&&e.__endpointa.objectid)||(c="B",g="A");b(this.get("__endpointa"),c,this);b(this.get("__endpointb"),g,this);this.endpoints=function(){if(1===arguments.length&&_type.isString(arguments[0])){if(this.endpointA.label.toLowerCase()===arguments[0].toLowerCase())return this.endpointA;if(this.endpointB.label.toLowerCase()===arguments[0].toLowerCase())return this.endpointB;throw Error("Invalid label provided");
}var b=[];b.push(this.endpointA);b.push(this.endpointB);return b};return this};g?this.parseConnection(e):e.__endpointa&&e.__endpointb&&this.setupConnection(this.get("__endpointa"),this.get("__endpointb"));return this};c.Appacitive.Connection.prototype=new c.Appacitive.BaseObject;c.Appacitive.Connection.prototype.constructor=c.Appacitive.Connection;c.Appacitive.Connection.prototype.setupConnection=function(b,c){if(!(b&&(b.objectid||b.object)&&b.label&&c&&(c.objectid||c.object)&&c.label))throw Error("Incorrect endpoints configuration passed.");
this.set("__endpointa",f(b,"A",this));this.set("__endpointb",f(c,"B",this));this.endpoints=function(){if(1===arguments.length&&_type.isString(arguments[0])){if(this.endpointA.label.toLowerCase()===arguments[0].toLowerCase())return this.endpointA;if(this.endpointB.label.toLowerCase()===arguments[0].toLowerCase())return this.endpointB;throw Error("Invalid label provided");}var b=[];b.push(this.endpointA);b.push(this.endpointB);return b}};c.Appacitive.Connection.get=function(b,g){b=b||{};if(!b.relation)throw Error("Specify relation");
if(!b.id)throw Error("Specify id to fetch");var f=new c.Appacitive.Connection({__relationtype:b.relation,__id:b.id});f.fields=b.fields;return f.fetch(g)};var h=function(b){var g=[];b||(b=[]);b.forEach(function(b){g.push(new c.Appacitive.Connection(b,!0))});return g};c.Appacitive.Connection._parseConnections=h;c.Appacitive.Connection.multiGet=function(b,g){b=b||{};if(!b.relation||!_type.isString(b.relation)||0===b.relation.length)throw Error("Specify valid relation");if(!b.ids||0===b.ids.length)throw Error("Specify ids to delete");
var f=new c.Appacitive._Request({method:"GET",type:"connection",op:"getMultiGetUrl",args:[b.relation,b.ids.join(","),b.fields],callbacks:g,onSuccess:function(b){f.promise.fulfill(h(b.connections))}});return f.send()};c.Appacitive.Connection.multiDelete=function(b,g){b=b||{};if(!b.relation||!_type.isString(b.relation)||0===b.relation.length)throw Error("Specify valid relation");if(!b.ids||0===b.ids.length)throw Error("Specify ids to get");var f=new c.Appacitive._Request({method:"POST",data:{idlist:b.ids},
type:"connection",op:"getMultiDeleteUrl",args:[b.relation],callbacks:g,onSuccess:function(b){f.promise.fulfill()}});return f.send()};c.Appacitive.Connection.findAll=function(b){return new c.Appacitive.Queries.FindAllQuery(b)};c.Appacitive.Connection.getInterconnects=function(b){return new c.Appacitive.Queries.InterconnectsQuery(b)};c.Appacitive.Connection.getBetweenObjects=function(b){return new c.Appacitive.Queries.GetConnectionsBetweenObjectsQuery(b)};c.Appacitive.Connection.getBetweenObjectsForRelation=
function(b){return new c.Appacitive.Queries.GetConnectionsBetweenObjectsForRelationQuery(b)}})(global);
...
e,g])};f.logout=function(b){return c.Appacitive.Users.logout(b)};c.Appacitive.eventManager.clearAndSubscribe("type.user."+p.get("__id")+".updated",function(b,e){c.Appacitive.localStorage.set("Appacitive-User",e.object.getObject())});return f};c.Appacitive.User=function(b){b=b||{};b.__type="user";c.Appacitive.Object.call(this,b);return this};c.Appacitive.User.prototype=new c.Appacitive.Object("user");c.Appacitive.User.prototype.constructor=c.Appacitive.User;c.Appacitive.User.prototype.linkedAccounts=
...
if(!e||!_type.isString(e)||0===e.length)throw Error("Plase specify subject for email");var h=new c.Appacitive._Request({method:"POST",type:"user",op:"getSendResetPasswordEmailUrl",callbacks:f,data:{username:b,subject:e},onSuccess:function(){h.promise.fulfill()}});return h.send()};this.resetPassword=function(b,e,f){if(!b)throw Error("Please specify token");if(!e||0===e.length)throw Error("Please specify password");var h=new c.Appacitive._Request({method:"POST",type:"user",op:"getResetPasswordUrl",
callbacks:f,data:{newpassword:e},args:[b],onSuccess:function(){h.promise.fulfill()}});return h.send()};this.validateResetPasswordToken=function(b,e){if(!b)throw Error("Please specify token");var f=new c.Appacitive._Request({method:"POST",type:"user",op:"getValidateResetPasswordUrl",callbacks:e,data:{},args:[b],onSuccess:function(b){f.promise.fulfill(b.user)}});return f.send()}}})(global);
...
b)})};this.save=function(b){return this.fileId&&_type.isString(this.fileId)&&0<this.fileId.length?l(b):g(b)};var g=function(f){if(!b.fileData)throw Error("Please specify filedata");if(!b.contentType)try{b.contentType=b.fileData.type}catch(g){}b.contentType&&_type.isString(b.contentType)&&0!==b.contentType.length||(b.contentType="text/plain");var l=c.Appacitive.Promise.buildPromise(f);f=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory.file.getUploadUrl(b.contentType,b.fileId?b.fileId:
"");h(f,function(c){e(c.url,b.fileData,b.contentType,function(){b.fileId=c.id;b.getDownloadUrl(function(c){return l.fulfill(c,b)},function(b){return l.reject(b)})},l)},l);return l},l=function(f){if(!b.fileData)throw Error("Please specify filedata");if(!b.contentType)try{b.contentType=b.fileData.type}catch(g){}b.contentType&&_type.isString(b.contentType)&&0!==b.contentType.length||(b.contentType="text/plain");var l=c.Appacitive.Promise.buildPromise(f);f=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory.file.getUpdateUrl(b.fileId,
b.contentType);h(f,function(c){e(c.url,b.fileData,b.contentType,function(){b.getDownloadUrl().then(function(c){l.fulfill(c,b)},function(b){l.reject(b)})},l)},l);return l};this.deleteFile=function(e){if(!this.fileId)throw Error("Please specify fileId to delete");var f=c.Appacitive.Promise.buildPromise(e);e=new c.Appacitive.HttpRequest;e.url=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory.file.getDeleteUrl(this.fileId);e.method="DELETE";e.onSuccess=function(b){f.fulfill()};e.promise=
f;e.entity=b;return c.Appacitive.http.send(e)};this.getDownloadUrl=function(e){if(!this.fileId)throw Error("Please specify fileId to download");var f=c.Appacitive.Promise.buildPromise(e);e=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory.file.getDownloadUrl(this.fileId,556E4);h(e,function(c){b.url=c.uri;f.fulfill(c.uri)},f);return f};this.getUploadUrl=function(e){b.contentType&&_type.isString(b.contentType)&&0!==b.contentType.length||(b.contentType="text/plain");var f=c.Appacitive.Promise.buildPromise(e);
e=c.Appacitive.config.apiBaseUrl+c.Appacitive.storage.urlFactory.file.getUploadUrl(this.contentType,this.fileId?this.fileId:"");h(e,function(c){b.url=c.url;f.fulfill(c.url,b)},f);return f}}})(global);
...
f)}})})(global);
(function(c){c.Appacitive.Cloud=new function(){var c=[],b=function(){if(2!==arguments.length)throw"Invalid no. of arguments provided to cloud function declare";if("string"!==typeof arguments[0])throw"Error: Provide name fo cloud api";if("function"!==typeof arguments[1])throw"Error: Invalid api function provided for cloud api";var b=arguments[0];if(!/^[A-Za-z][A-Za-z_0-9]*$/.test(b))throw"Error: Invalid name for api function "+b;c[b.toLowerCase()]=arguments[1]};this.declare=function(){b.apply(null,arguments)};
this.declare.toString=function(){return"function () { [native code] }"};var h=function(){if(2>arguments.length||"string"!==typeof arguments[0]||"object"!==typeof arguments[1])throw new "Error: Invalid list of arguments passed to cloud api";var b=arguments[0].toLowerCase(),g=arguments[1].request,h=arguments[1].response;if("function"==typeof c[b]){var k=c[b];setTimeout(function(){k.apply(null,[g,h])},0)}else throw{code:"404",message:"Error: Api with name "+arguments[0]+" doesn't exits"};};this.execute=
function(){h.apply(null,arguments)};this.execute.toString=function(){return"function () { [native code] }"}}})(global);"undefined"===typeof module||global.Appacitive.runtime.isBrowser||(module.exports=global.Appacitive);
