...
this.relation+"/"+this.schema+"/"+this.articleId+"/find?"+this.getQueryString()+this.label};var g=function(a,b){var c=[];a.forEach(function(a){var d=a.__edge;delete a.__edge;d.__endpointa=b;d.__endpointb={article:a,label:d.label,type:a.__schematype};delete d.label;a=new Appacitive.Connection(d,!0);c.push(a)});return c};this.fetch=function(c,k){var l=this.toRequest();l.onSuccess=function(b){b&&b.status&&"200"==b.status.code?"function"==typeof c&&c(g(b.nodes?b.nodes:[],{articleid:d.articleId,type:a,
