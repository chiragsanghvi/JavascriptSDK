...
(function(){global.Appacitive||("undefined"!==typeof module&&module.exports?(global="undefined"!==typeof process?process:{},global.Appacitive={runtime:{isNode:!0,isBrowser:!1}}):(global="undefined"!==typeof window?window:{},global.Appacitive={runtime:{isNode:!1,isBrowser:!0}}));var g=global.Appacitive,b=function(b){if(b&&b.send&&_type.isFunction(b.send))b.onResponse=this.onResponse;else throw Error("No applicable httpTransport class found");var d=[],c={},h=0,e={},l=0;this.addProcessor=function(b){b&&
(b.pre=b.pre||function(){},b.post=b.post||function(){},k(b.pre),y(b.post))};var k=function(b){h+=1;c[h]=b;return h},y=function(b){l+=1;e[l]=b;return l};this.enqueueRequest=function(b){d.push(b)};this.changeRequestForCors=function(b){var f={m:b.method.toUpperCase()};b.headers.forEach(function(b){f[b.key]=b.value});b.prevHeaders=b.headers;b.headers=[];b.headers.push({key:"Content-Type",value:"text/plain; charset=utf-8"});b.method="POST";b.data&&(f.b=b.data);delete b.data;g.config.debug&&(-1===b.url.indexOf("?")?
b.url+="?debug=true":b.url+="&debug=true");g.config.metadata&&(-1===b.url.indexOf("?")?b.url+="?metadata=true":b.url+="&metadata=true");try{b.data=JSON.stringify(f)}catch(d){}return b};this.notify=function(){if(0!==d.length){var h=[],l;for(l in e)e.hasOwnProperty(l)&&h.push(e[l]);for(;0<d.length;){var k=d.shift(),g=[];for(l in c)c.hasOwnProperty(l)&&g.push(c[l](k));this.changeRequestForCors(k);b.send(k,h,g)}}};this.onResponse=function(b){console.dir(b)}},c=function(){var b=function(){throw Error("Not Implemented Exception");
...
"application/javascript"==b.value.toLowerCase()||"application/json; charset=utf-8"==b.value.toLowerCase()||"application/json; charset=utf-8;"==b.value.toLowerCase())&&(k=!1)});if(k)c=b.data;else if(b.data&&(c=b.data,_type.isObject(b.data)))try{c=JSON.stringify(c)}catch(p){}var l=b.url.split("/")[2]||"";if(global.navigator&&-1!=global.navigator.userAgent.indexOf("MSIE 8")&&l!==window.location.host.toLowerCase())return b.data=c,new e(b);l=new d;l.onreadystatechange=function(){if(4==this.readyState)if(200<=
...
b))}h.fulfill(b,this)}else h.reject(this,new g.Error(g.Error.ConnectionFailed,this.responseText,"Unknown"))};l.open(b.method,b.url,b.sync?!1:!0);for(var t=0;t<b.headers.length;t+=1)l.setRequestHeader(b.headers[t].key,b.headers[t].value);g.runtime.isBrowser||l.setRequestHeader("User-Agent","Appacitive-NodeJSSDK");l.send(c);return h},k=function(){var b=new c;b.isOnline=function(){return!0};var d=function(c,d,e){c.options=c.options||{};new h({method:c.method,url:c.url,headers:c.headers,data:c.data,sync:c.options.sync,
onSuccess:function(h,n){if(h){try{h=JSON.parse(h)}catch(k){}var g=h;if(d.length!=e.length)throw Error("Callback length and state length mismatch!");for(var u=0;u<d.length;u+=1)d[u].apply({},[g,e[u]]);if(200<=h.code&&300>=h.code||h.status&&200<=h.status.code&&300>=h.status.code)b.onResponse(c,h);else h=h||{},h=h.status||h,h.message=h.message||"Bad Request",h.code=h.code||"400",b.onError(c,{responseText:h})}else b.onError(c,{responseText:{code:"400",message:"Invalid request"}})},onError:function(d,
...
d.prototype.fulfill;d.prototype.reject=function(b){if(this.state)return this;this.state=2;this.reason=this.value=b;this.done();return this};d.prototype.then=function(b,h){var k=this,f=new d;this.calls[this.calls.length]=[f,b,h];this.state&&c(function(){k.done()});return f};d.when=function(b){var h=[],k=[],f,g=0,q=new d;if(!b||_type.isArray(b)&&0==b.length)return q.fulfill(h),q;var r=function(){g+=1;g==f&&(q.state||(0<k.length?q.reject(k,h?h:[]):q.fulfill(h?h:[])))},p=function(f){var l=b[f];l instanceof
d||l&&"function"===typeof l.then?c(function(){l.then(function(b){h[f]=b;r()},function(b){k[f]=b;r()})}):c(function(){try{h[f]=l.call()}catch(b){k[f]=b}r()})};_type.isArray(b)||(b=[b]);f=b.length;for(var l=0;l<f;l+=1)p(l);return q};d.is=function(b){return b instanceof d?!0:!1};d.buildPromise=function(b){var c=new d;_type.isObject(b)&&c.then(b.success,b.error);return c};d._continueUntil=function(b,c){return _type.isFunction(b)&&b()?c().then(function(){return d._continueUntil(b,c)}):(new d).fulfill()};
b.Promise=d})(global);
...
0<c.options.userToken.length?c.options.userToken:!1;if(!0===g||n){var p=-1,l=c.headers.filter(function(b,c){return"ut"==b.key?(p=c,!0):!1});if(c.options.ignoreUserToken)-1!=p&&c.headers.splice(p,1);else{var t=n||h;1==l.length?c.headers.forEach(function(b){"ut"==b.key&&(b.value=t)}):c.headers.push({key:"ut",value:t})}}}});this.setUserAuthHeader=function(c,f,d){try{c&&(g=!0,h=c,d||(f||(f=-1),-1==f&&(f=null),b.localStorage.set("Appacitive-UserToken",c),b.localStorage.set("Appacitive-UserTokenExpiry",
...
this.val2.getValue())}};f.prototype=new d;f.prototype.constructor=f;var n=function(c){c=c||"";if(!(c.geoCoord&&c.geoCoord instanceof b.GeoCoord))throw Error("withinCircle filter needs Appacitive.GeoCoord object as argument");d.call(this,c);this.value=c.geoCoord;this.unit=c.unit||"mi";this.distance=c.distance||5;this.toString=function(){return String.format("{0}{1} {2} {3},{4} {5}",this.getFieldType(),this.field.toLowerCase(),this.operator,this.value.getValue(),this.distance,this.unit)}};n.prototype=
new d;n.prototype.constructor=f;var q=function(b){b=b||"";if(!b.geoCoords||0===b.geoCoords.length)throw Error("polygon filter needs array of Appacitive.GeoCoord objects as argument");if(3>b.geoCoords.length)throw Error("polygon filter needs atleast 3 Appacitive.GeoCoord objects as arguments");d.call(this,b);this.value=b.geoCoords;var c=function(b){var c="";b.forEach(function(b){c=0===c.length?b.toString():c+(" | "+b.toString())});return c};this.toString=function(){return String.format("{0}{1} {2} {3}",
this.getFieldType(),this.field.toLowerCase(),this.operator,c(this.value))}};q.prototype=new d;q.prototype.constructor=f;var r=function(b){c.call(this);b=b||{};if(!b.tags||!_type.isArray(b.tags)||0===b.tags.length)throw Error("Specify valid tags");this.tags=b.tags;this.operator=b.operator;this.toString=function(){return String.format("{0}('{1}')",this.operator,this.tags.join(","))}};r.prototype=new c;r.prototype.constructor=r;var p=function(b,f){if(!f||!f.length||2>f.length)throw Error("Provide valid or atleast 2 filters");
this.operator=b;this.innerFilters=[];for(var h=0;h<f.length;h+=1){if(!(f[h]instanceof c))throw Error("Invalid filter provided");this.innerFilters.push(f[h])}this.toString=function(){var b=this.operator,c="(";this.innerFilters.forEach(function(f){c=1===c.length?c+(" "+f.toString()):c+String.format(" {0} {1} ",b,f.toString())});return c+=")"}};p.prototype=new c;p.prototype.constructor=p;var l={isEqualTo:"==",notEqualTo:"<>",isGreaterThan:">",isGreaterThanEqualTo:">=",isLessThan:"<",isLessThanEqualTo:"<=",
like:"like",match:"match",between:"between",withinCircle:"within_circle",withinPolygon:"within_polygon",or:"or",and:"and",taggedWithAll:"tagged_with_all",taggedWithOneOrMore:"tagged_with_one_or_more",isNull:"is null",containedIn:"in",isNotNull:"is not null",notIn:"not in"},t=function(c,f){if(null===c||void 0===c||0===c.length)throw Error("Specify value");this.value=c;this.type=f?f:typeof this.value;if("number"===this.type&&!_type.isNumeric(this.value))throw Error("Value should be numeric for filter expression");
this.getValue=function(){return"number"===this.type||_type.isBoolean(this.value)||_type.isNumber(this.value)?this.value:"object"===this.type&&_type.isDate(this.value)?"datetime('"+b.Date.toISOString(this.value)+"')":"object"==this.type&&this.value instanceof b.GeoCoord?this.value.toString():"'"+this.value.toString()+"'"}},y=function(b,c,g){g||(g=this);g.type=b;g.name=c;g.equalTo=function(b){return new d({field:this.name,fieldType:this.type,value:new t(b),operator:l.isEqualTo})};g.notEqualTo=function(b){return new d({field:this.name,
fieldType:this.type,value:new t(b),operator:l.notEqualTo})};g.greaterThan=function(b){return new d({field:this.name,fieldType:this.type,value:new t(b),operator:l.isGreaterThan})};g.greaterThanEqualTo=function(b){return new d({field:this.name,fieldType:this.type,value:new t(b),operator:l.isGreaterThanEqualTo})};g.lessThan=function(b){return new d({field:this.name,fieldType:this.type,value:new t(b),operator:l.isLessThan})};g.lessThanEqualTo=function(b){return new d({field:this.name,fieldType:this.type,
value:new t(b),operator:l.isLessThanEqualTo})};g.like=function(b){return new d({field:this.name,fieldType:this.type,value:new t("*"+b+"*"),operator:l.like})};g.match=function(b){return new d({field:this.name,fieldType:this.type,value:new t("*"+b+"*"),operator:l.match})};g.startsWith=function(b){return new d({field:this.name,fieldType:this.type,value:new t(b+"*"),operator:l.like})};g.endsWith=function(b){return new d({field:this.name,fieldType:this.type,value:new t("*"+b),operator:l.like})};g.contains=
function(b){return new e({field:this.name,fieldType:this.type,value:b,operator:l.isEqualTo})};g.containedIn=function(b){return new h({field:this.name,fieldType:this.type,value:b,operator:l.containedIn})};g.isNull=function(){return new k({field:this.name,fieldType:this.type,operator:l.isNull})};g.notIn=function(b){return new h({field:this.name,fieldType:this.type,value:b,operator:l.notIn})};g.isNotNull=function(){return new k({field:this.name,fieldType:this.type,operator:l.isNotNull})};g.between=function(b,
c){return new f({field:this.name,fieldType:this.type,val1:new t(b),val2:new t(c),operator:l.between})};g.withinCircle=function(b,c,f){return new n({field:this.name,fieldType:this.type,geoCoord:b,distance:c,unit:f,operator:l.withinCircle})};g.withinPolygon=function(b){return new q({field:this.name,fieldType:this.type,geoCoords:b,operator:l.withinPolygon})}},w=function(b){if(!b||0===b.length)throw Error("Specify field name");this.field=b;y("property",b,this);return this},u=function(b){if(!b||0===b.length)throw Error("Specify field name");
this.field=b;var c=new y("aggregate",b);this.equalTo=function(b){return c.equalTo(b)};this.notEqualTo=function(b){return c.notEqualTo(b)};this.greaterThan=function(b){return c.greaterThan(b)};this.greaterThanEqualTo=function(b){return c.greaterThanEqualTo(b)};this.lessThan=function(b){return c.lessThan(b)};this.lessThanEqualTo=function(b){return c.lessThanEqualTo(b)};this.between=function(b,f){return c.between(b,f)};this.contains=function(b){return c.contains(b)};return this},z=function(b){if(!b||
0===b.length)throw Error("Specify field name");this.field=b;var c=new y("attribute",b);this.like=function(b){return c.like(b)};this.match=function(b){return c.match(b)};this.startsWith=function(b){return c.startsWith(b)};this.endsWith=function(b){return c.endsWith(b)};this.equalTo=function(b){return c.equalTo(b)};this.contains=function(b){return c.contains(b)};return this};b.Filter={Property:function(b){return new w(b)},Aggregate:function(b){return new u(b)},Attribute:function(b){return new z(b)},
Or:function(){return new p(l.or,arguments)},And:function(){return new p(l.and,arguments)},taggedWithOneOrMore:function(b){return new r({tags:b,operator:l.taggedWithOneOrMore})},taggedWithAll:function(b){return new r({tags:b,operator:l.taggedWithAll})}}})(global);
...
(c=arguments[0],this):c};this.isAscending=function(){return 1===arguments.length?(f=void 0===arguments[0]||null==arguments[0]?!1:arguments[0],this):f};this.orderBy(b.orderBy);this.isAscending(b.isAscending)};d.prototype.toString=function(){return this.orderBy()&&0<this.orderBy().length?"orderBy="+this.orderBy()+"&isAsc="+this.isAscending():""};var e=function(h){var e=h||{},f="",g="",q="",r=e.queryType||"BasicQuery",p=new c(h),l=new d(h),t=e.type||e.relation,y=e.relation?"connection":"object",w=this;
e.entity&&(this.entity=e.entity);this.type=function(){return y};this.entityType=function(){return t};this.queryType=function(){return r};this.pageQuery=function(){return p};this.pageNumber=function(){return 1===arguments.length?(p.pageNumber(arguments[0]),this):p.pageNumber()};this.pageSize=function(){return 1===arguments.length?(p.pageSize(arguments[0]),this):p.pageSize()};this.sortQuery=function(){return l};this.orderBy=function(){return 1===arguments.length?(l.orderBy(arguments[0]),this):l.orderBy()};
this.isAscending=function(){return 1===arguments.length?(l.isAscending(arguments[0]),this):l.isAscending()};this.filter=function(){return 1===arguments.length?(f=arguments[0],this):f};this.freeText=function(){if(1===arguments.length){var b=arguments[0];_type.isString(b)?g=arguments[0]:_type.isArray(b)&&b.length&&(g=arguments[0].join(" "));return this}return g};this.fields=function(){if(1===arguments.length){var b=arguments[0];_type.isString(b)?q=b:_type.isArray(b)&&b.length&&(q=b.join(","));return this}return q};
this.filter(e.filter||"");this.freeText(e.freeText||"");this.fields(e.fields||"");this.setFilter=function(b){this.filter(b)};this.setFreeText=function(b){this.freeText(b)};this.setFields=function(b){this.fields(b)};this.extendOptions=function(b){for(var f in b)e[f]=b[f];p=new c(e);l=new d(e);return this};this.getQueryString=function(){var b=p.toString(),c=l.toString();c&&(b+="&"+c);this.filter()&&(c=encodeURIComponent(this.filter().toString()),0<c.trim().length&&(b+="&query="+c));this.freeText()&&
...
this.data.placeholders[g]}this.toRequest=function(c){var f=new b.HttpRequest,d=this.toUrl();f.url=d.url;f.description=d.description;f.method="post";f.data=this.data;f.options=c;return f};this.toUrl=function(){return{url:b.config.apiBaseUrl+"search/"+this.name+"/project",description:"Project Query with name "+this.name}};var r=function(c){var f,d;for(d in c)if("status"!==d){f=c[d];break}var h=function(c,f,d,e,g){var l=[];c.forEach(function(c){var q=c.__children;delete c.__children;var n=c.__edge;delete c.__edge;
c=b.Object._create(_extend({__meta:e},c),!0);c.children={};for(var k in q)c.children[k]=[],c.children[k]=h(q[k].values,q[k].parent,c.id,q[k].__nodemeta,q[k].__edgemeta);n&&(n.__endpointa={objectid:d,label:f},n.__endpointb={objectid:c.id,label:n.__label},delete n.__label,c.connection=b.Connection._create(_extend({__meta:g},n),!0));l.push(c)});return l};return h(f.values,null,null,f.__nodemeta)};this.collection=function(c,f){f=f||{};_type.isObject(c)&&(f=c,c=null);c||(c=this.results?ths.results:[]);
...
b[f];_type.isArray(d)?(c[f]=[],d.forEach(function(b){(b=n(b))&&c[f].push(b)})):c[f]=n(b[f])}return c};b._decode=function(b){var c={},h=_extend({},d,k(b));delete b.__meta;for(var e in b)_type.isArray(b[e])?(c[e]=[],b[e].forEach(function(b){b=h[e]?f[h[e]](b):b;c[e].push(b)})):_type.isString(b[e])?c[e]=h[e]?f[h[e]](b[e]):b[e]:c[e]=b[e];return c};g=function(d,e){var g={};e=e||{};d=d||{};d=_deepExtend({},d);this.meta={};d.__meta=_extend(this.meta,d.__meta);e&&e.parse&&(d=this.parse(d));_type.isObject(this.defaults)&&
!e.setSnapShot&&(d=_deepExtend({},this.defaults,d));e&&e.collection&&(this.collection=e.collection);d=b._decode(d);var l=this,n=function(c,f){c.__meta=_extend(l.meta,c.__meta);l.meta=c.__meta;k(c);var d=b._decode(c),e;for(e in d)e==l.idAttribute&&(l.id=d[e]),w[e]&&delete w[e],u[e]&&delete u[e],z[e]&&delete z[e],h(d[e])?f[e]=d[e]:_type.isObject(d[e])?f[e]=_deepExtend({},f[e],d[e]):_type.isArray(d[e])?(f[e]=[],d[e].forEach(function(b){if(h(b)||"__link"==e)f[e].push(b);else throw Error("Multivalued property cannot add object or array as property of object");
})):f[e]=d[e]},k=function(c,f){var d={id:"id",__id:"id",__utclastupdateddate:"lastUpdatedAt",__utcdatecreated:"createdAt",__createdby:"createdBy",__updatedby:"lastUpdatedBy"};"id __id __utclastupdateddate __utcdatecreated __createdby __updatedby".split(" ").forEach(function(e){c[e]&&("__utcdatecreated"!==e&&"__utclastupdateddate"!==e||_type.isDate(c[e])?l[d[e]]=c[e]:l[d[e]]=b.Date.parseISODate(c[e]),f&&delete c[e])})};this.base=b.Object.prototype;this.cid=parseInt(1E8*Math.random(),10);this.idAttribute=
...
{});var v=[];m.__tags||(m.__tags=[]);g.__tags||(g.__tags=[]);this.attributes=m;var A="";k(this.attributes);var E="__id __revision __endpointa __endpointb __createdby __lastmodifiedby __type __relationtype __typeid __relationid __utcdatecreated __utclastupdateddate __tags __authType __link __acls __meta".split(" "),F=function(b){b=b||{};b.message=b.message||"Server error";b.code=b.code||"500";return b};this.getObject=function(){var c=b._encode(_deepExtend({__meta:this.meta},m));"connection"==l.type&&
(c.__endpointa=m.__endpointa.toJSON(),c.__endpointb=m.__endpointb.toJSON());Object.prototype.hasOwnProperty("id")&&(c.__id=this.id);return c};var M=function(){var b=_deepExtend({__meta:this.meta},m);"connection"==l.type&&(m.__endpointa=m.__endpointa.toJSON(),m.__endpointb=m.__endpointb.toJSON());this.hasOwnProperty("id")&&this.id&&(b.__id=this.id);return b};this.toJSON=function(b){if(b&&"object"==this.type){var c=function(b){var f=[];b.forEach(function(b){var d=b.toJSON();if(b.children&&!Object.isEmpty(b.children)){d.children=
...
C(h,d[h],m[h],c),void 0===e?delete d[h]:(f=!0,d[h]=e);try{E.forEach(function(b){d[b]&&delete d[b]})}catch(n){}c&&(d=b._encode(d));h=H();c?(h&&0<h.length&&(d.__addtags=h,f=!0),v&&0<v.length&&(d.__removetags=v,f=!0)):h&&0<h.length&&(d.__tags=h,f=!0);(c=G())&&!Object.isEmpty(c)?(d.__attributes=c,f=!0):delete d.__attributes;"object"==l.type&&l._aclFactory&&(c=l._aclFactory.getChanged())&&(f=!0,d.__acls=c);return f&&!Object.isEmpty(d)?d:!1};this.changed=function(){return this.isNew()?this.toJSON():D()};
this.hasChanged=function(){return this.isNew()?!0:0===arguments.length?Object.isEmpty(D(!0))?!1:!0:1==arguments.length&&_type.isString(arguments[0])&&0<arguments[0].length?void 0==C(arguments[0],g[arguments[0]],m[arguments[0]])?!1:!0:!1};this.changedAttributes=function(){if(this.isNew())return this.toJSON();if(0===arguments.length)return D();if(1==arguments.length&&_type.isArray(arguments[0])&&arguments[0].length){var b={};arguments[0].forEach(function(c){c=C(c,g[c],m[c]);void 0!=c&&b.push(c)});return b}return!1};
this.previous=function(){return this.isNew()?null:1==arguments.length&&_type.isString(arguments[0])&&arguments[0].length?g[arguments[0]]:null};this.previousAttributes=function(){return this.isNew()?null:_extend({},g)};this.fields=function(){if(1==arguments.length){var b=arguments[0];_type.isString(b)?A=b:_type.isArray(b)&&(A=b.join(","));return this}return A};this.get=function(b,c){if(b){if(c&&f[c.toLowerCase()]){if(f[c.toLowerCase()])return f[c.toLowerCase()](m[b]);throw Error('Invalid cast-type "'+
c+'"" provided for get "'+b+'"');}return m[b]}};this.tryGet=function(b,c,f){b=this.get(b,f);return void 0!==b?b:c};var B=function(b,c){if(c&&!c.silent){var f=C(b,g[b],m[b]);if(void 0!=f[b]||-1!=E.indexOf(b))l.trigger("change:"+b,l,f[b]||m[b],{}),c.ignoreChange||l.trigger("change",l,c)}},J=function(b){b&&!b.silent&&l.trigger("destroy",l,l.collection,b)};this._triggerError=function(b,c){b.silent||l.trigger("error",l,c,b)};var N=function(b,f,d){if(!b||!_type.isString(b)||0===b.length||0===b.trim().indexOf("$"))return this;
b=b.toLowerCase();try{if(_type.isNullOrUndefined(f))m[b]=null;else if(h(f))m[b]=f;else if(_type.isObject(f))if(-1!==c.indexOf(b))m[b]=f;else throw Error("Property cannot have value as an object");else _type.isArray(f)&&(m[b]=[],f.forEach(function(c){if(h(c))m[b].push(c);else throw Error("Multivalued property cannot have values of property as an object");}));delete w[b];delete u[b];delete z[b];_type.isEqual(m[b],g[b])||(z[b]=!0);b==l.idAttribute&&(l.id=f);return this}catch(e){throw Error("Unable to set "+
b);}};this.set=function(b,c,f){var d,e;if(null==b)return this;null==b||"object"===typeof b?(e=b,f=c):(e={})[b]=c;f||(f={});if(!this._validate(e,f))return!1;this.idAttribute in e&&(this.id=e[this.idAttribute]);k(e);var h=!1;for(d in e)c=e[d],N.apply(this,[d,c,_extend({},f,{ignoreChange:!0})]);if(f&&!f.silent)for(d in e)if(void 0!=C(d,g[d],m[d])||-1!=E.indexOf(d))h=!0,l.trigger("change:"+b,l,m[b],{});h&&this.trigger("change",this,f);return this};this.unset=function(b,c){if(!b||!_type.isString(b)||0===
b.length||0===b.indexOf("__"))return this;b=b.toLowerCase();delete m[b];B(b,c);return this};this._validate=function(b,c){if(!c.validate||!this.validate||!_type.isFunction(this.validate))return!0;b=_extend({},this.attributes,b);var f=this.validationError=this.validate(b,c)||null;if(!f)return!0;this.trigger("invalid",this,f,_extend(c,{validationError:f}));return!1};this.isValid=function(b){return this._validate({},_extend(b||{},{validate:!0}))};this.has=function(b){return b&&_type.isString(b)&&0!==
b.length?m[b]&&!_type.isUndefined(m[b])?!0:!1:!1};this.isNew=function(){return!(!_type.isNullOrUndefined(this.id)||this.has(this.idAttribute))};this.clone=function(){return"object"==this.type?b.Object._create(_deepExtend({__meta:this.meta},this.getObject())):new b.connection._create(_deepExtend({__meta:this.meta},this.getObject()))};this.copy=function(b,c){b&&(n(b,m),c&&n(b,g));return this};this.mergeWithPrevious=function(){n(m,g);l._aclFactory&&l._aclFactory.merge();k(g);v=[];w={};u={};z={};return this};
var K=function(){n(g,m);l._aclFactory&&l._aclFactory.merge();k(m);v=[];w={};u={};z={}};this.rollback=function(){m=x={};K();return this};var L=function(b,c,f,d){if(!b||!_type.isString(b)||0===b.length||0===b.indexOf("__"))return this;b=b.toLowerCase();if(_type.isObject(m[b])||_type.isArray(m[b]))throw Error("Cannot increment/decrement array/object");try{_type.isObject(c)?(d=c,c=f):c=!c||isNaN(Number(c))?f:Number(c)*f,m[b]=isNaN(Number(m[b]))?c:Number(m[b])+c,l.isNew()||(w[b]={value:(w[b]?w[b].value:
0)+c})}catch(e){throw Error("Cannot perform increment/decrement operation");}B(b,d);return l};this.increment=function(b,c,f){return L(b,c,1,f)};this.decrement=function(b,c,f){return L(b,c,-1,f)};this._findUnsavedChanges=function(){var b={object:null,isNested:!1};if(this.id)b.object=D(!0);else{var c=l.getObject();delete c.__meta;for(var f in c)"$"==f[0]&&delete c[f];c.__revision&&delete c.__revision;"object"==l.type&&l._aclFactory&&(f=l._aclFactory.getChanged())&&(c.__acls=f);c.__tags&&0==c.__tags.length&&
delete c.__tags;Object.isEmpty(c.__attributes)&&delete c.__attributes;"connection"==l.type&&(c.__endpointa.objectid&&delete c.__endpointa.object,c.__endpointb.objectid&&delete c.__endpointb.object);b.object=c}return b};this.getType=function(){var b=l.type;!m.__type||"user"!=m.__type.toLowerCase()&&"device"!=m.__type.toLowerCase()||(b=m.__type.toLowerCase());return b};this._parseOutput=function(c,f){var d=l.getType(),e;c=c||{};if(f&&f[d]){c&&c.parse&&(f[d]=this.parse(f[d]));var h=this.isNew(),n=!1;
"connection"==l.type&&m.__endpointa&&f[d].__endpointa.label!=m.__endpointa.label&&(n=f[d].__endpointa,f[d].__endpointa=f[d].__endpointb,f[d].__endpointb=n,n=!0);g=b._decode(_extend({__meta:_extend(l.meta,f.__meta)},f[d]));l.id=m[l.idAttribute]=f[d][l.idAttribute];K();h?("connection"==l.type&&(c._batch||(n?(m.__endpointa.object&&f.__bmeta&&(m.__endpointa.object.__meta=f.__bmeta),m.__endpointb.object&&f.__ameta&&(m.__endpointb.object.__meta=f.__ameta)):(m.__endpointa.object&&f.__ameta&&(m.__endpointa.object.__meta=
f.__ameta),m.__endpointb.object&&f.__bmeta&&(m.__endpointb.object.__meta=f.__bmeta))),l.parseConnection(c._batch)),l.trigger("change:__id",l,l.id,{}),b.eventManager.fire(l.entityType+"."+d+".created",l,{object:l}),l.created=!0):b.eventManager.fire(l.entityType+"."+d+"."+l.id+".updated",l,{object:l});c.silent||l.trigger("sync",l,f[d],c)}else f=f||{},f.status=f.status||{},e=F(f.status),l._triggerError(c,new b.Error(e)),l.isNew()?b.eventManager.fire(l.entityType+"."+d+".createFailed",l,{error:e}):b.eventManager.fire(l.entityType+
"."+d+"."+l.id+".updateFailed",l,{object:e});return e};this._save=function(){return this.id?O.apply(this,arguments):P.apply(this,arguments)};var P=function(c){c=c||{};var f=l.getType(),d=l._findUnsavedChanges(),e=new b._Request({method:"PUT",type:f,op:"getCreateUrl",args:[this.className,A],data:d.object,options:c,entity:l,onSuccess:function(b){(b=l._parseOutput(c,b))?e.promise.reject(b,l):e.promise.fulfill(l)}});return e.send()},O=function(c,f){b.Promise.is(f)||(f=b.Promise.buildPromise(c));var d=
l._findUnsavedChanges();c=c||{};if(Object.isEmpty(d.object))f.fulfill(l);else{var e=l.type,h=[l.className,l.id,A];m&&m.__type&&("user"==m.__type.toLowerCase()||"device"==m.__type.toLowerCase())&&(e=m.__type.toLowerCase(),h.splice(0,1));var g=new b._Request({method:"POST",type:e,op:"getUpdateUrl",args:h,data:d.object,options:c,entity:l,onSuccess:function(b){(b=l._parseOutput(c,b))?g.promise.reject(b,l):g.promise.fulfill(l)}});return g.send()}return f},Q=function(c){if(!l.id)throw Error("Please specify id for get operation");
c=c||{};var f=l.getType(),d=new b._Request({method:"GET",type:f,op:"getGetUrl",args:[this.className,l.id,A],options:c,entity:l,onSuccess:function(e){e&&e[f]?(c&&c.parse&&(e[f]=l.parse(e[f])),g=b._decode(_extend({__meta:_extend(l.meta,e.__meta)},e[f])),n(g,m),k(m),l._aclFactory&&l._aclFactory._rollback(),e.connection&&(l.endpoints||l.endpointA&&l.endpointB||l.setupConnection(m.__endpointa,m.__endpointb)),c.silent||l.trigger("sync",l,e[f],c),b.eventManager.fire(l.entityType+"."+f+"."+l.id+".fetched",
l,{object:l}),d.promise.fulfill(l)):(e=e||{},e.status=e.status||{},e.status=F(e.status),l._triggerError(c,new b.Error(e.status)),d.promise.reject(e.status,l))}});return d.send()};this._fetch=function(b){return Q.apply(this,[b])};this.del=this._destroy=function(c){c=c||{};var f=c.deleteConnections;_type.isBoolean(c)&&(f=c,c={});c.wait||J(c);if(!l.id)return(new b.Promise.buildPromise(c)).fulfill();var d=l.getType(),e=new b._Request({method:"DELETE",type:d,op:"getDeleteUrl",args:[this.className,l.id,
f],options:c,entity:this,onSuccess:function(f){f&&f.status?(m={},g={},c.wait&&J(c),e.promise.fulfill(f.status)):(f=f||{},f.status=f.status||{},f.status=F(f.status),l._triggerError(c,new b.Error(f.status)),e.promise.reject(f.status,l))}});return e.send()};"object"==this.type&&(this._destroyWithConnections=function(b){return this.destroy(_extend({deleteConnections:!0},b))})};g.prototype.save=function(){return this._save.apply(this,arguments)};g.prototype.fetch=function(){return this._fetch.apply(this,
arguments)};g.prototype.destroy=function(){return this._destroy.apply(this,arguments)};g.prototype.destroyWithConnections=function(){return this._destroyWithConnections.apply(this,arguments)};b.BaseObject=g;b.BaseObject._saveAll=function(c,f,d){var e=new b.Batch;f=f||{};if(!_type.isArray(c))throw Error("Provide an array of objects for Object.saveAll");c.forEach(function(c){c instanceof b.BaseObject||!_type.isObject(c)||(c=new b[this.className||d](c));e.add(c)});return e.execute(f)};b.BaseObject.prototype.toString=
function(){return JSON.stringify(this.getObject())};b.BaseObject.prototype.parse=function(b,c){return b};b.BaseObject.prototype.escape=function(b){return _.escape(this.get(b))};b.Events.mixin(b.BaseObject.prototype)})(global);
...
(function(g){var b=g.Appacitive,c=["allow","deny"],d=["create","read","update","delete","manageaccess"],e=function(b){var c=[];b.forEach(function(b){_type.isString(b)&&-1!=d.indexOf(b.toLowerCase())&&c.push(b.toLowerCase())});return c};b._Acl=function(h,g){var f=h||[];_type.isArray(f)||(f=[]);var n={};g&&(n=JSON.parse(JSON.stringify(f)));this.acls=f=JSON.parse(JSON.stringify(f));var q=[],r=function(d,h,g,l){if(!g)throw Error("Specify valid user or usergroup");g instanceof b.Object&&"user"==g.typeName&&
!g.isNew()&&(g=g.id);var n=f.filter(function(b){return b.sid==g&&b.type==h});n&&0!=n.length?n=n[0]:(n={sid:g,type:h,deny:[],allow:[]},f.push(n));n.allow||(n.allow=[]);n.deny||(n.deny=[]);l=e(l);var k=q.filter(function(b){return b.sid==g&&b.type==h});k&&0!=k.length?k=k[0]:(k={sid:g,type:h},q.push(k));l.forEach(function(b){for(var f=0;f<c.length;f+=1){var e=n[c[f]].indexOf(b);if(-1!=e){n[c[f]].splice(e,1);break}}"dontcare"!=d&&n[d].push(b);k[b]=d});return this},p=function(b,c,f,d){if(!f)throw Error("Please provide valid id or name for setting acls");
if(!d)throw Error("Please provide valid access permissions for setting acls");_type.isArray(d)||(d=[d]);_type.isArray(f)?f.forEach(function(f){r(b,c,f,d)}):r(b,c,f,d);return this},l=function(){f.allowUser=function(b,c){return p.apply(this,["allow","user",b,c])};f.allowGroup=function(b,c){return p.apply(this,["allow","usergroup",b,c])};f.denyUser=function(b,c){return p.apply(this,["deny","user",b,c])};f.denyGroup=function(b,c){return p.apply(this,["deny","usergroup",b,c])};f.resetUser=function(b,c){return p.apply(this,
...
(function(g){var b=g.Appacitive,c=function(c,d){c=c||{};c.__type="user";b.Object.call(this,c,d);return this},d=null;c.currentUser=c.current=function(){return d};var e=function(c,d,e){var g=this.get("__id");if(!g||!_type.isString(g)||0===g.length)throw Error("Please specify valid userid");if(!c||!_type.isString(c)||0===c.length)throw Error("Please specify valid oldPassword");if(!d||!_type.isString(d)||0===d.length)throw Error("Please specify valid newPassword");var h=this,l=new b._Request({method:"POST",
type:"user",op:"getUpdatePasswordUrl",args:[g],options:e,data:{oldpassword:c,newpassword:d},entity:this,onSuccess:function(b){l.promise.fulfill(h)}});return l.send()},h=function(c,d){var e=this.get("__id");if(!this.get("__id"))return this.set("__link",c),b.Promise.buildPromise(d).fulfill(this);var g=this,h=new b._Request({method:"POST",type:"user",op:"getLinkAccountUrl",args:[e],options:d,data:c,entity:this,onSuccess:function(b){b=g.get("__link");_type.isArray(b)||(b=b?[b]:[]);b.push(c);g.copy({__link:b},
...
return(new b.User(c)).save(d)};c.createUser=c.createNewUser;c.signup=function(c,d){var e=this,g=b.Promise.buildPromise(d);this.createUser(c).then(function(){e.login(c.username,c.password).then(function(){g.fulfill.apply(g,arguments)},function(b){g.reject.apply(g,arguments)})},function(){g.reject.apply(g,arguments)});return g};c.authenticateUser=function(c,e,h){e=e||{};c.expiry||(c.expiry=864E5);var k=this,p;_type.isString(h)&&_type.isObject(e.user)&&(c.user=e.user instanceof g.Appacitive.User?e.user.toJSON():
e.user,delete c.user.__meta,p=e.user);var l=new b._Request({method:"POST",type:"user",op:"getAuthenticateUserUrl",options:e,data:c,onSuccess:function(e){e&&e.user?(h&&(e.user.__authType=h),_extend(e.user,{__meta:e.__meta}),p instanceof g.Appacitive.User&&(e.user=p.copy(e.user,!0)),k.setCurrentUser(e.user,e.token,c.expiry),b.User.trigger("login",d,d,e.token),l.promise.fulfill({user:d,token:e.token})):l.promise.reject(e.status)}});return l.send()};c.login=function(b,c,d){if(!b||!c||0==b.length||0==
...
getObject:function(b){return this.models.map(function(d){return d.getObject(b)})},add:function(b,d){d=d||{};var e,g,k,f,n,q={},r={},p=[],l=d.sort,t;b=_type.isArray(b)?b.slice():[b];e=0;for(g=b.length;e<g;e++){b[e]=this._prepareModel(b[e]);k=b[e];if(!k)throw Error("Can't add an invalid model to a collection");f=k.cid;if(q[f]||this._byCid[f])throw Error("Duplicate cid: can't add the same model to a collection twice");(n=k.id)&&((t=r[n])||(t=this._byId[n]))?(t.copy(k.getObject(),d.setSnapShot),t.children=
k.children):(r[n]=k,q[f]=k,p.push(k),this._addReference(k,d))}this.models.splice.apply(this.models,[null!=d.at?d.at:this.models.length,0].concat(p));l&&this.comparator&&this.sort({silent:!0});this.length=this.models.length;if(d.silent)return this;e=0;for(g=p.length;e<g;e++)k=p[e],d.index=e,k.trigger("add",k,this,d);return this},remove:function(b,d){var e,g,k,f;d=d||{};b=_type.isArray(b)?b.slice():[b];e=0;for(g=b.length;e<g;e++)if(f=this.getByCid(b[e])||this.get(b[e]))delete this._byId[f.id],delete this._byCid[f.cid],
...
this.save=function(b,c){"number"!==typeof b&&(c=b,b=-1);return this.fileId&&_type.isString(this.fileId)&&0<this.fileId.length?f(b,c):k(b,c)};var k=function(c,f){if(!d.fileData)throw Error("Please specify filedata");if(!d.contentType)try{d.contentType=d.fileData.type}catch(k){}d.contentType&&_type.isString(d.contentType)&&0!==d.contentType.length||(d.contentType="text/plain");var p=b.Promise.buildPromise(f),l=b.config.apiBaseUrl+b.storage.urlFactory.file.getUploadUrl(d.contentType,d.fileId?d.fileId:
"");e(l,function(b){g(b.url,d.fileData,d.contentType,function(){d.fileId=b.id;d.getDownloadUrl(c,f).then(function(b){return p.fulfill(b,d)},function(b){return p.reject(b)})},p)},p," Get upload url for file ",f);return p},f=function(c,f){if(!d.fileData)throw Error("Please specify filedata");if(!d.contentType)try{d.contentType=d.fileData.type}catch(k){}d.contentType&&_type.isString(d.contentType)&&0!==d.contentType.length||(d.contentType="text/plain");var p=b.Promise.buildPromise(f),l=b.config.apiBaseUrl+
b.storage.urlFactory.file.getUpdateUrl(d.fileId,d.contentType);e(l,function(b){g(b.url,d.fileData,d.contentType,function(){d.getDownloadUrl(c,f).then(function(b){p.fulfill(b,d)},function(b){p.reject(b)})},p)},p," Get update url for file "+d.fileId,f);return p};this.destroy=function(c){if(!this.fileId)throw Error("Please specify fileId to delete");var e=b.Promise.buildPromise(c),f=new b.HttpRequest;f.url=b.config.apiBaseUrl+b.storage.urlFactory.file.getDeleteUrl(this.fileId);f.method="DELETE";f.description=
...
(function(g){g=g.Appacitive;g.Date={};var b=function(b){return 10>b?"0"+b:b};g.Date.parseISODate=function(b){try{if(!/^([0-9]{1,4})-([0-9]{1,2})-([0-9]{1,2})T([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2})(.([0-9]+))?Z?$/.exec(b))return new Date(b);var d=b.split("T"),e=d[0].split("-"),g=d[1].split("Z")[0].split(":"),k=g[2].split("."),f=Number(g[0]),n=new Date;n.setUTCFullYear(Number(e[0]));n.setUTCDate(Number(e[2]));n.setUTCMonth(Number(e[1])-1);n.setUTCHours(Number(f));n.setUTCMinutes(Number(g[1]));n.setUTCSeconds(Number(k[0]));
k[1]&&n.setUTCMilliseconds(Number(k[1].substring(0,3)));return n}catch(q){return null}};g.Date.toISOString=function(b){try{return b=b.toISOString(),b=b.replace("Z","0000Z")}catch(d){return null}};g.Date.toISODate=function(c){if(c instanceof Date)return String.format("{0}-{1}-{2}",c.getFullYear(),b(c.getMonth()+1),b(c.getDate()));throw Error("Invalid date provided Appacitive.Date.toISODate method");};g.Date.toISOTime=function(c){var d=function(b){return 10>b?b+"000000":100>b?b+"00000":1E3>b?b+"0000":
...
(d.setUTCHours(Number(f)),d.setUTCMinutes(Number(g[1])),d.setUTCSeconds(Number(k[0])),k[1]&&d.setUTCMilliseconds(Number(k[1].substring(0,3)))):(d.setHours(Number(f)),d.setMinutes(Number(g[1])),d.setSeconds(Number(k[0])),k[1]&&d.setMilliseconds(Number(k[1].substring(0,3))));return d}catch(n){return null}}})(global);
