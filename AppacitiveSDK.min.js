...
d,f(b))},getUpdateUrl:function(d,b,a){return String.format("{0}/{1}/{2}?fields={3}",this.connectionServiceUrl,d,b,f(a))},getDeleteUrl:function(d,b){return String.format("{0}/{1}/{2}",this.connectionServiceUrl,d,b)},getMultiDeleteUrl:function(d){return String.format("{0}/{1}/bulkdelete",this.connectionServiceUrl,d)},getSearchByArticleUrl:function(d,b,a,c){var e="",e=String.format("{0}/{1}/find/all?label={2}&articleid={3}",this.connectionServiceUrl,d,a,b);if("undefined"!==typeof c&&0<c.length)for(d=
0;d<c.length;d+=1)e=e+"&"+c[d];return e},getConnectedArticles:function(d,b,a){var c="",c=String.format("{0}/{1}/{2}/find",this.connectionServiceUrl,d,b);if(a&&a.length&&0<a.length)for(d=0;d<a.length;d+=1)c=0==d?c+("?"+a[d]):c+("&"+a[d]);return c},getInterconnectsUrl:function(){return String.format("{0}/interconnects",this.connectionServiceUrl)},getPropertiesSearchUrl:function(d,b){return String.format("{0}/{1}/find/all?properties=",this.connectionServiceUrl,d,b)}};this.cannedList={cannedListServiceUrl:"list",
...
c){var e=c.split("="),h=e[1];2<e.length&&e.forEach(function(a){0==a||1==a||(h=h+"="+e[a])});e[0].toLowerCase()==d&&(b=[e[0],h])}),b):location.search.split("?")[1].split("=")}}}})(global);
...
function(){return JSON.parse(JSON.stringify(c))};this.toJSON=function(){return c};this.__defineGetter__("id",function(){return this.get("__id")});this.__defineSetter__("id",function(a){this.set("__id",a)});c.__attributes||(c.__attributes={});b.__attributes||(b.__attributes={});this.attributes=function(){if(0===arguments.length)c.__attributes||(c.__attributes={});else{if(1==arguments.length)return c.__attributes||(c.__attributes={}),c.__attributes[arguments[0]];if(2==arguments.length){if("string"!==
typeof arguments[1]&&null!=arguments[1])throw Error("only string values can be stored in attributes.");c.__attributes||(c.__attributes={});c.__attributes[arguments[0]]=arguments[1]}else throw Error(".attributes() called with an incorrect number of arguments. 0, 1, 2 are supported.");}return c.__attributes};var m=function(){var a=!1,d=JSON.parse(JSON.stringify(b.__attributes)),e;for(e in c.__attributes)"undefined"==typeof c.__attributes[e]||null===c.__attributes[e]?(d[e]=null,a=!0):c.__attributes[e]!=
b.__attributes[e]?(d[e]=c.__attributes[e],a=!0):c.__attributes[e]==b.__attributes[e]&&delete d[e];return!a?null:d};this.getChangedAttributes=m;this.aggregates=function(){var a={},b;for(b in c){if(!c.hasOwnProperty(b))return;"$"==b[0]&&(a[b]=c[b])}if(0===arguments.length)return a;if(1==arguments.length)return a[arguments[0]];throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");};var l=[];c.__tags||(c.__tags=[]);b.__tags||(b.__tags=[]);this.__defineGetter__("tags",
function(){return!c.__tags?[]:c.__tags});this.addTag=function(a){if(!a||"string"!=typeof a||!a.length)return this;c.__tags.push(a);c.__tags=Array.distinct(c.__tags);if(!l||!l.length)return this;a=l.indexOf(a);-1!=a&&l.splice(a,1);return this};this.removeTag=function(a){if(!a||"string"!=typeof a||!a.length)return this;l.push(a);l=Array.distinct(l);if(!c.__tags||!c.__tags.length)return this;a=c.__tags.indexOf(a);-1!=a&&c.__tags.splice(a,1);return this};var p=function(){var a=[];c.__tags.every(function(c){-1==
b.__tags.indexOf(c)&&a.push(c)});return a};this.getChangedTags=p;this.getRemovedTags=function(){return _removetags};var n=function(a){var d=!1,e=JSON.parse(JSON.stringify(b)),g;for(g in c)"undefined"==typeof c[g]||null===c[g]?(e[g]=null,d=!0):c[g]!=b[g]?"__tags"==g||"__attributes"==g?delete e[g]:(e[g]=c[g],d=!0):c[g]==b[g]&&delete e[g];try{h.forEach(function(a){e[a]&&delete e[a]})}catch(k){}a?(c.__tags&&0<c.__tags.length&&(e.__addtags=p(),d=!0),l&&0<l.length&&(e.__removetags=l,d=!0)):c.__tags&&0<
c.__tags.length&&(e.__tags=p(),d=!0);(a=m())?(e.__attributes=a,d=!0):delete e.__attributes;return d?e:!1};this.__defineGetter__("changed",function(){return n()});this.hasChanged=function(){var a=n(!0);return 0===arguments.length?a?!0:!1:1==arguments.length&&"string"==typeof arguments[0]&&0<arguments[0].length&&a&&a[arguments[0]]?!0:!1};this.changedAttributes=function(){var a=n(!0);if(0===arguments.length)return a;if(1==arguments.length&&"object"==typeof arguments[0]&&arguments[0].length){var c={};
arguments[0].forEach(function(b){a[b]&&c.push(a[b])});return c}return!1};this.previous=function(){return 1==arguments.length&&"string"==typeof arguments[0]&&arguments[0].length?b[arguments[0]]:null};this.previousAttributes=function(){return b};var q="";this.__defineGetter__("fields",function(){return q});this.__defineSetter__("fields",function(a){"string"==typeof a?q=a:"object"==typeof a&&a.length&&(q=a.join(","))});this.get=function(a){if(a)return c[a]};this.set=function(a,b){if(!a||"string"!=typeof a||
...
function(){return"article"==this.type?new Appacitive.Article(c):new Appacitive.connection(c)};this.copy=function(b){b&&a(b,c);return this};this.save=function(a,b){c.__id?t.apply(this,arguments):r.apply(this,arguments);return this};var r=function(d,g){d=d||function(){};g=g||function(){};var h=this,j=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory[this.type].getCreateUrl(c.__schematype||c.__relationtype,q);if(c.__schematype&&("user"==c.__schematype.toLowerCase()||"device"==c.__schematype.toLowerCase()))j=
e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory[c.__schematype.toLowerCase()].getCreateUrl();var f=new e.Appacitive.HttpRequest;f.url=j;f.method="put";c.__revision&&delete c.__revision;f.data=c;f.onSuccess=function(j){var f=null;if(j&&(j.article||j.connection||j.user||j.device))f=j.article||j.connection||j.user||j.device;j&&f?(b=f,c.__id=f.__id,a(f,c),h.connectionCollections&&0<h.connectionCollections.length&&h.connectionCollections.forEach(function(a){a.getQuery().extendOptions({articleId:c.__id})}),
"connection"==h.type&&h.parseConnection(),e.Appacitive.eventManager.fire((h.schema||h.relation)+"."+h.type+".created",h,{object:h}),"function"==typeof d&&d(h)):(j=j||{},j.status=j.status||{},j.status=k(j.status),e.Appacitive.eventManager.fire((h.schema||h.relation)+"."+h.type+".createFailed",h,{error:j.status}),"function"==typeof g&&g(j.status,h))};f.onError=function(a){a=k(a);"function"==typeof g&&g(a,h)};e.Appacitive.http.send(f);return this},t=function(d,g){d=d||function(){};g=g||function(){};
var h=n(!0),j=this;if(h){var f=new e.Appacitive.HttpRequest,m=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory[this.type].getUpdateUrl(c.__schematype||c.__relationtype,b.__id?b.__id:c.__id,q);if(c&&c.__schematype&&("user"==c.__schematype.toLowerCase()||"device"==c.__schematype.toLowerCase()))m=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory[c.__schematype.toLowerCase()].getUpdateUrl(b.__id);f.url=m;f.method="post";f.data=h;f.onSuccess=function(h){h&&(h.article||h.connection||
h.user||h.device)?(b=h.article||h.connection||h.user||h.device,a(b,c),l=[],e.Appacitive.eventManager.fire((j.schema||j.relation)+"."+j.type+"."+c.__id+".updated",j,{object:j}),"function"==typeof d&&d(j)):(h=h||{},h.status=h.status||{},h.status=k(h.status),e.Appacitive.eventManager.fire((j.schema||j.relation)+"."+j.type+"."+c.__id+".updateFailed",j,{object:h.status}),"function"==typeof g&&g(h.status,j))};f.onError=function(a){a=a||{};a.message=a.message||"Server error";a.code=a.code||"500";"function"==
typeof g&&g(a,j)};e.Appacitive.http.send(f)}else"function"==typeof d&&d(j);return this};this.fetch=function(d,g){d=d||function(){};g=g||function(){};if(c.__id){var h=this,j=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory[this.type].getGetUrl(c.__schematype||c.__relationtype,c.__id,q),f=new e.Appacitive.HttpRequest;f.url=j;f.method="get";f.onSuccess=function(e){e&&(e.article||e.connection||e.user||e.device)?(b=e.article||e.connection||e.user||e.device,a(b,c),h.___collection&&"article"==
h.___collection.collectionType&&h.___collection.addToCollection(h),"function"==typeof d&&d(h)):(e=e||{},e.status=e.status||{},e.status=k(e),"function"==typeof g&&g(e.status,h))};f.onError=function(a){a=k(a);"function"==typeof g&&g(a,h)};e.Appacitive.http.send(f);return this}"function"==typeof g&&g({code:"400",message:"Please specify id for get operation"},this)};this.del=function(a,b,d){if(!c.__id&&this.___collection)this.___collection.removeByCId(g),"function"==typeof a&&a(this);else{a=a||function(){};
b=b||function(){};d=d||{};var h=this,j=e.Appacitive.config.apiBaseUrl,j=j+e.Appacitive.storage.urlFactory[this.type].getDeleteUrl(c.__schematype||c.__relationtype,c.__id);if(c&&c.__schematype&&("user"==c.__schematype.toLowerCase()||"device"==c.__schematype.toLowerCase()))j=e.Appacitive.config.apiBaseUrl,j+=e.Appacitive.storage.urlFactory[c.__schematype.toLowerCase()].getDeleteUrl(c.__id);d.deleteConnections&&!0===d.deleteConnections&&(j=-1==j.indexOf("?")?j+"?deleteconnections=true":j+"&deleteconnections=true");
d=new e.Appacitive.HttpRequest;d.url=j;d.method="delete";d.onSuccess=function(d){"200"==d.code?(h.___collection&&h.___collection.removeById(c.__id),"function"==typeof a&&a(d)):(d=k(d),"function"==typeof b&&b(d,h))};d.onError=function(a){a=k(a);"function"==typeof b&&b(a,h)};e.Appacitive.http.send(d)}}};e.Appacitive.BaseObject.prototype.toString=function(){return JSON.stringify(this.getObject())}})(global);
...
null:a.slice(c,c+1)[0]};this.addToCollection=function(c){if(!c||c.get("__schematype")!=d)throw Error("Null article passed or schema type mismatch");var b=null;a.forEach(function(a,d){a.get("__id")==c.get("__id")&&(b=d)});null!=b?a.splice(b,1):a.push(c);return this};this.getArticleById=function(c){var b=a.filter(function(a){return a.get("__id")==c});return 1==b.length?b[0]:null};this.getAll=function(){return Array.prototype.slice.call(a)};this.getAllArticles=function(){return Array.prototype.slice.call(a).map(function(a){return a.getArticle()})};
...
function(){return b};var j=["BasicFilterQuery","ConnectedArticlesQuery","GetConnectionsQuery","GetConnectionsBetweenArticlesForRelationQuery"];this.__defineSetter__("query",function(d){if(!d||!d.toRequest)throw Error("Invalid  appacitive query passed to connectionCollection");if(-1==j.indexOf(d.queryType))throw Error("ConnectionCollection only accepts "+j.join(", "));c.length=0;a.length=0;b=d});this.setQuery=function(a){this.query=a;return this};this.reset=function(){d=g=null;c.length=0;a.length=
0;b=null};this.setOptions=f;f(g);this.get=function(c){if(c!=parseInt(c,10))return null;c=parseInt(c,10);return"number"!=typeof c||c>=a.length?null:a.slice(c,c+1)[0]};this.addToCollection=function(c){if(!c||c.get("__relationtype")!=d)throw Error("Null connection passed or relation type mismatch");var b=null;a.forEach(function(a,d){a.get("__id")==c.get("__id")&&(b=d)});null!==b?a.splice(b,1):a.push(c);return this};this.getConnection=function(c){var b=a.filter(function(a){return a.get("__id")==c});return 1==
...
this.getConnectedArticle=function(a){if(!c||0===c.length)return null;var b=c.filter(function(c){return c.get("__id")==a});return 0<b.length?b[0]:null};this.fetch=function(d,g){d=d||function(){};g=g||function(){};a.length=0;var f=b.toRequest();f.onSuccess=function(f){a:{var j=d;f=f||{};var l=f.connections;"GetConnectionsBetweenArticlesForRelationQuery"==b.queryType&&f.connection&&(l=[f.connection]);if(!l)if(f.status&&f.status.code&&"200"==f.status.code)l=[];else{j=f.status||{message:"Server error",
code:400};"function"==typeof g&&g(j,h);break a}if(!l.length||0===l.length)l=[];l.forEach(function(b){b=new e.Appacitive.Connection(b,!0);b.___collection=h;if(b.endpointA.article||b.endpointB.article){var d=b.endpointA.article||b.endpointB.article;d.___collection=h;c.push(d)}try{b.___collection.connectedArticle||delete b.connectedArticle}catch(g){}a.push(b)});j(f.paginginfo||{},h)}};f.onError=function(a){a=a||{message:"Server error",code:400};"function"==typeof g&&g(a)};e.Appacitive.http.send(f);return this};
this.fetchByPageNumber=function(a,c,d){b.getOptions().pageQuery.pageNumber=d;this.fetch(a,c);return this};this.fetchNextPage=function(a,c){b.getOptions().pageQuery.pageNumber+=1;this.fetch(a,c);return this};this.fetchPreviousPage=function(a,c){var d=b.getOptions().pageQuery;d.pageNumber-=1;0===d.pageNumber&&(d.pageNumber=1);this.fetch(a,c);return this};this.createNewConnection=function(c){c=c||{};c.__relationtype=d;c=new e.Appacitive.Connection(c);c.___collection=h;a.push(c);return c};this.map=function(){return a.map.apply(this,
...
(function(e){var f=function(d,b){d=d||function(){};b=b||function(){};var a=new e.Appacitive.HttpRequest;a.method="get";a.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getGetAllLinkedAccountsUrl(this.get("__id"));a.onSuccess=function(a){var e=null;a&&(a.identities&&0<a.identities.length)&&(a=a.identities.filter(function(a){return"facebook"==a.authtype.toLowerCase()}),1==a.length&&(e=a[0].username));null!==e?FB.api("/"+e,function(a){a?d(a):b()}):b({code:"404",message:"fb account not found"})};
a.onError=b;e.Appacitive.http.send(a)};e.Appacitive.Article=function(d,b){d=d||{};"string"==typeof d&&(d={__schematype:d});if(!d.__schematype&&!d.schema)throw Error("Cannot set article without __schematype");d.schema&&(d.__schematype=d.schema,delete d.schema);e.Appacitive.BaseObject.call(this,d,b);this.type="article";this.connectionCollections=[];this.getArticle=this.getObject;"user"==this.get("__schematype").toLowerCase()&&(this.getFacebookProfile=f);return this};e.Appacitive.Article.prototype=new e.Appacitive.BaseObject;
e.Appacitive.Article.prototype.constructor=e.Appacitive.Article;e.Appacitive.Article.prototype.getConnections=function(d){if("article"!=this.type)return null;d=d||{};d.articleId=this.get("__id");var b=new e.Appacitive.ConnectionCollection({relation:d.relation});this.connectionCollections.push(b);b.query=new e.Appacitive.Queries.GetConnectionsQuery(d);return b};e.Appacitive.Article.prototype.getConnectedArticles=function(d){d=d||{};"string"==typeof d&&(rName=d,d={relation:rName});d.articleId=this.get("__id");
var b=new e.Appacitive.ConnectionCollection({relation:d.relation});b.connectedArticle=this;this.connectionCollections.push(b);b.query=new e.Appacitive.Queries.ConnectedArticlesQuery(d);return b};e.Appacitive.Article.multiDelete=function(d,b,a){d=d||{};if(!d.schema||"string"!=typeof d.schema||0==d.schema.length)throw Error("Specify valid schema");if("user"==d.schema.toLowerCase()||"device"==d.schema.toLowerCase())throw Error("Cannot delete user and devices using multidelete");if(d.ids&&0<d.ids.length){b=
b||function(){};a=a||function(){};var c=new e.Appacitive.HttpRequest;c.url=e.Appacitive.config.apiBaseUrl+Appacitive.storage.urlFactory.article.getMultiDeleteUrl(d.schema);c.method="post";c.data={idlist:d.ids};c.onSuccess=function(c){c&&"200"==c.code?"function"==typeof b&&b():(c=c||{},"function"==typeof a&&a(c.status||{message:"Server error",code:400}))};c.onError=function(c){c=c||{};"function"==typeof a&&a(c.status||{message:"Server error",code:400})};e.Appacitive.http.send(c)}else b()};e.Appacitive.Article.multiGet=
function(d,b,a){d=d||{};if(!d.schema||"string"!=typeof d.schema||0==d.schema.length)throw Error("Specify valid schema");if(d.ids&&0<d.ids.length){var c=new e.Appacitive.HttpRequest;c.url=e.Appacitive.config.apiBaseUrl+Appacitive.storage.urlFactory.article.getMultiGetUrl(d.schema,d.ids.join(","),d.fields);c.method="get";c.onSuccess=function(c){if(c&&c.articles){if("function"==typeof b){var d=[];c.articles.forEach(function(a){d.push(new e.Appacitive.Article(a))});b(d,c.paginginfo)}}else c=c||{},"function"==
typeof a&&a(c.status||{message:"Server error",code:400})};c.onError=function(c){c=c||{message:"Server error",code:400};"function"==typeof a&&a(c)};e.Appacitive.http.send(c)}else"function"==typeof b&&b([])};e.Appacitive.Article.get=function(d,b,a){d=d||{};if(!d.schema)throw Error("Specify schema");if(!d.id)throw Error("Specify id to fetch");var c={},c="user"==d.schema.toLowerCase()?new e.Appacitive.User({__id:d.id}):new e.Appacitive.Article({__schematype:d.schema,__id:d.id});c.fields=d.fields;c.fetch(b,
a);return c}})(global);
(function(e){var f=function(a,c,b){var d={label:a.label};a.articleid&&(d.articleid=a.articleid);if(a.article)"function"==typeof a.article.getArticle?a.article.get("__id")?d.articleid=a.article.get("__id"):d.article=a.article.getArticle():"object"==typeof a.article&&a.article.__schematype&&(a.article.__id?d.articleid=a.article.__id:d.article=a.article,a.article=new e.Appacitive.Article(a.article));else if(!d.articleid&&!d.article)throw Error("Incorrectly configured endpoints provided to setupConnection");b["endpoint"+
c]=a;return d},d=function(a,c,b){a.article&&"object"==typeof a.article?(b["endpoint"+c]?b["endpoint"+c]&&b["endpoint"+c].article&&b["endpoint"+c].article.getArticle?b["endpoint"+c].article.copy(a.article):b["endpoint"+c].article=new e.Appacitive.Article(a.article):(b["endpoint"+c]={},b["endpoint"+c].article=new e.Appacitive.Article(a.article)),b["endpoint"+c].articleid=a.articleid,b["endpoint"+c].label=a.label,b["endpoint"+c].type=a.type,b["endpoint"+c].article.___collection=b.___collection):b["endpoint"+
c]=a};e.Appacitive.Connection=function(a,c){a=a||{};"string"==typeof a&&(a={__relationtype:a});if(!a.__relationtype&&!a.relation)throw new error("Cannot set connection without relation");a.relation&&(a.__relationtype=a.relation,delete a.relation);a.endpoints&&2==a.endpoints.length&&(a.__endpointa=a.endpoints[0],a.__endpointb=a.endpoints[1],delete a.endpoints);e.Appacitive.BaseObject.call(this,a);this.type="connection";this.getConnection=this.getObject;this.parseConnection=function(){var c="A",b="B";
if(a.__endpointa.label==this.get("__endpointb").label&&a.__endpointa.label!=a.__endpointb.label&&(a.__endpointa.articleid==this.get("__endpointb").articleid||!a.__endpointa.articleid))c="B",b="A";d(this.get("__endpointa"),c,this);d(this.get("__endpointb"),b,this);this.__defineGetter__("endpoints",function(){var a=[];a.push(this.endpointA);a.push(this.endpointB);return a});return this};c?(this.__defineGetter__("connectedArticle",function(){if(!this.___collection.connectedArticle)throw Error("connectedArticle can be accessed only by using the getConnectedArticles call");
...
e.Appacitive.Connection;e.Appacitive.Connection.prototype.setupConnection=function(a,c){if(!a||!a.articleid&&!a.article||!a.label||!c||!c.articleid&&!c.article||!c.label)throw Error("Incorrect endpoints configuration passed.");this.set("__endpointa",f(a,"A",this));this.set("__endpointb",f(c,"B",this))};e.Appacitive.Connection.get=function(a,c,b,d){options=options||{};if(!options.relation)throw Error("Specify relation");if(!options.id)throw Error("Specify id to fetch");a=new e.Appacitive.Connection({__relationtype:options.relation,
__id:options.id});a.fields=options.fields;a.fetch(b,d)};var b=function(a,c,b){a.onSuccess=function(a){if(a&&a.status&&"200"==a.status.code){if("function"==typeof c){var d=a.connections,f=[];d||(d=[]);d.forEach(function(a){f.push(new e.Appacitive.Connection(a))});c(f,a.paginginfo)}}else a=a||{},"function"==typeof b&&b(a.status||{message:"Server error",code:400})};a.onError=function(a){a=a||{message:"Server error",code:400};"function"==typeof b&&b(a)};e.Appacitive.http.send(a)};e.Appacitive.Connection.multiGet=
function(a,c,d,f){options=options||{};if(!options.relation||"string"!=typeof options.relation||0==options.relation.length)throw Error("Specify valid relation");if(options.ids&&0<options.ids.length)return a=new e.Appacitive.HttpRequest,a.url=e.Appacitive.config.apiBaseUrl+Appacitive.storage.urlFactory.connection.getMultiGetUrl(options.relation,options.ids.join(","),options.fields),a.method="get",b(a,d,f);"function"==typeof d&&d([])};e.Appacitive.Connection.multiDelete=function(a,c,b){a=a||{};if(!a.relation||
"string"!=typeof a.relation||0==a.relation.length)throw Error("Specify valid relation");if(a.ids&&0<a.ids.length){var d=new e.Appacitive.HttpRequest;d.url=e.Appacitive.config.apiBaseUrl+Appacitive.storage.urlFactory.connection.getMultiDeleteUrl(a.relation);d.method="post";d.data={idlist:a.ids};d.onSuccess=function(a){a&&"200"==a.code?"function"==typeof c&&c():(a=a||{},"function"==typeof b&&b(a||{message:"Server error",code:400}))};d.onError=function(a){a=a||{};"function"==typeof b&&b(a||{message:"Server error",
code:400})};e.Appacitive.http.send(d)}else c()};e.Appacitive.Connection.getInterconnects=function(a,c,d){a=new Appacitive.Queries.InterconnectsQuery(a);b(a.toRequest(),request,c,d)};e.Appacitive.Connection.getBetweenArticles=function(a,c,d){a=new Appacitive.Queries.GetConnectionsBetweenArticlesQuery(a);b(a.toRequest(),c,d)};e.Appacitive.Connection.getBetweenArticlesForRelation=function(a,c,b){a=(new Appacitive.Queries.GetConnectionsBetweenArticlesForRelationQuery(a)).toRequest();a.onSuccess=function(a){a&&
a.status&&"200"==a.status.code?"function"==typeof c&&(a=a.connection?new e.Appacitive.Connection(a.connection):null,"function"==typeof c&&c(a)):(a=a||{},"function"==typeof b&&b(a.status||{message:"Server error",code:400}))};a.onError=function(a){a=a||{};"function"==typeof b&&b(a.status||{message:"Server error",code:400})};e.Appacitive.http.send(a)}})(global);
(function(e){e.Appacitive.Users=new function(){var f=null;this.__defineGetter__("currentUser",function(){return f});var d=function(b,a,c,d){c=c||function(){};d=d||function(){};var f={authtype:"facebook",accesstoken:b,name:"facebook"};b=a.get("__id");if(a.get("__id")){var j=new e.Appacitive.HttpRequest;j.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getLinkAccountUrl(b);j.method="post";j.data=f;j.onSuccess=function(b){b&&"200"==b.code?(a.set("__link",f),"function"==typeof c&&
c(a)):d(b,a)};j.onError=d;e.Appacitive.http.send(j)}else a.set("__link",f),"function"==typeof c&&c(a)};this.setCurrentUser=function(b,a,c){if(!b||"object"!=typeof b||0<=b.length)throw Error("Cannot set null object as user");var g=b;b.getArticle||(g=new e.Appacitive.User(b,!0));if(!g.get("__id")||0==g.get("__id").length)throw Error("Specify user __id");e.Appacitive.localStorage.set("Appacitive-User",b);c||(c=60);f=g;a&&e.Appacitive.Session.setUserAuthHeader(a,c);f.logout=function(a){e.Appacitive.Users.logout(a)};
f.updatePassword=function(a,c,b,d){var g=this,f=b,n=d;b=g.get("__id");if(!b||"string"!==typeof b||0==b.length)throw Error("Please specify valid userid");if(!a||"string"!==typeof a||0==a.length)throw Error("Please specify valid oldPassword");if(!c||"string"!==typeof c||0==c.length)throw Error("Please specify valid newPassword");f=f||function(){};n=n||function(){};a==c?"function"==typeof f&&f(g):(a={oldpassword:a,newpassword:c},c=new e.Appacitive.HttpRequest,c.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getUpdatePasswordUrl(b),
c.method="post",c.data=a,c.onSuccess=function(a){a&&"200"==a.code&&("function"==typeof f?f(g):n(a,g))},c.onError=n,e.Appacitive.http.send(c));return this};f.linkFacebookAccount=function(a,c){var b=function(){d(Appacitive.Facebook.accessToken,f,function(c){e.Appacitive.eventManager.fire("user..article."+c.get("__id")+".updated",c,{object:c});"function"==typeof a&&a(c)},c)};Appacitive.Facebook.getCurrentUserInfo(function(){b()},function(){Appacitive.Facebook.requestLogin(function(){b()},c)});return this};
f.unlinkFacebookAccount=function(a,c){d("facebook",this,function(c){e.Appacitive.eventManager.fire("user.article."+c.get("__id")+".updated",c,{object:c});"function"==typeof a&&a(c)},c);return this};f.logout=function(a){Appacitive.Users.logout(a)};e.Appacitive.eventManager.clearAndSubscribe("user.article."+g.get("__id")+".updated",function(a,c){e.Appacitive.localStorage.set("Appacitive-User",c.object.getArticle())});return f};e.Appacitive.User=function(b){b=b||{};b.__schematype="user";e.Appacitive.Article.call(this,
b);return this};e.Appacitive.User.prototype=new e.Appacitive.Article("user");e.Appacitive.User.prototype.constructor=e.Appacitive.User;e.Appacitive.User.prototype.__defineGetter__("linkedAccounts",function(){var b=this.get("__link");b?"object"==typeof b&&!(0<=b.length)?b=[b]:0<=b.length||(b=b[0]):b=[];return b});e.Appacitive.User.prototype.getAllLinkedAccounts=function(b,a){b=b||function(){};var c=this,d=this,f=function(a){c.linkedAccounts=a;"function"==typeof b&&b(a,c)},j=a,k=d.get("__id");(!k||
"string"!==typeof k||0==k.length)&&"function"==typeof f&&f(d.linkedAccounts,d);var f=f||function(){},j=j||function(){},m=new e.Appacitive.HttpRequest;m.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getGetAllLinkedAccountsUrl(k);m.method="get";m.onSuccess=function(a){a&&a.status&&"200"==a.status.code?(a=a.identities||[],0<a.length?d.set("__link",a):d.set("__link",null),"function"==typeof f&&f(a,d)):j(a.status,d)};m.onError=j;e.Appacitive.http.send(m);return this};e.Appacitive.User.prototype.linkFacebookAccount=
function(b,a,c){d(b,this,a,c);return this};e.Appacitive.User.prototype.unlinkFacebookAccount=function(b,a){var c=this;var d=this,f=function(){var a=c.get("__link");a?0<=a.length||(a=a[0]):a=[];0<a.length&&"name"==a[0].name&&c.set("__link",null);"function"==typeof b&&b(c)},j=a,f=f||function(){},j=j||function(){},k=d.get("__id");if(d.get("__id")){var m=new e.Appacitive.HttpRequest;m.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getLinkAccountUrl(k,"facebook");m.method="post";
m.onSuccess=function(a){a&&"200"==a.code?"function"==typeof f&&f(d):j(a,d)};m.onError=j;e.Appacitive.http.send(m)}else"function"==typeof f&&f(d);return this};e.Appacitive.User.prototype.clone=function(){return new Appacitive.User(this.getObject())};this.deleteUser=function(b,a,c){if(!b)throw Error("Specify userid for user delete");(new e.Appacitive.Article({__schematype:"user",__id:b})).del(a||function(){},c||function(){})};this.deleteCurrentUser=function(b,a){b=b||function(){};if(null===f)throw Error("Current user is not yet set for delete operation");
var c=f.get("__id");this.deleteUser(c,function(a){e.Appacitive.Session.removeUserAuthHeader();"function"==typeof b&&b(a)},a)};this.createUser=this.createNewUser=function(b,a,c){b=b||{};b.__schematype="user";if(!b.username||!b.password||!b.firstname||0==b.username.length||0==b.password.length||0==b.firstname.length)throw Error("username, password and firstname are mandatory");(new e.Appacitive.User(b)).save(a,c)};this.signup=function(b,a,c){var d=this;this.createUser(b,function(){d.login(b.username,
b.password,a,c)},function(a){c(a)})};this.authenticateUser=function(b,a,c,d){a=a||function(){};c=c||function(){};b.expiry||(b.expiry=864E5);var f=this,j=new e.Appacitive.HttpRequest;j.method="post";j.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getAuthenticateUserUrl();j.data=b;j.onSuccess=function(e){e&&e.user?(d&&(e.user.__authType=d),f.setCurrentUser(e.user,e.token,b.expiry),a({user:f.currentUser,token:e.token})):(e=e||{},c(e.status))};j.onError=c;e.Appacitive.http.send(j)};
this.login=function(b,a,c,d){if(!b||!a||0==b.length||0==a.length)throw Error("Please specify username and password");this.authenticateUser({username:b,password:a,expiry:864E5},c||function(){},d||function(){},"BASIC")};this.loginWithFacebook=function(b,a,c){b=b||function(){};a=a||function(){};var d=this,f=function(){d.authenticateUser({accesstoken:e.Appacitive.Facebook.accessToken,type:"facebook",expiry:864E5,createnew:!0},function(c){c.user?(c.user.__authType="FB","function"==typeof b&&b({user:d.currentUser,
token:c.token})):(c=c||{},"function"==typeof a&&a(c.status))},a,"FB")};c?f():FB?Appacitive.Facebook.requestLogin(function(){f()},a):"function"==typeof a&&a()};this.authenticateWithFacebook=this.signupWithFacebook;this.validateCurrentUser=function(b,a){b&&("function"!=typeof b&&"boolean"==typeof b)&&(a=b,b=function(){});var c=e.Appacitive.Cookie.readCookie("Appacitive-UserToken");if(!c)return"function"==typeof b&&b(!1),!1;if(a)return"function"==typeof b&&b(!0),!0;try{var d=new e.Appacitive.HttpRequest;
d.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getValidateTokenUrl(c);d.method="POST";d.data={};d.onSuccess=function(a){"function"==typeof b&&b(a.result)};e.Appacitive.http.send(d)}catch(f){b(!1)}};this.sendResetPasswordEmail=function(b,a,c,d){c=c||function(){};d=d||function(){};if(!b||"string"!=typeof b||0==b.length)throw Error("Please specify valid username");if(a&&"string"==typeof a&&0==a.length)throw Error("Plase specify subject for email");b={username:b,subject:a};
a=new e.Appacitive.HttpRequest;a.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.user.getSendResetPasswordEmailUrl();a.method="post";a.data=b;a.onSuccess=function(a){a&&"200"==a.code&&("function"==typeof c?c():d(a))};a.onError=d;e.Appacitive.http.send(a)};this.logout=function(b,a){f=null;e.Appacitive.Session.removeUserAuthHeader(b||function(){},a)}}})(global);
(function(e){e.Appacitive.Email=new function(){var f={smtp:{username:null,password:null,host:"smtp.gmail.com",port:465,enablessl:!0},from:null,replyto:null};this.getConfig=function(){return f};var d=function(b,a,c){var d=new e.Appacitive.HttpRequest;d.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.email.getSendEmailUrl();d.method="post";d.data=b;d.onSuccess=function(b){b&&b.status&&"200"==b.status.code?a(b.email):(b=b||{},b.status=b.status||{},c(b.status.message||"Server error"))};
e.Appacitive.http.send(d)};this.setupEmail=function(b){b=b||{};f.smtp.username=b.username||f.smtp.username;f.from=b.from||f.from;f.smtp.password=b.password||f.smtp.password;f.smtp.host=b.smtp.host||f.smtp.host;f.smtp.port=b.smtp.port||f.smtp.port;f.smtp.enablessl=b.enableSSL||f.smtp.enablessl;f.replyto=b.replyTo||f.replyto};this.sendTemplatedEmail=function(b,a,c){a=a||function(){};c=c||function(){};if(!b||!b.to||!b.to.length||0==b.to.length)throw Error("Atleast one receipient is mandatory to send an email");
...
e.from=b.from||f.from;e.replyto=b.replyTo||f.replyto}d(e,a,c)};this.sendRawEmail=function(b,a,c){a=a||function(){};c=c||function(){};if(!b||!b.to||!b.to.length||0==b.to.length)throw Error("Atleast one receipient is mandatory to send an email");if(!b.subject||0==b.subject.trim().length)throw Error("Subject is mandatory to send an email");if(!b.body)throw Error("body is mandatory to send an email");var e={to:b.to||[],cc:b.cc||[],bcc:b.bcc||[],subject:b.subject,body:{content:b.body||"",ishtml:!1==b.isHtml?
!1:!0}};if(b.useConfig){e.smtp=f.smtp;if(!b.from&&!f.from)throw Error("from is mandatory to send an email. Set it in config or send it in options");e.from=b.from||f.from;e.replyto=b.replyTo||f.replyto}d(e,a,c)}}})(global);
(function(e){var f=function(){var d=require("facebook-node-sdk"),b=null,a=this.FB=null,c=!0;this.initialize=function(b){if(!d)throw Error("node-facebook SDK needs be loaded before calling initialize.");if(!b.appId)throw Error("Please provide appid");if(!b.appSecret)throw Error("Please provide app secret");a=b.appSecret;this.FB=new d({appId:_appId,secret:a});c=!0};this.requestLogin=function(a,d,e){c?(b=accesstoken,FB.setAccessToken(e),Appacitive.Users.loginWithFacebook(a,d,!0)):"function"==typeof d&&
d("Intialize facebook with your appid and appsecret")};this.getCurrentUserInfo=function(a,d){if(!c)throw Error("Either facebook sdk has not yet been initialized, or not yet loaded.");this.FB&&b?(a=a||function(){},d=d||function(){},this.FB.api("/me",function(c,b){b?"function"==typeof a&&a(b):"function"==typeof d&&d("Access token is invalid")})):d("Either intialize facebook with your appid and appsecret or set accesstoken")};this.__defineGetter__("accessToken",function(){return b});this.__defineSetter__("accessToken",
function(a){console.log(a);b=a;this.FB&&this.FB.setAccessToken(a)});this.getProfilePictureUrl=function(a){return"https://graph.facebook.com/"+a+"/picture"};this.logout=function(a){a=a||function(){};Appacitive.facebook.accessToken="";"function"==typeof a&&a()}};e.Appacitive.Facebook=e.Appacitive.runtime.isBrowser?new function(){var d=null,b=!0;this.initialize=function(a){if(!FB)throw"Facebook SDK needs be loaded before calling initialize.";if(!a.appId)throw Error("Please provide appid");FB.init(a);
b=!0};this.requestLogin=function(a,c){if(!b)throw Error("Either facebook sdk has not yet been initialized, or not yet loaded.");a=a||function(){};c=c||function(){};FB.login(function(b){b&&"connected"===b.status&&b.authResponse?(d=b.authResponse.accessToken,"function"==typeof a&&a(b.authResponse)):"function"==typeof c&&c()},{scope:"email,user_birthday"})};this.getCurrentUserInfo=function(a,c){if(!b)throw Error("Either facebook sdk has not yet been initialized, or not yet loaded.");a=a||function(){};
c=c||function(){};FB.api("/me",function(b){b&&!b.error?(d=FB.getAuthResponse().accessToken,"function"==typeof a&&a(b)):"function"==typeof c&&c()})};this.__defineGetter__("accessToken",function(){return d});this.__defineSetter__("accessToken",function(a){d=a});this.getProfilePictureUrl=function(a){return"https://graph.facebook.com/"+a+"/picture"};this.logout=function(a,c){a=a||function(){};c=c||function(){};Appacitive.facebook.accessToken="";try{FB.logout(function(){Appacitive.Users.logout();"function"==
typeof a&&a()})}catch(b){"function"==typeof c&&c(b.message)}}}:new f})(global);
(function(e){e.Appacitive.Push=new function(){this.send=function(f,d,b){d=d||function(){};b=b||function(){};if(!f)throw Error("Please specify push options");var a=new e.Appacitive.HttpRequest;a.url=e.Appacitive.config.apiBaseUrl+Appacitive.storage.urlFactory.push.getPushUrl();a.method="post";a.data=f;a.onSuccess=function(a){a&&a.status&&"200"==a.status.code?d(a.id):(a=a||{},a.status=a.status||{},b(a.status.message||"Server error"))};a.onError=function(a){b(a||"Server error")};e.Appacitive.http.send(a)};
this.getNotification=function(f,d,b){d=d||function(){};b=b||function(){};if(!f)throw Error("Please specify notification id");var a=new e.Appacitive.HttpRequest;a.url=e.Appacitive.config.apiBaseUrl+Appacitive.storage.urlFactory.push.getGetNotificationUrl(f);a.method="get";a.onSuccess=function(a){a&&a.status&&"200"==a.status.code?d(a.pushnotification):(a=a||{},a.status=a.status||{},b(a.status.message||"Server error"))};a.onError=function(a){b(a||"Server error")};e.Appacitive.http.send(a)};this.getAllNotifications=
function(f,d,b){d=d||function(){};b=b||function(){};f?(f.pnum=f.pnum||1,f.psize=f.psize||20):f={pnum:1,psize:20};var a=new e.Appacitive.HttpRequest;a.url=e.Appacitive.config.apiBaseUrl+Appacitive.storage.urlFactory.push.getGetAllNotificationsUrl(f);a.method="get";a.onSuccess=function(a){a&&a.status&&"200"==a.status.code?d(a.pushnotifications,a.paginginfo):(a=a||{},a.status=a.status||{},b(a.status.message||"Server error"))};a.onError=function(a){b(a||"Server error")};e.Appacitive.http.send(a)}}})(global);
(function(e){e.Appacitive.File=function(f){f=f||{};this.fileId=f.fileId;this.contentType=f.contentType;this.fileData=f.fileData;var d=function(a,b,c){var d=new e.Appacitive.HttpRequest;d.url=a;d.method="GET";d.onSuccess=b;d.onError=c;e.Appacitive.http.send(d)},b=function(a,b,c,d,f){(new FormData).append("fileToUpload",b);var l=new e.Appacitive.HttpRequest;l.url=a;l.method="PUT";l.data=b;l.headers.push({key:"content-type",value:c});l.onSuccess=d;l.onError=f;l.send(!0)};this.save=function(b,d,e){this.fileId&&
"string"==typeof this.fileId&&0<this.fileId.length?c(this,b,d,e):a(this,b,d,e)};var a=function(a,c,f,k){if(!a.fileData)throw Error("Please specify filedata");if(k||"string"==typeof k)a.contentType=k;else{if(!a.contentType||"string"!==typeof k||0==a.contentType.length)a.contentType="text/plain";try{a.contentType=file.type}catch(m){}}k=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.file.getUploadUrl(a.contentType);c=c||function(){};f=f||function(){};d(k,function(d){d&&d.status&&"200"==
d.status.code?b(d.url,a.fileData,a.contentType,function(){a.fileId=d.id;a.getDownloadUrl(function(b){c(b,a)},f)},f):"function"==typeof f&&f(d.status,a)},f);return this},c=function(a,c,f,k){if(!a.fileData)throw Error("Please specify filedata");if(k||"string"==typeof k)a.contentType=k;else{if(!a.contentType||"string"!==typeof k||0==a.contentType.length)a.contentType="text/plain";try{a.contentType=file.type}catch(m){}}k=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.file.getUpdateUrl(a.fileId,
a.contentType);c=c||function(){};f=f||function(){};d(k,function(d){d&&d.status&&"200"==d.status.code?b(d.url,a.fileData,a.contentType,function(){a.getDownloadUrl(function(b){c(b,a)},f)},f):"function"==typeof f&&f(d.status,a)},f);return this};this.deleteFile=function(a,b){if(!this.fileId)throw Error("Please specify fileId to delete");a=a||function(){};b=b||function(){};var c=new e.Appacitive.HttpRequest;c.url=e.Appacitive.config.apiBaseUrl+e.Appacitive.storage.urlFactory.file.getDeleteUrl(this.fileId);
...
(function(e){e.Appacitive.Date={};e.Appacitive.Date.parseISODate=function(e){try{var d=new Date(e);if(isNaN(d)){var b=/^([0-9]{1,4})-([0-9]{1,2})-([0-9]{1,2})T([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2})(.([0-9]+))?Z$/,a=!1;if(!b.exec(e))if(b=/^([0-9]{1,4})-([0-9]{1,2})-([0-9]{1,2})/,b.exec(e))a=!0;else return null;var c=e.split("T"),g=c[0].split("-"),h=c[1].split("Z")[0].split(":"),j=h[2].split("."),k=Number(h[0]),d=new Date;d.setUTCFullYear(Number(g[0]));d.setUTCMonth(Number(g[1])-1);d.setUTCDate(Number(g[2]));
a||(d.setUTCHours(Number(k)),d.setUTCMinutes(Number(h[1])),d.setUTCSeconds(Number(j[0])),j[1]&&d.setUTCMilliseconds(Number(j[1])))}return d}catch(m){return null}};e.Appacitive.Date.toISOString=function(e){try{return e=e.toISOString(),e=e.replace("Z","0000Z")}catch(d){return null}};e.Appacitive.Date.toISODate=function(e){try{return e=e.toISOString()[0]}catch(d){return null}};e.Appacitive.Date.toISOTime=function(e){try{return e=e.toISOString().split("T")[1],e=e.replace("Z","0000Z")}catch(d){return null}};
e.Appacitive.Date.parseISOTime=function(e){try{var d=new Date;if(!/^([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2})(.([0-9]+))?Z$/.exec(e))return null;var b=e.split("T");1==b.length&&b.push(b[0]);var a=b[1].split("Z")[0].split(":"),c=a[2].split(".");d.setUTCHours(Number(Number(a[0])));d.setUTCMinutes(Number(a[1]));d.setUTCSeconds(Number(c[0]));c[1]&&d.setUTCMilliseconds(Number(c[1]));return d}catch(g){return null}}})(global);
(function(e){e.Appacitive.localStorage=new function(){var f=e.Appacitive.runtime.isBrowser?window.localStorage:{};this.set=function(d,b){b=b||"";if(!d)return!1;if("object"==typeof b)try{b=JSON.stringify(b)}catch(a){}f[d]=b;return!0};this.get=function(d){if(!d)return null;d=f.getItem(d);if(!d)return null;if("{"==d[0])try{d=JSON.parse(d)}catch(b){}return d};this.remove=function(d){if(d)try{delete f[d]}catch(b){}}}})(global);
(function(e){e.Appacitive.runtime.isBrowser&&(e.Appacitive.Cookie=new function(){this.setCookie=function(e,d,b,a){if(b){var c=new Date;c.setTime(c.getTime()+6E4*b);c="; expires="+c.toGMTString()}a||(c="");document.cookie=e+"="+d+c+"; path=/"};this.readCookie=function(e){e+="=";for(var d=document.cookie.split(";"),b=0;b<d.length;b++){for(var a=d[b];" "==a.charAt(0);)a=a.substring(1,a.length);if(0==a.indexOf(e))return a.substring(e.length,a.length)}return null};this.eraseCookie=function(e){this.setCookie(e,
