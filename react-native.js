...
(function(global) {
    ...
    _BaseObject.prototype._copy = function(src, des) {
    ...
    _BaseObject.prototype._mergePrivateFields = function(attrs, del) {
    ...
    _BaseObject.prototype._getOutpuStatus = function(data) {
        data = data || {};
    ...
    _BaseObject.prototype.getObject = function() {
    ...
    _BaseObject.prototype.toJSON = function(recursive) {
    ...
    _BaseObject.prototype.properties = function() {
    ...
    _BaseObject.prototype.attr = function() {
    ...
    _BaseObject.prototype.getChangedAttributes = function() {
    ...
    _BaseObject.prototype.aggregate = function() {
        var aggregates = {};
    ...
    _BaseObject.prototype.tags = function() {
        if (!this._object.__tags) return [];
        return this._object.__tags;
    };

    _BaseObject.prototype.addTag = function(tag) {
    ...
    _BaseObject.prototype.removeTag = function(tag) {
        if (!tag || !_type.isString(tag) || !tag.length) return this;
        //tag = tag.toLowerCase();
    ...
    _BaseObject.prototype.getChangedTags = function() {
    ...
    _BaseObject.prototype.getRemovedTags = function() {
        return this._removetags;
    };

    _BaseObject.prototype._setMutliItems = function(key, value, op, options) {
    ...
    _BaseObject.prototype.add = function(key, value, options) {
        return this._setMutliItems(key, value, 'additems', options);
    };

    _BaseObject.prototype.addUnique = function(key, value, options) {
        return this._setMutliItems(key, value, 'adduniqueitems', options);
    };

    _BaseObject.prototype.remove = function(key, value, options) {
        return this._setMutliItems(key, value, 'removeitems', options);
    };

    _BaseObject.prototype._hasChanged = function(property, prevValue, currValue, isInternal) {
    ...
    _BaseObject.prototype._getChanged = function(isInternal) {
        var isDirty = false;
    ...
    _BaseObject.prototype.changed = function() {
        if (this.isNew()) return this.toJSON();
        return this._getChanged();
    };

    _BaseObject.prototype.hasChanged = function() {
    ...
    _BaseObject.prototype.changedAttributes = function() {
        if (this.isNew()) return this.toJSON();
    ...
    _BaseObject.prototype.previous = function() {
    ...
    _BaseObject.prototype.previousAttributes = function() {
        if (this.isNew()) return null;
        return _extend({}, this._snapshot);
    };

    _BaseObject.prototype.fields = function() {
        if (arguments.length == 1) {
            var value = arguments[0];
            if (_type.isString(value)) this._fields = value;
    ...
    _BaseObject.prototype.get = function(key, type) {
        if (key) {
    ...
    _BaseObject.prototype.tryGet = function(key, value, type) {
        var res = this.get(key, type);
        if (res !== undefined) return res;
        return value;
    };

    _BaseObject.prototype.triggerChangeEvent = function(key, options) {
    ...
    _BaseObject.prototype.triggerDestroy = function(opts) {
        if (opts && !opts.silent) this.trigger('destroy', this, this.collection, opts);
    };

    _BaseObject.prototype._triggerError = function(options, status) {
        if (!options.silent) this.trigger('error', this, status, options);
    };

    _BaseObject.prototype._set = function(key, value, options) {
    ...
    _BaseObject.prototype.set = function(key, val, options) {
    ...
    _BaseObject.prototype.unset = function(key, options) {
    ...
    _BaseObject.prototype._validate = function(attrs, options) {
    ...
    _BaseObject.prototype.copy = function(properties, setSnapShot) {
        if (properties) {
    ...
    _BaseObject.prototype.mergeWithPrevious = function() {
    ...
    _BaseObject.prototype._merge = function() {
    ...
    _BaseObject.prototype.rollback = function() {
        this._object = this.raw = {};
        this._merge();
        return this;
    };

    _BaseObject.prototype._atomic = function(key, amount, multiplier, options) {
        if (!key || !_type.isString(key) || key.length === 0 || key.indexOf('__') === 0) return this;
    ...
    _BaseObject.prototype.increment = function(key, amount, options) {
        return this._atomic(key, amount, 1, options);
    };

    _BaseObject.prototype.decrement = function(key, amount, options) {
        return this._atomic(key, amount, -1, options);
    };

    _BaseObject.prototype._findUnsavedChanges = function() {
    ...
    _BaseObject.prototype.getType = function() {
        var type = this.type;
    ...
    _BaseObject.prototype._parseOutput = function(options, data) {
    ...
    _BaseObject.prototype._save = function() {
        if (this.id) return this._update(arguments);
        else return this._create(arguments);
    };

    // to create the object
    _BaseObject.prototype._create = function(options) {
    ...
    _BaseObject.prototype._update = function(options, promise) {
    ...
    _BaseObject.prototype._fetch = function(options) {
    ...
    // delete the object
    _BaseObject.prototype._destroy = function(opts) {
        opts = opts || {};
...
(function(global) {
    ...
    Appacitive._Acl = function(o, setSnapshot) {
        ...
        var setPermission = function(access, type, sid, permissions) {
            ...
            var chAcl = changed.filter(function(a) {
                return (a.sid == sid && a.type == type);
            });
...
(function(global) {
    ...
    Appacitive.Object.extend = function(typeName, protoProps, staticProps) {
        ...
        entity = Appacitive.utils.classExtend(Appacitive.Object, protoProps, staticProps);
    ...
    var _parseObjects = function(objects, typeClass, metadata) {
        ...
        objects.forEach(function(a) {
            var obj = Appacitive.Object._create(_extend(a, {
                __meta: metadata
            }), true, typeClass);
            tmpObjects.push(obj);
        });
    ...
    Appacitive.Object.get = function(attrs, options) {
        ...
        var obj = Appacitive.Object._create({
            __type: attrs.type,
            __id: attrs.id
        });
    ...
    Appacitive.Object.prototype.getConnectedObjects = function(options) {
        if (this.isNew()) throw new Error("Cannot fetch connections for new object");
        options = options || {};
        if (_type.isString(options)) options = {
            relation: options
        };
...
(function(global) {
    ...
    Appacitive.Connection.extend = function(relationName, protoProps, staticProps) {
        ...
        entity = Appacitive.utils.classExtend(Appacitive.Connection, protoProps, staticProps);
    ...
    var _parseConnections = function(connections, relationClass, metadata) {
        ...
        connections.forEach(function(c) {
            connectionObjects.push(Appacitive.Connection._create(_extend(c, {
                __meta: metadata
            }), true, relationClass));
        });
    ...
    Appacitive.Connection.get = function(attrs, options) {
        attrs = attrs || {};
        if (_type.isString(attrs) && this.className) {
            attrs = {
                id: attrs
        ...
        if (!attrs.id) throw new Error("Specify id to fetch");
        var obj = Appacitive.Connection._create({
            __relationtype: attrs.relation,
            __id: attrs.id
        });
        obj.fields = attrs.fields;
        return obj.fetch(options);
  ...
  (function(global) {
      ...
      _extend(Appacitive.Collection.prototype, {
          ...
          getObject: function(options) {
              return this.models.map(function(model) {
                  return model.getObject(options);
              });
          },
          ...
          add: function(models, options) {
              ...
              if (sort && this.comparator) this.sort({
                  silent: true
              });
          ...
          fetch: function(options) {
              options = Appacitive.utils._clone(options) || {};
              ...
              query.fetch(options).then(function(results) {
                  if (options.reset == false) collection.add(results, _extend({
                      setSnapShot: true
                  }, options));
          ...
          create: function(model, options) {
              var collection = this;
              options = options ? Appacitive.utils._clone(options) : {};
              if (!(model = this._prepareModel(model, options))) return false;
              if (!options.wait) this.add(model, options);
              var success = options.success;
              options.success = function() {
                  if (options.wait) collection.add(model, _extend({
                      setSnapShot: true
                  }, options));
      ...
      Appacitive.Collection.extend = function(protoProps, classProps) {
          ...
          var child = Appacitive.utils.classExtend(this, protoProps, classProps);
...
(function(global) {
    ...
    Appacitive.LocalStorage = new (function() {
        ...
        this.set = function(key, value) {
            ...
            AsyncStorage.setItem(path, value.toString());
            return this;
        };
        ...
        this.multiGet = function() {
            ...
            if (arguments.length > 1) {
                ...
                keys.forEach(function(key) {
                    ...
                    key.replace(/\s/g, '').split(',').forEach(function(k) {
                        var p = self.get(k);
                        p.then(function(value, o) { output[o] = value });
                        promises.push(p);
                    });
                });
