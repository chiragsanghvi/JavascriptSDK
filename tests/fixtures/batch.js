...
var createProfile = function(attrs) {
    attrs = Appacitive.utils._extend({
        __type: 'profile'
    }, attrs);
...
var createConnection = function() {
    ...
    var profile = new Appacitive.Object({
        __type: 'profile',
        name: 'chirag sanghvi'
    });
...
asyncTest('Update/Create objects/connections using Multicaller API', function() {
    ...
    con1.save().then(function() {
        ...
        con2.save().then(function() {
            ...
            s5 = createSchool({
                location: new Appacitive.GeoCoord(12, 2)
            });
            ...
            m3 = new MySchool(x3, s2, {
                __id: con1.id,
                year: 1980
            });
            m4 = new MySchool(x3, s2, {
                __id: con1.id,
                year: 1980
            });
            m5 = new MySchool(x4, s4, {
                __id: con2.id
            });
